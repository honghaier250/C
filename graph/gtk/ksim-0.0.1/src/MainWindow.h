...
private:
    ...
    static gboolean TreeQueryTooltip(GtkWidget * view, gint x, gint y, gboolean key, GtkTooltip * tooltip, GtkTreeModel * model);
    static void TreeItemActivated(GtkWidget * view, GtkTreePath * path, GtkTreeViewColumn * column, GtkTreeModel * model);
    ...
    static void TreeDragDataReceived(GtkWidget * view, GdkDragContext * context, gint x, gint y, GtkSelectionData * select, guint info, guint time, GtkTreeModel * model);
    ...
    static void ListItemActivated(GtkWidget * view, GtkTreePath * path, GtkTreeViewColumn * column, GtkTreeModel * model);
    static gboolean ListPopupMenu(GtkWidget * view, GdkEventButton * event, gpointer data);    //
    static void ListDragDataReceived(GtkWidget * view, GdkDragContext * context, gint x, gint y, GtkSelectionData * select, guint info, guint time, GtkTreeModel * model);
    static void ButtonLoginCB(gpointer data);
};
