...
G_DEFINE_BOXED_TYPE(GIOChannel, g_io_channel, g_io_channel_ref, g_io_channel_unref) GType g_io_condition_get_type(void)
{
 ...
 * instance object.
 */
static void source_closure_marshal_BOOLEAN__VOID(GClosure * closure, GValue * return_value, guint n_param_values, const GValue * param_values, gpointer invocation_hint, gpointer marshal_data)
{
...
static gboolean g_child_watch_closure_callback(GPid pid, gint status, gpointer data)
{
    GClosure *closure = data;
...
#ifdef G_OS_UNIX
static gboolean g_unix_fd_source_closure_callback(int fd, GIOCondition condition, gpointer data)
{
    GClosure *closure = data;
...
#ifdef G_OS_UNIX
        source->source_funcs != &g_unix_fd_source_funcs && source->source_funcs != &g_unix_signal_funcs &&
#endif
        source->source_funcs != &g_child_watch_funcs && source->source_funcs != &g_io_watch_funcs && source->source_funcs != &g_timeout_funcs && source->source_funcs != &g_idle_funcs)
    {
...
static void dummy_closure_marshal(GClosure * closure, GValue * return_value, guint n_param_values, const GValue * param_values, gpointer invocation_hint, gpointer marshal_data)
{
