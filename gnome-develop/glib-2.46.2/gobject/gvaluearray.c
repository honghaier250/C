...
GValueArray *g_value_array_prepend(GValueArray * value_array, const GValue * value)
{
    ...
    G_GNUC_BEGIN_IGNORE_DEPRECATIONS return g_value_array_insert(value_array, 0, value);
...
GValueArray *g_value_array_append(GValueArray * value_array, const GValue * value)
{
    ...
    G_GNUC_BEGIN_IGNORE_DEPRECATIONS return g_value_array_insert(value_array, value_array->n_values, value);
G_GNUC_END_IGNORE_DEPRECATIONS}
...
GValueArray *g_value_array_sort_with_data(GValueArray * value_array, GCompareDataFunc compare_func, gpointer user_data)
{
    ...
    if (value_array->n_values)
        g_qsort_with_data(value_array->values, value_array->n_values, sizeof(value_array->values[0]), compare_func, user_data);
    return value_array;
}
