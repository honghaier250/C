...
void _g_boxed_type_init(void)
{
    ...
    /* G_TYPE_BOXED
     */
    type = g_type_register_fundamental(G_TYPE_BOXED, g_intern_static_string("GBoxed"), &info, &finfo, G_TYPE_FLAG_ABSTRACT | G_TYPE_FLAG_VALUE_ABSTRACT);
...
G_DEFINE_BOXED_TYPE(GValue, g_value, value_copy, value_free) G_DEFINE_BOXED_TYPE(GValueArray, g_value_array, g_value_array_copy, g_value_array_free) G_DEFINE_BOXED_TYPE(GDate, g_date, gdate_copy, g_date_free)
...
G_DEFINE_BOXED_TYPE(GPtrArray, g_ptr_array, g_ptr_array_ref, g_ptr_array_unref) G_DEFINE_BOXED_TYPE(GByteArray, g_byte_array, g_byte_array_ref, g_byte_array_unref) G_DEFINE_BOXED_TYPE(GBytes, g_bytes, g_bytes_ref, g_bytes_unref);

G_DEFINE_BOXED_TYPE(GRegex, g_regex, g_regex_ref, g_regex_unref) G_DEFINE_BOXED_TYPE(GMatchInfo, g_match_info, g_match_info_ref, g_match_info_unref)
...
G_DEFINE_BOXED_TYPE(GVariantDict, g_variant_dict, g_variant_dict_ref, g_variant_dict_unref) G_DEFINE_BOXED_TYPE(GError, g_error, g_error_copy, g_error_free) G_DEFINE_BOXED_TYPE(GDateTime, g_date_time, g_date_time_ref, g_date_time_unref);
...
G_DEFINE_BOXED_TYPE(GThread, g_thread, g_thread_ref, g_thread_unref) G_DEFINE_BOXED_TYPE(GChecksum, g_checksum, g_checksum_copy, g_checksum_free) G_DEFINE_BOXED_TYPE(GOptionGroup, g_option_group, g_option_group_ref, g_option_group_unref)
...
GType g_strv_get_type(void)
{
    ...
    {
        GType g_define_type_id = g_boxed_type_register_static(g_intern_static_string("GStrv"),
