...
static void g_closure_set_meta_va_marshal(GClosure * closure, GVaClosureMarshal va_meta_marshal)
{
...
void _g_closure_invoke_va(GClosure * closure, GValue /*out */  * return_value,
                          gpointer instance, va_list args, int n_params, GType * param_types)
{
    GRealClosure *real_closure;
...
void _g_closure_set_va_marshal(GClosure * closure, GVaClosureMarshal marshal)
{
    ...
    if (real_closure->va_marshal && real_closure->va_marshal != marshal)
        g_warning("attempt to override closure->va_marshal (%p) with new marshal (%p)", real_closure->va_marshal, marshal);
    else
...
static void g_type_class_meta_marshal(GClosure * closure, GValue /*out */  * return_value,
...
static void g_type_class_meta_marshalv(GClosure * closure, GValue * return_value, gpointer instance, va_list args, gpointer marshal_data, int n_params, GType * param_types)
{
    GRealClosure *real_closure;
    GTypeClass *class;
    gpointer callback;
...
static void g_type_iface_meta_marshal(GClosure * closure, GValue /*out */  * return_value,
                                      guint n_param_values, const GValue * param_values, gpointer invocation_hint, gpointer marshal_data)
{
    GTypeClass *class;
    gpointer callback;
...
static void g_type_iface_meta_marshalv(GClosure * closure, GValue * return_value, gpointer instance, va_list args, gpointer marshal_data, int n_params, GType * param_types)
{
    GRealClosure *real_closure;
    GTypeClass *class;
    gpointer callback;
...
#include <ffi.h>
static ffi_type *value_to_ffi_type(const GValue * gvalue, gpointer * value, gint * enum_tmpval, gboolean * tmpval_used)
{
...
static void value_from_ffi_type(GValue * gvalue, gpointer * value)
{
    ...
    switch (g_type_fundamental(G_VALUE_TYPE(gvalue)))
    {
        ...
        case G_TYPE_VARIANT:
            ...
            break;
        default:
            g_warning("value_from_ffi_type: Unsupported fundamental type: %s", g_type_name(g_type_fundamental(G_VALUE_TYPE(gvalue))));
    }
}
...
static ffi_type *va_to_ffi_type(GType gtype, va_list * va, va_arg_storage * storage)
{
    ffi_type *rettype = NULL;
