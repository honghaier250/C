...
static void test_registration_serial(void)
{
...
G_DEFINE_INTERFACE(Bar, bar, G_TYPE_OBJECT)
     static void bar_default_init(BarInterface * iface)
{
}
...
G_DEFINE_INTERFACE_WITH_CODE(Foo, foo, G_TYPE_OBJECT, g_type_interface_add_prerequisite(g_define_type_id, bar_get_type());
    )
     static void foo_default_init(FooInterface * iface)
{
}

static void test_interface_prerequisite(void)
{
    GType *prereqs;
    guint n_prereqs;
    gpointer iface;
...
G_DEFINE_INTERFACE(Baz, baz, G_TYPE_OBJECT)
     static void baz_default_init(BazInterface * iface)
{
}
...
G_DEFINE_TYPE_WITH_CODE(Bazo, bazo, G_TYPE_INITIALLY_UNOWNED, G_IMPLEMENT_INTERFACE(baz_get_type(), bazo_iface_init);
    )
     static void bazo_init(Bazo * b)
{
}

static void bazo_class_init(BazoClass * c)
{
}
...
static void check_func(gpointer check_data, gpointer g_iface)
{
...
static void test_interface_check(void)
{
    GObject *o;
...
static void test_next_base(void)
{
    GType type;
