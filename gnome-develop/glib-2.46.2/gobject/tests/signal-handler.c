...
G_DEFINE_TYPE(MyObj, my_obj, G_TYPE_OBJECT)
     static void my_obj_init(MyObj * o)
{
}

static void my_obj_class_init(MyObjClass * class)
{
    signals[SIGNAL1] = g_signal_new("signal1", G_TYPE_FROM_CLASS(class), G_SIGNAL_RUN_LAST, 0, NULL, NULL, NULL, G_TYPE_NONE, 0);
    signals[SIGNAL2] = g_signal_new("signal2", G_TYPE_FROM_CLASS(class), G_SIGNAL_RUN_LAST, 0, NULL, NULL, NULL, G_TYPE_NONE, 0);
}
...
static void test_connect_many(void)
{
    MyObj *o;
...
static void test_disconnect_many_ordered(void)
{
    MyObj *o;
...
static void test_disconnect_many_inverse(void)
{
    MyObj *o;
    gulong handlers[HANDLERS];
    gdouble time_elapsed;
...
static void test_disconnect_many_random(void)
{
    MyObj *o;
    gulong handlers[HANDLERS];
    gulong id;
...
static void test_disconnect_2_signals(void)
{
    MyObj *o;
    gulong handlers[HANDLERS];
    gulong id;
...
static void test_disconnect_2_objects(void)
{
    MyObj *o1, *o2, *o;
    gulong handlers[HANDLERS];
...
static void test_block_many(void)
{
    MyObj *o;
    gulong handlers[HANDLERS];
    gulong id;
