...
static void test_boxed_matchinfo(void)
{
    GRegex *r;
...
static void test_boxed_keyfile(void)
{
    GKeyFile *k, *k2;
    GValue value = G_VALUE_INIT;
...
static void test_boxed_mainloop(void)
{
    GMainLoop *l, *l2;
    GValue value = G_VALUE_INIT;
...
static void test_boxed_maincontext(void)
{
    GMainContext *c, *c2;
    GValue value = G_VALUE_INIT;
...
static void test_boxed_source(void)
{
    GSource *s, *s2;
    GValue value = G_VALUE_INIT;
...
static void test_boxed_variantbuilder(void)
{
...
static void test_boxed_timezone(void)
{
    GTimeZone *z, *z2;
    GValue value = G_VALUE_INIT;
...
static void test_boxed_pollfd(void)
{
    GPollFD *p, *p2;
    GValue value = G_VALUE_INIT;
...
static void test_boxed_markup(void)
{
...
static void test_boxed_thread(void)
{
    GThread *t, *t2;
    GValue value = G_VALUE_INIT;
...
static void test_boxed_checksum(void)
{
    GChecksum *c, *c2;
    GValue value = G_VALUE_INIT;
