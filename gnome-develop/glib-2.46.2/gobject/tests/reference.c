...
static void toggle_cb(gpointer data, GObject * obj, gboolean is_last)
{
    gboolean *b = data;
...
static void test_object_value(void)
{
    ...
    G_GNUC_BEGIN_IGNORE_DEPRECATIONS g_value_set_object_take_ownership(&value, v);
    G_GNUC_END_IGNORE_DEPRECATIONS toggled = FALSE;
    g_value_unset(&value);
    g_assert(toggled);
...
static void test_weak_ref(void)
{
    GObject *obj;
    GObject *obj2;
    GObject *tmp;
...
static void toggle_notify(gpointer data, GObject * obj, gboolean is_last)
{
    Count *c = data;
...
static void test_toggle_ref(void)
{
    GObject *obj;
    Count c, c2;
...
static void test_object_qdata(void)
{
    GObject *obj;
    gpointer v;
    GQuark quark;
...
static gpointer ref_value(gpointer value, gpointer user_data)
{
    Value *v = value;
...
static void unref_value(gpointer value)
{
    Value *v = value;
...
static Value *new_value(const gchar * s)
{
    Value *v;
...
static void test_object_qdata2(void)
{
    GObject *obj;
