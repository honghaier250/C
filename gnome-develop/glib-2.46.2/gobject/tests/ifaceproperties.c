...
{
    inherited_spec1 = iface_spec1 = g_param_spec_int("prop1", "Prop1", "Property 1", G_MININT,    /* min */
                                                     0xFFFF,    /* max */
                                                     42,    /* default */
                                                     G_PARAM_READWRITE | G_PARAM_CONSTRUCT);
    g_object_interface_install_property(iface_vtable, iface_spec1);

    iface_spec2 = g_param_spec_int("prop2", "Prop2", "Property 2", G_MININT,    /* min */
                                   G_MAXINT,    /* max */
                                   0,    /* default */
                                   G_PARAM_WRITABLE);
    g_object_interface_install_property(iface_vtable, iface_spec2);

    inherited_spec3 = iface_spec3 = g_param_spec_int("prop3", "Prop3", "Property 3", G_MININT,    /* min */
                                                     G_MAXINT,    /* max */
                                                     0,    /* default */
                                                     G_PARAM_READWRITE);
...
static void base_object_class_init(BaseObjectClass * class)
{
     ...
     */
    inherited_spec2 = g_param_spec_int("prop2", "Prop2", "Property 2", G_MININT,    /* min */
                                       G_MAXINT,    /* max */
                                       0,    /* default */
                                       G_PARAM_READWRITE);
    ...
    inherited_spec4 = g_param_spec_int("prop4", "Prop4", "Property 4", G_MININT,    /* min */
                                       G_MAXINT,    /* max */
                                       0,    /* default */
                                       G_PARAM_READWRITE);
...
static void test_not_overridden(void)
{
    ...
    g_test_expect_message(G_LOG_DOMAIN, G_LOG_LEVEL_CRITICAL, "*Base2Object doesn't implement property 'prop3' from interface 'TestIface'*");
