...
G_BEGIN_DECLS typedef struct _GVariant GVariant;
...
GLIB_AVAILABLE_IN_ALL GVariant * g_variant_new_byte(guchar value);
...
GLIB_AVAILABLE_IN_2_38 GVariant * g_variant_new_printf(const gchar * format_string, ...) G_GNUC_PRINTF(1, 2);
...
GLIB_AVAILABLE_IN_ALL guchar g_variant_get_byte(GVariant * value);
