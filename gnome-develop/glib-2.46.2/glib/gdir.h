...
G_BEGIN_DECLS typedef struct _GDir GDir;
...
GLIB_AVAILABLE_IN_ALL GDir * g_dir_open_utf8(const gchar * path, guint flags, GError ** error);
GLIB_AVAILABLE_IN_ALL const gchar *g_dir_read_name_utf8(GDir * dir);
#        endif                    /* G_OS_WIN32 */
