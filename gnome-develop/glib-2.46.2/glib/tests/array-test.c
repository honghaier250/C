...
static void my_clear_func(gpointer data)
{
    num_clear_func_invocations += 1;
}

static void array_clear_func(void)
{
    GArray *garray;
    gint i;
    gint cur;
...
static void pointer_array_insert(void)
{
    GPtrArray *gparray;
    gint i;
    gint sum = 0;
...
static void byte_array_new_take(void)
{
    GByteArray *gbarray;
    guint8 *data;
...
static void byte_array_free_to_bytes(void)
{
    GByteArray *gbarray;
    gpointer memory;
    GBytes *bytes;
