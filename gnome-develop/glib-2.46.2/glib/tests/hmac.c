...
HmacCase hmac_sha1_tests[] = {
    ...
    {G_CHECKSUM_SHA1, key_sha1_test6_7, 80,
     ...
     result_sha1_test6},
    {G_CHECKSUM_SHA1, key_sha1_test6_7, 80,
     "Test Using Larger Than Block-Size Key and Larger" " Than One Block-Size Data", 73, result_sha1_test7,},
    {-1, NULL, 0, NULL, 0, NULL},
};
...
HmacCase hmac_sha256_tests[] = {
    ...
    {G_CHECKSUM_SHA256, key_sha256_test5_6, 131,
     ...
     result_sha256_test5},
    {G_CHECKSUM_SHA256, key_sha256_test5_6, 131,
     "This is a test using a larger than block-size key and a larger than " "block-size data. The key needs to be hashed before being used by the " "HMAC algorithm.", 152, result_sha256_test6,},
    {-1, NULL, 0, NULL, 0, NULL},
};
...
HmacCase hmac_sha512_tests[] = {
    ...
    {G_CHECKSUM_SHA512, key_sha256_test5_6, 131,
     ...
     result_sha512_test5},
    {G_CHECKSUM_SHA512, key_sha256_test5_6, 131,
     "This is a test using a larger than block-size key and a larger than " "block-size data. The key needs to be hashed before being used by the " "HMAC algorithm.", 152, result_sha512_test6,},
    {-1, NULL, 0, NULL, 0, NULL},
};

static void test_hmac(HmacCase * t)
{
    GHmac *hmac;
...
static void test_hmac_ref_unref(void)
{
    GHmac *hmac, *check;
...
static void test_hmac_copy(void)
{
    GHmac *hmac, *check;
...
static void test_hmac_for_data(void)
{
    gchar *string;
    GHmac *hmac;

    string = g_compute_hmac_for_data(G_CHECKSUM_SHA1, (guchar *) "aaa", 3, (guchar *) "bcdef", 5);
...
static void test_hmac_for_string(void)
{
    gchar *string;
    GHmac *hmac;

    string = g_compute_hmac_for_string(G_CHECKSUM_SHA1, (guchar *) "aaa", 3, "bcdef", -1);
...
int main(int argc, char **argv)
{
    ...
    for (i = 0; hmac_sha1_tests[i].key_len > 0; i++)
    {
        ...
        g_test_add_data_func(name, hmac_sha1_tests + i, (void (*)(const void *)) test_hmac);
        g_free(name);
    }
    ...
    for (i = 0; hmac_sha256_tests[i].key_len > 0; i++)
    {
        ...
        g_test_add_data_func(name, hmac_sha256_tests + i, (void (*)(const void *)) test_hmac);
        g_free(name);
    }
    ...
    for (i = 0; hmac_sha512_tests[i].key_len > 0; i++)
    {
        ...
        g_test_add_data_func(name, hmac_sha512_tests + i, (void (*)(const void *)) test_hmac);
        g_free(name);
    }
    ...
    for (i = 0; hmac_md5_tests[i].key_len > 0; i++)
    {
        ...
        g_test_add_data_func(name, hmac_md5_tests + i, (void (*)(const void *)) test_hmac);
        g_free(name);
    }
