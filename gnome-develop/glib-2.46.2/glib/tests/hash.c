...
static void direct_hash_test2(void)
{
    gint i, rc;
    GHashTable *h;
...
static void set_check(gpointer key, gpointer value, gpointer user_data)
{
    int *pi = user_data;
    if (key != value)
        g_assert_not_reached();
...
static void set_hash_test(void)
{
...
static guint null_safe_str_hash(gconstpointer key)
{
    if (key == NULL)
        return 0;
    else
...
static gboolean null_safe_str_equal(gconstpointer a, gconstpointer b)
{
    return g_strcmp0(a, b) == 0;
}

static void test_lookup_null_key(void)
{
    GHashTable *h;
    gboolean res;
    gpointer key;
...
static void key_destroy(gpointer key)
{
    destroy_key_counter++;
}
...
static void recursive_value_destroy(gpointer value)
{
    destroy_counter++;
...
static void test_recursive_remove_all_subprocess(void)
{
    GHashTable *h;
...
static void test_recursive_remove_all(void)
{
...
static gboolean eq_func(gconstpointer a, gconstpointer b)
{
...
static void key_unref(gpointer data)
{
...
static RefCountedKey *key_ref(RefCountedKey * key)
{
    key->ref_count += 1;
...
static RefCountedKey *key_new(const gchar * key)
{
    RefCountedKey *rkey;
...
static void set_ref_hash_test(void)
{
    GHashTable *h;
    RefCountedKey *key1;
    RefCountedKey *key2;
...
static void fake_free(gpointer dead)
{
    guint i;
...
static void value_destroy_insert(gpointer value)
{
    g_hash_table_remove_all(h);
}

static void test_destroy_modify(void)
{
    FakeFreeData *ffd;
    guint i;
...
static void foreach_func(gpointer key, gpointer value, gpointer data)
{
...
static gboolean foreach_steal_func(gpointer key, gpointer value, gpointer data)
{
...
static void test_foreach_steal(void)
{
    GHashTable *hash;
    GHashTable *hash2;
...
static void count_keys(GHashTable * h, gint * unused, gint * occupied, gint * tombstones)
{
    gint i;
...
static void check_data(GHashTable * h)
{
    gint i;
...
static void check_consistency(GHashTable * h)
{
    gint unused;
    gint occupied;
    gint tombstones;
...
static void check_counts(GHashTable * h, gint occupied, gint tombstones)
{
    g_assert_cmpint(occupied, ==, h->nnodes);
    g_assert_cmpint(occupied + tombstones, ==, h->noccupied);
}

static void trivial_key_destroy(gpointer key)
{
}
...
static void my_key_free(gpointer v)
{
    gchar *s = v;
    g_assert(s[0] != 'x');
    s[0] = 'x';
...
static void my_value_free(gpointer v)
{
    gchar *s = v;
    g_assert(s[0] != 'y');
    s[0] = 'y';
...
static void test_iter_replace(void)
{
    GHashTable *h;
    GHashTableIter iter;
    gpointer k, v;
...
static void replace_first_character(gchar * string)
{
    string[0] = 'b';
}

static void test_set_insert_corruption(void)
{
    GHashTable *hash_table = g_hash_table_new_full(g_str_hash, g_str_equal,
...
static void test_set_to_strv(void)
{
    GHashTable *set;
    gchar **strv;
    guint n;
...
static gboolean is_prime(guint p)
{
    guint i;
