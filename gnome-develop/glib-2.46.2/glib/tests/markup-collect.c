...
static void start(GMarkupParseContext * context, const char *element_name, const char **attribute_names, const char **attribute_values, gpointer user_data, GError ** error)
{
...
static void start_element(GMarkupParseContext * context, const gchar * element_name, const gchar ** attribute_names, const gchar ** attribute_values, gpointer user_data, GError ** error)
{
    ...
    g_markup_collect_attributes(element_name, attribute_names, attribute_values, error, G_MARKUP_COLLECT_STRING, "a", NULL, G_MARKUP_COLLECT_STRING, "b", NULL, G_MARKUP_COLLECT_INVALID);
}
...
static void test_cleanup(void)
{
    ...
    g_test_expect_message(G_LOG_DOMAIN, G_LOG_LEVEL_CRITICAL, "g_markup_parse_context_end_parse: assertion 'context->state != STATE_ERROR' failed");
