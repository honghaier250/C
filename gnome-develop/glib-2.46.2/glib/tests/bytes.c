...
static void test_new_take(void)
{
    gchar *data;
    GBytes *bytes;
    gsize size;
...
static void test_new_static(void)
{
    const gchar *data;
    GBytes *bytes;
    gsize size;
...
static void test_new_from_bytes(void)
{
...
static void on_destroy_increment(gpointer data)
{
    gint *count = data;
    g_assert(count != NULL);
    (*count)++;
...
static void test_new_with_free_func(void)
{
    GBytes *bytes;
    gchar *data;
    gint count = 0;
...
static void test_to_data_transferred(void)
{
...
static void test_to_data_two_refs(void)
{
    gconstpointer memory;
    gpointer data;
    gsize size;
...
static void test_to_data_non_malloc(void)
{
    gpointer data;
    gsize size;
    GBytes *bytes;
...
static void test_to_array_transferred(void)
{
    gconstpointer memory;
    GByteArray *array;
    GBytes *bytes;
...
static void test_to_array_two_refs(void)
{
    gconstpointer memory;
    GByteArray *array;
    GBytes *bytes;
...
static void test_to_array_non_malloc(void)
{
    GByteArray *array;
    GBytes *bytes;
