...
static void test_list_insert_sorted_with_data(void)
{
    ...
    for (i = 0; i < SIZE; i++)
        list = g_list_insert_sorted_with_data(list, GINT_TO_POINTER(array[i]), (GCompareDataFunc) sort, NULL);
...
static gpointer multiply_value(gconstpointer value, gpointer data)
{
