...
static void test_filename_utf8(void)
{
...
static void test_filename_display(void)
{
    const gchar *filename = "/my/path/to/foo";
    char *display;
...
static void test_no_conv(void)
{
    ...
    out = g_convert(in, -1, "XXX", "UVZ", &bytes_read, &bytes_written, &error);
