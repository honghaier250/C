...
#    endif
    ...
    g_return_val_if_fail(format_char == 'e' || format_char == 'E' || format_char == 'f' || format_char == 'F' || format_char == 'g' || format_char == 'G', NULL);
...
static guint64 g_parse_long_long(const gchar * nptr, const gchar ** endptr, guint base, gboolean * negative)
{
...
static void index_add_folded(GPtrArray * array, const gchar * start, const gchar * end)
{
    gchar *normal;
