...
G_BEGIN_DECLS typedef enum        /*< flags > */
{
...
GLIB_AVAILABLE_IN_ALL gboolean g_main_context_wait(GMainContext * context, GCond * cond, GMutex * mutex);
...
GLIB_AVAILABLE_IN_ALL gint g_main_context_check(GMainContext * context, gint max_priority, GPollFD * fds, gint n_fds);
 ...
 */
     GLIB_AVAILABLE_IN_ALL void g_get_current_time(GTimeVal * result);
