...
G_BEGIN_DECLS typedef struct _GRelation GRelation;
...
GLIB_DEPRECATED_IN_2_26 void g_relation_insert(GRelation * relation, ...);
...
GLIB_DEPRECATED_IN_2_26 gboolean g_relation_exists(GRelation * relation,...);
