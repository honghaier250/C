...
static void sha512_transform(guint64 H[8], guint8 const data[SHA512_BLOCK_LEN])
{
    gint i;
    gint t;
    ...
    for (i = 0; i < 16; i++)
    {
        ...
        M[i] =
            ((guint64) data[p + 0] << 56) |
            ((guint64) data[p + 1] << 48) | ((guint64) data[p + 2] << 40) | ((guint64) data[p + 3] << 32) | ((guint64) data[p + 4] << 24) | ((guint64) data[p + 5] << 16) | ((guint64) data[p + 6] << 8) | ((guint64) data[p + 7]);
    }
...
static void sha512_sum_update(Sha512sum * sha512, const guchar * buffer, gsize length)
{
