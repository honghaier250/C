...
GLIB_AVAILABLE_IN_ALL GDateTime * g_date_time_new_from_timeval_local(const GTimeVal * tv);
GLIB_AVAILABLE_IN_ALL GDateTime * g_date_time_new_from_timeval_utc(const GTimeVal * tv);
...
GLIB_AVAILABLE_IN_ALL gboolean g_date_time_to_timeval(GDateTime * datetime, GTimeVal * tv);
