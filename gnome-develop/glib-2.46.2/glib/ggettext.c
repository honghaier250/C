 ...
 * Since: 2.18
 */
const gchar *g_dpgettext2(const gchar * domain, const gchar * msgctxt, const gchar * msgid)
{
...
static gboolean _g_dgettext_should_translate(void)
{
    ...
    if (G_UNLIKELY(g_once_init_enter(&translate)))
    {
         ...
         */
        if (!default_domain || !translator_comment || !translate_locale || (0 != strcmp(default_domain, "messages") && '\0' == *translator_comment && 0 != strncmp(translate_locale, "en_", 3) && 0 != strcmp(translate_locale, "C")))
