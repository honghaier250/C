...
static const gchar *lookup_in_item(guint item_id, const gunichar * key, gint * result_len, gint * key_consumed);
...
static const gchar *lookup_in_mapping(const struct mapping_entry *mapping, gint mapping_size, const gunichar * key, gint * result_len, gint * key_consumed)
{
...
static const gchar *lookup_in_chain(const guint8 * chain, const gunichar * key, gint * result_len, gint * key_consumed)
{
    const gchar *result;
