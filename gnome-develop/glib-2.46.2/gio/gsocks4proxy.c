...
G_DEFINE_TYPE_WITH_CODE(GSocks4Proxy, g_socks4_proxy, G_TYPE_SOCKS4A_PROXY, _g_io_modules_ensure_extension_points_registered(); g_io_extension_point_implement(G_PROXY_EXTENSION_POINT_NAME, g_define_type_id, "socks4", 0))
