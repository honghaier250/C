...
GLIB_AVAILABLE_IN_ALL GType g_file_icon_get_type(void) G_GNUC_CONST;

GLIB_AVAILABLE_IN_ALL GIcon * g_file_icon_new(GFile * file);

GLIB_AVAILABLE_IN_ALL GFile * g_file_icon_get_file(GFileIcon * icon);
