...
static void g_app_launch_context_class_init(GAppLaunchContextClass * klass)
{
   ...
   * Since: 2.36
   */
    signals[LAUNCH_FAILED] = g_signal_new(I_("launch-failed"), G_OBJECT_CLASS_TYPE(object_class), G_SIGNAL_RUN_LAST, G_STRUCT_OFFSET(GAppLaunchContextClass, launch_failed), NULL, NULL, NULL, G_TYPE_NONE, 1, G_TYPE_STRING);
   ...
   * Since: 2.36
   */
    signals[LAUNCHED] = g_signal_new(I_("launched"), G_OBJECT_CLASS_TYPE(object_class), G_SIGNAL_RUN_LAST, G_STRUCT_OFFSET(GAppLaunchContextClass, launched), NULL, NULL, NULL, G_TYPE_NONE, 2, G_TYPE_APP_INFO, G_TYPE_VARIANT);
}
...
void g_app_launch_context_setenv(GAppLaunchContext * context, const char *variable, const char *value)
{
    ...
    context->priv->envp = g_environ_setenv(context->priv->envp, variable, value, TRUE);
}
...
static void g_app_info_monitor_class_init(GAppInfoMonitorClass * class)
{
   ...
   **/
    g_app_info_monitor_changed_signal = g_signal_new(I_("changed"), G_TYPE_APP_INFO_MONITOR, G_SIGNAL_RUN_FIRST, 0, NULL, NULL, g_cclosure_marshal_VOID__VOID, G_TYPE_NONE, 0);
...
{
    return g_context_specific_group_get(&g_app_info_monitor_group, G_TYPE_APP_INFO_MONITOR, G_STRUCT_OFFSET(GAppInfoMonitor, context), NULL);
}
