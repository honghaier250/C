...
typedef struct
{
    ...
    void (*keys_changed) (GObject * target, GSettingsBackend * backend, const gchar * prefix, gpointer origin_tag, const gchar * const *names);
...
gboolean g_settings_backend_get_writable(GSettingsBackend * backend, const char *key);
