...
struct _GNotificationBackendClass
{
    ...
    void (*send_notification) (GNotificationBackend * backend, const gchar * id, GNotification * notification);

    void (*withdraw_notification) (GNotificationBackend * backend, const gchar * id);
};
