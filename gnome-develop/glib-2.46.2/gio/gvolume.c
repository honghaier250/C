     ...
     static void g_volume_default_init(GVolumeInterface * iface)
{
   ...
   */
    g_signal_new(I_("changed"), G_TYPE_VOLUME, G_SIGNAL_RUN_LAST, G_STRUCT_OFFSET(GVolumeIface, changed), NULL, NULL, g_cclosure_marshal_VOID__VOID, G_TYPE_NONE, 0);
   ...
   */
    g_signal_new(I_("removed"), G_TYPE_VOLUME, G_SIGNAL_RUN_LAST, G_STRUCT_OFFSET(GVolumeIface, removed), NULL, NULL, g_cclosure_marshal_VOID__VOID, G_TYPE_NONE, 0);
}
...
void g_volume_mount(GVolume * volume, GMountMountFlags flags, GMountOperation * mount_operation, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    {
        g_task_report_new_error(volume, callback, user_data, g_volume_mount, G_IO_ERROR, G_IO_ERROR_NOT_SUPPORTED, _("volume doesn't implement mount"));
        return;
    }
...
void g_volume_eject(GVolume * volume, GMountUnmountFlags flags, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    if (iface->eject == NULL)
    {
        g_task_report_new_error(volume, callback, user_data, g_volume_eject_with_operation, G_IO_ERROR, G_IO_ERROR_NOT_SUPPORTED, _("volume doesn't implement eject"));
        return;
    }
...
void g_volume_eject_with_operation(GVolume * volume, GMountUnmountFlags flags, GMountOperation * mount_operation, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    {
        g_task_report_new_error(volume, callback, user_data, g_volume_eject_with_operation, G_IO_ERROR, G_IO_ERROR_NOT_SUPPORTED,
