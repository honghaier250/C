...
G_DEFINE_TYPE_WITH_CODE(GWin32FileMonitor, g_win32_file_monitor, G_TYPE_LOCAL_FILE_MONITOR, g_io_extension_point_implement(G_LOCAL_FILE_MONITOR_EXTENSION_POINT_NAME, g_define_type_id, "win32filemonitor", 20))
     static void g_win32_file_monitor_start(GLocalFileMonitor * monitor, const gchar * dirname, const gchar * basename, const gchar * filename, GFileMonitorSource * source)
{
...
static gboolean g_win32_file_monitor_is_supported(void)
{
    return TRUE;
}

static void g_win32_file_monitor_init(GWin32FileMonitor * monitor)
{
...
static void g_win32_file_monitor_finalize(GObject * base)
{
...
static gboolean g_win32_file_monitor_cancel(GFileMonitor * monitor)
{
...
static void g_win32_file_monitor_class_init(GWin32FileMonitorClass * klass)
{
