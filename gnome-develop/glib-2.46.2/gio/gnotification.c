...
void g_notification_add_button_with_target_value(GNotification * notification, const gchar * label, const gchar * action, GVariant * target)
{
    ...
    {
        g_warning("%s: action '%s' does not start with 'app.'." "This is unlikely to work properly.", G_STRFUNC, action);
    }
 ...
 * g_notification_get_n_buttons().
 */
void g_notification_get_button(GNotification * notification, gint index, gchar ** label, gchar ** action, GVariant ** target)
{
    Button *button;
 ...
 */
gint g_notification_get_button_with_action(GNotification * notification, const gchar * action)
{
    guint i;
 ...
 */
gboolean g_notification_get_default_action(GNotification * notification, gchar ** action, GVariant ** target)
{
...
GVariant *g_notification_serialize(GNotification * notification)
{
    ...
    {
        g_variant_builder_add(&builder, "{sv}", "default-action", g_variant_new_string(notification->default_action));

        if (notification->default_action_target)
            g_variant_builder_add(&builder, "{sv}", "default-action-target", notification->default_action_target);
    }
