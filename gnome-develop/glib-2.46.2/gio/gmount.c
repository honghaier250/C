     ...
     static void g_mount_default_init(GMountInterface * iface)
{
   ...
   * finalized.
   **/
    g_signal_new(I_("unmounted"), G_TYPE_MOUNT, G_SIGNAL_RUN_LAST, G_STRUCT_OFFSET(GMountIface, unmounted), NULL, NULL, g_cclosure_marshal_VOID__VOID, G_TYPE_NONE, 0);
  /**
   * GMount::pre-unmount:
   * @mount: the object on which the signal is emitted
   *
   ...
   * Since: 2.22
   **/
    g_signal_new(I_("pre-unmount"), G_TYPE_MOUNT, G_SIGNAL_RUN_LAST, G_STRUCT_OFFSET(GMountIface, pre_unmount), NULL, NULL, g_cclosure_marshal_VOID__VOID, G_TYPE_NONE, 0);
}
...
void g_mount_unmount(GMount * mount, GMountUnmountFlags flags, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    {
        g_task_report_new_error(mount, callback, user_data, g_mount_unmount_with_operation, G_IO_ERROR, G_IO_ERROR_NOT_SUPPORTED,
...
void g_mount_eject(GMount * mount, GMountUnmountFlags flags, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    if (iface->eject == NULL)
    {
        g_task_report_new_error(mount, callback, user_data, g_mount_eject_with_operation, G_IO_ERROR, G_IO_ERROR_NOT_SUPPORTED,
                                /* Translators: This is an error
                                 * message for mount objects that
...
void g_mount_remount(GMount * mount, GMountMountFlags flags, GMountOperation * mount_operation, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    {
        g_task_report_new_error(mount, callback, user_data, g_mount_remount, G_IO_ERROR, G_IO_ERROR_NOT_SUPPORTED,
                                /* Translators: This is an error
                                 * message for mount objects that
...
void g_mount_guess_content_type(GMount * mount, gboolean force_rescan, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    {
        g_task_report_new_error(mount, callback, user_data, g_mount_guess_content_type, G_IO_ERROR, G_IO_ERROR_NOT_SUPPORTED,
                                /* Translators: This is an error
                                 * message for mount objects that
