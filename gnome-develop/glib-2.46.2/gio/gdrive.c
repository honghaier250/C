     ...
     static void g_drive_default_init(GDriveInterface * iface)
{
   ...
   **/
    g_signal_new(I_("changed"), G_TYPE_DRIVE, G_SIGNAL_RUN_LAST, G_STRUCT_OFFSET(GDriveIface, changed), NULL, NULL, g_cclosure_marshal_VOID__VOID, G_TYPE_NONE, 0);
   ...
   * finalized.
   **/
    g_signal_new(I_("disconnected"), G_TYPE_DRIVE, G_SIGNAL_RUN_LAST, G_STRUCT_OFFSET(GDriveIface, disconnected), NULL, NULL, g_cclosure_marshal_VOID__VOID, G_TYPE_NONE, 0);
   ...
   * been pressed.
   **/
    g_signal_new(I_("eject-button"), G_TYPE_DRIVE, G_SIGNAL_RUN_LAST, G_STRUCT_OFFSET(GDriveIface, eject_button), NULL, NULL, g_cclosure_marshal_VOID__VOID, G_TYPE_NONE, 0);
   ...
   * Since: 2.22
   **/
    g_signal_new(I_("stop-button"), G_TYPE_DRIVE, G_SIGNAL_RUN_LAST, G_STRUCT_OFFSET(GDriveIface, stop_button), NULL, NULL, g_cclosure_marshal_VOID__VOID, G_TYPE_NONE, 0);
}
...
void g_drive_eject(GDrive * drive, GMountUnmountFlags flags, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    if (iface->eject == NULL)
    {
        g_task_report_new_error(drive, callback, user_data, g_drive_eject_with_operation, G_IO_ERROR, G_IO_ERROR_NOT_SUPPORTED, _("drive doesn't implement eject"));
        return;
    }
...
void g_drive_eject_with_operation(GDrive * drive, GMountUnmountFlags flags, GMountOperation * mount_operation, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    {
        g_task_report_new_error(drive, callback, user_data, g_drive_eject_with_operation, G_IO_ERROR, G_IO_ERROR_NOT_SUPPORTED,
...
void g_drive_poll_for_media(GDrive * drive, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    if (iface->poll_for_media == NULL)
    {
        g_task_report_new_error(drive, callback, user_data, g_drive_poll_for_media, G_IO_ERROR, G_IO_ERROR_NOT_SUPPORTED, _("drive doesn't implement polling for media"));
        return;
    }
...
void g_drive_start(GDrive * drive, GDriveStartFlags flags, GMountOperation * mount_operation, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    if (iface->start == NULL)
    {
        g_task_report_new_error(drive, callback, user_data, g_drive_start, G_IO_ERROR, G_IO_ERROR_NOT_SUPPORTED, _("drive doesn't implement start"));
        return;
    }
...
void g_drive_stop(GDrive * drive, GMountUnmountFlags flags, GMountOperation * mount_operation, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    if (iface->stop == NULL)
    {
        g_task_report_new_error(drive, callback, user_data, g_drive_start, G_IO_ERROR, G_IO_ERROR_NOT_SUPPORTED, _("drive doesn't implement stop"));
        return;
    }
