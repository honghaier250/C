     ...
     static void g_filter_output_stream_class_init(GFilterOutputStreamClass * klass)
{
    ...
    g_object_class_install_property(object_class,
                                    ...
                                    g_param_spec_object("base-stream",
                                                        ...
                                                        G_TYPE_OUTPUT_STREAM, G_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY | G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB));
    ...
    g_object_class_install_property(object_class,
                                    ...
                                    g_param_spec_boolean("close-base-stream",
                                                         ...
                                                         TRUE, G_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY | G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB));
}
...
static void g_filter_output_stream_set_property(GObject * object, guint prop_id, const GValue * value, GParamSpec * pspec)
{
    ...
    switch (prop_id)
    {
        ...
        case PROP_CLOSE_BASE:
            g_filter_output_stream_set_close_base_stream(filter_stream, g_value_get_boolean(value));
            break;
