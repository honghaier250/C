...
G_DEFINE_INTERFACE(GActionGroup, g_action_group, G_TYPE_OBJECT)
     ...
     static gboolean g_action_group_real_has_action(GActionGroup * action_group, const gchar * action_name)
{
    return g_action_group_query_action(action_group, action_name, NULL, NULL, NULL, NULL, NULL);
}

static gboolean g_action_group_real_get_action_enabled(GActionGroup * action_group, const gchar * action_name)
{
...
static const GVariantType *g_action_group_real_get_action_parameter_type(GActionGroup * action_group, const gchar * action_name)
{
...
static const GVariantType *g_action_group_real_get_action_state_type(GActionGroup * action_group, const gchar * action_name)
{
    const GVariantType *type = NULL;
...
static GVariant *g_action_group_real_get_action_state_hint(GActionGroup * action_group, const gchar * action_name)
{
    GVariant *hint = NULL;
...
static GVariant *g_action_group_real_get_action_state(GActionGroup * action_group, const gchar * action_name)
{
    GVariant *state = NULL;
...
static gboolean g_action_group_real_query_action(GActionGroup * action_group, const gchar * action_name, gboolean * enabled, const GVariantType ** parameter_type, const GVariantType ** state_type, GVariant ** state_hint, GVariant ** state)
{
    ...
    if G_UNLIKELY
        (iface->has_action == g_action_group_real_has_action ||
         ...
         iface->get_action_state_type == g_action_group_real_get_action_state_type || iface->get_action_state_hint == g_action_group_real_get_action_state_hint || iface->get_action_state == g_action_group_real_get_action_state)
    {
        g_critical("Class '%s' implements GActionGroup interface without overriding " "query_action() method -- bailing out to avoid infinite recursion.", G_OBJECT_TYPE_NAME(action_group));
        return FALSE;
    }
...
static void g_action_group_default_init(GActionGroupInterface * iface)
{
   ...
   **/
    g_action_group_signals[SIGNAL_ACTION_ADDED] =
        g_signal_new(I_("action-added"), G_TYPE_ACTION_GROUP, G_SIGNAL_RUN_LAST | G_SIGNAL_DETAILED, G_STRUCT_OFFSET(GActionGroupInterface, action_added), NULL, NULL, g_cclosure_marshal_VOID__STRING, G_TYPE_NONE, 1, G_TYPE_STRING);
   ...
   **/
    g_action_group_signals[SIGNAL_ACTION_REMOVED] =
        g_signal_new(I_("action-removed"), G_TYPE_ACTION_GROUP, G_SIGNAL_RUN_LAST | G_SIGNAL_DETAILED, G_STRUCT_OFFSET(GActionGroupInterface, action_removed), NULL, NULL, g_cclosure_marshal_VOID__STRING, G_TYPE_NONE, 1, G_TYPE_STRING);
   ...
   **/
    g_action_group_signals[SIGNAL_ACTION_ENABLED_CHANGED] =
        g_signal_new(I_("action-enabled-changed"), G_TYPE_ACTION_GROUP, G_SIGNAL_RUN_LAST | G_SIGNAL_DETAILED, G_STRUCT_OFFSET(GActionGroupInterface, action_enabled_changed), NULL, NULL, NULL, G_TYPE_NONE, 2, G_TYPE_STRING, G_TYPE_BOOLEAN);
   ...
   **/
    g_action_group_signals[SIGNAL_ACTION_STATE_CHANGED] =
        g_signal_new(I_("action-state-changed"),
                     G_TYPE_ACTION_GROUP, G_SIGNAL_RUN_LAST | G_SIGNAL_DETAILED | G_SIGNAL_MUST_COLLECT, G_STRUCT_OFFSET(GActionGroupInterface, action_state_changed), NULL, NULL, NULL, G_TYPE_NONE, 2, G_TYPE_STRING, G_TYPE_VARIANT);
}
...
{
    return G_ACTION_GROUP_GET_IFACE(action_group)->query_action(action_group, action_name, enabled, parameter_type, state_type, state_hint, state);
}
