...
GLIB_AVAILABLE_IN_ALL GType g_unix_socket_address_get_type(void) G_GNUC_CONST;

GLIB_AVAILABLE_IN_ALL GSocketAddress * g_unix_socket_address_new(const gchar * path);
...
GLIB_AVAILABLE_IN_ALL GSocketAddress * g_unix_socket_address_new_with_type(const gchar * path, gint path_len, GUnixSocketAddressType type);
     GLIB_AVAILABLE_IN_ALL const char *g_unix_socket_address_get_path(GUnixSocketAddress * address);
GLIB_AVAILABLE_IN_ALL gsize g_unix_socket_address_get_path_len(GUnixSocketAddress * address);
GLIB_AVAILABLE_IN_ALL GUnixSocketAddressType g_unix_socket_address_get_address_type(GUnixSocketAddress * address);
GLIB_DEPRECATED gboolean g_unix_socket_address_get_is_abstract(GUnixSocketAddress * address);

GLIB_AVAILABLE_IN_ALL gboolean g_unix_socket_address_abstract_names_supported(void);
