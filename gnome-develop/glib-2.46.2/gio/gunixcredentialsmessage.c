...
static GSocketControlMessage *g_unix_credentials_message_deserialize(gint level, gint type, gsize size, gpointer data)
{
    ...
    {
        g_warning("Expected a credentials struct of %" G_GSIZE_FORMAT " bytes but " "got %" G_GSIZE_FORMAT " bytes of data", G_CREDENTIALS_NATIVE_SIZE, size);
        return NULL;
    }
...
static void g_unix_credentials_message_serialize(GSocketControlMessage * _message, gpointer data)
{
    ...
    memcpy(data, g_credentials_get_native(message->priv->credentials, G_CREDENTIALS_NATIVE_TYPE), G_CREDENTIALS_NATIVE_SIZE);
#endif
}
   ...
   */
    g_object_class_install_property(gobject_class,
                                    ...
                                    g_param_spec_object("credentials",
                                                        ...
                                                        G_TYPE_CREDENTIALS, G_PARAM_READABLE | G_PARAM_WRITABLE | G_PARAM_CONSTRUCT_ONLY | G_PARAM_STATIC_NAME | G_PARAM_STATIC_BLURB | G_PARAM_STATIC_NICK));
