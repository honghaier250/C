...
G_DEFINE_ABSTRACT_TYPE_WITH_PRIVATE(GOutputStream, g_output_stream, G_TYPE_OBJECT)
     ...
     static void g_output_stream_real_write_async(GOutputStream * stream, const void *buffer, gsize count, int io_priority, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer data);
     static gssize g_output_stream_real_write_finish(GOutputStream * stream, GAsyncResult * result, GError ** error);
     static void g_output_stream_real_splice_async(GOutputStream * stream, GInputStream * source, GOutputStreamSpliceFlags flags, int io_priority, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer data);
     ...
     static gboolean g_output_stream_internal_close(GOutputStream * stream, GCancellable * cancellable, GError ** error);
     static void g_output_stream_internal_close_async(GOutputStream * stream, int io_priority, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer data);
     static gboolean g_output_stream_internal_close_finish(GOutputStream * stream, GAsyncResult * result, GError ** error);
...
gboolean g_output_stream_printf(GOutputStream * stream, gsize * bytes_written, GCancellable * cancellable, GError ** error, const gchar * format, ...)
{
    ...
    success = g_output_stream_vprintf(stream, bytes_written, cancellable, error, format, args);
    va_end(args);
...
gboolean g_output_stream_vprintf(GOutputStream * stream, gsize * bytes_written, GCancellable * cancellable, GError ** error, const gchar * format, va_list args)
{
    ...
    success = g_output_stream_write_all(stream, text, strlen(text), bytes_written, cancellable, error);
    g_free(text);
...
static void async_ready_write_callback_wrapper(GObject * source_object, GAsyncResult * res, gpointer user_data)
{
...
void g_output_stream_write_async(GOutputStream * stream, const void *buffer, gsize count, int io_priority, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    if (((gssize) count) < 0)
    {
        g_task_return_new_error(task, G_IO_ERROR, G_IO_ERROR_INVALID_ARGUMENT, _("Too large count value passed to %s"), G_STRFUNC);
        g_object_unref(task);
        return;
    }
    ...
    class->write_async(stream, buffer, count, io_priority, cancellable, async_ready_write_callback_wrapper, task);
}
...
static void write_all_callback(GObject * stream, GAsyncResult * result, gpointer user_data)
{
    GTask *task = user_data;
    ...
    if (data->to_write == 0)
    {
        ...
        g_output_stream_write_async(G_OUTPUT_STREAM(stream), data->buffer + data->bytes_written, data->to_write, g_task_get_priority(task), g_task_get_cancellable(task), write_all_callback, task);
}

static void write_all_async_thread(GTask * task, gpointer source_object, gpointer task_data, GCancellable * cancellable)
{
    GOutputStream *stream = source_object;
    AsyncWriteAll *data = task_data;
    GError *error = NULL;

    if (g_output_stream_write_all(stream, data->buffer, data->to_write, &data->bytes_written, g_task_get_cancellable(task), &error))
        g_task_return_boolean(task, TRUE);
    else
        g_task_return_error(task, error);
}
...
static void write_bytes_callback(GObject * stream, GAsyncResult * result, gpointer user_data)
{
    GTask *task = user_data;
    GError *error = NULL;
    gssize nwrote;

    nwrote = g_output_stream_write_finish(G_OUTPUT_STREAM(stream), result, &error);
    if (nwrote == -1)
        g_task_return_error(task, error);
    else
        g_task_return_int(task, nwrote);
...
void g_output_stream_write_bytes_async(GOutputStream * stream, GBytes * bytes, int io_priority, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    g_output_stream_write_async(stream, data, size, io_priority, cancellable, write_bytes_callback, task);
}
...
void g_output_stream_splice_async(GOutputStream * stream, GInputStream * source, GOutputStreamSpliceFlags flags, int io_priority, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    if (g_input_stream_is_closed(source))
    {
        g_task_return_new_error(task, G_IO_ERROR, G_IO_ERROR_CLOSED, _("Source stream is already closed"));
        g_object_unref(task);
        return;
    }
    ...
    class->splice_async(stream, source, flags, io_priority, cancellable, async_ready_splice_callback_wrapper, task);
}
...
static void async_ready_flush_callback_wrapper(GObject * source_object, GAsyncResult * res, gpointer user_data)
{
    GOutputStream *stream = G_OUTPUT_STREAM(source_object);
    GOutputStreamClass *class;
    GTask *task = user_data;
...
void g_output_stream_flush_async(GOutputStream * stream, int io_priority, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    class->flush_async(stream, io_priority, cancellable, async_ready_flush_callback_wrapper, task);
}
...
static void async_ready_close_flushed_callback_wrapper(GObject * source_object, GAsyncResult * res, gpointer user_data)
{
    ...
    class->close_async(stream, g_task_get_priority(task), g_task_get_cancellable(task), async_ready_close_callback_wrapper, task);
}

static void real_close_async_cb(GObject * source_object, GAsyncResult * res, gpointer user_data)
{
    GOutputStream *stream = G_OUTPUT_STREAM(source_object);
    GTask *task = user_data;
    GError *error = NULL;
...
void g_output_stream_close_async(GOutputStream * stream, int io_priority, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    g_output_stream_internal_close_async(stream, io_priority, cancellable, real_close_async_cb, task);
}

/* Must always be called inside
 * g_output_stream_set_pending()/g_output_stream_clear_pending().
 */
void g_output_stream_internal_close_async(GOutputStream * stream, int io_priority, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    GOutputStreamClass *class;
    GTask *task;
    ...
    if (class->flush_async == NULL || (class->flush_async == g_output_stream_real_flush_async && (class->flush == NULL || class->close_async == g_output_stream_real_close_async)))
    {
        class->close_async(stream, io_priority, cancellable, async_ready_close_callback_wrapper, task);
    }
    else
    {
        /* First do an async flush, then do the async close in the callback
           wrapper (see async_ready_close_flushed_callback_wrapper) */
        class->flush_async(stream, io_priority, cancellable, async_ready_close_flushed_callback_wrapper, task);
    }
}
...
gboolean g_output_stream_async_write_is_via_threads(GOutputStream * stream)
{
    ...
    return (class->write_async == g_output_stream_real_write_async && !(G_IS_POLLABLE_OUTPUT_STREAM(stream) && g_pollable_output_stream_can_poll(G_POLLABLE_OUTPUT_STREAM(stream))));
}
...
static void write_async_thread(GTask * task, gpointer source_object, gpointer task_data, GCancellable * cancellable)
{
    GOutputStream *stream = source_object;
    ...
    class = G_OUTPUT_STREAM_GET_CLASS(stream);
    count_written = class->write_fn(stream, op->buffer, op->count_requested, cancellable, &error);
    if (count_written == -1)
        g_task_return_error(task, error);
    else
...
static gboolean write_async_pollable_ready(GPollableOutputStream * stream, gpointer user_data)
{
    GTask *task = user_data;
...
static void write_async_pollable(GPollableOutputStream * stream, GTask * task)
{
    ...
    count_written = G_POLLABLE_OUTPUT_STREAM_GET_INTERFACE(stream)->write_nonblocking(stream, op->buffer, op->count_requested, &error);
    ...
    if (g_error_matches(error, G_IO_ERROR, G_IO_ERROR_WOULD_BLOCK))
    {
        ...
        g_task_attach_source(task, source, (GSourceFunc) write_async_pollable_ready);
...
static void g_output_stream_real_write_async(GOutputStream * stream, const void *buffer, gsize count, int io_priority, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    GTask *task;
    WriteData *op;
...
static void real_splice_async_complete_cb(GTask * task)
{
    ...
    if (op->flags & G_OUTPUT_STREAM_SPLICE_CLOSE_SOURCE && !g_input_stream_is_closed(op->source))
        return;

    if (op->flags & G_OUTPUT_STREAM_SPLICE_CLOSE_TARGET && !g_output_stream_is_closed(g_task_get_source_object(task)))
        return;
...
static void real_splice_async_close_input_cb(GObject * source, GAsyncResult * res, gpointer user_data)
{
    GTask *task = user_data;
...
static void real_splice_async_close_output_cb(GObject * source, GAsyncResult * res, gpointer user_data)
{
...
static void real_splice_async_complete(GTask * task)
{
    ...
    if (op->flags & G_OUTPUT_STREAM_SPLICE_CLOSE_SOURCE)
    {
        ...
        g_input_stream_close_async(op->source, g_task_get_priority(task), g_task_get_cancellable(task), real_splice_async_close_input_cb, task);
    }

    if (op->flags & G_OUTPUT_STREAM_SPLICE_CLOSE_TARGET)
    {
        done = FALSE;
        g_output_stream_internal_close_async(g_task_get_source_object(task), g_task_get_priority(task), g_task_get_cancellable(task), real_splice_async_close_output_cb, task);
    }
...
static void real_splice_async_read_cb(GObject * source, GAsyncResult * res, gpointer user_data);

static void real_splice_async_write_cb(GObject * source, GAsyncResult * res, gpointer user_data)
{
    GOutputStreamClass *class;
    GTask *task = G_TASK(user_data);
    SpliceData *op = g_task_get_task_data(task);
    ...
    {
        class->write_async(g_task_get_source_object(task), op->buffer + op->n_written, op->n_read - op->n_written, g_task_get_priority(task), g_task_get_cancellable(task), real_splice_async_write_cb, task);
        return;
    }

    g_input_stream_read_async(op->source, op->buffer, 8192, g_task_get_priority(task), g_task_get_cancellable(task), real_splice_async_read_cb, task);
}
...
static void real_splice_async_read_cb(GObject * source, GAsyncResult * res, gpointer user_data)
{
    ...
    class->write_async(g_task_get_source_object(task), op->buffer, op->n_read, g_task_get_priority(task), g_task_get_cancellable(task), real_splice_async_write_cb, task);
}

static void splice_async_thread(GTask * task, gpointer source_object, gpointer task_data, GCancellable * cancellable)
{
    GOutputStream *stream = source_object;
    ...
    bytes_copied = class->splice(stream, op->source, op->flags, cancellable, &error);
    if (bytes_copied == -1)
        g_task_return_error(task, error);
    else
...
static void g_output_stream_real_splice_async(GOutputStream * stream, GInputStream * source, GOutputStreamSpliceFlags flags, int io_priority, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    GTask *task;
    SpliceData *op;
    ...
    if (g_input_stream_async_read_is_via_threads(source) && g_output_stream_async_write_is_via_threads(stream))
    {
...
static void flush_async_thread(GTask * task, gpointer source_object, gpointer task_data, GCancellable * cancellable)
{
    GOutputStream *stream = source_object;
    GOutputStreamClass *class;
    gboolean result;
...
static void close_async_thread(GTask * task, gpointer source_object, gpointer task_data, GCancellable * cancellable)
{
    GOutputStream *stream = source_object;
    GOutputStreamClass *class;
    GError *error = NULL;
