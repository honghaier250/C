...
struct _GDBusAuthObserverClass
{
    ...
    /* Signals */
      ...
      gboolean(*allow_mechanism) (GDBusAuthObserver * observer, const gchar * mechanism);
};
...
static gboolean g_dbus_auth_observer_allow_mechanism_real(GDBusAuthObserver * observer, const gchar * mechanism)
{
    return TRUE;
}
...
static void g_dbus_auth_observer_class_init(GDBusAuthObserverClass * klass)
{
   ...
   * Since: 2.26
   */
    signals[AUTHORIZE_AUTHENTICATED_PEER_SIGNAL] = g_signal_new(I_("authorize-authenticated-peer"), G_TYPE_DBUS_AUTH_OBSERVER, G_SIGNAL_RUN_LAST, G_STRUCT_OFFSET(GDBusAuthObserverClass, authorize_authenticated_peer), _g_signal_accumulator_false_handled, NULL,    /* accu_data */
   ...
   * Since: 2.34
   */
    signals[ALLOW_MECHANISM_SIGNAL] = g_signal_new(I_("allow-mechanism"), G_TYPE_DBUS_AUTH_OBSERVER, G_SIGNAL_RUN_LAST, G_STRUCT_OFFSET(GDBusAuthObserverClass, allow_mechanism), _g_signal_accumulator_false_handled, NULL,    /* accu_data */
...
gboolean g_dbus_auth_observer_allow_mechanism(GDBusAuthObserver * observer, const gchar * mechanism)
{
    ...
    ret = FALSE;
    g_signal_emit(observer, signals[ALLOW_MECHANISM_SIGNAL], 0, mechanism, &ret);
    return ret;
}
