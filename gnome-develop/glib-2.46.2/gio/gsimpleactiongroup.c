...
G_DEFINE_TYPE_WITH_CODE(GSimpleActionGroup,
                        ...
                        G_ADD_PRIVATE(GSimpleActionGroup) G_IMPLEMENT_INTERFACE(G_TYPE_ACTION_GROUP, g_simple_action_group_iface_init); G_IMPLEMENT_INTERFACE(G_TYPE_ACTION_MAP, g_simple_action_group_map_iface_init))
...
static gboolean g_simple_action_group_query_action(GActionGroup * group, const gchar * action_name, gboolean * enabled, const GVariantType ** parameter_type, const GVariantType ** state_type, GVariant ** state_hint, GVariant ** state)
{
    GSimpleActionGroup *simple = G_SIMPLE_ACTION_GROUP(group);
    GAction *action;
...
static void g_simple_action_group_change_state(GActionGroup * group, const gchar * action_name, GVariant * value)
{
    GSimpleActionGroup *simple = G_SIMPLE_ACTION_GROUP(group);
    GAction *action;
...
static GAction *g_simple_action_group_lookup_action(GActionMap * action_map, const gchar * action_name)
{
...
static void g_simple_action_group_add_action(GActionMap * action_map, GAction * action)
{
    GSimpleActionGroup *simple = G_SIMPLE_ACTION_GROUP(action_map);
    ...
    if (old_action != action)
    {
        ...
        if (g_action_get_state_type(action) != NULL)
            g_signal_connect(action, "notify::state", G_CALLBACK(action_state_notify), simple);
...
static void g_simple_action_group_remove_action(GActionMap * action_map, const gchar * action_name)
{
    GSimpleActionGroup *simple = G_SIMPLE_ACTION_GROUP(action_map);
    GAction *action;
