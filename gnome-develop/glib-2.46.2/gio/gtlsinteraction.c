...
static InvokeClosure *invoke_closure_new(GTlsInteraction * interaction, GObject * argument, GCancellable * cancellable)
{
...
static GTlsInteractionResult invoke_closure_wait_and_free(InvokeClosure * closure, GError ** error)
{
    GTlsInteractionResult result;
...
static GTlsInteractionResult invoke_closure_complete_and_free(GTlsInteraction * interaction, InvokeClosure * closure, GError ** error)
{
    GTlsInteractionResult result;
    gboolean complete;
...
static gboolean on_invoke_ask_password_sync(gpointer user_data)
{
    ...
    closure->result = klass->ask_password(closure->interaction, G_TLS_PASSWORD(closure->argument), closure->cancellable, &closure->error);
...
static void on_ask_password_complete(GObject * source, GAsyncResult * result, gpointer user_data)
{
    InvokeClosure *closure = user_data;
    GTlsInteractionClass *klass;
    ...
    closure->result = klass->ask_password_finish(closure->interaction, result, &closure->error);
...
static gboolean on_invoke_ask_password_async_as_sync(gpointer user_data)
{
    ...
    klass->ask_password_async(closure->interaction, G_TLS_PASSWORD(closure->argument), closure->cancellable, on_ask_password_complete, closure);
...
GTlsInteractionResult g_tls_interaction_invoke_ask_password(GTlsInteraction * interaction, GTlsPassword * password, GCancellable * cancellable, GError ** error)
{
    ...
    if (klass->ask_password)
    {
        ...
        g_main_context_invoke(interaction->priv->context, on_invoke_ask_password_sync, closure);
        result = invoke_closure_wait_and_free(closure, error);
    }
    else if (klass->ask_password_async)
    {
        ...
        closure = invoke_closure_new(interaction, G_OBJECT(password), cancellable);
        g_main_context_invoke(interaction->priv->context, on_invoke_ask_password_async_as_sync, closure);
...
void g_tls_interaction_ask_password_async(GTlsInteraction * interaction, GTlsPassword * password, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    if (klass->ask_password_async)
    {
        ...
        (klass->ask_password_async) (interaction, password, cancellable, callback, user_data);
    }
    else
    {
...
static gboolean on_invoke_request_certificate_sync(gpointer user_data)
{
    ...
    closure->result = klass->request_certificate(closure->interaction, G_TLS_CONNECTION(closure->argument), 0, closure->cancellable, &closure->error);
...
static void on_request_certificate_complete(GObject * source, GAsyncResult * result, gpointer user_data)
{
    InvokeClosure *closure = user_data;
    GTlsInteractionClass *klass;
    ...
    closure->result = klass->request_certificate_finish(closure->interaction, result, &closure->error);
...
static gboolean on_invoke_request_certificate_async_as_sync(gpointer user_data)
{
    ...
    klass->request_certificate_async(closure->interaction, G_TLS_CONNECTION(closure->argument), 0, closure->cancellable, on_request_certificate_complete, closure);
...
GTlsInteractionResult g_tls_interaction_invoke_request_certificate(GTlsInteraction * interaction, GTlsConnection * connection, GTlsCertificateRequestFlags flags, GCancellable * cancellable, GError ** error)
{
    ...
    if (klass->request_certificate)
    {
        ...
        g_main_context_invoke(interaction->priv->context, on_invoke_request_certificate_sync, closure);
        result = invoke_closure_wait_and_free(closure, error);
    }
    else if (klass->request_certificate_async)
    {
        ...
        closure = invoke_closure_new(interaction, G_OBJECT(connection), cancellable);
        g_main_context_invoke(interaction->priv->context, on_invoke_request_certificate_async_as_sync, closure);
...
void g_tls_interaction_request_certificate_async(GTlsInteraction * interaction, GTlsConnection * connection, GTlsCertificateRequestFlags flags, GCancellable * cancellable, GAsyncReadyCallback callback, gpointer user_data)
{
    ...
    if (klass->request_certificate_async)
    {
        ...
        (klass->request_certificate_async) (interaction, connection, flags, cancellable, callback, user_data);
    }
    else
    {
        task = g_task_new(interaction, cancellable, callback, user_data);
