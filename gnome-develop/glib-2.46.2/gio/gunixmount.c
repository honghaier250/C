...
static void eject_unmount_done(GObject * source, GAsyncResult * result, gpointer user_data)
{
...
static gboolean eject_unmount_do_cb(gpointer user_data)
{
    ...
    g_subprocess_communicate_utf8_async(subprocess, NULL, g_task_get_cancellable(task), eject_unmount_done, task);
