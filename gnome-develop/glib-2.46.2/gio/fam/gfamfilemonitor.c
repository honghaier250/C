...
G_DEFINE_DYNAMIC_TYPE(GFamFileMonitor, g_fam_file_monitor, G_TYPE_LOCAL_FILE_MONITOR)
     static gboolean g_fam_file_monitor_callback(gint fd, GIOCondition condition, gpointer user_data)
{
...
static void g_fam_file_monitor_start(GLocalFileMonitor * local_monitor, const gchar * dirname, const gchar * basename, const gchar * filename, GFileMonitorSource * source)
{
...
static void g_fam_file_monitor_class_init(GFamFileMonitorClass * class)
{
...
static void g_fam_file_monitor_class_finalize(GFamFileMonitorClass * class)
{
}
...
void g_io_module_load(GIOModule * module)
{
    ...
    g_io_extension_point_implement(G_NFS_FILE_MONITOR_EXTENSION_POINT_NAME, G_TYPE_FAM_FILE_MONITOR, "fam", 10);
}
