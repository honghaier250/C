...
GLIB_AVAILABLE_IN_ALL GType g_win32_output_stream_get_type(void) G_GNUC_CONST;

GLIB_AVAILABLE_IN_ALL GOutputStream * g_win32_output_stream_new(void *handle, gboolean close_handle);
     GLIB_AVAILABLE_IN_ALL void g_win32_output_stream_set_close_handle(GWin32OutputStream * stream, gboolean close_handle);
GLIB_AVAILABLE_IN_ALL gboolean g_win32_output_stream_get_close_handle(GWin32OutputStream * stream);
     GLIB_AVAILABLE_IN_ALL void *g_win32_output_stream_get_handle(GWin32OutputStream * stream);
G_END_DECLS
