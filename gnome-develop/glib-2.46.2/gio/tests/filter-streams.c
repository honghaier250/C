...
static void test_filter_input_stream_init(TestFilterInputStream * stream)
{
}

static void test_filter_input_stream_class_init(TestFilterInputStreamClass * klass)
{
}

static void test_filter_output_stream_init(TestFilterOutputStream * stream)
{
}

static void test_filter_output_stream_class_init(TestFilterOutputStreamClass * klass)
{
}
...
static void test_input_filter(void)
{
    ...
    f1 = g_object_new(TEST_TYPE_FILTER_INPUT_STREAM, "base-stream", base, "close-base-stream", FALSE, NULL);
    f2 = g_object_new(TEST_TYPE_FILTER_INPUT_STREAM, "base-stream", base, NULL);
    ...
    g_object_get(f1, "close-base-stream", &close_base, "base-stream", &s, NULL);
    g_assert(!close_base);
    g_assert(s == base);
    g_object_unref(s);
...
static void test_output_filter(void)
{
    ...
    f1 = g_object_new(TEST_TYPE_FILTER_OUTPUT_STREAM, "base-stream", base, "close-base-stream", FALSE, NULL);
    f2 = g_object_new(TEST_TYPE_FILTER_OUTPUT_STREAM, "base-stream", base, NULL);
...
static void return_result_cb(GObject * object, GAsyncResult * result, gpointer user_data)
{
...
static void test_input_async(void)
{
    ...
    g_input_stream_read_async(f1, buf, 10, G_PRIORITY_DEFAULT, NULL, return_result_cb, &result);
    ...
    g_input_stream_skip_async(f2, 10, G_PRIORITY_DEFAULT, NULL, return_result_cb, &result);
    g_main_loop_run(loop);
...
static void test_output_async(void)
{
    ...
    g_output_stream_write_async(f1, "abcdefghijklm", 13, G_PRIORITY_DEFAULT, NULL, return_result_cb, &result);
    g_main_loop_run(loop);
    ...
    g_output_stream_write_async(f2, "nopqrstuvwxyz", 13, G_PRIORITY_DEFAULT, NULL, return_result_cb, &result);
    g_main_loop_run(loop);
