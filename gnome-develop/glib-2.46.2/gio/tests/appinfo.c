...
static void test_commandline(void)
{
    ...
    error = NULL;
    appinfo = g_app_info_create_from_commandline(cmdline, "cmdline-app-test", G_APP_INFO_CREATE_SUPPORTS_URIS, &error);
    g_assert(appinfo != NULL);
    g_assert_no_error(error);
    ...
    error = NULL;
    appinfo = g_app_info_create_from_commandline(cmdline, "cmdline-app-test", G_APP_INFO_CREATE_NONE, &error);
    g_assert(appinfo != NULL);
    g_assert_no_error(error);
    g_assert_cmpstr(g_app_info_get_name(appinfo), ==, "cmdline-app-test");
    g_assert_cmpstr(g_app_info_get_commandline(appinfo), ==, cmdline_out);
...
static void test_launch_context(void)
{
    ...
    appinfo = g_app_info_create_from_commandline(cmdline, "cmdline-app-test", G_APP_INFO_CREATE_SUPPORTS_URIS, NULL);
...
static void launched(GAppLaunchContext * context, GAppInfo * info, GVariant * platform_data, gpointer user_data)
{
    gint pid;
...
static void launch_failed(GAppLaunchContext * context, const gchar * startup_notify_id)
{
    g_assert_not_reached();
}

static void test_launch_context_signals(void)
{
    GAppLaunchContext *context;
    GAppInfo *appinfo;
    GError *error = NULL;
...
static void test_startup_wm_class(void)
{
...
static void test_supported_types(void)
{
    GAppInfo *appinfo;
...
static void test_from_keyfile(void)
{
