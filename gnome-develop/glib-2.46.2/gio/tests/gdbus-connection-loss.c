...
static void sleep_cb(GObject * source_object, GAsyncResult * res, gpointer user_data)
{
...
static void test_connection_loss(void)
{
    ...
    error = NULL;
    proxy = g_dbus_proxy_new_sync(c, G_DBUS_PROXY_FLAGS_NONE, NULL,    /* GDBusInterfaceInfo */
    ...
    error = NULL;
    g_dbus_proxy_call(proxy, "Sleep", g_variant_new("(i)", 100 * 1000 /* msec */ ),
                      G_DBUS_CALL_FLAGS_NONE, 10 * 1000 /* msec */ ,
                      NULL,        /* GCancellable */
                      sleep_cb, &error);
