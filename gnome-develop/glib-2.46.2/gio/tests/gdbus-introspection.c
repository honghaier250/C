...
static void test_generate(void)
{
    ...
    const gchar *data =
        ...
        "      </method>" "      <property name='y' type='y' access='readwrite'>" "        <annotation name='needs-escaping' value='bar&lt;&gt;&apos;&quot;'/>" "      </property>" "    </interface>" "  </node>";
...
static void test_default_direction(void)
{
    ...
    const gchar *data =
        "  <node>"
        "    <interface name='com.example.Frob'>"
        "      <signal name='HelloWorld'>" "        <arg type='s' name='greeting'/>" "      </signal>" "      <method name='Sleep'>" "        <arg type='i' name='timeout'/>" "      </method>" "    </interface>" "  </node>";
...
static void test_extra_data(void)
{
    ...
    const gchar *data =
        ...
        "      </signal>" "      <method name='Sleep'>" "        <arg type='i' name='timeout' direction='in'/>" "      </method>" "      <property name='y' type='y' access='readwrite'/>" "    </interface>" "  </node>";
    GError *error;
