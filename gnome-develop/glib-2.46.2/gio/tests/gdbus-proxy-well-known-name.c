...
static void test_proxy_well_known_name(void)
{
    ...
    error = NULL;
    p = g_dbus_proxy_new_sync(c, G_DBUS_PROXY_FLAGS_NONE, NULL,    /* GDBusInterfaceInfo* */
    ...
    g_dbus_proxy_new(c, G_DBUS_PROXY_FLAGS_NONE, NULL,    /* GDBusInterfaceInfo* */
                     "com.example.TestService",    /* name */
                     "/com/example/TestObject",    /* object path */
                     "com.example.Frob",    /* interface name */
                     NULL,        /* GCancellable */
                     (GAsyncReadyCallback) proxy_new_cb, &ap);
     ...
     */
    error = NULL;
    p2 = g_dbus_proxy_new_sync(c, G_DBUS_PROXY_FLAGS_NONE, NULL,    /* GDBusInterfaceInfo* */
                               "com.example.TestService",    /* name */
                               "/com/example/TestObject",    /* object path */
                               "com.example.Frob",    /* interface name */
                               NULL,    /* GCancellable */
    ...
    g_dbus_proxy_new(c, G_DBUS_PROXY_FLAGS_NONE, NULL,    /* GDBusInterfaceInfo* */
                     ...
                     "com.example.Frob",    /* interface name */
                     NULL,        /* GCancellable */
                     (GAsyncReadyCallback) proxy_new_cb, &ap2);
    g_main_loop_run(loop);
