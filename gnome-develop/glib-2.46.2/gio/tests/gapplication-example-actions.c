...
static void activate_toggle_action(GSimpleAction * action, GVariant * parameter, gpointer data)
{
    GApplication *application = G_APPLICATION(data);
    GVariant *state;
    gboolean b;
...
static void describe_and_activate_action(GActionGroup * group, const gchar * name)
{
