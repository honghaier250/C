...
static void test_store_refcounts(void)
{
    GListStore *store;
    GMenuItem *items[10];
    GMenuItem *tmp;
...
static gchar *make_random_string(void)
{
...
static gint compare_items(gconstpointer a_p, gconstpointer b_p, gpointer user_data)
{
...
static void insert_string(GListStore * store, const gchar * str)
{
    GObject *obj;
...
static void test_store_sorted(void)
{
    GListStore *store;
    guint i;
