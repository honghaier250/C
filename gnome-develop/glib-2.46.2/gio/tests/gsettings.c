...
static void test_basic(void)
{
    ...
    g_object_get(settings, "schema-id", &str, "backend", &b, "path", &path, "has-unapplied", &has_unapplied, "delay-apply", &delay_apply, NULL);
    ...
    if (!backend_set && g_test_undefined())
    {
        ...
        g_test_expect_message(G_LOG_DOMAIN, G_LOG_LEVEL_CRITICAL, "*g_settings_set_value*expects type*");
...
static void test_wrong_type(void)
{
    ...
    g_test_expect_message("GLib", G_LOG_LEVEL_CRITICAL, "*given value has a type of*");
    g_test_expect_message("GLib", G_LOG_LEVEL_CRITICAL, "*valid_format_string*");
    g_settings_get(settings, "greeting", "o", &str);
    g_test_assert_expected_messages();

    g_assert(str == NULL);

    g_test_expect_message(G_LOG_DOMAIN, G_LOG_LEVEL_CRITICAL, "*expects type 's'*");
 ...
 * maintained.
 */
static void test_delay_apply(void)
{
    GSettings *settings;
    GSettings *settings2;
    gchar *str;
...
static void test_delay_child(void)
{
    GSettings *base;
    GSettings *settings;
    GSettings *child;
...
static void keys_changed_cb(GSettings * settings, const GQuark * keys, gint n_keys)
{
    ...
    g_assert((keys[0] == g_quark_from_static_string("greeting") && keys[1] == g_quark_from_static_string("farewell")) || (keys[1] == g_quark_from_static_string("greeting") && keys[0] == g_quark_from_static_string("farewell")));
...
static GType test_flags_get_type(void)
{
    static volatile gsize define_type_id = 0;
...
static void test_object_class_init(TestObjectClass * class)
{
    ...
    g_object_class_install_property(gobject_class, PROP_FLAGS, g_param_spec_flags("flags", "", "", test_flags_get_type(), TEST_FLAGS_NONE, G_PARAM_READWRITE));
}
 ...
 * works in 'GET' mode.
 */
static void test_no_read_binding_fail(void)
{
    TestObject *obj;
    GSettings *settings;
...
static void test_no_read_binding_pass(void)
{
    TestObject *obj;
    GSettings *settings;
 ...
 * works in 'SET' mode.
 */
static void test_no_write_binding_fail(void)
{
    TestObject *obj;
    GSettings *settings;
...
static void test_no_write_binding_pass(void)
{
    TestObject *obj;
    GSettings *settings;
...
static void key_changed_cb(GSettings * settings, const gchar * key, gpointer data)
{
    gboolean *b = data;
    (*b) = TRUE;
}
...
static void test_enums_non_enum_key(void)
{
    GSettings *direct;
...
static void test_enums_non_enum_value(void)
{
    GSettings *settings;
...
static void test_enums_range(void)
{
    GSettings *settings;
...
static void test_flags_non_flags_key(void)
{
    GSettings *direct;
...
static void test_flags_non_flags_value(void)
{
    GSettings *settings;
...
static void test_flags_range(void)
{
    GSettings *settings;
...
static void test_flags_non_enum(void)
{
    GSettings *settings;
...
static void test_range_high(void)
{
    GSettings *settings;
...
static void test_range_low(void)
{
    GSettings *settings;
...
static void test_range(void)
{
    ...
    G_GNUC_BEGIN_IGNORE_DEPRECATIONS value = g_variant_new_int32(1);
...
static void test_list_schemas(void)
{
    ...
    G_GNUC_BEGIN_IGNORE_DEPRECATIONS relocs = g_settings_list_relocatable_schemas();
    schemas = g_settings_list_schemas();
    G_GNUC_END_IGNORE_DEPRECATIONS g_assert(strv_set_equal((gchar **) relocs, "org.gtk.test.no-path", "org.gtk.test.extends.base", "org.gtk.test.extends.extended", NULL));

    g_assert(strv_set_equal((gchar **) schemas,
                            "org.gtk.test",
                            "org.gtk.test.basic-types",
                            "org.gtk.test.complex-types",
                            "org.gtk.test.localized", "org.gtk.test.binding", "org.gtk.test.enums", "org.gtk.test.enums.direct", "org.gtk.test.range", "org.gtk.test.range.direct", "org.gtk.test.mapped", "org.gtk.test.descriptions", NULL));
}
...
static void test_get_range(void)
{
    ...
    G_GNUC_BEGIN_IGNORE_DEPRECATIONS settings = g_settings_new("org.gtk.test.range");
...
static void test_schema_source(void)
{
...
static void test_schema_list_keys(void)
{
    gchar **keys;
    ...
    g_assert(strv_set_equal((gchar **) keys, "greeting", "farewell", NULL));
...
static void test_actions(void)
{
    ...
    g_object_get(string, "name", &name, "parameter-type", &param_type, "enabled", &enabled, "state-type", &state_type, "state", &state, NULL);
...
static void test_null_backend(void)
{
    GSettingsBackend *backend;
    GSettings *settings;
    gchar *str;
...
static void test_read_descriptions(void)
{
    GSettingsSchema *schema;
...
static void test_extended_schema(void)
{
    GSettingsSchema *schema;
    GSettings *settings;
    gchar **keys;
...
int main(int argc, char *argv[])
{
    ...
    if (!g_test_subprocess())
    {
        ...
        g_assert(g_spawn_command_line_sync("../glib-compile-schemas --targetdir=. " "--schema-file=org.gtk.test.enums.xml " "--schema-file=org.gtk.test.gschema.xml", NULL, NULL, &result, NULL));
        g_assert(result == 0);

        g_remove("schema-source/gschemas.compiled");
        g_mkdir("schema-source", 0777);
        g_assert(g_spawn_command_line_sync("../glib-compile-schemas --targetdir=schema-source " "--schema-file=" SRCDIR "/org.gtk.schemasourcecheck.gschema.xml", NULL, NULL, &result, NULL));
        g_assert(result == 0);
    }
