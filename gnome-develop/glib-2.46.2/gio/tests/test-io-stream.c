...
G_DEFINE_TYPE(TestIOStream, test_io_stream, G_TYPE_IO_STREAM)
     static void test_io_stream_finalize(GObject * object)
{
...
static void test_io_stream_init(TestIOStream * stream)
{
}

static GInputStream *test_io_stream_get_input_stream(GIOStream * _stream)
{
...
static GOutputStream *test_io_stream_get_output_stream(GIOStream * _stream)
{
    TestIOStream *stream = TEST_IO_STREAM(_stream);
...
static void test_io_stream_class_init(TestIOStreamClass * klass)
{
 ...
 */
GIOStream *test_io_stream_new(GInputStream * input_stream, GOutputStream * output_stream)
{
    TestIOStream *stream;
