...
const gchar *myapp5_data = "[Desktop Entry]\n" "Encoding=UTF-8\n" "Version=1.0\n" "Type=Application\n" "Exec=true %f\n" "Name=my app 5\n" "MimeType=image/bmp;x-scheme-handler/ftp;";

const gchar *nosuchapp_data = "[Desktop Entry]\n" "Encoding=UTF-8\n" "Version=1.0\n" "Type=Application\n" "Exec=no_such_application %f\n" "Name=no such app\n";
...
static void test_mime_api(void)
{
    GAppInfo *appinfo;
    GAppInfo *appinfo2;
    GError *error = NULL;
 ...
 */
static void test_mime_file(void)
{
    gchar **assoc;
    GAppInfo *appinfo;
    GAppInfo *appinfo2;
...
static void test_mime_default(void)
{
    GAppInfo *appinfo;
    GAppInfo *appinfo2;
    GAppInfo *appinfo3;
 ...
 * change the default
 */
static void test_mime_default_last_used(void)
{
    GAppInfo *appinfo4;
    GAppInfo *appinfo5;
    GError *error = NULL;
...
static void test_scheme_handler(void)
{
    GAppInfo *info, *info5;
 ...
 */
static void test_mime_ignore_nonexisting(void)
{
    GAppInfo *appinfo;
