...
static void test_connection_bus_failure(void)
{
    GDBusConnection *c;
    GError *error = NULL;
...
static void test_connection_life_cycle(void)
{
    ...
    g_dbus_connection_signal_subscribe(c2, "org.freedesktop.DBus",    /* bus name */
                                       "org.freedesktop.DBus",    /* interface */
                                       "NameOwnerChanged",    /* member */
                                       "/org/freesktop/DBus",    /* path */
                                       NULL,    /* arg0 */
                                       G_DBUS_SIGNAL_FLAGS_NONE, on_name_owner_changed, (gpointer) & on_signal_registration_freed_called, a_gdestroynotify_that_sets_a_gboolean_to_true_and_quits_loop);
    /* filter func */
    ...
    error = NULL;
    registration_id = g_dbus_connection_register_object(c2, "/foo", (GDBusInterfaceInfo *) & boo_interface_info, &boo_vtable, (gpointer) & on_register_object_freed_called, a_gdestroynotify_that_sets_a_gboolean_to_true_and_quits_loop, &error);
    g_assert_no_error(error);
    ...
    _log("destroynotifies for\n" " register_object %p\n" " filter          %p\n" " signal          %p", &on_register_object_freed_called, &on_filter_freed_called, &on_signal_registration_freed_called);
    while (TRUE)
    {
        if (on_signal_registration_freed_called && on_filter_freed_called && on_register_object_freed_called)
            break;
...
static void test_connection_send(void)
{
    ...
    g_dbus_connection_call(c, "org.freedesktop.DBus",    /* bus_name */
                           "/org/freedesktop/DBus",    /* object path */
                           "org.freedesktop.DBus",    /* interface name */
                           "GetId",    /* method name */
                           NULL, NULL, G_DBUS_CALL_FLAGS_NONE, -1, ca, (GAsyncReadyCallback) msg_cb_expect_error_cancelled, NULL);
    g_main_loop_run(loop);
    g_object_unref(ca);
    ...
    g_dbus_connection_call(c, "org.freedesktop.DBus",    /* bus_name */
                           ...
                           "org.freedesktop.DBus",    /* interface name */
                           "GetId",    /* method name */
                           NULL, NULL, G_DBUS_CALL_FLAGS_NONE, -1, NULL, (GAsyncReadyCallback) msg_cb_expect_success, NULL);
    g_main_loop_run(loop);
    ...
    g_dbus_connection_call(c, "org.freedesktop.DBus",    /* bus_name */
                           ...
                           NULL, NULL, G_DBUS_CALL_FLAGS_NONE, -1, NULL, (GAsyncReadyCallback) msg_cb_expect_error_unknown_method, NULL);
    g_main_loop_run(loop);
    ...
    g_dbus_connection_call(c, "org.freedesktop.DBus",    /* bus_name */
                           ...
                           "org.freedesktop.DBus",    /* interface name */
                           "GetId",    /* method name */
                           NULL, NULL, G_DBUS_CALL_FLAGS_NONE, -1, ca, (GAsyncReadyCallback) msg_cb_expect_error_cancelled_2, NULL);
    g_cancellable_cancel(ca);
    g_main_loop_run(loop);
    g_object_unref(ca);
    ...
    g_dbus_connection_call(c, "org.freedesktop.DBus",    /* bus_name */
                           ...
                           "org.freedesktop.DBus",    /* interface name */
                           "GetId",    /* method name */
                           NULL, NULL, G_DBUS_CALL_FLAGS_NONE, -1, NULL, (GAsyncReadyCallback) msg_cb_expect_error_disconnected, NULL);
    g_main_loop_run(loop);
...
static void test_connection_signal_handler(GDBusConnection * connection, const gchar * sender_name, const gchar * object_path, const gchar * interface_name, const gchar * signal_name, GVariant * parameters, gpointer user_data)
{
...
static void test_connection_signals(void)
{
     ...
     */
    s1 = g_dbus_connection_signal_subscribe(c1, ":1.2", "org.gtk.GDBus.ExampleInterface", "Foo", "/org/gtk/GDBus/ExampleInterface", NULL, G_DBUS_SIGNAL_FLAGS_NONE, test_connection_signal_handler, &count_s1, NULL);
    s2 = g_dbus_connection_signal_subscribe(c1, NULL,    /* match any sender */
                                            "org.gtk.GDBus.ExampleInterface", "Foo", "/org/gtk/GDBus/ExampleInterface", NULL, G_DBUS_SIGNAL_FLAGS_NONE, test_connection_signal_handler, &count_s2, NULL);
    s3 = g_dbus_connection_signal_subscribe(c1, "org.freedesktop.DBus",    /* sender */
                                            "org.freedesktop.DBus",    /* interface */
                                            "NameOwnerChanged",    /* member */
                                            "/org/freedesktop/DBus",    /* path */
                                            NULL, G_DBUS_SIGNAL_FLAGS_NONE, test_connection_signal_handler, &count_name_owner_changed, NULL);
     ...
     */
    s1b = g_dbus_connection_signal_subscribe(c1, ":1.2", "org.gtk.GDBus.ExampleInterface", "Foo", "/org/gtk/GDBus/ExampleInterface", NULL, G_DBUS_SIGNAL_FLAGS_NONE, test_connection_signal_handler, &count_s1b, NULL);
    g_assert(s1 != 0);
    g_assert(s1b != 0);
    g_assert(s2 != 0);
    g_assert(s3 != 0);
     ...
     */
    result = g_dbus_connection_call_sync(c1, "org.freedesktop.DBus",    /* bus name */
                                         "/org/freedesktop/DBus",    /* object path */
                                         "org.freedesktop.DBus",    /* interface name */
                                         "GetId",    /* method name */
                                         NULL,    /* parameters */
    ...
    ret = g_dbus_connection_emit_signal(c2, NULL,    /* destination bus name */
                                        "/org/gtk/GDBus/ExampleInterface", "org.gtk.GDBus.ExampleInterface", "Foo", NULL, &error);
    g_assert_no_error(error);
    g_assert(ret);
     ...
     */
    ret = g_dbus_connection_emit_signal(c3, NULL,    /* destination bus name */
                                        "/org/gtk/GDBus/ExampleInterface", "org.gtk.GDBus.ExampleInterface", "Foo", NULL, &error);
    g_assert_no_error(error);
    g_assert(ret);
...
static void test_match_rule(GDBusConnection * connection, GDBusSignalFlags flags, gchar * arg0_rule, gchar * arg0, gboolean should_match)
{
    ...
    subscription_ids[0] = g_dbus_connection_signal_subscribe(connection, NULL, "org.gtk.ExampleInterface", "Foo", "/", NULL, G_DBUS_SIGNAL_FLAGS_NONE, test_connection_signal_handler, &emissions, NULL);
    subscription_ids[1] = g_dbus_connection_signal_subscribe(connection, NULL, "org.gtk.ExampleInterface", "Foo", "/", arg0_rule, flags, test_connection_signal_handler, &matches, NULL);
    g_assert_cmpint(subscription_ids[0], !=, 0);
    g_assert_cmpint(subscription_ids[1], !=, 0);

    g_dbus_connection_emit_signal(connection, NULL, "/", "org.gtk.ExampleInterface", "Foo", g_variant_new("(s)", arg0), &error);
    g_assert_no_error(error);

    /* synchronously ping a non-existent method to make sure the signals are dispatched */
    g_dbus_connection_call_sync(connection, "org.gtk.ExampleInterface", "/", "org.gtk.ExampleInterface", "Bar", g_variant_new("()"), G_VARIANT_TYPE_UNIT, G_DBUS_CALL_FLAGS_NONE, -1, NULL, NULL);
...
static void test_connection_signal_match_rules(void)
{
    GDBusConnection *con;
...
static void
test_connection_filter_name_owner_changed_signal_handler(GDBusConnection * connection, const gchar * sender_name, const gchar * object_path, const gchar * interface_name, const gchar * signal_name, GVariant * parameters, gpointer user_data)
{
    const gchar *name;
...
static void test_connection_filter(void)
{
    ...
    m2 = g_dbus_message_copy(m, &error);
    g_assert_no_error(error);
    r = g_dbus_connection_send_message_with_reply_sync(c, m2, G_DBUS_SEND_MESSAGE_FLAGS_NONE, -1, &data.serial, NULL,    /* GCancellable */
                                                       &error);
    g_object_unref(m2);
    g_assert_no_error(error);
    g_assert(r != NULL);
    ...
    signal_handler_id = g_dbus_connection_signal_subscribe(c, "org.freedesktop.DBus",    /* sender */
                                                           "org.freedesktop.DBus", "NameOwnerChanged", "/org/freedesktop/DBus", NULL,    /* arg0 */
    ...
    error = NULL;
    result = g_dbus_connection_call_sync(c, "com.example.TestService",    /* bus name */
...
static void send_bogus_message(GDBusConnection * c, guint32 * out_serial)
{
    GDBusMessage *m;
    GError *error;
...
static gpointer serials_thread_func(GDBusConnection * c)
{
...
static void test_connection_serials(void)
{
    GDBusConnection *c;
    GError *error;
...
static void test_connection_basic(void)
{
    ...
    g_object_get(connection, "stream", &stream, "guid", &guid, "unique-name", &name, "closed", &closed, "exit-on-close", &exit_on_close, "capabilities", &flags, NULL);
