...
static void wait_for_read(gboolean success, gsize read)
{
...
static void wait_for_write(gboolean success, gsize written)
{
...
static void test_write_all_async_memory(void)
{
    GOutputStream *ms;
    gchar b[24];
...
static void test_read_all_async_memory(void)
{
    GInputStream *ms;
...
static void test_read_write_all_async_pipe(void)
{
