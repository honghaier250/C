...
static void g_list_model_default_init(GListModelInterface * iface)
{
   ...
   * Since: 2.44
   */
    g_list_model_changed_signal = g_signal_new(I_("items-changed"), G_TYPE_LIST_MODEL, G_SIGNAL_RUN_LAST, 0, NULL, NULL, g_cclosure_marshal_generic, G_TYPE_NONE, 3, G_TYPE_UINT, G_TYPE_UINT, G_TYPE_UINT);
}
