...
static void g_unix_fd_message_class_init(GUnixFDMessageClass * class)
{
    ...
    g_object_class_install_property(object_class, 1, g_param_spec_object("fd-list", "file descriptor list", "The GUnixFDList object to send with the message", G_TYPE_UNIX_FD_LIST, G_PARAM_STATIC_STRINGS | G_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY));
}
