...
G_GNUC_BEGIN_IGNORE_DEPRECATIONS static void g_simple_async_result_async_result_iface_init(GAsyncResultIface * iface);
...
static gboolean g_simple_async_result_is_tagged(GAsyncResult * res, gpointer source_tag)
{
...
void g_simple_async_result_complete(GSimpleAsyncResult * simple)
{
    ...
    if (simple->callback)
    {
        ...
        simple->callback(simple->source_object, G_ASYNC_RESULT(simple), simple->user_data);
...
gboolean g_simple_async_result_is_valid(GAsyncResult * result, GObject * source, gpointer source_tag)
{
    ...
    return source_tag == NULL || result_source_tag == NULL || source_tag == result_source_tag;
}
