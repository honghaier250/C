...
static void test_enum_transformation(void)
{
    GType type;
...
static void test_gtype_value(void)
{
    GType type;
...
static gchar *collect(GValue * value, ...)
{
    gchar *error;
    va_list var_args;
...
static gchar *lcopy(GValue * value, ...)
{
    gchar *error;
    va_list var_args;
