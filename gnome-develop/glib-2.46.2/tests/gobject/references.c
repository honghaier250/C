...
static void test_object_init(TestObject * test_object)
{
}
...
static void weak_ref1(gpointer data, GObject * object)
{
...
static void weak_ref2(gpointer data, GObject * object)
{
    g_assert(object == global_object);
...
static void toggle_ref1(gpointer data, GObject * object, gboolean is_last_ref)
{
    g_assert(object == global_object);
    g_assert(data == GUINT_TO_POINTER(42));
...
static void toggle_ref2(gpointer data, GObject * object, gboolean is_last_ref)
{
    g_assert(object == global_object);
    g_assert(data == GUINT_TO_POINTER(24));
...
static void toggle_ref3(gpointer data, GObject * object, gboolean is_last_ref)
{
    g_assert(object == global_object);
