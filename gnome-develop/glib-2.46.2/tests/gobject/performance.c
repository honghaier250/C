...
struct _PerformanceTest
{
    ...
    void (*init) (PerformanceTest * test, gpointer data, double factor);
    void (*run) (PerformanceTest * test, gpointer data);
    void (*finish) (PerformanceTest * test, gpointer data);
    void (*teardown) (PerformanceTest * test, gpointer data);
    void (*print_result) (PerformanceTest * test, gpointer data, double time);
};

static void run_test(PerformanceTest * test)
{
    gpointer data = NULL;
...
static void simple_object_finalize(GObject * object)
{
    G_OBJECT_CLASS(simple_object_parent_class)->finalize(object);
}

static void simple_object_class_init(SimpleObjectClass * class)
{
...
static void simple_object_init(SimpleObject * simple_object)
{
...
#define COMPLEX_TYPE_OBJECT        (complex_object_get_type ())
     ...
     static void complex_test_iface_init(gpointer g_iface, gpointer iface_data);
...
G_DEFINE_TYPE_EXTENDED(ComplexObject, complex_object,
                       ...
                       G_IMPLEMENT_INTERFACE(TEST_TYPE_IFACE2,
                                             complex_test_iface_init)
                       G_IMPLEMENT_INTERFACE(TEST_TYPE_IFACE3, complex_test_iface_init) G_IMPLEMENT_INTERFACE(TEST_TYPE_IFACE4, complex_test_iface_init) G_IMPLEMENT_INTERFACE(TEST_TYPE_IFACE5, complex_test_iface_init));
...
static void complex_object_finalize(GObject * object)
{
    G_OBJECT_CLASS(complex_object_parent_class)->finalize(object);
}

static void complex_object_set_property(GObject * object, guint prop_id, const GValue * value, GParamSpec * pspec)
{
...
static void complex_object_get_property(GObject * object, guint prop_id, GValue * value, GParamSpec * pspec)
{
    ComplexObject *complex = COMPLEX_OBJECT(object);
...
static void complex_object_real_signal(ComplexObject * obj)
{
}

static void complex_object_class_init(ComplexObjectClass * class)
{
    GObjectClass *object_class = G_OBJECT_CLASS(class);
    ...
    complex_signals[COMPLEX_SIGNAL] = g_signal_new("signal", G_TYPE_FROM_CLASS(object_class), G_SIGNAL_RUN_FIRST, G_STRUCT_OFFSET(ComplexObjectClass, signal), NULL, NULL, g_cclosure_marshal_VOID__VOID, G_TYPE_NONE, 0);

    complex_signals[COMPLEX_SIGNAL_EMPTY] = g_signal_new("signal-empty", G_TYPE_FROM_CLASS(object_class), G_SIGNAL_RUN_FIRST, G_STRUCT_OFFSET(ComplexObjectClass, signal_empty), NULL, NULL, g_cclosure_marshal_VOID__VOID, G_TYPE_NONE, 0);

    complex_signals[COMPLEX_SIGNAL_GENERIC] = g_signal_new("signal-generic", G_TYPE_FROM_CLASS(object_class), G_SIGNAL_RUN_FIRST, G_STRUCT_OFFSET(ComplexObjectClass, signal), NULL, NULL, NULL, G_TYPE_NONE, 0);
    complex_signals[COMPLEX_SIGNAL_GENERIC_EMPTY] = g_signal_new("signal-generic-empty", G_TYPE_FROM_CLASS(object_class), G_SIGNAL_RUN_FIRST, G_STRUCT_OFFSET(ComplexObjectClass, signal_empty), NULL, NULL, NULL, G_TYPE_NONE, 0);

    complex_signals[COMPLEX_SIGNAL_ARGS] =
        g_signal_new("signal-args", G_TYPE_FROM_CLASS(object_class), G_SIGNAL_RUN_FIRST, G_STRUCT_OFFSET(ComplexObjectClass, signal), NULL, NULL, g_cclosure_marshal_VOID__UINT_POINTER, G_TYPE_NONE, 2, G_TYPE_UINT, G_TYPE_POINTER);

    g_object_class_install_property(object_class, PROP_VAL1, g_param_spec_int("val1", "val1", "val1", 0, G_MAXINT, 42, G_PARAM_CONSTRUCT | G_PARAM_READWRITE));
    g_object_class_install_property(object_class, PROP_VAL2, g_param_spec_int("val2", "val2", "val2", 0, G_MAXINT, 43, G_PARAM_READWRITE));

}

static void complex_object_iface_method(TestIface * obj)
{
...
static void complex_object_init(ComplexObject * complex_object)
{
...
static gpointer test_construction_setup(PerformanceTest * test)
{
...
static void test_construction_init(PerformanceTest * test, gpointer _data, double count_factor)
{
...
static void test_construction_run(PerformanceTest * test, gpointer _data)
{
    struct ConstructionTest *data = _data;
...
static void test_construction_finish(PerformanceTest * test, gpointer _data)
{
    struct ConstructionTest *data = _data;
    int i;
...
static void test_construction_teardown(PerformanceTest * test, gpointer _data)
{
    struct ConstructionTest *data = _data;
    g_free(data->objects);
    g_free(data);
...
static void test_construction_print_result(PerformanceTest * test, gpointer _data, double time)
{
    struct ConstructionTest *data = _data;
...
static gpointer test_type_check_setup(PerformanceTest * test)
{
...
static void test_type_check_init(PerformanceTest * test, gpointer _data, double factor)
{
...
gboolean(*my_type_check_instance_is_a) (GTypeInstance * type_instance, GType iface_type) = &g_type_check_instance_is_a;
...
static void test_type_check_run(PerformanceTest * test, gpointer _data)
{
    ...
    for (i = 0; i < data->n_checks; i++)
    {
        ...
        for (j = 0; j < 1000; j++)
        {
            my_type_check_instance_is_a((GTypeInstance *) object, type);
        }
    }
}

static void test_type_check_finish(PerformanceTest * test, gpointer data)
{
}

static void test_type_check_print_result(PerformanceTest * test, gpointer _data, double time)
{
    struct TypeCheckTest *data = _data;
    g_print("Million type checks per second: %.2f\n", data->n_checks / (1000 * time));
}

static void test_type_check_teardown(PerformanceTest * test, gpointer _data)
{
    struct TypeCheckTest *data = _data;
...
static void test_emission_run(PerformanceTest * test, gpointer _data)
{
...
static void test_emission_run_args(PerformanceTest * test, gpointer _data)
{
    struct EmissionTest *data = _data;
    GObject *object = data->object;
    int i;
...
static gpointer test_emission_unhandled_setup(PerformanceTest * test)
{
...
static void test_emission_unhandled_init(PerformanceTest * test, gpointer _data, double factor)
{
    struct EmissionTest *data = _data;
...
static void test_emission_unhandled_finish(PerformanceTest * test, gpointer data)
{
}

static void test_emission_unhandled_print_result(PerformanceTest * test, gpointer _data, double time)
{
    struct EmissionTest *data = _data;
...
static void test_emission_unhandled_teardown(PerformanceTest * test, gpointer _data)
{
    struct EmissionTest *data = _data;
...
static void test_emission_handled_handler(ComplexObject * obj, gpointer data)
{
}

static gpointer test_emission_handled_setup(PerformanceTest * test)
{
    struct EmissionTest *data;
    ...
    data->object = g_object_new(COMPLEX_TYPE_OBJECT, NULL);
    data->signal_id = complex_signals[GPOINTER_TO_INT(test->extra_data)];
    g_signal_connect(data->object, "signal", G_CALLBACK(test_emission_handled_handler), NULL);
    g_signal_connect(data->object, "signal-empty", G_CALLBACK(test_emission_handled_handler), NULL);
    g_signal_connect(data->object, "signal-generic", G_CALLBACK(test_emission_handled_handler), NULL);
    g_signal_connect(data->object, "signal-generic-empty", G_CALLBACK(test_emission_handled_handler), NULL);
    g_signal_connect(data->object, "signal-args", G_CALLBACK(test_emission_handled_handler), NULL);

    return data;
}

static void test_emission_handled_init(PerformanceTest * test, gpointer _data, double factor)
{
    struct EmissionTest *data = _data;
...
static void test_emission_handled_finish(PerformanceTest * test, gpointer data)
{
}

static void test_emission_handled_print_result(PerformanceTest * test, gpointer _data, double time)
{
    struct EmissionTest *data = _data;
...
static void test_emission_handled_teardown(PerformanceTest * test, gpointer _data)
{
    struct EmissionTest *data = _data;
...
static gpointer test_refcount_setup(PerformanceTest * test)
{
...
static void test_refcount_init(PerformanceTest * test, gpointer _data, double factor)
{
...
static void test_refcount_run(PerformanceTest * test, gpointer _data)
{
    struct RefcountTest *data = _data;
    GObject *object = data->object;
    int i;
...
static void test_refcount_finish(PerformanceTest * test, gpointer _data)
{
}

static void test_refcount_print_result(PerformanceTest * test, gpointer _data, double time)
{
    struct RefcountTest *data = _data;
    g_print("Million refs+unref per second: %.2f\n", data->n_checks * 5 / (time * 1000000));
}

static void test_refcount_teardown(PerformanceTest * test, gpointer _data)
{
    struct RefcountTest *data = _data;
...
static PerformanceTest *find_test(const char *name)
{
    int i;
