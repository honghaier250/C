...
static GType simple_register_class(const char *name, GType parent, ...)
{
    ...
    type = g_type_register_static_simple(parent, name, sizeof(GObjectClass), NULL, parent == G_TYPE_INTERFACE ? 0 : sizeof(GObject), NULL, 0);
    for (;;)
    {
...
static gpointer register_types(void)
{
    ...
    if (g_once_init_enter(&inited))
    {
        ...
        liststore = simple_register_class("GtkListStore", G_TYPE_OBJECT, liststore_interfaces[0], liststore_interfaces[1], liststore_interfaces[2], liststore_interfaces[3], liststore_interfaces[4], (GType) 0);
...
static void liststore_is_a_run(gpointer data)
{
    guint i;
...
static gpointer liststore_get_class(void)
{
    register_types();
    return g_type_class_ref(liststore);
}

static void liststore_interface_peek_run(gpointer klass)
{
    guint i;
    gpointer iface;
...
static void liststore_interface_peek_same_run(gpointer klass)
{
    guint i;
    gpointer iface;
...
static gpointer no_setup(void)
{
    return NULL;
}

static void no_run(gpointer data)
{
}
#endif

static void no_reset(gpointer data)
{
}

static void no_teardown(gpointer data)
{
}
...
static void print_results(GArray * array)
{
    double min, max, avg;
    guint i;
...
static void run_test(const PerformanceTest * test)
{
    GArray *results;
...
static const PerformanceTest *find_test(const char *name)
{
    int i;
