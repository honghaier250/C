...
static void test_param_spec_char(void)
{
    GParamSpec *pspec;
    GValue value = G_VALUE_INIT;
    gboolean modified;

    pspec = g_param_spec_char("char", "nick", "blurb", 20, 40, 30, G_PARAM_READWRITE);
...
static void test_param_spec_string(void)
{
    GParamSpec *pspec;
    GValue value = G_VALUE_INIT;
    gboolean modified;

    pspec = g_param_spec_string("string", "nick", "blurb", NULL, G_PARAM_READWRITE);
...
static void test_param_spec_override(void)
{
    GParamSpec *ospec, *pspec;
    GValue value = G_VALUE_INIT;
    gboolean modified;

    ospec = g_param_spec_char("char", "nick", "blurb", 20, 40, 30, G_PARAM_READWRITE);
...
static void test_param_spec_gtype(void)
{
    GParamSpec *pspec;
    GValue value = G_VALUE_INIT;
    gboolean modified;

    pspec = g_param_spec_gtype("gtype", "nick", "blurb", G_TYPE_PARAM, G_PARAM_READWRITE);
...
static void test_param_spec_variant(void)
{
    GParamSpec *pspec;
    GValue value = G_VALUE_INIT;
    gboolean modified;

    pspec = g_param_spec_variant("variant", "nick", "blurb", G_VARIANT_TYPE("i"), g_variant_new_int32(42), G_PARAM_READWRITE);
