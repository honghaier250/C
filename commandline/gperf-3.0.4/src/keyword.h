...
struct KeywordExt:public Keyword
{
	...
	void init_selchars_multiset (const Positions & positions, const unsigned int *alpha_unify,
  ...
  private:
	unsigned int *init_selchars_low (const Positions & positions, const unsigned int *alpha_unify,
									 const unsigned int *alpha_inc);
};
...
class Keyword_Factory
{
  public:
	...
	create_keyword (const char *allchars, int allchars_length, const char *rest) = 0;
};
