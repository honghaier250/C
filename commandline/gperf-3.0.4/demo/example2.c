...
/* Command-line: ../src/gperf -t -L C example2.gperf  */
...
#line 1 "example2.gperf"

    /* C code that goes verbatim in output */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#line 7 "example2.gperf"
     ...
     register unsigned int len;
{
  static struct tl wordlist[] =
    {
#line 9 "example2.gperf"
      {"--name",'n'},
#line 10 "example2.gperf"
      {"--love",'l'}
    };
