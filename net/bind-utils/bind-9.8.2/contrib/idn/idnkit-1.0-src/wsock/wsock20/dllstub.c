...
{
    static int (WINAPI * fp) (SOCKET a0, const struct sockaddr * a1, int a2, LPWSABUF a3, LPWSABUF a4, LPQOS a5,
                              LPQOS a6);
...
int WINAPI
WSAIoctl (SOCKET a0, DWORD a1, LPVOID a2, DWORD a3, LPVOID a4, DWORD a5, LPDWORD a6, LPWSAOVERLAPPED a7,
          LPWSAOVERLAPPED_COMPLETION_ROUTINE a8)
{
    static int (WINAPI * fp) (SOCKET a0, DWORD a1, LPVOID a2, DWORD a3, LPVOID a4, DWORD a5, LPDWORD a6,
...
{
    static SOCKET (WINAPI * fp) (SOCKET a0, const struct sockaddr * a1, int a2, LPWSABUF a3, LPWSABUF a4, LPQOS a5,
                                 LPQOS a6, DWORD a7);
...
INT WINAPI _org_WSALookupServiceBeginA (LPWSAQUERYSETA a0, DWORD a1, LPHANDLE a2)
{
...
INT WINAPI _org_WSALookupServiceBeginW (LPWSAQUERYSETW a0, DWORD a1, LPHANDLE a2)
{
...
INT WINAPI _org_WSALookupServiceEnd (HANDLE a0)
{
...
INT WINAPI _org_WSALookupServiceNextA (HANDLE a0, DWORD a1, LPDWORD a2, LPWSAQUERYSETA a3)
{
...
INT WINAPI _org_WSALookupServiceNextW (HANDLE a0, DWORD a1, LPDWORD a2, LPWSAQUERYSETW a3)
{
...
int WINAPI
WSARecv (SOCKET a0, LPWSABUF a1, DWORD a2, LPDWORD a3, LPDWORD a4, LPWSAOVERLAPPED a5,
         LPWSAOVERLAPPED_COMPLETION_ROUTINE a6)
{
    static int (WINAPI * fp) (SOCKET a0, LPWSABUF a1, DWORD a2, LPDWORD a3, LPDWORD a4, LPWSAOVERLAPPED a5,
                              LPWSAOVERLAPPED_COMPLETION_ROUTINE a6);
...
int WINAPI
WSARecvFrom (SOCKET a0, LPWSABUF a1, DWORD a2, LPDWORD a3, LPDWORD a4, struct sockaddr *a5, LPINT a6,
             LPWSAOVERLAPPED a7, LPWSAOVERLAPPED_COMPLETION_ROUTINE a8)
{
    static int (WINAPI * fp) (SOCKET a0, LPWSABUF a1, DWORD a2, LPDWORD a3, LPDWORD a4, struct sockaddr * a5, LPINT a6,
                              LPWSAOVERLAPPED a7, LPWSAOVERLAPPED_COMPLETION_ROUTINE a8);
...
int WINAPI
WSASend (SOCKET a0, LPWSABUF a1, DWORD a2, LPDWORD a3, DWORD a4, LPWSAOVERLAPPED a5,
         LPWSAOVERLAPPED_COMPLETION_ROUTINE a6)
{
    static int (WINAPI * fp) (SOCKET a0, LPWSABUF a1, DWORD a2, LPDWORD a3, DWORD a4, LPWSAOVERLAPPED a5,
                              LPWSAOVERLAPPED_COMPLETION_ROUTINE a6);
...
int WINAPI
WSASendTo (SOCKET a0, LPWSABUF a1, DWORD a2, LPDWORD a3, DWORD a4, const struct sockaddr *a5, int a6,
           LPWSAOVERLAPPED a7, LPWSAOVERLAPPED_COMPLETION_ROUTINE a8)
{
    static int (WINAPI * fp) (SOCKET a0, LPWSABUF a1, DWORD a2, LPDWORD a3, DWORD a4, const struct sockaddr * a5,
                              int a6, LPWSAOVERLAPPED a7, LPWSAOVERLAPPED_COMPLETION_ROUTINE a8);
...
int PASCAL _org_getaddrinfo (const char *a0, const char *a1, LPVOID a2, LPVOID a3)
{
...
void PASCAL _org_freeaddrinfo (LPVOID a0)
{
...
int PASCAL _org_getnameinfo (LPVOID a0, DWORD a1, char *a2, DWORD a3, char *a4, DWORD a5, int a6)
{
