...
int PASCAL closesocket (SOCKET a0)
{
...
int PASCAL connect (SOCKET a0, const struct sockaddr *a1, int a2)
{
    static int (PASCAL * fp) (SOCKET a0, const struct sockaddr * a1, int a2);
...
int PASCAL recv (SOCKET a0, char *a1, int a2, int a3)
{
...
int PASCAL send (SOCKET a0, const char *a1, int a2, int a3)
{
...
int PASCAL MigrateWinsockConfiguration (int a0, int a1, int a2)
{
...
struct hostent *PASCAL _org_gethostbyaddr (const char *a0, int a1, int a2)
{
...
struct hostent *PASCAL _org_gethostbyname (const char *a0)
{
...
int PASCAL _org_gethostname (char *a0, int a1)
{
...
HANDLE PASCAL _org_WSAAsyncGetHostByAddr (HWND a0, u_int a1, const char *a2, int a3, int a4, char *a5, int a6)
{
...
HANDLE PASCAL _org_WSAAsyncGetHostByName (HWND a0, u_int a1, const char *a2, char *a3, int a4)
{
...
int PASCAL WsControl (int a0, int a1, int a2, int a3, int a4, int a5)
{
...
int PASCAL closesockinfo (int a0)
{
    static int (PASCAL * fp) (int a0);
...
int PASCAL Arecv (int a0, int a1, int a2, int a3)
{
...
int PASCAL Asend (int a0, int a1, int a2, int a3)
{
    static int (PASCAL * fp) (int a0, int a1, int a2, int a3);
...
int PASCAL WSHEnumProtocols (void)
{
    static int (PASCAL * fp) (void);
...
int PASCAL inet_network (int a0)
{
    static int (PASCAL * fp) (int a0);
...
int PASCAL getnetbyname (int a0)
{
    static int (PASCAL * fp) (int a0);
...
int PASCAL rcmd (int a0, int a1, int a2, int a3, int a4, int a5)
{
    static int (PASCAL * fp) (int a0, int a1, int a2, int a3, int a4, int a5);
...
int PASCAL rexec (int a0, int a1, int a2, int a3, int a4, int a5)
{
    static int (PASCAL * fp) (int a0, int a1, int a2, int a3, int a4, int a5);
...
int PASCAL sethostname (int a0, int a1)
{
...
int PASCAL dn_expand (int a0, int a1, int a2, int a3, int a4)
{
...
int PASCAL WSARecvEx (SOCKET a0, char *a1, int a2, int *a3)
{
    static int (PASCAL * fp) (SOCKET a0, char *a1, int a2, int *a3);
...
int PASCAL s_perror (int a0, int a1)
{
    static int (PASCAL * fp) (int a0, int a1);
...
INT PASCAL
GetAddressByNameA (DWORD a0, LPGUID a1, LPSTR a2, LPINT a3, DWORD a4, LPSERVICE_ASYNC_INFO a5, LPVOID a6, LPDWORD a7,
                   LPSTR a8, LPDWORD a9)
{
    static INT (PASCAL * fp) (DWORD a0, LPGUID a1, LPSTR a2, LPINT a3, DWORD a4, LPSERVICE_ASYNC_INFO a5, LPVOID a6,
                              LPDWORD a7, LPSTR a8, LPDWORD a9);
...
INT PASCAL
GetAddressByNameW (DWORD a0, LPGUID a1, LPWSTR a2, LPINT a3, DWORD a4, LPSERVICE_ASYNC_INFO a5, LPVOID a6, LPDWORD a7,
                   LPWSTR a8, LPDWORD a9)
{
    static INT (PASCAL * fp) (DWORD a0, LPGUID a1, LPWSTR a2, LPINT a3, DWORD a4, LPSERVICE_ASYNC_INFO a5, LPVOID a6,
                              LPDWORD a7, LPWSTR a8, LPDWORD a9);
...
INT PASCAL EnumProtocolsA (LPINT a0, LPVOID a1, LPDWORD a2)
{
...
INT PASCAL EnumProtocolsW (LPINT a0, LPVOID a1, LPDWORD a2)
{
    static INT (PASCAL * fp) (LPINT a0, LPVOID a1, LPDWORD a2);
...
INT PASCAL GetTypeByNameA (LPSTR a0, LPGUID a1)
{
...
INT PASCAL GetTypeByNameW (LPWSTR a0, LPGUID a1)
{
...
INT PASCAL GetNameByTypeA (LPGUID a0, LPSTR a1, DWORD a2)
{
...
INT PASCAL GetNameByTypeW (LPGUID a0, LPWSTR a1, DWORD a2)
{
...
INT PASCAL SetServiceA (DWORD a0, DWORD a1, DWORD a2, LPSERVICE_INFOA a3, LPSERVICE_ASYNC_INFO a4, LPDWORD a5)
{
...
INT PASCAL SetServiceW (DWORD a0, DWORD a1, DWORD a2, LPSERVICE_INFOW a3, LPSERVICE_ASYNC_INFO a4, LPDWORD a5)
{
...
INT PASCAL GetServiceA (DWORD a0, LPGUID a1, LPSTR a2, DWORD a3, LPVOID a4, LPDWORD a5, LPSERVICE_ASYNC_INFO a6)
{
...
INT PASCAL GetServiceW (DWORD a0, LPGUID a1, LPWSTR a2, DWORD a3, LPVOID a4, LPDWORD a5, LPSERVICE_ASYNC_INFO a6)
{
...
int PASCAL NPLoadNameSpaces (int a0, int a1, int a2)
{
    static int (PASCAL * fp) (int a0, int a1, int a2);
...
int PASCAL NSPStartup (int a0, int a1)
{
    static int (PASCAL * fp) (int a0, int a1);
...
{
    static BOOL (PASCAL * fp) (SOCKET a0, HANDLE a1, DWORD a2, DWORD a3, LPOVERLAPPED a4, LPTRANSMIT_FILE_BUFFERS a5,
                               DWORD a6);
...
BOOL PASCAL AcceptEx (SOCKET a0, SOCKET a1, PVOID a2, DWORD a3, DWORD a4, DWORD a5, LPDWORD a6, LPOVERLAPPED a7)
{
    static BOOL (PASCAL * fp) (SOCKET a0, SOCKET a1, PVOID a2, DWORD a3, DWORD a4, DWORD a5, LPDWORD a6,
                               LPOVERLAPPED a7);
...
VOID PASCAL
GetAcceptExSockaddrs (PVOID a0, DWORD a1, DWORD a2, DWORD a3, struct sockaddr ** a4, LPINT a5, struct sockaddr ** a6,
                      LPINT a7)
{
    static VOID (PASCAL * fp) (PVOID a0, DWORD a1, DWORD a2, DWORD a3, struct sockaddr ** a4, LPINT a5,
                               struct sockaddr ** a6, LPINT a7);
