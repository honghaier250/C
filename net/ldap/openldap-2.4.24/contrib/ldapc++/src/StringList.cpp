...
char **StringList::toCharArray() const const
{
    if (!empty())
    {
...
size_t StringList::size() const const
{
    return m_data.size();
}

bool StringList::empty() const const
{
    return m_data.empty();
}

StringList::const_iterator StringList::begin() constconst
{
    return m_data.begin();
}

StringList::const_iterator StringList::end() constconst
{
    return m_data.end();
}
