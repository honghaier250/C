...
LDAPException::LDAPException(int res_code, const string & err_string) throw():std::runtime_error(err_string)
{
    m_res_code = res_code;
...
LDAPException::LDAPException(const LDAPAsynConnection * lc) throw():std::runtime_error("")
{
...
int LDAPException::getResultCode() const const throw()
{
    return m_res_code;
}

const string & LDAPException::getResultMsg() const const throw()
{
    return m_res_string;
}

const string & LDAPException::getServerMsg() const const throw()
{
    return m_err_string;
}

const char *LDAPException::what() const const throw()
{
...
LDAPReferralException::LDAPReferralException(const LDAPUrlList & urls) throw():LDAPException(LDAPResult::REFERRAL), m_urlList(urls)
{
}
