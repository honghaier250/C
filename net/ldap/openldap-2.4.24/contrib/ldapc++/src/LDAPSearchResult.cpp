...
LDAPSearchResult::LDAPSearchResult(const LDAPRequest * req, LDAPMessage * msg):LDAPMsg(msg)
{
...
LDAPSearchResult::LDAPSearchResult(const LDAPSearchResult & res):LDAPMsg(res)
{
...
const LDAPEntry *LDAPSearchResult::getEntry() const const
{
