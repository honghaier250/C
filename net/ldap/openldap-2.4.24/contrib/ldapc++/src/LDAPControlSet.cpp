...
size_t LDAPControlSet::size() const const
{
    DEBUG(LDAP_DEBUG_TRACE, "LDAPControlSet::size()" << endl);
    return data.size();
}

bool LDAPControlSet::empty() const const
{
    DEBUG(LDAP_DEBUG_TRACE, "LDAPControlSet::empty()" << endl);
    return data.empty();
}

LDAPControlSet::const_iterator LDAPControlSet::begin() constconst
{
    DEBUG(LDAP_DEBUG_TRACE, "LDAPControlSet::begin()" << endl);
    return data.begin();
}

LDAPControlSet::const_iterator LDAPControlSet::end() constconst
{
...
LDAPControl **LDAPControlSet::toLDAPControlArray() const const
{
