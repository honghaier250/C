...
{
    DEBUG(LDAP_DEBUG_CONSTRUCT, "LDAPAttrType::LDAPAttrType( )" << endl);
...
bool LDAPAttrType::isSingle() const const
{
    return single;
}

string LDAPAttrType::getOid() const const
{
    return oid;
}

string LDAPAttrType::getDesc() const const
{
    return desc;
}

StringList LDAPAttrType::getNames() const const
{
    return names;
}

string LDAPAttrType::getName() const const
{
...
int LDAPAttrType::getUsage() const const
{
    return usage;
}

std::string LDAPAttrType::getSuperiorOid() constconst
{
    return superiorOid;
}

std::string LDAPAttrType::getEqualityOid() constconst
{
    return equalityOid;
}

std::string LDAPAttrType::getOrderingOid() constconst
{
    return orderingOid;
}

std::string LDAPAttrType::getSubstringOid() constconst
{
    return substringOid;
}

std::string LDAPAttrType::getSyntaxOid() constconst
{
    return syntaxOid;
}
