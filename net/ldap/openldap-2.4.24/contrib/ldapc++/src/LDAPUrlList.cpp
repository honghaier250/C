...
size_t LDAPUrlList::size() const const
{
    return m_urls.size();
}

bool LDAPUrlList::empty() const const
{
    return m_urls.empty();
}

LDAPUrlList::const_iterator LDAPUrlList::begin() constconst
{
    return m_urls.begin();
}

LDAPUrlList::const_iterator LDAPUrlList::end() constconst
{
    return m_urls.end();
}
