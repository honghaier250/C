...
size_t LDAPReferenceList::size() const const
{
    return m_refs.size();
}

bool LDAPReferenceList::empty() const const
{
    return m_refs.empty();
}

LDAPReferenceList::const_iterator LDAPReferenceList::begin() constconst
{
    return m_refs.begin();
}

LDAPReferenceList::const_iterator LDAPReferenceList::end() constconst
{
    return m_refs.end();
}
