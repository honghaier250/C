...
LDAPExtResult::LDAPExtResult(const LDAPRequest * req, LDAPMessage * msg):LDAPResult(req, msg)
{
...
const string & LDAPExtResult::getResponseOid() const const
{
    return m_oid;
}

const string & LDAPExtResult::getResponse() const const
{
    return m_data;
}
