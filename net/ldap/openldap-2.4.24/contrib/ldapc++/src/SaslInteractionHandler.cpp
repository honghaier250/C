...
void DefaultSaslInteractionHandler::handleInteractions(const std::list < SaslInteraction * >&cb)
{
    DEBUG(LDAP_DEBUG_TRACE, "DefaultSaslInteractionHandler::handleCallbacks()" << std::endl);
...
{
    DEBUG(LDAP_DEBUG_TRACE, "DefaultSaslInteractionHandler::~DefaultSaslInteractionHandler()" << std::endl);
