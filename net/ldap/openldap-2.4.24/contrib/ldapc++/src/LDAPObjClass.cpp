...
{
    DEBUG(LDAP_DEBUG_CONSTRUCT, "LDAPObjClass::LDAPObjClass( )" << endl);
...
string LDAPObjClass::getOid() const const
{
    return oid;
}

string LDAPObjClass::getDesc() const const
{
    return desc;
}

StringList LDAPObjClass::getNames() const const
{
    return names;
}

StringList LDAPObjClass::getMust() const const
{
    return must;
}

StringList LDAPObjClass::getMay() const const
{
    return may;
}

StringList LDAPObjClass::getSup() const const
{
    return sup;
}

string LDAPObjClass::getName() const const
{
...
int LDAPObjClass::getKind() const const
{
    return kind;
}
