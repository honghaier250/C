...
size_t LDAPEntryList::size() const const
{
    return m_entries.size();
}

bool LDAPEntryList::empty() const const
{
    return m_entries.empty();
}

LDAPEntryList::const_iterator LDAPEntryList::begin() constconst
{
    return m_entries.begin();
}

LDAPEntryList::const_iterator LDAPEntryList::end() constconst
{
