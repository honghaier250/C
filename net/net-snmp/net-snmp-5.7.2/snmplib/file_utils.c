...
netsnmp_feature_child_of (file_utils, file_utils_all) netsnmp_feature_child_of (file_close, file_utils_all)
 ...
 */
netsnmp_file *netsnmp_file_new (const char *name, int fs_flags, mode_t mode, u_int ns_flags)
{
 ...
 */
netsnmp_file *netsnmp_file_fill (netsnmp_file * filei, const char *name, int fs_flags, mode_t mode, u_int ns_flags)
{
    if (NULL == filei)
    {
