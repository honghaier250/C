...
u_char *snmp_parse_var_op (u_char * data,
                           oid * var_name,
                           size_t * var_name_len,
                           u_char * var_val_type, size_t * var_val_len, u_char ** var_val, size_t * listlength)
{
    u_char var_op_type;
    ...
    data = asn_parse_sequence (data, &var_op_len, &var_op_type, (ASN_SEQUENCE | ASN_CONSTRUCTOR), "var_op");
    if (data == NULL)
    {
        /*
         * msg detail is set 
...
u_char *snmp_build_var_op (u_char * data,
                           oid * var_name,
                           size_t * var_name_len,
                           u_char var_val_type, size_t var_val_len, u_char * var_val, size_t * listlength)
{
    ...
    dataPtr = data;
#if 0
    data = asn_build_sequence (data, &dummyLen, (u_char) (ASN_SEQUENCE | ASN_CONSTRUCTOR), 0);
    if (data == NULL)
    {
        return NULL;
    }
    ...
    *listlength -= headerLen;
    ...
    data = asn_build_objid (data, listlength,
                            (u_char) (ASN_UNIVERSAL | ASN_PRIMITIVE | ASN_OBJECT_ID), var_name, *var_name_len);
    DEBUGINDENTLESS ();
    if (data == NULL)
    {
    ...
    {
        case ASN_INTEGER:
            data = asn_build_int (data, listlength, var_val_type, (long *) var_val, var_val_len);
            break;
        case ASN_GAUGE:
        case ASN_COUNTER:
        case ASN_TIMETICKS:
        case ASN_UINTEGER:
            data = asn_build_unsigned_int (data, listlength, var_val_type, (u_long *) var_val, var_val_len);
            break;
...
#endif
        case ASN_COUNTER64:
            data = asn_build_unsigned_int64 (data, listlength, var_val_type, (struct counter64 *) var_val, var_val_len);
            break;
        case ASN_OCTET_STR:
        case ASN_IPADDRESS:
        case ASN_OPAQUE:
        case ASN_NSAP:
            data = asn_build_string (data, listlength, var_val_type, var_val, var_val_len);
            break;
        case ASN_OBJECT_ID:
            data = asn_build_objid (data, listlength, var_val_type, (oid *) var_val, var_val_len / sizeof (oid));
            break;
        case ASN_NULL:
            data = asn_build_null (data, listlength, var_val_type);
            break;
        case ASN_BIT_STR:
            data = asn_build_bitstring (data, listlength, var_val_type, var_val, var_val_len);
            break;
        ...
        case ASN_OPAQUE_FLOAT:
            data = asn_build_float (data, listlength, var_val_type, (float *) var_val, var_val_len);
            break;
        case ASN_OPAQUE_DOUBLE:
            data = asn_build_double (data, listlength, var_val_type, (double *) var_val, var_val_len);
            break;
        case ASN_OPAQUE_I64:
            data = asn_build_signed_int64 (data, listlength, var_val_type, (struct counter64 *) var_val, var_val_len);
            break;
        ...
        default:
            {
                ...
                snprintf (error_buf, sizeof (error_buf), "wrong type in snmp_build_var_op: %d", var_val_type);
                ERROR_MSG (error_buf);
                data = NULL;
            }
    }
    ...
    asn_build_sequence (dataPtr, &dummyLen, (u_char) (ASN_SEQUENCE | ASN_CONSTRUCTOR), dummyLen);
    return data;
}
...
snmp_realloc_rbuild_var_op (u_char ** pkt, size_t * pkt_len,
                            ...
                            u_char var_val_type, u_char * var_val, size_t var_val_len)
{
    ...
    switch (var_val_type)
    {
        ...
        case ASN_UINTEGER:
            rc = asn_realloc_rbuild_unsigned_int (pkt, pkt_len, offset,
                                                  allow_realloc, var_val_type, (u_long *) var_val, var_val_len);
            break;
        ...
        case ASN_OPAQUE:
        case ASN_NSAP:
            rc = asn_realloc_rbuild_string (pkt, pkt_len, offset, allow_realloc, var_val_type, var_val, var_val_len);
            break;
        ...
        case ASN_NULL:
            rc = asn_realloc_rbuild_null (pkt, pkt_len, offset, allow_realloc, var_val_type);
            break;

        case ASN_BIT_STR:
            rc = asn_realloc_rbuild_bitstring (pkt, pkt_len, offset, allow_realloc, var_val_type, var_val, var_val_len);
            break;
        ...
        default:
            {
                ...
                snprintf (error_buf, sizeof (error_buf), "wrong type in snmp_realloc_rbuild_var_op: %d", var_val_type);
                ERROR_MSG (error_buf);
                rc = 0;
            }
    }
