...
void netsnmp_container_init_list (void)
{
     ...
     */
    netsnmp_container_register ("table_container", netsnmp_container_get_factory ("binary_array"));

#ifndef NETSNMP_FEATURE_REMOVE_CONTAINER_LINKED_LIST
    netsnmp_container_register ("linked_list", netsnmp_container_get_factory ("sorted_singly_linked_list"));
    netsnmp_container_register ("ssll_container", netsnmp_container_get_factory ("sorted_singly_linked_list"));
#endif                            /* NETSNMP_FEATURE_REMOVE_CONTAINER_LINKED_LIST */

    netsnmp_container_register_with_compare
        ("cstring", netsnmp_container_get_factory ("binary_array"), netsnmp_compare_direct_cstring);

    netsnmp_container_register_with_compare
        ("string", netsnmp_container_get_factory ("binary_array"), netsnmp_compare_cstring);
    netsnmp_container_register_with_compare
        ("string_binary_array", netsnmp_container_get_factory ("binary_array"), netsnmp_compare_cstring);
...
int netsnmp_container_register_with_compare (const char *name, netsnmp_factory * f, netsnmp_container_compare * c)
{
    ...
    if (NULL != ct)
    {
        DEBUGMSGT (("container_registry", "replacing previous container factory\n"));
        ct->factory = f;
    }
    else
    {
...
/*------------------------------------------------------------------
 */
void netsnmp_container_add_index (netsnmp_container * primary, netsnmp_container * new_index)
{
 ...
 */
void CONTAINER_CLEAR (netsnmp_container * x, netsnmp_container_obj_func * f, void *c)
{
...
int netsnmp_compare_netsnmp_index (const void *lhs, const void *rhs)
{
    ...
    DEBUGIF ("compare:index")
    {
        ...
        DEBUGMSGSUBOID (("compare:index", ((const netsnmp_index *) lhs)->oids, ((const netsnmp_index *) lhs)->len));
        DEBUGMSG (("compare:index", " to "));
        DEBUGMSGSUBOID (("compare:index", ((const netsnmp_index *) rhs)->oids, ((const netsnmp_index *) rhs)->len));
...
int netsnmp_ncompare_netsnmp_index (const void *lhs, const void *rhs)
{
    ...
    rc = snmp_oid_ncompare (((const netsnmp_index *) lhs)->oids,
                            ...
                            ((const netsnmp_index *) rhs)->len, ((const netsnmp_index *) rhs)->len);
    DEBUGMSGT (("compare:index", "result was %d\n", rc));
    return rc;
}
...
{
    return strcmp (((const container_type *) lhs)->name, ((const container_type *) rhs)->name);
}
...
int netsnmp_ncompare_cstring (const void *lhs, const void *rhs)
{
    return strncmp (((const container_type *) lhs)->name,
                    ((const container_type *) rhs)->name, strlen (((const container_type *) rhs)->name));
}
...
void netsnmp_container_simple_free (void *data, void *context)
{
    ...
    DEBUGMSGTL (("verbose:container", "netsnmp_container_simple_free) called for %p/%p\n", data, context));
