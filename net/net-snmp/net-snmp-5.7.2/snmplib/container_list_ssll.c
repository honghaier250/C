...
netsnmp_feature_child_of (container_fifo, container_types) netsnmp_feature_child_of (container_lifo, container_types)
...
static void _ssll_for_each (netsnmp_container * c, netsnmp_container_obj_func * f, void *context)
{
    sl_container *sl = (sl_container *) c;
...
static void _ssll_clear (netsnmp_container * c, netsnmp_container_obj_func * f, void *context)
{
    sl_container *sl = (sl_container *) c;
...
{
    netsnmp_container_register ("sorted_singly_linked_list", netsnmp_container_get_ssll_factory ());
    netsnmp_container_register ("unsorted_singly_linked_list", netsnmp_container_get_usll_factory ());
