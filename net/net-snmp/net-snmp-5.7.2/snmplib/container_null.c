...
static void _null_for_each (netsnmp_container * container, netsnmp_container_obj_func * f, void *context)
{
    DEBUGMSGTL (("container:null:for_each", "in\n"));
}

static netsnmp_void_array *_null_get_subset (netsnmp_container * container, void *data)
{
    DEBUGMSGTL (("container:null:get_subset", "in\n"));
    return NULL;
}

static void _null_clear (netsnmp_container * container, netsnmp_container_obj_func * f, void *context)
{
...
netsnmp_factory *netsnmp_container_get_null_factory (void)
{
    static netsnmp_factory f = { "null",
        (netsnmp_factory_produce_f *) netsnmp_container_get_null
    };
