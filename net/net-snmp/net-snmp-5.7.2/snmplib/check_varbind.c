...
netsnmp_feature_child_of (check_vb_truthvalue, check_varbind_all)
    ...
    netsnmp_feature_require (check_rowstatus_with_storagetype_transition)
     ...
     NETSNMP_INLINE int netsnmp_check_vb_type (const netsnmp_variable_list * var, int type)
{
...
NETSNMP_INLINE int netsnmp_check_vb_size (const netsnmp_variable_list * var, size_t size)
{
    register int rc = SNMP_ERR_NOERROR;
...
NETSNMP_INLINE int netsnmp_check_vb_max_size (const netsnmp_variable_list * var, size_t size)
{
    register int rc = SNMP_ERR_NOERROR;
...
NETSNMP_INLINE int netsnmp_check_vb_range (const netsnmp_variable_list * var, size_t low, size_t high)
{
    register int rc = SNMP_ERR_NOERROR;
...
NETSNMP_INLINE int netsnmp_check_vb_size_range (const netsnmp_variable_list * var, size_t low, size_t high)
{
    register int rc = SNMP_ERR_NOERROR;
...
NETSNMP_INLINE int netsnmp_check_vb_type_and_size (const netsnmp_variable_list * var, int type, size_t size)
{
    register int rc = SNMP_ERR_NOERROR;
...
NETSNMP_INLINE int netsnmp_check_vb_type_and_max_size (const netsnmp_variable_list * var, int type, size_t size)
{
    register int rc = SNMP_ERR_NOERROR;
...
NETSNMP_INLINE int netsnmp_check_vb_int_range (const netsnmp_variable_list * var, int low, int high)
{
    register int rc = SNMP_ERR_NOERROR;
...
NETSNMP_INLINE int netsnmp_check_vb_rowstatus_value (const netsnmp_variable_list * var)
{
    register int rc = SNMP_ERR_NOERROR;
    ...
    return netsnmp_check_vb_int_range (var, SNMP_ROW_NONEXISTENT, SNMP_ROW_DESTROY);
}
...
int netsnmp_check_vb_rowstatus_with_storagetype (const netsnmp_variable_list * var, int old_value, int old_storage)
{
    register int rc = SNMP_ERR_NOERROR;
    ...
    return check_rowstatus_with_storagetype_transition (old_value, *var->val.integer, old_storage);
}
#endif                            /* NETSNMP_FEATURE_REMOVE_CHECK_VB_ROWSTATUS_WITH_STORAGETYPE */

#ifndef NETSNMP_FEATURE_REMOVE_CHECK_VB_STORAGETYPE
int netsnmp_check_vb_storagetype (const netsnmp_variable_list * var, int old_value)
{
    ...
    if ((rc = netsnmp_check_vb_int_range (var, SNMP_STORAGE_NONE, SNMP_STORAGE_READONLY)))
        return rc;
