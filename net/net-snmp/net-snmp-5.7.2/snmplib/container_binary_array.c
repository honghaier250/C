 ...
 *
 */
static void array_qsort (void **data, int first, int last, netsnmp_container_compare * f)
{
    int i, j;
...
NETSNMP_STATIC_INLINE void *netsnmp_binary_array_get (netsnmp_container * c, const void *key, int exact)
{
    binary_array_table *t = (binary_array_table *) c->container_data;
...
int netsnmp_binary_array_remove_at (netsnmp_container * c, size_t index, void **save)
{
    binary_array_table *t = (binary_array_table *) c->container_data;
    ...
    if (index != t->count)
    {
         ...
         */
        memmove (&t->data[index], &t->data[index + 1], sizeof (void *) * (t->count - index));
...
netsnmp_binary_array_for_each (netsnmp_container * c, netsnmp_container_obj_func * fe, void *context, int sort)
{
    binary_array_table *t = (binary_array_table *) c->container_data;
...
NETSNMP_STATIC_INLINE void
netsnmp_binary_array_clear (netsnmp_container * c, netsnmp_container_obj_func * fe, void *context)
{
    binary_array_table *t = (binary_array_table *) c->container_data;
...
NETSNMP_STATIC_INLINE int netsnmp_binary_array_insert (netsnmp_container * c, const void *entry)
{
    binary_array_table *t = (binary_array_table *) c->container_data;
    ...
    if (t->max_size <= t->count)
    {
        ...
        memset (new_data + t->max_size, 0x0, (new_max - t->max_size) * sizeof (void *));
...
void **netsnmp_binary_array_get_subset (netsnmp_container * c, void *key, int *len)
{
    binary_array_table *t;
...
static void _ba_for_each (netsnmp_container * container, netsnmp_container_obj_func * f, void *context)
{
    netsnmp_binary_array_for_each (container, f, context, 1);
}

static void _ba_clear (netsnmp_container * container, netsnmp_container_obj_func * f, void *context)
{
    netsnmp_binary_array_clear (container, f, context);
}

static netsnmp_void_array *_ba_get_subset (netsnmp_container * container, void *data)
{
...
static netsnmp_container *_ba_duplicate (netsnmp_container * c, void *ctx, u_int flags)
{
...
netsnmp_container *netsnmp_container_get_binary_array (void)
{
     ...
     */
    netsnmp_init_container (c, NULL, _ba_free, _ba_size, NULL, _ba_insert, _ba_remove, _ba_find);
...
{
    netsnmp_container_register ("binary_array", netsnmp_container_get_binary_array_factory ());
}
...
NETSNMP_STATIC_INLINE void *_ba_iterator_position (binary_array_iterator * it, size_t pos)
{
