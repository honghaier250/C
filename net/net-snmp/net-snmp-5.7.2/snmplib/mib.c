...
netsnmp_feature_child_of (snprint_value, mib_strings_all) netsnmp_feature_child_of (mib_to_asn_type, mib_api)
 ...
 */
     ...
     static struct tree *_get_realloc_symbol (const oid * objid, size_t objidlen,
                                              ...
                                              size_t * out_len,
                                              int allow_realloc,
                                              int *buf_overflow, struct index_list *in_dices, size_t * end_of_known);

     static int print_tree_node (u_char ** buf, size_t * buf_len,
                                 size_t * out_len, int allow_realloc, struct tree *tp, int width);
                        ...
                        int allow_realloc, const u_char * cp, size_t line_len)
{
    ...
    for (; lenleft >= 8; lenleft -= 8)
    {
        sprintf ((char *) (*buf + *out_len),
                 "%02X %02X %02X %02X %02X %02X %02X %02X ", cp[0], cp[1], cp[2], cp[3], cp[4], cp[5], cp[6], cp[7]);
...
sprint_realloc_asciistring (u_char ** buf, size_t * buf_len,
                            size_t * out_len, int allow_realloc, const u_char * cp, size_t len)
{
    int i;
                             ...
                             const struct enum_list *enums, const char *hint, const char *units)
{
    ...
    if ((var->type != ASN_OCTET_STR) && (!netsnmp_ds_get_boolean (NETSNMP_DS_LIBRARY_ID, NETSNMP_DS_LIB_QUICKE_PRINT)))
    {
            ...
            while (repeat && cp < ecp)
            {
                ...
                switch (code)
                {
                    ...
                    case 'a':
                        ...
                        if (!sprint_realloc_asciistring (buf, buf_len, out_len, allow_realloc, cp, cnt))
                            return 0;
                        cp += cnt;
                        break;
                    default:
                        *out_len = saved_out_len;
                            ...
                            && snmp_cstrcat (buf, buf_len, out_len, allow_realloc, ") "))
                        {
                            return sprint_realloc_octet_string (buf, buf_len,
                                                                out_len, allow_realloc, var, enums, NULL, NULL);
                        }
                        else
                        {
                            return 0;
                      ...
                      const struct enum_list *enums, const char *hint, const char *units)
{
    ...
    {
        if (snmp_cstrcat (buf, buf_len, out_len, allow_realloc, "Wrong Type (should be Float): "))
        {
            return sprint_realloc_by_type (buf, buf_len, out_len, allow_realloc, var, NULL, NULL, NULL);
        }
        else
                       ...
                       const struct enum_list *enums, const char *hint, const char *units)
{
    if ((var->type != ASN_OPAQUE_DOUBLE) &&
        (!netsnmp_ds_get_boolean (NETSNMP_DS_LIBRARY_ID, NETSNMP_DS_LIB_QUICKE_PRINT)))
    {
        if (snmp_cstrcat (buf, buf_len, out_len, allow_realloc, "Wrong Type (should be Double): "))
        {
            return sprint_realloc_by_type (buf, buf_len, out_len, allow_realloc, var, NULL, NULL, NULL);
        }
        else
...
#ifdef NETSNMP_WITH_OPAQUE_SPECIAL_TYPES
         && var->type != ASN_OPAQUE_COUNTER64 && var->type != ASN_OPAQUE_I64 && var->type != ASN_OPAQUE_U64
#endif
        ) && (!netsnmp_ds_get_boolean (NETSNMP_DS_LIBRARY_ID, NETSNMP_DS_LIB_QUICKE_PRINT)))
    {
        if (snmp_cstrcat (buf, buf_len, out_len, allow_realloc, "Wrong Type (should be Counter64): "))
        {
            return sprint_realloc_by_type (buf, buf_len, out_len, allow_realloc, var, NULL, NULL, NULL);
        }
        else
                       ...
                       const struct enum_list *enums, const char *hint, const char *units)
{
    if ((var->type != ASN_OPAQUE
         ...
         && var->type != ASN_OPAQUE_I64 && var->type != ASN_OPAQUE_FLOAT && var->type != ASN_OPAQUE_DOUBLE
#endif                            /* NETSNMP_WITH_OPAQUE_SPECIAL_TYPES */
        ) && (!netsnmp_ds_get_boolean (NETSNMP_DS_LIBRARY_ID, NETSNMP_DS_LIB_QUICKE_PRINT)))
    {
        if (snmp_cstrcat (buf, buf_len, out_len, allow_realloc, "Wrong Type (should be Opaque): "))
        {
            return sprint_realloc_by_type (buf, buf_len, out_len, allow_realloc, var, NULL, NULL, NULL);
        }
        else
    ...
    if (units)
    {
        return (snmp_strcat
                (buf, buf_len, out_len, allow_realloc,
                 (const u_char *) " ") && snmp_strcat (buf, buf_len, out_len, allow_realloc, (const u_char *) units));
    }
    return 1;
}
                                  ...
                                  const struct enum_list *enums, const char *hint, const char *units)
{
    ...
    if ((var->type != ASN_OBJECT_ID) && (!netsnmp_ds_get_boolean (NETSNMP_DS_LIBRARY_ID, NETSNMP_DS_LIB_QUICKE_PRINT)))
    {
    ...
    netsnmp_sprint_realloc_objid_tree (buf, buf_len, out_len, allow_realloc,
                                       &buf_overflow, (oid *) (var->val.objid), var->val_len / sizeof (oid));
                          ...
                          const struct enum_list *enums, const char *hint, const char *units)
{
    ...
    if ((var->type != ASN_TIMETICKS) && (!netsnmp_ds_get_boolean (NETSNMP_DS_LIBRARY_ID, NETSNMP_DS_LIB_QUICKE_PRINT)))
    {
...
sprint_realloc_hinted_integer (u_char ** buf, size_t * buf_len,
                               size_t * out_len, int allow_realloc,
                               long val, const char decimaltype, const char *hint, const char *units)
{
                        ...
                        const struct enum_list *enums, const char *hint, const char *units)
{
    ...
    if ((var->type != ASN_INTEGER) && (!netsnmp_ds_get_boolean (NETSNMP_DS_LIBRARY_ID, NETSNMP_DS_LIB_QUICKE_PRINT)))
    {
    ...
    if (enum_string == NULL || netsnmp_ds_get_boolean (NETSNMP_DS_LIBRARY_ID, NETSNMP_DS_LIB_PRINT_NUMERIC_ENUM))
    {
        if (hint)
        {
            if (!(sprint_realloc_hinted_integer (buf, buf_len, out_len,
                                                 allow_realloc, *var->val.integer, 'd', hint, units)))
            {
                return 0;
            }
        }
                         ...
                         const struct enum_list *enums, const char *hint, const char *units)
{
    ...
    if ((var->type != ASN_UINTEGER) && (!netsnmp_ds_get_boolean (NETSNMP_DS_LIBRARY_ID, NETSNMP_DS_LIB_QUICKE_PRINT)))
    {
    ...
    if (enum_string == NULL || netsnmp_ds_get_boolean (NETSNMP_DS_LIBRARY_ID, NETSNMP_DS_LIB_PRINT_NUMERIC_ENUM))
    {
        ...
        {
            if (!(sprint_realloc_hinted_integer (buf, buf_len, out_len,
                                                 allow_realloc, *var->val.integer, 'u', hint, units)))
            {
                return 0;
            }
        }
                      ...
                      const struct enum_list *enums, const char *hint, const char *units)
{
    ...
    if ((var->type != ASN_GAUGE) && (!netsnmp_ds_get_boolean (NETSNMP_DS_LIBRARY_ID, NETSNMP_DS_LIB_QUICKE_PRINT)))
    {
                        ...
                        const struct enum_list *enums, const char *hint, const char *units)
{
    ...
    if ((var->type != ASN_COUNTER) && (!netsnmp_ds_get_boolean (NETSNMP_DS_LIBRARY_ID, NETSNMP_DS_LIB_QUICKE_PRINT)))
    {
                               ...
                               const struct enum_list *enums, const char *hint, const char *units)
{
    ...
    if ((var->type != ASN_IPADDRESS) && (!netsnmp_ds_get_boolean (NETSNMP_DS_LIBRARY_ID, NETSNMP_DS_LIB_QUICKE_PRINT)))
    {
...
sprint_realloc_null (u_char ** buf, size_t * buf_len, size_t * out_len,
                     ...
                     const struct enum_list *enums, const char *hint, const char *units)
{
    if ((var->type != ASN_NULL) && (!netsnmp_ds_get_boolean (NETSNMP_DS_LIBRARY_ID, NETSNMP_DS_LIB_QUICKE_PRINT)))
    {
...
sprint_realloc_nsapaddress (u_char ** buf, size_t * buf_len,
                            ...
                            const struct enum_list *enums, const char *hint, const char *units)
{
    if ((var->type != ASN_NSAP) && (!netsnmp_ds_get_boolean (NETSNMP_DS_LIBRARY_ID, NETSNMP_DS_LIB_QUICKE_PRINT)))
    {
    ...
    if (env_var && ((*env_var == '+') || (*env_var == '-')))
    {
        ...
        else
        {
            if (*env_var == '+')
                ...
                sprintf (entry, "%s%c%s", env_var + 1, ENV_SEPARATOR_CHAR, NETSNMP_DEFAULT_MIBS);
        }
        SNMP_FREE (env_var);
        env_var = entry;
    }
        ...
        if ((*env_var == '+') || (*env_var == '-'))
        {
            ...
            else
            {
                if (*env_var++ == '+')
                    ...
                    sprintf (entry, "%s%c%s", env_var, ENV_SEPARATOR_CHAR, NETSNMP_DEFAULT_MIBFILES);
            }
            SNMP_FREE (env_var);
            env_var = entry;
#else
...
int _mibindex_add (const char *dirname, int i)
{
    ...
    if (i >= _mibindex_max)
    {
        ...
        memset (_mibindexes + old_mibindex, 0, (i - old_mibindex) * sizeof (_mibindexes[0]));
    }
...
#else
struct tree *netsnmp_sprint_realloc_objid_tree (u_char ** buf, size_t * buf_len,
                                                size_t * out_len, int allow_realloc,
                                                int *buf_overflow, const oid * objid, size_t objidlen)
{
    u_char *tbuf = NULL, *cp = NULL;
    ...
    subtree = _get_realloc_symbol (objid, objidlen, subtree,
                                   &tbuf, &tbuf_len, &tout_len, allow_realloc, &tbuf_overflow, NULL, &midpoint_offset);
...
sprint_realloc_objid (u_char ** buf, size_t * buf_len,
                      size_t * out_len, int allow_realloc, const oid * objid, size_t objidlen)
{
    int buf_overflow = 0;
...
sprint_realloc_variable (u_char ** buf, size_t * buf_len,
                         size_t * out_len, int allow_realloc,
                         const oid * objid, size_t objidlen, const netsnmp_variable_list * variable)
{
    int buf_overflow = 0;
...
int
snprint_variable (char *buf, size_t buf_len, const oid * objid, size_t objidlen, const netsnmp_variable_list * variable)
{
    size_t out_len = 0;
        ...
        if (subtree)
        {
            if (subtree->printomat)
            {
                return (*subtree->printomat) (buf, buf_len, out_len,
                                              allow_realloc, variable, subtree->enums, subtree->hint, units);
            }
            else
            {
...
int
snprint_value (char *buf, size_t buf_len, const oid * objid, size_t objidlen, const netsnmp_variable_list * variable)
{
    size_t out_len = 0;
        ...
        switch (var->type)
        {
            ...
            case ASN_IPADDRESS:
                ...
                DEBUGMSGTL (("parse_oid_indexes",
                             ...
                             var->val.string[0], var->val.string[1], var->val.string[2], var->val.string[3]));
                break;
...
dump_realloc_oid_to_inetaddress (const int addr_type, const oid * objid, size_t objidlen,
                                 u_char ** buf, size_t * buf_len, size_t * out_len, int allow_realloc, char quotechar)
{
    if (buf)
    {
        int i, len;
        ...
        switch (addr_type)
        {
            ...
            case IPV4Z:
                ...
                len = sprintf (p, "%" NETSNMP_PRIo "u.%" NETSNMP_PRIo "u."
                               "%" NETSNMP_PRIo "u.%" NETSNMP_PRIo "u", objid[0], objid[1], objid[2], objid[3]);
                p += len;
                if (addr_type == IPV4Z)
                {
        ...
        *p = quotechar;
        ...
        return snmp_strcat (buf, buf_len, out_len, allow_realloc, (const u_char *) intbuf);
    }
    return 1;
}
...
_oid_finish_printing (const oid * objid, size_t objidlen,
                      u_char ** buf, size_t * buf_len, size_t * out_len, int allow_realloc, int *buf_overflow)
{
    char intbuf[64];
        ...
        if (*objid == subtree->subid)
        {
            ...
            if (objidlen > 1)
            {
                ...
                return_tree = _get_realloc_symbol (objid + 1, objidlen - 1,
                                                   subtree->child_list,
                                                   buf, buf_len, out_len,
                                                   allow_realloc, buf_overflow, in_dices, end_of_known);
            }
        ...
        switch (tp->type)
        {
                    ...
                    else
                    {
                        if (!*buf_overflow)
                        {
                            ...
                            if (tp->next_peer &&
                                ...
                                strcmp (get_tc_descriptor (next_peer->tc_index), "InetAddressType") == 0)
                            {
                            ...
                            if (normal_handling && !dump_realloc_oid_to_string
                                (objid + 1, numids - 1, buf, buf_len, out_len, allow_realloc, '"'))
                            {
                                *buf_overflow = 1;
                            }
                        }
            ...
            case TYPE_INTEGER:
                if (tp->enums)
                {
                    ...
                    {
                        if (!*buf_overflow
                            && !snmp_strcat (buf, buf_len, out_len, allow_realloc, (const u_char *) ep->label))
                        {
                            *buf_overflow = 1;
                        }
                    }
                    else
                    {
                        sprintf (intbuf, "%" NETSNMP_PRIo "u", *objid);
                        if (!*buf_overflow
                            && !snmp_strcat (buf, buf_len, out_len, allow_realloc, (const u_char *) intbuf))
                        {
                            *buf_overflow = 1;
                        }
                    }
            ...
            case TYPE_OBJID:
                ...
                if (extended_index)
                {
                    ...
                    else
                    {
                        if (!*buf_overflow
                            && !netsnmp_sprint_realloc_objid_tree (buf, buf_len,
                                                                   out_len,
                                                                   allow_realloc, buf_overflow, objid + 1, numids - 1))
                        {
                            *buf_overflow = 1;
                        }
                    }
                ...
                else
                {
                    _get_realloc_symbol (objid, numids, NULL, buf, buf_len,
                                         out_len, allow_realloc, buf_overflow, NULL, NULL);
                }
                objid += (numids);
                objidlen -= (numids);
                break;
 ...
 */
void print_description (oid * objid, size_t objidlen,    /* number of subidentifiers */
                        int width)
{
...
sprint_realloc_description (u_char ** buf, size_t * buf_len,
                            size_t * out_len, int allow_realloc, oid * objid, size_t objidlen, int width)
{
...
static int
print_tree_node (u_char ** buf, size_t * buf_len, size_t * out_len, int allow_realloc, struct tree *tp, int width)
{
    const char *cp;
    ...
    if (tp)
    {
        ...
        if (cp)
            if (!snmp_cstrcat (buf, buf_len, out_len, allow_realloc,
                               "  SYNTAX\t") || !snmp_cstrcat (buf, buf_len, out_len, allow_realloc, cp))
                return 0;
        if (tp->ranges)
        {
                ...
                switch (tp->type)
                {
                    ...
                    case TYPE_INTEGER32:
                        if (rp->low == rp->high)
                            ...
                            sprintf (str, "%s%d..%d", (first ? "" : " | "), rp->low, rp->high);
                        break;
                    case TYPE_UNSIGNED32:
                    case TYPE_OCTETSTR:
                    case TYPE_GAUGE:
                    case TYPE_UINTEGER:
                        if (rp->low == rp->high)
                            ...
                            sprintf (str, "%s%u..%u", (first ? "" : " | "), (unsigned) rp->low, (unsigned) rp->high);
                        break;
                    default:
...
static int
#ifndef NETSNMP_DISABLE_MIB_LOADING
_add_strings_to_oid (struct tree *tp, char *cp, oid * objid, size_t * objidlen, size_t maxlen)
#else
            ...
            case TYPE_TIMETICKS:
                ...
                if (check && tp->ranges)
                {
                    ...
                    if (tp->type == TYPE_INTEGER || tp->type == TYPE_INTEGER32)
                    {
                        while (!ok && rp)
                        {
                            if ((rp->low <= (int) subid) && ((int) subid <= rp->high))
                                ok = 1;
                            else
                                rp = rp->next;
                        }
                    ...
                    {            /* check unsigned range */
                        while (!ok && rp)
                        {
                            if (((unsigned int) rp->low <= subid) && (subid <= (unsigned int) rp->high))
                                ok = 1;
                            else
                                rp = rp->next;
                        }
...
#ifndef NETSNMP_DISABLE_MIB_LOADING
    if (netsnmp_ds_get_boolean (NETSNMP_DS_LIBRARY_ID, NETSNMP_DS_LIB_RANDOM_ACCESS) || strchr (argv, ':'))
    {
...
snprint_by_type (char *buf, size_t buf_len,
                 netsnmp_variable_list * var, const struct enum_list *enums, const char *hint, const char *units)
{
    size_t out_len = 0;
...
snprint_opaque (char *buf, size_t buf_len,
                const netsnmp_variable_list * var, const struct enum_list *enums, const char *hint, const char *units)
{
    size_t out_len = 0;
