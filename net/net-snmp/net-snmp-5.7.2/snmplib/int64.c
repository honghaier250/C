 ...
 */
void divBy10 (U64 u64, U64 * pu64Q, unsigned int *puR)
{
    unsigned long ulT;
 ...
 */
void multBy10 (U64 u64, U64 * pu64P)
{
    unsigned long ulT;
 ...
 *
 */
void incrByU16 (U64 * pu64, unsigned int u16)
{
    incrByU32 (pu64, u16);
}
 ...
 *
 */
void incrByU32 (U64 * pu64, unsigned int u32)
{
    uint32_t tmp;
 ...
 */
void u64Subtract (const U64 * pu64one, const U64 * pu64two, U64 * pu64out)
{
    int carry;
 ...
 */
void u64UpdateCounter (U64 * pu64out, const U64 * pu64one, const U64 * pu64two)
{
    U64 tmp;
 ...
 */
int netsnmp_c64_check_for_32bit_wrap (struct counter64 *old_val, struct counter64 *new_val, int adjust)
{
                                ...
                                struct counter64 *old_prev_val, int *need_wrap_check)
{
    ...
    else if (64 == rc)
    {
         ...
         */
        if ((prev_val->low != new_val->low) || (prev_val->high != new_val->high))
        {
...
int read64 (U64 * i64, const char *str)
{
    U64 i64p;
