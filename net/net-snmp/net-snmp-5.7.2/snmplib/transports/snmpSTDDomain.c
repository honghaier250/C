...
static char *netsnmp_std_fmtaddr (netsnmp_transport * t, void *data, int len)
{
    char *buf;
...
static int netsnmp_std_recv (netsnmp_transport * t, void *buf, int size, void **opaque, int *olength)
{
    int rc = -1;
...
static int netsnmp_std_send (netsnmp_transport * t, void *buf, int size, void **opaque, int *olength)
{
    int rc = -1;
...
static int netsnmp_std_close (netsnmp_transport * t)
{
...
static int netsnmp_std_accept (netsnmp_transport * t)
{
...
netsnmp_transport *netsnmp_std_transport (const char *instring, size_t instring_len, const char *default_target)
{
    netsnmp_transport *t;
    ...
    t->domain_length = sizeof (netsnmp_snmpSTDDomain) / sizeof (netsnmp_snmpSTDDomain[0]);
    ...
    if (instring_len != 0)
    {
        ...
        {
            snmp_log (LOG_ERR, "Failed to create needed pipes for a STD transport");
...
netsnmp_transport *netsnmp_std_create_tstring (const char *instring, int local, const char *default_target)
{
    return netsnmp_std_transport (instring, strlen (instring), default_target);
}

netsnmp_transport *netsnmp_std_create_ostring (const u_char * o, size_t o_len, int local)
{
