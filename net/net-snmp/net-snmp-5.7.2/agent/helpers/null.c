...
int netsnmp_register_null_context (oid * loc, size_t loc_len, const char *contextName)
{
                      ...
                      netsnmp_agent_request_info * reqinfo, netsnmp_request_info * requests)
{
    ...
    DEBUGMSGOID (("helper:null", requests->requestvb->name, requests->requestvb->name_length));
