...
netsnmp_feature_provide (mode_end_call) netsnmp_feature_child_of (mode_end_call, mib_helpers)
...
{
    netsnmp_mib_handler *me = netsnmp_create_handler ("mode_end_call",
 ...
 */
netsnmp_mode_handler_list *netsnmp_mode_end_call_add_mode_callback (netsnmp_mode_handler_list * endlist,
                                                                    int mode, netsnmp_mib_handler * callbackh)
{
                              ...
                              netsnmp_agent_request_info * reqinfo, netsnmp_request_info * requests)
{
    ...
    {
        if (ptr->mode == NETSNMP_MODE_END_ALL_MODES || reqinfo->mode == ptr->mode)
        {
            ret2 = netsnmp_call_handler (ptr->callback_handler, reginfo, reqinfo, requests);
