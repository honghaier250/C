...
unsigned char *var_tunnelIfEntry (struct variable *, oid *, size_t *, int, size_t *, WriteMethod ** write_method);

unsigned char *var_tunnelConfigEntry (struct variable *, oid *, size_t *, int, size_t *, WriteMethod ** write_method);
