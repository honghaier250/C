 ...
 */
int dot3StatsTable_indexes_set_tbl_idx (dot3StatsTable_mib_index * tbl_idx, long dot3StatsIndex_val)
{
 ...
 *  from the mib index.
 */
int dot3StatsTable_indexes_set (dot3StatsTable_rowreq_ctx * rowreq_ctx, long dot3StatsIndex_val)
{
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsTable_indexes_set", "called\n"));

    if (MFD_SUCCESS != dot3StatsTable_indexes_set_tbl_idx (&rowreq_ctx->tbl_idx, dot3StatsIndex_val))
        return MFD_ERROR;
    ...
    if (0 != dot3StatsTable_index_to_oid (&rowreq_ctx->oid_idx, &rowreq_ctx->tbl_idx))
    {
        return MFD_ERROR;
    }
 ...
 */
int dot3StatsAlignmentErrors_get (dot3StatsTable_rowreq_ctx * rowreq_ctx, u_long * dot3StatsAlignmentErrors_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsAlignmentErrors_get", "called\n"));
     ...
     */
    (*dot3StatsAlignmentErrors_val_ptr) = rowreq_ctx->data.dot3StatsAlignmentErrors;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int dot3StatsFCSErrors_get (dot3StatsTable_rowreq_ctx * rowreq_ctx, u_long * dot3StatsFCSErrors_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsFCSErrors_get", "called\n"));
...
dot3StatsSingleCollisionFrames_get (dot3StatsTable_rowreq_ctx * rowreq_ctx,
                                    u_long * dot3StatsSingleCollisionFrames_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
     ...
     */
    (*dot3StatsSingleCollisionFrames_val_ptr) = rowreq_ctx->data.dot3StatsSingleCollisionFrames;
...
dot3StatsMultipleCollisionFrames_get (dot3StatsTable_rowreq_ctx *
                                      rowreq_ctx, u_long * dot3StatsMultipleCollisionFrames_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
     ...
     */
    (*dot3StatsMultipleCollisionFrames_val_ptr) = rowreq_ctx->data.dot3StatsMultipleCollisionFrames;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int dot3StatsSQETestErrors_get (dot3StatsTable_rowreq_ctx * rowreq_ctx, u_long * dot3StatsSQETestErrors_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsSQETestErrors_get", "called\n"));
     ...
     */
    (*dot3StatsSQETestErrors_val_ptr) = rowreq_ctx->data.dot3StatsSQETestErrors;
...
dot3StatsDeferredTransmissions_get (dot3StatsTable_rowreq_ctx * rowreq_ctx,
                                    u_long * dot3StatsDeferredTransmissions_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
     ...
     */
    (*dot3StatsDeferredTransmissions_val_ptr) = rowreq_ctx->data.dot3StatsDeferredTransmissions;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int dot3StatsLateCollisions_get (dot3StatsTable_rowreq_ctx * rowreq_ctx, u_long * dot3StatsLateCollisions_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsLateCollisions_get", "called\n"));
     ...
     */
    (*dot3StatsLateCollisions_val_ptr) = rowreq_ctx->data.dot3StatsLateCollisions;
 ...
 */
int
dot3StatsExcessiveCollisions_get (dot3StatsTable_rowreq_ctx * rowreq_ctx, u_long * dot3StatsExcessiveCollisions_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsExcessiveCollisions_get", "called\n"));
     ...
     */
    (*dot3StatsExcessiveCollisions_val_ptr) = rowreq_ctx->data.dot3StatsExcessiveCollisions;
                                        ...
                                        rowreq_ctx, u_long * dot3StatsInternalMacTransmitErrors_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
     ...
     */
    (*dot3StatsInternalMacTransmitErrors_val_ptr) = rowreq_ctx->data.dot3StatsInternalMacTransmitErrors;
 ...
 */
int
dot3StatsCarrierSenseErrors_get (dot3StatsTable_rowreq_ctx * rowreq_ctx, u_long * dot3StatsCarrierSenseErrors_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsCarrierSenseErrors_get", "called\n"));
     ...
     */
    (*dot3StatsCarrierSenseErrors_val_ptr) = rowreq_ctx->data.dot3StatsCarrierSenseErrors;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int dot3StatsFrameTooLongs_get (dot3StatsTable_rowreq_ctx * rowreq_ctx, u_long * dot3StatsFrameTooLongs_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsFrameTooLongs_get", "called\n"));
     ...
     */
    (*dot3StatsFrameTooLongs_val_ptr) = rowreq_ctx->data.dot3StatsFrameTooLongs;
...
dot3StatsInternalMacReceiveErrors_get (dot3StatsTable_rowreq_ctx *
                                       rowreq_ctx, u_long * dot3StatsInternalMacReceiveErrors_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
     ...
     */
    (*dot3StatsInternalMacReceiveErrors_val_ptr) = rowreq_ctx->data.dot3StatsInternalMacReceiveErrors;
...
dot3StatsEtherChipSet_get (dot3StatsTable_rowreq_ctx * rowreq_ctx,
                           oid ** dot3StatsEtherChipSet_val_ptr_ptr, size_t * dot3StatsEtherChipSet_val_ptr_len_ptr)
{

   /** we should have a non-NULL pointer and enough storage */
    netsnmp_assert ((NULL != dot3StatsEtherChipSet_val_ptr_ptr) && (NULL != *dot3StatsEtherChipSet_val_ptr_ptr));
    netsnmp_assert (NULL != dot3StatsEtherChipSet_val_ptr_len_ptr);


    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsEtherChipSet_get", "called\n"));
    ...
    if ((NULL == (*dot3StatsEtherChipSet_val_ptr_ptr)) ||
        ((*dot3StatsEtherChipSet_val_ptr_len_ptr) <
         (rowreq_ctx->data.dot3StatsEtherChipSet_len * sizeof (rowreq_ctx->data.dot3StatsEtherChipSet[0]))))
    {
        /*
         * allocate space for dot3StatsEtherChipSet data
         */
        (*dot3StatsEtherChipSet_val_ptr_ptr) =
            malloc (rowreq_ctx->data.dot3StatsEtherChipSet_len * sizeof (rowreq_ctx->data.dot3StatsEtherChipSet[0]));
        if (NULL == (*dot3StatsEtherChipSet_val_ptr_ptr))
        {
 ...
 * @retval MFD_ERROR           : Any other error
 */
int dot3StatsSymbolErrors_get (dot3StatsTable_rowreq_ctx * rowreq_ctx, u_long * dot3StatsSymbolErrors_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsSymbolErrors_get", "called\n"));
     ...
     */
    (*dot3StatsSymbolErrors_val_ptr) = rowreq_ctx->data.dot3StatsSymbolErrors;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int dot3StatsDuplexStatus_get (dot3StatsTable_rowreq_ctx * rowreq_ctx, u_long * dot3StatsDuplexStatus_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsDuplexStatus_get", "called\n"));
     ...
     */
    (*dot3StatsDuplexStatus_val_ptr) = rowreq_ctx->data.dot3StatsDuplexStatus;
 ...
 */
int
dot3StatsRateControlAbility_get (dot3StatsTable_rowreq_ctx * rowreq_ctx, u_long * dot3StatsRateControlAbility_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
     ...
     */
    (*dot3StatsRateControlAbility_val_ptr) = rowreq_ctx->data.dot3StatsRateControlAbility;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int dot3StatsRateControlStatus_get (dot3StatsTable_rowreq_ctx * rowreq_ctx, u_long * dot3StatsRateControlStatus_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsRateControlStatus_get", "called\n"));
     ...
     */
    (*dot3StatsRateControlStatus_val_ptr) = rowreq_ctx->data.dot3StatsRateControlStatus;
