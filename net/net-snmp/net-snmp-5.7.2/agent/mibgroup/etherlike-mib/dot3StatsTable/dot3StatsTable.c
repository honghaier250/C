...
void initialize_table_dot3StatsTable (void)
{
    ...
    DEBUGMSGTL (("verbose:dot3StatsTable:initialize_table_dot3StatsTable", "called\n"));
     ...
     */
    dot3StatsTable_user_context_p = netsnmp_create_data_list ("dot3StatsTable", NULL, NULL);
...
{
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsTable_rowreq_ctx_init", "called\n"));
...
{
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsTable_rowreq_ctx_cleanup", "called\n"));
...
{
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsTable_pre_request", "called\n"));
...
{
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsTable_post_request", "called\n"));
