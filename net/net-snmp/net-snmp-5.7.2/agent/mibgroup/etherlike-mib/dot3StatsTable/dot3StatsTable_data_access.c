 ...
 */
int dot3StatsTable_init_data (dot3StatsTable_registration * dot3StatsTable_reg)
{
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsTable_init_data", "called\n"));
 ...
 */
void dot3StatsTable_container_init (netsnmp_container ** container_ptr_ptr, netsnmp_cache * cache)
{
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsTable_container_init", "called\n"));

    if (NULL == container_ptr_ptr)
    {
        snmp_log (LOG_ERR, "bad container param to dot3StatsTable_container_init\n");
        return;
    }
    ...
    *container_ptr_ptr = NULL;
    ...
    if (NULL == cache)
    {
        snmp_log (LOG_ERR, "bad cache param to dot3StatsTable_container_init\n");
        return;
    }
 ...
 */
void dot3StatsTable_container_shutdown (netsnmp_container * container_ptr)
{
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsTable_container_shutdown", "called\n"));

    if (NULL == container_ptr)
    {
        snmp_log (LOG_ERR, "bad params to dot3StatsTable_container_shutdown\n");
        return;
    }
...
int dot3StatsTable_container_load (netsnmp_container * container)
{
    ...
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsTable_container_load", "called\n"));
    ...
    for (p = list_head; p; p = p->ifn_next)
    {
        ...
        if (MFD_SUCCESS != dot3StatsTable_indexes_set (rowreq_ctx, dot3StatsIndex))
        {
            snmp_log (LOG_ERR, "error setting index while loading " "dot3StatsTable data.\n");
 ...
 * @retval MFD_ERROR       : other error.
 */
int dot3StatsTable_row_prep (dot3StatsTable_rowreq_ctx * rowreq_ctx)
{
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsTable_row_prep", "called\n"));
