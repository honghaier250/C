 ...
 */
     ...
     static void _dot3StatsTable_container_init (dot3StatsTable_interface_ctx * if_ctx);

     static void _dot3StatsTable_container_shutdown (dot3StatsTable_interface_ctx * if_ctx);
...
dot3StatsTable_registration *dot3StatsTable_registration_set (dot3StatsTable_registration * newreg)
{
 ...
 */
void _dot3StatsTable_initialize_interface (dot3StatsTable_registration * reg_ptr, u_long flags)
{
    netsnmp_baby_steps_access_methods *access_multiplexer = &dot3StatsTable_if_ctx.access_multiplexer;

    netsnmp_table_registration_info *tbl_info = &dot3StatsTable_if_ctx.tbl_info;
    ...
    {
        snmp_log (LOG_ERR, "could not initialize container for dot3StatsTable\n");
        return;
    }
     ...
     */
    DEBUGMSGTL (("dot3StatsTable:init_dot3StatsTable", "Registering dot3StatsTable as a mibs-for-dummies table.\n"));
    handler = netsnmp_baby_steps_access_multiplexer_get (access_multiplexer);
    reginfo =
        netsnmp_handler_registration_create ("dot3StatsTable", handler,
                                             dot3StatsTable_oid,
                                             dot3StatsTable_oid_size, HANDLER_CAN_BABY_STEP | HANDLER_CAN_RONLY);
    if (NULL == reginfo)
    {
    ...
    handler =
        netsnmp_container_table_handler_get (tbl_info,
                                             dot3StatsTable_if_ctx.container, TABLE_CONTAINER_KEY_NETSNMP_INDEX);
    netsnmp_inject_handler (reginfo, handler);
 ...
 */
void _dot3StatsTable_shutdown_interface (dot3StatsTable_registration * reg_ptr)
{
    /*
...
void dot3StatsTable_valid_columns_set (netsnmp_column_info * vc)
{
 ...
 */
int dot3StatsTable_index_to_oid (netsnmp_index * oid_idx, dot3StatsTable_mib_index * mib_idx)
{
    ...
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsTable_index_to_oid", "called\n"));

    /*
     * dot3StatsIndex(1)/InterfaceIndex/ASN_INTEGER/long(long)//l/A/w/e/R/d/H 
     */
    snmp_set_var_value (&var_dot3StatsIndex, (u_char *) & mib_idx->dot3StatsIndex, sizeof (mib_idx->dot3StatsIndex));


    err = build_oid_noalloc (oid_idx->oids, oid_idx->len, &oid_idx->len, NULL, 0, &var_dot3StatsIndex);
    if (err)
 ...
 */
int dot3StatsTable_index_from_oid (netsnmp_index * oid_idx, dot3StatsTable_mib_index * mib_idx)
{
    int err = SNMP_ERR_NOERROR;
    ...
    DEBUGMSGTL (("verbose:dot3StatsTable:dot3StatsTable_index_from_oid", "called\n"));

    /*
     * parse the oid into the individual index components
     */
    err = parse_oid_indexes (oid_idx->oids, oid_idx->len, &var_dot3StatsIndex);
    if (err == SNMP_ERR_NOERROR)
    {
        /*
         * copy out values
         */
        mib_idx->dot3StatsIndex = *((long *) var_dot3StatsIndex.val.string);
 ...
 */
dot3StatsTable_rowreq_ctx *dot3StatsTable_allocate_rowreq_ctx (void *user_init_ctx)
{
    dot3StatsTable_rowreq_ctx *rowreq_ctx = SNMP_MALLOC_TYPEDEF (dot3StatsTable_rowreq_ctx);

    DEBUGMSGTL (("internal:dot3StatsTable:dot3StatsTable_allocate_rowreq_ctx", "called\n"));

    if (NULL == rowreq_ctx)
    {
        snmp_log (LOG_ERR, "Couldn't allocate memory for a " "dot3StatsTable_rowreq_ctx.\n");
        return NULL;
    }
    ...
    {
        if (SNMPERR_SUCCESS != dot3StatsTable_rowreq_ctx_init (rowreq_ctx, user_init_ctx))
        {
 ...
 */
void dot3StatsTable_release_rowreq_ctx (dot3StatsTable_rowreq_ctx * rowreq_ctx)
{
                                 ...
                                 netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    DEBUGMSGTL (("internal:dot3StatsTable:_mfd_dot3StatsTable_pre_request", "called\n"));

    if (1 != netsnmp_row_merge_status_first (reginfo, agtreq_info))
    {
        DEBUGMSGTL (("internal:dot3StatsTable", "skipping additional pre_request\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         */
        DEBUGMSGTL (("dot3StatsTable", "error %d from " "dot3StatsTable_pre_request\n", rc));
...
_mfd_dot3StatsTable_post_request (netsnmp_mib_handler * handler,
                                  ...
                                  netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    dot3StatsTable_rowreq_ctx *rowreq_ctx = netsnmp_container_table_row_extract (requests);

    int rc, packet_rc;

    DEBUGMSGTL (("internal:dot3StatsTable:_mfd_dot3StatsTable_post_request", "called\n"));
    ...
    {
        DEBUGMSGTL (("internal:dot3StatsTable", "waiting for last post_request\n"));
        return SNMP_ERR_NOERROR;
    }

    packet_rc = netsnmp_check_all_requests_error (agtreq_info->asp, 0);
    rc = dot3StatsTable_post_request (dot3StatsTable_if_ctx.user_ctx, packet_rc);
    if (MFD_SUCCESS != rc)
    {
        /*
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("dot3StatsTable", "error %d from " "dot3StatsTable_post_request\n", rc));
    }
...
_dot3StatsTable_get_column (dot3StatsTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL (("internal:dot3StatsTable:_mfd_dot3StatsTable_get_column", "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_DOT3STATSALIGNMENTERRORS:
            if (!(COLUMN_DOT3STATSALIGNMENTERRORS_FLAG & rowreq_ctx->column_exists_flags))
            {
                DEBUGMSGTL (("internal:dot3StatsTable:_mfd_dot3StatsTable_get_column",
                             "column %d (dot3StatsAlignmentErrors) doesn't exist\n", column));
                return MFD_SKIP;
            }

            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = dot3StatsAlignmentErrors_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_DOT3STATSFCSERRORS:
            if (!(COLUMN_DOT3STATSFCSERRORS_FLAG & rowreq_ctx->column_exists_flags))
            {
                DEBUGMSGTL (("internal:dot3StatsTable:_mfd_dot3StatsTable_get_column",
                             "column %d (dot3StatsFCSErrors) doesn't exist\n", column));
                return MFD_SKIP;
            }

            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = dot3StatsFCSErrors_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_DOT3STATSSINGLECOLLISIONFRAMES:
            if (!(COLUMN_DOT3STATSSINGLECOLLISIONFRAMES_FLAG & rowreq_ctx->column_exists_flags))
            {
                DEBUGMSGTL (("internal:dot3StatsTable:_mfd_dot3StatsTable_get_column",
                             "column %d (dot3StatsSingleCollisionFrames) doesn't exist\n", column));
                return MFD_SKIP;
            }

            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = dot3StatsSingleCollisionFrames_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_DOT3STATSMULTIPLECOLLISIONFRAMES:
            if (!(COLUMN_DOT3STATSMULTIPLECOLLISIONFRAMES_FLAG & rowreq_ctx->column_exists_flags))
            {
                DEBUGMSGTL (("internal:dot3StatsTable:_mfd_dot3StatsTable_get_column",
                             "column %d (dot3StatsMultipleCollisionFrames) doesn't exist\n", column));
                return MFD_SKIP;
            }

            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = dot3StatsMultipleCollisionFrames_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_DOT3STATSSQETESTERRORS:
            if (!(COLUMN_DOT3STATSSQETESTERRORS_FLAG & rowreq_ctx->column_exists_flags))
            {
                DEBUGMSGTL (("internal:dot3StatsTable:_mfd_dot3StatsTable_get_column",
                             "column %d (dot3StatsSQETestErrors) doesn't exist\n", column));
                return MFD_SKIP;
            }

            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = dot3StatsSQETestErrors_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_DOT3STATSDEFERREDTRANSMISSIONS:
            if (!(COLUMN_DOT3STATSDEFERREDTRANSMISSIONS_FLAG & rowreq_ctx->column_exists_flags))
            {
                DEBUGMSGTL (("internal:dot3StatsTable:_mfd_dot3StatsTable_get_column",
                             "column %d (dot3StatsDeferredTransmissions) doesn't exist\n", column));
                return MFD_SKIP;
            }

            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = dot3StatsDeferredTransmissions_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_DOT3STATSLATECOLLISIONS:
            if (!(COLUMN_DOT3STATSLATECOLLISIONS_FLAG & rowreq_ctx->column_exists_flags))
            {
                DEBUGMSGTL (("internal:dot3StatsTable:_mfd_dot3StatsTable_get_column",
                             "column %d (dot3StatsLateCollisions) doesn't exist\n", column));
                return MFD_SKIP;
            }

            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = dot3StatsLateCollisions_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_DOT3STATSEXCESSIVECOLLISIONS:
            ...
            {
                DEBUGMSGTL (("internal:dot3StatsTable:_mfd_dot3StatsTable_get_column",
                             "column %d (dot3StatsExcessiveCollisions) doesn't exist\n", column));
                return MFD_SKIP;
            }

            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = dot3StatsExcessiveCollisions_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_DOT3STATSINTERNALMACTRANSMITERRORS:
            if (!(COLUMN_DOT3STATSINTERNALMACTRANSMITERRORS_FLAG & rowreq_ctx->column_exists_flags))
            {
                DEBUGMSGTL (("internal:dot3StatsTable:_mfd_dot3StatsTable_get_column",
                             "column %d (dot3StatsInternalMacTransmitErrors) doesn't exist\n", column));
                return MFD_SKIP;
            }

            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = dot3StatsInternalMacTransmitErrors_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_DOT3STATSCARRIERSENSEERRORS:
            if (!(COLUMN_DOT3STATSCARRIERSENSEERRORS_FLAG & rowreq_ctx->column_exists_flags))
            {
                DEBUGMSGTL (("internal:dot3StatsTable:_mfd_dot3StatsTable_get_column",
                             "column %d (dot3StatsCarrierSenseErrors) doesn't exist\n", column));
                return MFD_SKIP;
            }
        ...
        case COLUMN_DOT3STATSFRAMETOOLONGS:
            if (!(COLUMN_DOT3STATSFRAMETOOLONGS_FLAG & rowreq_ctx->column_exists_flags))
            {
                DEBUGMSGTL (("internal:dot3StatsTable:_mfd_dot3StatsTable_get_column",
                             "column %d (dot3StatsFrameTooLongs) doesn't exist\n", column));
                return MFD_SKIP;
            }
        ...
        case COLUMN_DOT3STATSINTERNALMACRECEIVEERRORS:
            if (!(COLUMN_DOT3STATSINTERNALMACRECEIVEERRORS_FLAG & rowreq_ctx->column_exists_flags))
            {
                DEBUGMSGTL (("internal:dot3StatsTable:_mfd_dot3StatsTable_get_column",
                             "column %d (dot3StatsInternalMacReceiveErrors) doesn't exist\n", column));
                return MFD_SKIP;
            }

            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = dot3StatsInternalMacReceiveErrors_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_DOT3STATSETHERCHIPSET:
            if (!(COLUMN_DOT3STATSETHERCHIPSET_FLAG & rowreq_ctx->column_exists_flags))
            {
                DEBUGMSGTL (("internal:dot3StatsTable:_mfd_dot3StatsTable_get_column",
                             "column %d (dot3StatsEtherChipSet) doesn't exist\n", column));
                return MFD_SKIP;
            }

            var->type = ASN_OBJECT_ID;
            rc = dot3StatsEtherChipSet_get (rowreq_ctx, (oid **) & var->val.string, &var->val_len);
            break;
        ...
        case COLUMN_DOT3STATSSYMBOLERRORS:
            if (!(COLUMN_DOT3STATSSYMBOLERRORS_FLAG & rowreq_ctx->column_exists_flags))
            {
                DEBUGMSGTL (("internal:dot3StatsTable:_mfd_dot3StatsTable_get_column",
                             "column %d (dot3StatsSymbolErrors) doesn't exist\n", column));
                return MFD_SKIP;
            }

            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = dot3StatsSymbolErrors_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_DOT3STATSDUPLEXSTATUS:
            if (!(COLUMN_DOT3STATSDUPLEXSTATUS_FLAG & rowreq_ctx->column_exists_flags))
            {
                DEBUGMSGTL (("internal:dot3StatsTable:_mfd_dot3StatsTable_get_column",
                             "column %d (dot3StatsDuplexStatus) doesn't exist\n", column));
                return MFD_SKIP;
            }

            var->val_len = sizeof (u_long);
            var->type = ASN_INTEGER;
            rc = dot3StatsDuplexStatus_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_DOT3STATSRATECONTROLABILITY:
            if (!(COLUMN_DOT3STATSRATECONTROLABILITY_FLAG & rowreq_ctx->column_exists_flags))
            {
                DEBUGMSGTL (("internal:dot3StatsTable:_mfd_dot3StatsTable_get_column",
                             "column %d (dot3StatsRateControlAbility) doesn't exist\n", column));
                return MFD_SKIP;
            }

            var->val_len = sizeof (u_long);
            var->type = ASN_INTEGER;
            rc = dot3StatsRateControlAbility_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_DOT3STATSRATECONTROLSTATUS:
            if (!(COLUMN_DOT3STATSRATECONTROLSTATUS_FLAG & rowreq_ctx->column_exists_flags))
            {
                DEBUGMSGTL (("internal:dot3StatsTable:_mfd_dot3StatsTable_get_column",
                             "column %d (dot3StatsRateControlStatus) doesn't exist\n", column));
                return MFD_SKIP;
            }

            var->val_len = sizeof (u_long);
            var->type = ASN_INTEGER;
            rc = dot3StatsRateControlStatus_get (rowreq_ctx, (u_long *) var->val.string);
            break;

        default:
            if (DOT3STATSTABLE_MIN_COL <= column && column <= DOT3STATSTABLE_MAX_COL)
            {
            ...
            {
                snmp_log (LOG_ERR, "unknown column %d in _dot3StatsTable_get_column\n", column);
            }
            break;
    }
                                ...
                                netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    DEBUGMSGTL (("internal:dot3StatsTable:_mfd_dot3StatsTable_get_values", "called\n"));

    netsnmp_assert (NULL != rowreq_ctx);

    DEBUGMSGTL (("9:dot3StatsTable:_mfd_dot3StatsTable_get_values", "exists %u\n", rowreq_ctx->column_exists_flags));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _dot3StatsTable_get_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            if (MFD_SKIP == rc)
            {
...
static int _cache_load (netsnmp_cache * cache, void *vmagic)
{
     ...
     * call user code
     */
    return dot3StatsTable_container_load ((netsnmp_container *) cache->magic);
}                                /* _cache_load */
 ...
 * @internal
 */
static void _container_item_free (dot3StatsTable_rowreq_ctx * rowreq_ctx, void *context)
{
    DEBUGMSGTL (("internal:dot3StatsTable:_container_item_free", "called\n"));
...
static void _container_free (netsnmp_container * container)
{
    ...
    if (NULL == container)
    {
        snmp_log (LOG_ERR, "invalid container in dot3StatsTable_container_free\n");
        return;
    }
 ...
 */
void _dot3StatsTable_container_init (dot3StatsTable_interface_ctx * if_ctx)
{
    DEBUGMSGTL (("internal:dot3StatsTable:_dot3StatsTable_container_init", "called\n"));

    /*
     * cache init
     */
    if_ctx->cache = netsnmp_cache_create (30,    /* timeout in seconds */
                                          _cache_load, _cache_free, dot3StatsTable_oid, dot3StatsTable_oid_size);
    ...
    if (NULL == if_ctx->container)
        if_ctx->container = netsnmp_container_find ("dot3StatsTable:table_container");
    if (NULL == if_ctx->container)
    {
        snmp_log (LOG_ERR, "error creating container in " "dot3StatsTable_container_init\n");
        return;
    }
 ...
 */
void _dot3StatsTable_container_shutdown (dot3StatsTable_interface_ctx * if_ctx)
{
