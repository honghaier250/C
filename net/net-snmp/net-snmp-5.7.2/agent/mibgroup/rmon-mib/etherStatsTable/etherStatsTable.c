...
{
    DEBUGMSGTL (("verbose:etherStatsTable:init_etherStatsTable", "called\n"));
...
void initialize_table_etherStatsTable (void)
{
    ...
    DEBUGMSGTL (("verbose:etherStatsTable:initialize_table_etherStatsTable", "called\n"));
     ...
     */
    etherStatsTable_user_context_p = netsnmp_create_data_list ("etherStatsTable", NULL, NULL);
     ...
     */
    _etherStatsTable_initialize_interface (etherStatsTable_user_context_p, flags);
}                                /* initialize_table_etherStatsTable */
 ...
 */
int etherStatsTable_rowreq_ctx_init (etherStatsTable_rowreq_ctx * rowreq_ctx, void *user_init_ctx)
{
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsTable_rowreq_ctx_init", "called\n"));
 ...
 *
 */
void etherStatsTable_rowreq_ctx_cleanup (etherStatsTable_rowreq_ctx * rowreq_ctx)
{
 ...
 */
int etherStatsTable_pre_request (etherStatsTable_registration * user_context)
{
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsTable_pre_request", "called\n"));
 ...
 */
int etherStatsTable_post_request (etherStatsTable_registration * user_context, int rc)
{
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsTable_post_request", "called\n"));
