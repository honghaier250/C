...
int etherStatsTable_undo_setup (etherStatsTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsTable_undo_setup", "called\n"));
...
int etherStatsTable_undo (etherStatsTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsTable_undo", "called\n"));
...
int etherStatsTable_undo_cleanup (etherStatsTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsTable_undo_cleanup", "called\n"));
...
int etherStatsTable_commit (etherStatsTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsTable_commit", "called\n"));
    ...
    if (save_flags & COLUMN_ETHERSTATSDATASOURCE_FLAG)
    {
        ...
        if (-1 == rc)
        {
            snmp_log (LOG_ERR, "etherStatsTable column etherStatsDataSource commit failed\n");
        }
        else
        {
            /*
    ...
    if (save_flags & COLUMN_ETHERSTATSOWNER_FLAG)
    {
        ...
        if (-1 == rc)
        {
            snmp_log (LOG_ERR, "etherStatsTable column etherStatsOwner commit failed\n");
        }
        else
        {
            /*
    ...
    if (save_flags & COLUMN_ETHERSTATSSTATUS_FLAG)
    {
        ...
        if (-1 == rc)
        {
            snmp_log (LOG_ERR, "etherStatsTable column etherStatsStatus commit failed\n");
        }
        else
        {
            /*
...
int etherStatsTable_undo_commit (etherStatsTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsTable_undo_commit", "called\n"));
...
{
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsDataSource_check_value", "called\n"));
...
int etherStatsDataSource_undo_setup (etherStatsTable_rowreq_ctx * rowreq_ctx)
{
    ...
    memcpy (rowreq_ctx->undo->etherStatsDataSource,
            ...
            (rowreq_ctx->data.etherStatsDataSource_len * sizeof (rowreq_ctx->undo->etherStatsDataSource[0])));
    rowreq_ctx->undo->etherStatsDataSource_len = rowreq_ctx->data.etherStatsDataSource_len;
                          ...
                          oid * etherStatsDataSource_val_ptr, size_t etherStatsDataSource_val_ptr_len)
{
    ...
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsDataSource_set", "called\n"));
     ...
     */
    memcpy (rowreq_ctx->data.etherStatsDataSource, etherStatsDataSource_val_ptr, etherStatsDataSource_val_ptr_len);

    /** convert bytes to number of oid */
    rowreq_ctx->data.etherStatsDataSource_len =
        etherStatsDataSource_val_ptr_len / sizeof (etherStatsDataSource_val_ptr[0]);
...
int etherStatsDataSource_undo (etherStatsTable_rowreq_ctx * rowreq_ctx)
{
    ...
    memcpy (rowreq_ctx->data.etherStatsDataSource,
            ...
            (rowreq_ctx->undo->etherStatsDataSource_len * sizeof (rowreq_ctx->data.etherStatsDataSource[0])));
    rowreq_ctx->data.etherStatsDataSource_len = rowreq_ctx->undo->etherStatsDataSource_len;
...
etherStatsOwner_check_value (etherStatsTable_rowreq_ctx * rowreq_ctx,
                             char *etherStatsOwner_val_ptr, size_t etherStatsOwner_val_ptr_len)
{
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsOwner_check_value", "called\n"));
...
int etherStatsOwner_undo_setup (etherStatsTable_rowreq_ctx * rowreq_ctx)
{
    ...
    memcpy (rowreq_ctx->undo->etherStatsOwner,
            ...
            (rowreq_ctx->data.etherStatsOwner_len * sizeof (rowreq_ctx->undo->etherStatsOwner[0])));
    rowreq_ctx->undo->etherStatsOwner_len = rowreq_ctx->data.etherStatsOwner_len;
                     ...
                     char *etherStatsOwner_val_ptr, size_t etherStatsOwner_val_ptr_len)
{
    ...
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsOwner_set", "called\n"));
     ...
     */
    memcpy (rowreq_ctx->data.etherStatsOwner, etherStatsOwner_val_ptr, etherStatsOwner_val_ptr_len);

    /** convert bytes to number of char */
    rowreq_ctx->data.etherStatsOwner_len = etherStatsOwner_val_ptr_len / sizeof (etherStatsOwner_val_ptr[0]);
...
int etherStatsOwner_undo (etherStatsTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsOwner_undo", "called\n"));
    ...
    memcpy (rowreq_ctx->data.etherStatsOwner,
            ...
            (rowreq_ctx->undo->etherStatsOwner_len * sizeof (rowreq_ctx->data.etherStatsOwner[0])));
    rowreq_ctx->data.etherStatsOwner_len = rowreq_ctx->undo->etherStatsOwner_len;
...
{
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsStatus_check_value", "called\n"));
...
int etherStatsStatus_set (etherStatsTable_rowreq_ctx * rowreq_ctx, u_long etherStatsStatus_val)
{
    ...
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsStatus_set", "called\n"));
