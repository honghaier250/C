 ...
 */
int etherStatsTable_indexes_set_tbl_idx (etherStatsTable_mib_index * tbl_idx, long etherStatsIndex_val)
{
 ...
 *  from the mib index.
 */
int etherStatsTable_indexes_set (etherStatsTable_rowreq_ctx * rowreq_ctx, long etherStatsIndex_val)
{
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsTable_indexes_set", "called\n"));

    if (MFD_SUCCESS != etherStatsTable_indexes_set_tbl_idx (&rowreq_ctx->tbl_idx, etherStatsIndex_val))
        return MFD_ERROR;
    ...
    if (0 != etherStatsTable_index_to_oid (&rowreq_ctx->oid_idx, &rowreq_ctx->tbl_idx))
    {
        return MFD_ERROR;
    }
...
etherStatsDataSource_get (etherStatsTable_rowreq_ctx * rowreq_ctx,
                          oid ** etherStatsDataSource_val_ptr_ptr, size_t * etherStatsDataSource_val_ptr_len_ptr)
{

   /** we should have a non-NULL pointer and enough storage */
    netsnmp_assert ((NULL != etherStatsDataSource_val_ptr_ptr) && (NULL != *etherStatsDataSource_val_ptr_ptr));
    netsnmp_assert (NULL != etherStatsDataSource_val_ptr_len_ptr);


    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsDataSource_get", "called\n"));
    ...
    if ((NULL == (*etherStatsDataSource_val_ptr_ptr)) ||
        ((*etherStatsDataSource_val_ptr_len_ptr) <
         (rowreq_ctx->data.etherStatsDataSource_len * sizeof (rowreq_ctx->data.etherStatsDataSource[0]))))
    {
        /*
         * allocate space for etherStatsDataSource data
         */
        (*etherStatsDataSource_val_ptr_ptr) =
            malloc (rowreq_ctx->data.etherStatsDataSource_len * sizeof (rowreq_ctx->data.etherStatsDataSource[0]));
        if (NULL == (*etherStatsDataSource_val_ptr_ptr))
        {
 ...
 * @retval MFD_ERROR           : Any other error
 */
int etherStatsDropEvents_get (etherStatsTable_rowreq_ctx * rowreq_ctx, u_long * etherStatsDropEvents_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsDropEvents_get", "called\n"));
     ...
     */
    (*etherStatsDropEvents_val_ptr) = rowreq_ctx->data.etherStatsDropEvents;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int etherStatsOctets_get (etherStatsTable_rowreq_ctx * rowreq_ctx, u_long * etherStatsOctets_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int etherStatsPkts_get (etherStatsTable_rowreq_ctx * rowreq_ctx, u_long * etherStatsPkts_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int etherStatsBroadcastPkts_get (etherStatsTable_rowreq_ctx * rowreq_ctx, u_long * etherStatsBroadcastPkts_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
     ...
     */
    (*etherStatsBroadcastPkts_val_ptr) = rowreq_ctx->data.etherStatsBroadcastPkts;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int etherStatsMulticastPkts_get (etherStatsTable_rowreq_ctx * rowreq_ctx, u_long * etherStatsMulticastPkts_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsMulticastPkts_get", "called\n"));
     ...
     */
    (*etherStatsMulticastPkts_val_ptr) = rowreq_ctx->data.etherStatsMulticastPkts;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int etherStatsCRCAlignErrors_get (etherStatsTable_rowreq_ctx * rowreq_ctx, u_long * etherStatsCRCAlignErrors_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsCRCAlignErrors_get", "called\n"));
     ...
     */
    (*etherStatsCRCAlignErrors_val_ptr) = rowreq_ctx->data.etherStatsCRCAlignErrors;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int etherStatsUndersizePkts_get (etherStatsTable_rowreq_ctx * rowreq_ctx, u_long * etherStatsUndersizePkts_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsUndersizePkts_get", "called\n"));
     ...
     */
    (*etherStatsUndersizePkts_val_ptr) = rowreq_ctx->data.etherStatsUndersizePkts;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int etherStatsOversizePkts_get (etherStatsTable_rowreq_ctx * rowreq_ctx, u_long * etherStatsOversizePkts_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsOversizePkts_get", "called\n"));
     ...
     */
    (*etherStatsOversizePkts_val_ptr) = rowreq_ctx->data.etherStatsOversizePkts;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int etherStatsFragments_get (etherStatsTable_rowreq_ctx * rowreq_ctx, u_long * etherStatsFragments_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsFragments_get", "called\n"));
 ...
 * @retval MFD_ERROR           : Any other error
 */
int etherStatsJabbers_get (etherStatsTable_rowreq_ctx * rowreq_ctx, u_long * etherStatsJabbers_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsJabbers_get", "called\n"));
 ...
 * @retval MFD_ERROR           : Any other error
 */
int etherStatsCollisions_get (etherStatsTable_rowreq_ctx * rowreq_ctx, u_long * etherStatsCollisions_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
     ...
     */
    (*etherStatsCollisions_val_ptr) = rowreq_ctx->data.etherStatsCollisions;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int etherStatsPkts64Octets_get (etherStatsTable_rowreq_ctx * rowreq_ctx, u_long * etherStatsPkts64Octets_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsPkts64Octets_get", "called\n"));
     ...
     */
    (*etherStatsPkts64Octets_val_ptr) = rowreq_ctx->data.etherStatsPkts64Octets;
 ...
 */
int
etherStatsPkts65to127Octets_get (etherStatsTable_rowreq_ctx * rowreq_ctx, u_long * etherStatsPkts65to127Octets_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
     ...
     */
    (*etherStatsPkts65to127Octets_val_ptr) = rowreq_ctx->data.etherStatsPkts65to127Octets;
...
etherStatsPkts128to255Octets_get (etherStatsTable_rowreq_ctx * rowreq_ctx,
                                  u_long * etherStatsPkts128to255Octets_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
     ...
     */
    (*etherStatsPkts128to255Octets_val_ptr) = rowreq_ctx->data.etherStatsPkts128to255Octets;
...
etherStatsPkts256to511Octets_get (etherStatsTable_rowreq_ctx * rowreq_ctx,
                                  u_long * etherStatsPkts256to511Octets_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsPkts256to511Octets_get", "called\n"));
     ...
     */
    (*etherStatsPkts256to511Octets_val_ptr) = rowreq_ctx->data.etherStatsPkts256to511Octets;
...
etherStatsPkts512to1023Octets_get (etherStatsTable_rowreq_ctx * rowreq_ctx,
                                   u_long * etherStatsPkts512to1023Octets_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
     ...
     */
    (*etherStatsPkts512to1023Octets_val_ptr) = rowreq_ctx->data.etherStatsPkts512to1023Octets;
...
etherStatsPkts1024to1518Octets_get (etherStatsTable_rowreq_ctx * rowreq_ctx,
                                    u_long * etherStatsPkts1024to1518Octets_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
     ...
     */
    (*etherStatsPkts1024to1518Octets_val_ptr) = rowreq_ctx->data.etherStatsPkts1024to1518Octets;
                     ...
                     char **etherStatsOwner_val_ptr_ptr, size_t * etherStatsOwner_val_ptr_len_ptr)
{
   ...
   /** we should have a non-NULL pointer and enough storage */
    netsnmp_assert ((NULL != etherStatsOwner_val_ptr_ptr) && (NULL != *etherStatsOwner_val_ptr_ptr));
    netsnmp_assert (NULL != etherStatsOwner_val_ptr_len_ptr);


    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsOwner_get", "called\n"));
    ...
    if ((NULL == (*etherStatsOwner_val_ptr_ptr)) ||
        ((*etherStatsOwner_val_ptr_len_ptr) <
         (rowreq_ctx->data.etherStatsOwner_len * sizeof (rowreq_ctx->data.etherStatsOwner[0]))))
    {
        /*
         * allocate space for etherStatsOwner data
         */
        (*etherStatsOwner_val_ptr_ptr) =
            malloc (rowreq_ctx->data.etherStatsOwner_len * sizeof (rowreq_ctx->data.etherStatsOwner[0]));
        if (NULL == (*etherStatsOwner_val_ptr_ptr))
        {
            snmp_log (LOG_ERR, "could not allocate memory\n");
            return MFD_ERROR;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int etherStatsStatus_get (etherStatsTable_rowreq_ctx * rowreq_ctx, u_long * etherStatsStatus_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:etherStatsTable:etherStatsStatus_get", "called\n"));
