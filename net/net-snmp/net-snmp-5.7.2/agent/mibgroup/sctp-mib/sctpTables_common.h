...
typedef struct sctpAssocLocalAddrTable_entry_s sctpAssocLocalAddrTable_entry;

typedef struct sctpLookupLocalPortTable_entry_s sctpLookupLocalPortTable_entry;

typedef struct sctpLookupRemPortTable_entry_s sctpLookupRemPortTable_entry;

typedef struct sctpLookupRemHostNameTable_entry_s sctpLookupRemHostNameTable_entry;

typedef struct sctpLookupRemPrimIPAddrTable_entry_s sctpLookupRemPrimIPAddrTable_entry;

typedef struct sctpLookupRemIPAddrTable_entry_s sctpLookupRemIPAddrTable_entry;
 ...
 */
extern int sctpTables_arch_load (sctpTables_containers * containers, u_long * flags);
 ...
 */
extern int sctpAssocTable_add_or_update (netsnmp_container * assocTable, sctpAssocTable_entry * entry);
 ...
 * Caller must not use the entry after calling the function, it may be freed.
 */
extern int sctpAssocRemAddrTable_add_or_update (netsnmp_container * remAddrTable, sctpAssocRemAddrTable_entry * entry);
...
extern int sctpAssocLocalAddrTable_add_or_update (netsnmp_container
                                                  * localAddrTable, sctpAssocLocalAddrTable_entry * entry);
