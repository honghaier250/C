...
void initialize_table_sctpAssocTable (void)
{
    ...
    size_t sctpAssocTable_oid_len = OID_LENGTH (sctpAssocTable_oid);
    ...
    reg =
        netsnmp_create_handler_registration ("sctpAssocTable",
                                             ...
                                             sctpAssocTable_oid, sctpAssocTable_oid_len, HANDLER_CAN_RWRITE);
    if (NULL == reg)
    {
        snmp_log (LOG_ERR, "error creating handler registration for sctpAssocTable\n");
        goto bail;
    }
    ...
    if (NULL == table_info)
    {
        snmp_log (LOG_ERR, "error allocating table registration for sctpAssocTable\n");
        goto bail;
    }
     ...
     */
    handler = netsnmp_container_table_handler_get (table_info, container, TABLE_CONTAINER_KEY_NETSNMP_INDEX);
    if (NULL == handler)
    {
        snmp_log (LOG_ERR, "error allocating table registration for sctpAssocTable\n");
        goto bail;
    ...
    {
        snmp_log (LOG_ERR, "error injecting container_table handler for sctpAssocTable\n");
        goto bail;
    }
    ...
    cache = netsnmp_cache_create (SCTP_TABLES_CACHE_TIMEOUT,    /* timeout in seconds */
                                  _cache_load, _cache_free, sctpAssocTable_oid, sctpAssocTable_oid_len);
    ...
    cache->flags = NETSNMP_CACHE_DONT_INVALIDATE_ON_SET | NETSNMP_CACHE_AUTO_RELOAD | NETSNMP_CACHE_PRELOAD;
    cache->magic = container;

    handler = netsnmp_cache_handler_get (cache);
    if (NULL == handler)
    {
        snmp_log (LOG_ERR, "error creating cache handler for sctpAssocTable\n");
        goto bail;
    }
    ...
    if (SNMPERR_SUCCESS != netsnmp_inject_handler (reg, handler))
    {
        snmp_log (LOG_ERR, "error injecting cache handler for sctpAssocTable\n");
        goto bail;
    }
    ...
    {
        snmp_log (LOG_ERR, "error registering table handler for sctpAssocTable\n");
        ...
        case MODE_GET:
            for (request = requests; request; request = request->next)
            {
                if (request->processed)
                    continue;
                table_entry = (sctpAssocTable_entry *) netsnmp_container_table_extract_context (request);
                table_info = netsnmp_extract_table_info (request);
                if ((NULL == table_entry) || (NULL == table_info))
                {
                    snmp_log (LOG_ERR, "could not extract table entry or info for sctpAssocTable\n");
                ...
                switch (table_info->colnum)
                {
                    ...
                    case COLUMN_SCTPASSOCLOCALPORT:
                        ...
                        snmp_set_var_typed_integer (request->requestvb, ASN_UNSIGNED, table_entry->sctpAssocLocalPort);
                        break;
                    case COLUMN_SCTPASSOCREMPORT:
                        ...
                        snmp_set_var_typed_integer (request->requestvb, ASN_UNSIGNED, table_entry->sctpAssocRemPort);
                        break;
                    ...
                    case COLUMN_SCTPASSOCHEARTBEATINTERVAL:
                        ...
                        snmp_set_var_typed_integer (request->requestvb,
                                                    ASN_UNSIGNED, table_entry->sctpAssocHeartBeatInterval);
                        break;
                    ...
                    case COLUMN_SCTPASSOCINSTREAMS:
                        ...
                        snmp_set_var_typed_integer (request->requestvb, ASN_UNSIGNED, table_entry->sctpAssocInStreams);
                        break;
                    ...
                    case COLUMN_SCTPASSOCPRIMPROCESS:
                        ...
                        snmp_set_var_typed_integer (request->requestvb,
                                                    ASN_UNSIGNED, table_entry->sctpAssocPrimProcess);
                        break;
                    case COLUMN_SCTPASSOCT1EXPIREDS:
                        ...
                        snmp_set_var_typed_integer (request->requestvb, ASN_COUNTER, table_entry->sctpAssocT1expireds);
                        break;
                    case COLUMN_SCTPASSOCT2EXPIREDS:
                        ...
                        snmp_set_var_typed_integer (request->requestvb, ASN_COUNTER, table_entry->sctpAssocT2expireds);
                        break;
                    ...
                    case COLUMN_SCTPASSOCSTARTTIME:
                        ...
                        snmp_set_var_typed_integer (request->requestvb, ASN_TIMETICKS, table_entry->sctpAssocStartTime);
                        break;
                    case COLUMN_SCTPASSOCDISCONTINUITYTIME:
                        ...
                        snmp_set_var_typed_integer (request->requestvb,
                                                    ASN_TIMETICKS, table_entry->sctpAssocDiscontinuityTime);
                        break;
                    default:
...
static void sctpAssocTable_freeEntry_cb (sctpAssocTable_entry * entry, void *magic)
{
...
static void _cache_free (netsnmp_cache * cache, void *magic)
{
     ...
     */
    CONTAINER_CLEAR (container, (netsnmp_container_obj_func *) sctpAssocTable_freeEntry_cb, NULL);
}                                /* _cache_free */

sctpAssocTable_entry *sctpAssocTable_entry_create (void)
{
    sctpAssocTable_entry *entry = SNMP_MALLOC_TYPEDEF (sctpAssocTable_entry);
...
int sctpAssocTable_entry_update_index (sctpAssocTable_entry * entry)
{
    ...
    snmp_set_var_value (&var_sctpAssocId, (u_char *) & entry->sctpAssocId, sizeof (entry->sctpAssocId));
    ...
    err =
        build_oid_noalloc (entry->oid_index.oids, entry->oid_index.len,
                           &entry->oid_index.len, NULL, 0, &var_sctpAssocId);
    if (err)
...
void sctpAssocTable_entry_copy (sctpAssocTable_entry * from, sctpAssocTable_entry * to)
{
...
netsnmp_container *sctpAssocTable_get_container (void)
{
    return sctpAssocTable_container;
}

static void sctpAssocTable_entry_clear (void *what, void *magic)
{
    sctpAssocTable_entry_free (what);
}

void sctpAssocTable_container_clear (netsnmp_container * container)
{
