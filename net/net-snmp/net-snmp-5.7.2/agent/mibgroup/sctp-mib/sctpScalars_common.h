 ...
 */
extern int netsnmp_access_sctp_stats_arch_load (netsnmp_sctp_stats * sctp_stats);
 ...
 * Load the sctpParams.
 */
extern int netsnmp_access_sctp_params_arch_load (netsnmp_sctp_params * sctp_params);
