 ...
 */
int tcpListenerTable_init_data (tcpListenerTable_registration * tcpListenerTable_reg)
{
    DEBUGMSGTL (("verbose:tcpListenerTable:tcpListenerTable_init_data", "called\n"));
 ...
 */
void tcpListenerTable_container_init (netsnmp_container ** container_ptr_ptr, netsnmp_cache * cache)
{
    DEBUGMSGTL (("verbose:tcpListenerTable:tcpListenerTable_container_init", "called\n"));

    if (NULL == container_ptr_ptr)
    {
        snmp_log (LOG_ERR, "bad container param to tcpListenerTable_container_init\n");
        return;
    }
    ...
    *container_ptr_ptr = NULL;
    ...
    if (NULL == cache)
    {
        snmp_log (LOG_ERR, "bad cache param to tcpListenerTable_container_init\n");
        return;
    }
...
void tcpListenerTable_container_shutdown (netsnmp_container * container_ptr)
{
    ...
    {
        snmp_log (LOG_ERR, "bad params to tcpListenerTable_container_shutdown\n");
        return;
    }
...
static void _add_connection (netsnmp_tcpconn_entry * entry, netsnmp_container * container)
{
    ...
    else
    {
        if (rowreq_ctx)
        {
            snmp_log (LOG_ERR, "error setting index while loading " "tcpListenerTable cache.\n");
            tcpListenerTable_release_rowreq_ctx (rowreq_ctx);
        }
        else
        {
            snmp_log (LOG_ERR, "memory allocation failed while loading " "tcpListenerTable cache.\n");
...
{
    DEBUGMSGTL (("verbose:tcpListenerTable:tcpListenerTable_container_free", "called\n"));
...
{
    DEBUGMSGTL (("verbose:tcpListenerTable:tcpListenerTable_row_prep", "called\n"));
