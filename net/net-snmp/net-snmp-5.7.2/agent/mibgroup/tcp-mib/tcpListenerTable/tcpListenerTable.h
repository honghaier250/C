 ...
 **********************************************************************/
    ...
    int tcpListenerTable_indexes_set_tbl_idx (tcpListenerTable_mib_index *
                                              tbl_idx,
                                              u_long
                                              ...
                                              *tcpListenerLocalAddress_val_ptr,
                                              size_t
                                              tcpListenerLocalAddress_val_ptr_len, u_long tcpListenerLocalPort_val);
    int tcpListenerTable_indexes_set (tcpListenerTable_rowreq_ctx *
                                      rowreq_ctx,
                                      u_long
                                      tcpListenerLocalAddressType_val,
