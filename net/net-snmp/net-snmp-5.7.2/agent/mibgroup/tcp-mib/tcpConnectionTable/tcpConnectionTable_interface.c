 ...
 */
     ...
     static void _tcpConnectionTable_container_init (tcpConnectionTable_interface_ctx * if_ctx);

     static void _tcpConnectionTable_container_shutdown (tcpConnectionTable_interface_ctx * if_ctx);
...
tcpConnectionTable_registration *tcpConnectionTable_registration_set (tcpConnectionTable_registration * newreg)
{
...
_tcpConnectionTable_undo_column (tcpConnectionTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column);
 ...
 */
void _tcpConnectionTable_initialize_interface (tcpConnectionTable_registration * reg_ptr, u_long flags)
{
    netsnmp_baby_steps_access_methods *access_multiplexer = &tcpConnectionTable_if_ctx.access_multiplexer;

    netsnmp_table_registration_info *tbl_info = &tcpConnectionTable_if_ctx.tbl_info;
    ...
    {
        snmp_log (LOG_ERR, "could not initialize container for tcpConnectionTable\n");
        return;
    }
    ...
    reginfo =
        netsnmp_handler_registration_create ("tcpConnectionTable", handler,
                                             tcpConnectionTable_oid, tcpConnectionTable_oid_size, HANDLER_CAN_BABY_STEP
#if !(defined(NETSNMP_NO_WRITE_SUPPORT) || defined(NETSNMP_DISABLE_SET_SUPPORT))
                                             | HANDLER_CAN_RWRITE
#endif
        );
    ...
    handler =
        netsnmp_container_table_handler_get (tbl_info,
                                             tcpConnectionTable_if_ctx.container, TABLE_CONTAINER_KEY_NETSNMP_INDEX);
    netsnmp_inject_handler (reginfo, handler);
 ...
 */
void _tcpConnectionTable_shutdown_interface (tcpConnectionTable_registration * reg_ptr)
{
    /*
 ...
 */
int tcpConnectionTable_index_to_oid (netsnmp_index * oid_idx, tcpConnectionTable_mib_index * mib_idx)
{
     ...
     * set up varbinds
     */
    memset (&var_tcpConnectionLocalAddressType, 0x00, sizeof (var_tcpConnectionLocalAddressType));
    var_tcpConnectionLocalAddressType.type = ASN_INTEGER;
    memset (&var_tcpConnectionLocalAddress, 0x00, sizeof (var_tcpConnectionLocalAddress));
    var_tcpConnectionLocalAddress.type = ASN_OCTET_STR;
    memset (&var_tcpConnectionLocalPort, 0x00, sizeof (var_tcpConnectionLocalPort));
    ...
    memset (&var_tcpConnectionRemAddress, 0x00, sizeof (var_tcpConnectionRemAddress));
     ...
     */
    var_tcpConnectionLocalAddressType.next_variable = &var_tcpConnectionLocalAddress;
    ...
    var_tcpConnectionRemAddressType.next_variable = &var_tcpConnectionRemAddress;
    ...
    snmp_set_var_value (&var_tcpConnectionLocalPort,
                        (u_char *) & mib_idx->tcpConnectionLocalPort, sizeof (mib_idx->tcpConnectionLocalPort));
    ...
    snmp_set_var_value (&var_tcpConnectionRemPort,
                        (u_char *) & mib_idx->tcpConnectionRemPort, sizeof (mib_idx->tcpConnectionRemPort));


    err = build_oid_noalloc (oid_idx->oids, oid_idx->len, &oid_idx->len, NULL, 0, &var_tcpConnectionLocalAddressType);
    if (err)
 ...
 */
int tcpConnectionTable_index_from_oid (netsnmp_index * oid_idx, tcpConnectionTable_mib_index * mib_idx)
{
    int err = SNMP_ERR_NOERROR;
     ...
     */
    err = parse_oid_indexes (oid_idx->oids, oid_idx->len, &var_tcpConnectionLocalAddressType);
    if (err == SNMP_ERR_NOERROR)
    {
         ...
         */
        if (var_tcpConnectionLocalAddress.val_len > sizeof (mib_idx->tcpConnectionLocalAddress))
            err = SNMP_ERR_GENERR;
        else
        {
            memcpy (mib_idx->tcpConnectionLocalAddress,
                    var_tcpConnectionLocalAddress.val.string, var_tcpConnectionLocalAddress.val_len);
            mib_idx->tcpConnectionLocalAddress_len =
                var_tcpConnectionLocalAddress.val_len / sizeof (mib_idx->tcpConnectionLocalAddress[0]);
        }
         ...
         */
        if (var_tcpConnectionRemAddress.val_len > sizeof (mib_idx->tcpConnectionRemAddress))
            err = SNMP_ERR_GENERR;
        else
        {
            memcpy (mib_idx->tcpConnectionRemAddress,
                    var_tcpConnectionRemAddress.val.string, var_tcpConnectionRemAddress.val_len);
            mib_idx->tcpConnectionRemAddress_len =
                var_tcpConnectionRemAddress.val_len / sizeof (mib_idx->tcpConnectionRemAddress[0]);
        }
 ...
 */
tcpConnectionTable_rowreq_ctx *tcpConnectionTable_allocate_rowreq_ctx (tcpConnectionTable_data * data,
                                                                       void *user_init_ctx)
{
    tcpConnectionTable_rowreq_ctx *rowreq_ctx = SNMP_MALLOC_TYPEDEF (tcpConnectionTable_rowreq_ctx);

    DEBUGMSGTL (("internal:tcpConnectionTable:tcpConnectionTable_allocate_rowreq_ctx", "called\n"));

    if (NULL == rowreq_ctx)
    {
        snmp_log (LOG_ERR, "Couldn't allocate memory for a " "tcpConnectionTable_rowreq_ctx.\n");
        return NULL;
    }
    else
    {
    ...
    {
        if (SNMPERR_SUCCESS != tcpConnectionTable_rowreq_ctx_init (rowreq_ctx, user_init_ctx))
        {
 ...
 */
void tcpConnectionTable_release_rowreq_ctx (tcpConnectionTable_rowreq_ctx * rowreq_ctx)
{
                                     ...
                                     netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    {
        DEBUGMSGTL (("internal:tcpConnectionTable", "skipping additional pre_request\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         */
        DEBUGMSGTL (("tcpConnectionTable", "error %d from " "tcpConnectionTable_pre_request\n", rc));
                                      ...
                                      netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    {
        DEBUGMSGTL (("internal:tcpConnectionTable", "waiting for last post_request\n"));
        return SNMP_ERR_NOERROR;
    }
    ...
    if ((MFD_SUCCESS != packet_rc) && tcpConnectionTable_dirty_get ())
    {
         ...
         * the dirty flags.
         */
        snmp_log (LOG_WARNING, "tcpConnectionTable dirty flag set in post_request " "but status != SUCCESS.\n");
    }
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("tcpConnectionTable", "error %d from " "tcpConnectionTable_post_request\n", rc));
    }
 ...
 */
NETSNMP_STATIC_INLINE int
_tcpConnectionTable_get_column (tcpConnectionTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    ...
    switch (column)
    {
        ...
        default:
            snmp_log (LOG_ERR, "unknown column %d in _tcpConnectionTable_get_column\n", column);
            break;
    }
                                    ...
                                    netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _tcpConnectionTable_get_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            if (MFD_SKIP == rc)
            {
 ...
 */
NETSNMP_STATIC_INLINE int
_tcpConnectionTable_check_column (tcpConnectionTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    switch (column)
    {
        ...
        case COLUMN_TCPCONNECTIONSTATE:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("tcpConnectionTable:_tcpConnectionTable_check_column:tcpConnectionState",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = tcpConnectionState_check_value (rowreq_ctx, *((u_long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from tcpConnectionState_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        default:
            ...
            rc = SNMP_ERR_GENERR;
            snmp_log (LOG_ERR, "unknown column %d in _tcpConnectionTable_check_column\n", column);
    }
                                       ...
                                       * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _tcpConnectionTable_check_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            netsnmp_request_set_error (requests, SNMP_VALIDATE_ERR (rc));
            break;
                                            ...
                                            * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (rc)
    {
        DEBUGMSGTL (("tcpConnectionTable:mfd", "error %d from " "tcpConnectionTable_check_dependencies\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
 ...
 */
NETSNMP_STATIC_INLINE int _tcpConnectionTable_undo_setup_column (tcpConnectionTable_rowreq_ctx * rowreq_ctx, int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    switch (column)
    {
        ...
        default:
            snmp_log (LOG_ERR, "unknown column %d in _tcpConnectionTable_undo_setup_column\n", column);
            break;
    }
                                    ...
                                    netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("tcpConnectionTable:mfd", "error %d from " "tcpConnectionTable_undo_setup\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
    else
    {
        ...
        for (; requests; requests = requests->next)
        {
            ...
            if (MFD_SUCCESS != rc)
            {
                DEBUGMSGTL (("tcpConnectionTable:mfd", "error %d from " "tcpConnectionTable_undo_setup_column\n", rc));
                                      ...
                                      netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("tcpConnectionTable:mfd", "error %d from " "tcpConnectionTable_undo_cleanup\n", rc));
    }
 ...
 */
NETSNMP_STATIC_INLINE int
_tcpConnectionTable_set_column (tcpConnectionTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    switch (column)
    {
        ...
        case COLUMN_TCPCONNECTIONSTATE:
            rowreq_ctx->column_set_flags |= COLUMN_TCPCONNECTIONSTATE_FLAG;
            rc = tcpConnectionState_set (rowreq_ctx, *((u_long *) var->val.string));
            break;

        default:
            snmp_log (LOG_ERR, "unknown column %d in _tcpConnectionTable_set_column\n", column);
            rc = SNMP_ERR_GENERR;
            break;
    }
                                    ...
                                    netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _tcpConnectionTable_set_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            DEBUGMSGTL (("tcpConnectionTable:mfd", "error %d from " "tcpConnectionTable_set_column\n", rc));
            netsnmp_set_request_error (agtreq_info, requests, SNMP_VALIDATE_ERR (rc));
        }
    }                            /* for results */
                                ...
                                netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("tcpConnectionTable:mfd", "error %d from " "tcpConnectionTable_commit\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
                                     ...
                                     netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("tcpConnectionTable:mfd", "error %d from " "tcpConnectionTable_undo_commit\n", rc));
    }

    if (rowreq_ctx->rowreq_flags & MFD_ROW_DIRTY)
    {
        snmp_log (LOG_WARNING, "tcpConnectionTable row dirty flag still set after undo_commit\n");
...
_tcpConnectionTable_undo_column (tcpConnectionTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    ...
    switch (column)
    {
        ...
        default:
            snmp_log (LOG_ERR, "unknown column %d in _tcpConnectionTable_undo_column\n", column);
            break;
    }
                                     ...
                                     netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("tcpConnectionTable:mfd", "error %d from " "tcpConnectionTable_undo\n", rc));
    }
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _tcpConnectionTable_undo_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            /*
             * nothing we can do about it but log it
             */
            DEBUGMSGTL (("tcpConnectionTable:mfd", "error %d from " "tcpConnectionTable_undo_column\n", rc));
        }
    }                            /* for results */
 ...
 * @internal
 */
static void _container_item_free (tcpConnectionTable_rowreq_ctx * rowreq_ctx, void *context)
{
    DEBUGMSGTL (("internal:tcpConnectionTable:_container_item_free", "called\n"));
...
static void _container_free (netsnmp_container * container)
{
    ...
    if (NULL == container)
    {
        snmp_log (LOG_ERR, "invalid container in tcpConnectionTable_container_free\n");
        return;
    }
 ...
 */
void _tcpConnectionTable_container_init (tcpConnectionTable_interface_ctx * if_ctx)
{
    ...
    if_ctx->cache = netsnmp_cache_create (30,    /* timeout in seconds */
                                          ...
                                          tcpConnectionTable_oid, tcpConnectionTable_oid_size);
    ...
    {
        if_ctx->container = netsnmp_container_find ("tcpConnectionTable:table_container");
        if (if_ctx->container)
            if_ctx->container->container_name = strdup ("tcpConnectionTable");
    }
    if (NULL == if_ctx->container)
    {
        snmp_log (LOG_ERR, "error creating container in " "tcpConnectionTable_container_init\n");
        return;
    }
 ...
 */
void _tcpConnectionTable_container_shutdown (tcpConnectionTable_interface_ctx * if_ctx)
{
...
tcpConnectionTable_rowreq_ctx *tcpConnectionTable_row_find_by_mib_index (tcpConnectionTable_mib_index * mib_idx)
{
    ...
    rowreq_ctx = (tcpConnectionTable_rowreq_ctx *) CONTAINER_FIND (tcpConnectionTable_if_ctx.container, &oid_idx);
