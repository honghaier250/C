 ...
 */
int tcpConnectionTable_rowreq_ctx_init (tcpConnectionTable_rowreq_ctx * rowreq_ctx, void *user_init_ctx)
{
 ...
 *
 */
void tcpConnectionTable_rowreq_ctx_cleanup (tcpConnectionTable_rowreq_ctx * rowreq_ctx)
{
 ...
 */
int tcpConnectionTable_pre_request (tcpConnectionTable_registration * user_context)
{
 ...
 */
int tcpConnectionTable_post_request (tcpConnectionTable_registration * user_context, int rc)
{
...
tcpConnectionTable_data *tcpConnectionTable_allocate_data (void)
{
    ...
    if (NULL == rtn)
    {
        snmp_log (LOG_ERR, "unable to malloc memory for new " "tcpConnectionTable_data.\n");
    }
                                        ...
                                        size_t tcpConnectionRemAddress_val_ptr_len, u_long tcpConnectionRemPort_val)
{
    ...
    netsnmp_assert (tbl_idx->tcpConnectionRemAddressType == tbl_idx->tcpConnectionLocalAddressType);
    ...
    memcpy (tbl_idx->tcpConnectionLocalAddress,
            tcpConnectionLocalAddress_val_ptr, tcpConnectionLocalAddress_val_ptr_len);
    ...
    tbl_idx->tcpConnectionRemAddress_len = tcpConnectionRemAddress_val_ptr_len;
    memcpy (tbl_idx->tcpConnectionRemAddress, tcpConnectionRemAddress_val_ptr, tcpConnectionRemAddress_val_ptr_len);
                                ...
                                size_t tcpConnectionRemAddress_val_ptr_len, u_long tcpConnectionRemPort_val)
{
    ...
    if (0 != tcpConnectionTable_index_to_oid (&rowreq_ctx->oid_idx, &rowreq_ctx->tbl_idx))
    {
        return MFD_ERROR;
    }
 ...
 */
int tcpConnectionState_get (tcpConnectionTable_rowreq_ctx * rowreq_ctx, u_long * tcpConnectionState_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:tcpConnectionTable:tcpConnectionState_get", "called\n"));
 ...
 * @retval MFD_ERROR           : Any other error
 */
int tcpConnectionProcess_get (tcpConnectionTable_rowreq_ctx * rowreq_ctx, u_long * tcpConnectionProcess_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:tcpConnectionTable:tcpConnectionProcess_get", "called\n"));
...
int tcpConnectionTable_undo_setup (tcpConnectionTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:tcpConnectionTable:tcpConnectionTable_undo_setup", "called\n"));
...
int tcpConnectionTable_undo (tcpConnectionTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:tcpConnectionTable:tcpConnectionTable_undo", "called\n"));
...
int tcpConnectionTable_commit (tcpConnectionTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:tcpConnectionTable:tcpConnectionTable_commit", "called\n"));
    ...
    if (save_flags & COLUMN_TCPCONNECTIONSTATE_FLAG)
    {
        ...
        if (-1 == rc)
        {
            snmp_log (LOG_ERR, "tcpConnectionTable column tcpConnectionState commit failed\n");
        }
        else
        {
            /*
 ...
 *
 */
int tcpConnectionState_check_value (tcpConnectionTable_rowreq_ctx * rowreq_ctx, u_long tcpConnectionState_val)
{
...
{
    DEBUGMSGTL (("verbose:tcpConnectionTable:tcpConnectionState_undo_setup", "called\n"));
 ...
 *        A long containing the new value.
 */
int tcpConnectionState_set (tcpConnectionTable_rowreq_ctx * rowreq_ctx, u_long tcpConnectionState_val)
{

    DEBUGMSGTL (("verbose:tcpConnectionTable:tcpConnectionState_set", "called\n"));
...
int tcpConnectionState_undo (tcpConnectionTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:tcpConnectionTable:tcpConnectionState_undo", "called\n"));
 ...
 */
int tcpConnectionTable_check_dependencies (tcpConnectionTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;
