 ...
 **********************************************************************/
    ...
    int tcpConnectionTable_indexes_set_tbl_idx (tcpConnectionTable_mib_index
                                                ...
                                                *tcpConnectionRemAddress_val_ptr,
                                                size_t
                                                tcpConnectionRemAddress_val_ptr_len, u_long tcpConnectionRemPort_val);
    int tcpConnectionTable_indexes_set (tcpConnectionTable_rowreq_ctx *
                                        rowreq_ctx,
                                        u_long
                                        tcpConnectionLocalAddressType_val,
                                        const void
 ...
 **********************************************************************/
    ...
    int tcpConnectionProcess_check_value (tcpConnectionTable_rowreq_ctx * rowreq_ctx, u_long tcpConnectionProcess_val);
    int tcpConnectionProcess_undo_setup (tcpConnectionTable_rowreq_ctx * rowreq_ctx);
    int tcpConnectionProcess_set (tcpConnectionTable_rowreq_ctx * rowreq_ctx, u_long tcpConnectionProcess_val);
    int tcpConnectionProcess_undo (tcpConnectionTable_rowreq_ctx * rowreq_ctx);


    int tcpConnectionTable_check_dependencies (tcpConnectionTable_rowreq_ctx * ctx);
