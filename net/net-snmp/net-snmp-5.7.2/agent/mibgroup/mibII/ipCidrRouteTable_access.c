...
u_long *get_ipCidrRouteNextHop (void *data_context, size_t * ret_len)
{
    RTENTRY *ourroute = (RTENTRY *) data_context;
...
long *get_ipCidrRouteIfIndex (void *data_context, size_t * ret_len)
{
    RTENTRY *ourroute = (RTENTRY *) data_context;
...
int set_ipCidrRouteIfIndex (void *data_context, long *val, size_t val_len)
{
...
int set_ipCidrRouteType (void *data_context, long *val, size_t val_len)
{
...
long *get_ipCidrRouteProto (void *data_context, size_t * ret_len)
{
    ...
    /* XXX: this is wacked */
    long_ret = (ourroute->rt_flags & RTF_DYNAMIC) ? IPCIDRROUTEPROTO_ICMP : IPCIDRROUTEPROTO_LOCAL;
    *ret_len = sizeof (long_ret);
    return &long_ret;
}
...
int set_ipCidrRouteInfo (void *data_context, oid * val, size_t val_len)
{
...
long *get_ipCidrRouteNextHopAS (void *data_context, size_t * ret_len)
{
    long_ret = 0;                /* we don't know, and defval = 0 */
    *ret_len = sizeof (long_ret);
    return &long_ret;
...
int set_ipCidrRouteNextHopAS (void *data_context, long *val, size_t val_len)
{

    return SNMP_ERR_NOERROR;      /** XXX: change if an error occurs */
}

long *get_ipCidrRouteMetric1 (void *data_context, size_t * ret_len)
{
    RTENTRY *ourroute = (RTENTRY *) data_context;
...
int set_ipCidrRouteMetric1 (void *data_context, long *val, size_t val_len)
{

    return SNMP_ERR_NOERROR;      /** XXX: change if an error occurs */
}

long *get_ipCidrRouteMetric2 (void *data_context, size_t * ret_len)
{
    long_ret = -1;                /* unused */
    *ret_len = sizeof (long_ret);
    return &long_ret;
...
int set_ipCidrRouteMetric2 (void *data_context, long *val, size_t val_len)
{
...
/** XXX: return a data pointer to the data for the ipCidrRouteMetric3 column and set
         ret_len to its proper size in bytes. */
long *get_ipCidrRouteMetric3 (void *data_context, size_t * ret_len)
{
    long_ret = -1;                /* unused */
    *ret_len = sizeof (long_ret);
    return &long_ret;
 ...
 /** XXX: Set the value of the ipCidrRouteMetric3 column and return
          SNMPERR_SUCCESS on SNMPERR_GENERR on failure. */
int set_ipCidrRouteMetric3 (void *data_context, long *val, size_t val_len)
{
...
/** XXX: return a data pointer to the data for the ipCidrRouteMetric4 column and set
         ret_len to its proper size in bytes. */
long *get_ipCidrRouteMetric4 (void *data_context, size_t * ret_len)
{
    long_ret = -1;                /* unused */
    *ret_len = sizeof (long_ret);
    return &long_ret;
 ...
 /** XXX: Set the value of the ipCidrRouteMetric4 column and return
          SNMPERR_SUCCESS on SNMPERR_GENERR on failure. */
int set_ipCidrRouteMetric4 (void *data_context, long *val, size_t val_len)
{
...
/** XXX: return a data pointer to the data for the ipCidrRouteMetric5 column and set
         ret_len to its proper size in bytes. */
long *get_ipCidrRouteMetric5 (void *data_context, size_t * ret_len)
{
    long_ret = -1;                /* unused */
    *ret_len = sizeof (long_ret);
    return &long_ret;
 ...
 /** XXX: Set the value of the ipCidrRouteMetric5 column and return
          SNMPERR_SUCCESS on SNMPERR_GENERR on failure. */
int set_ipCidrRouteMetric5 (void *data_context, long *val, size_t val_len)
{
...
/** XXX: return a data pointer to the data for the ipCidrRouteStatus column and set
         ret_len to its proper size in bytes. */
long *get_ipCidrRouteStatus (void *data_context, size_t * ret_len)
{
 ...
 /** XXX: Set the value of the ipCidrRouteStatus column and return
          SNMPERR_SUCCESS on SNMPERR_GENERR on failure. */
int set_ipCidrRouteStatus (void *data_context, long *val, size_t val_len)
{
