...
void init_snmp_mib_5_5 (void)
{
    ...
    NETSNMP_REGISTER_STATISTIC_HANDLER (netsnmp_create_handler_registration
                                        ("mibII/snmp", handle_snmp, snmp_oid, OID_LENGTH (snmp_oid), HANDLER_CAN_RONLY),
                                        1, SNMP);
    {
...
#ifndef NETSNMP_NO_WRITE_SUPPORT
            netsnmp_create_update_handler_registration ("mibII/snmpEnableAuthenTraps",
