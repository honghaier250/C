 ...
 */
netsnmp_variable_list *get_first_context (void **my_loop_context, void **my_data_context,
                                          netsnmp_variable_list * put_data, netsnmp_iterator_info * iinfo)
{
    ...
    *my_data_context = context_ptr;
    ...
    snmp_set_var_value (put_data, context_ptr->context_name, strlen (context_ptr->context_name));
    return put_data;
}
...
void init_vacm_context (void)
{
    ...
    netsnmp_table_helper_add_index (table_info, ASN_OCTET_STR) table_info->min_column = 1;
                      ...
                      netsnmp_agent_request_info * reqinfo, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        context_ptr = (subtree_context_cache *) netsnmp_extract_iterator_context (requests);
        ...
        switch (reqinfo->mode)
        {
            case MODE_GET:
                ...
                snmp_set_var_typed_value (var, ASN_OCTET_STR,
                                          context_ptr->context_name, strlen (context_ptr->context_name));
            ...
            default:
                 ...
                 */
                snmp_log (LOG_ERR,
                          "vacm_context table accessed as mode=%d.  We're improperly registered!", reqinfo->mode);
                break;
        }
    }
