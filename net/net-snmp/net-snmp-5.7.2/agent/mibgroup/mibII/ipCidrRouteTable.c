...
{
    static oid ipCidrRouteTable_oid[] = { 1, 3, 6, 1, 2, 1, 4, 24, 4 };
    ...
    my_handler = netsnmp_create_handler_registration ("ipCidrRouteTable",
                                                      ...
                                                      OID_LENGTH (ipCidrRouteTable_oid), HANDLER_CAN_RWRITE);

    if (!my_handler || !table_info || !iinfo)
    {
        snmp_log (LOG_ERR, "malloc failed in initialize_table_ipCidrRouteTable");
     ...
     */
    DEBUGMSGTL (("initialize_table_ipCidrRouteTable", "Registering table ipCidrRouteTable as a table iterator\n"));
...
netsnmp_variable_list *ipCidrRouteTable_set_indexes (RTENTRY * ourroute, netsnmp_variable_list * put_index_data)
{
    ...
    /** ipCidrRouteTos */
    vptr = vptr->next_variable;
    snmp_set_var_value (vptr, (u_char *) & ourroute->rt_tos, sizeof (ourroute->rt_tos));
    vptr = vptr->next_variable;
...
*/
netsnmp_variable_list *ipCidrRouteTable_get_first_data_point (void **my_loop_context,
                                                              void **my_data_context,
                                                              netsnmp_variable_list *
                                                              put_index_data, netsnmp_iterator_info * mydata)
{
    int *position;
...
netsnmp_variable_list *ipCidrRouteTable_get_next_data_point (void **my_loop_context,
                                                             void **my_data_context,
                                                             netsnmp_variable_list *
                                                             put_index_data, netsnmp_iterator_info * mydata)
{
                          ...
                          netsnmp_agent_request_info * reqinfo, netsnmp_request_info * requests)
{
    ...
    const oid *const suffix = requests->requestvb->name + reginfo->rootoid_len + 1;

    const size_t suffix_len = requests->requestvb->name_length - (reginfo->rootoid_len + 1);
        ...
        switch (reqinfo->mode)
        {
            case MODE_GET:
                switch (table_info->colnum)
                {
                    case COLUMN_IPCIDRROUTEDEST:
                        {
                            ...
                            retval = get_ipCidrRouteDest (data_context, &retval_len);
                            snmp_set_var_typed_value (var, ASN_IPADDRESS, (const u_char *) retval, retval_len);
                        }
                        break;
                    ...
                    case COLUMN_IPCIDRROUTEMASK:
                        {
                            ...
                            retval = get_ipCidrRouteMask (data_context, &retval_len);
                            snmp_set_var_typed_value (var, ASN_IPADDRESS, (const u_char *) retval, retval_len);
                        }
                        break;
                    ...
                    case COLUMN_IPCIDRROUTENEXTHOP:
                        {
                            ...
                            retval = get_ipCidrRouteNextHop (data_context, &retval_len);
                            snmp_set_var_typed_value (var, ASN_IPADDRESS, (const u_char *) retval, retval_len);
                        }
                        break;
                    ...
                    case COLUMN_IPCIDRROUTEIFINDEX:
                        {
                            ...
                            retval = get_ipCidrRouteIfIndex (data_context, &retval_len);
                            snmp_set_var_typed_value (var, ASN_INTEGER, (const u_char *) retval, retval_len);
                        }
                        break;
                    ...
                    case COLUMN_IPCIDRROUTETYPE:
                        {
                            ...
                            retval = get_ipCidrRouteType (data_context, &retval_len);
                            snmp_set_var_typed_value (var, ASN_INTEGER, (const u_char *) retval, retval_len);
                        }
                        break;
                    ...
                    case COLUMN_IPCIDRROUTEPROTO:
                        {
                            ...
                            retval = get_ipCidrRouteProto (data_context, &retval_len);
                            snmp_set_var_typed_value (var, ASN_INTEGER, (const u_char *) retval, retval_len);
                        }
                        break;
                    ...
                    case COLUMN_IPCIDRROUTEINFO:
                        {
                            ...
                            retval = get_ipCidrRouteInfo (data_context, &retval_len);
                            snmp_set_var_typed_value (var, ASN_OBJECT_ID, (const u_char *) retval, retval_len);
                        }
                        break;
                    ...
                    case COLUMN_IPCIDRROUTENEXTHOPAS:
                        {
                            ...
                            retval = get_ipCidrRouteNextHopAS (data_context, &retval_len);
                            snmp_set_var_typed_value (var, ASN_INTEGER, (const u_char *) retval, retval_len);
                        }
                        break;
                    ...
                    case COLUMN_IPCIDRROUTEMETRIC1:
                        {
                            ...
                            retval = get_ipCidrRouteMetric1 (data_context, &retval_len);
                            snmp_set_var_typed_value (var, ASN_INTEGER, (const u_char *) retval, retval_len);
                        }
                        break;
                    ...
                    case COLUMN_IPCIDRROUTEMETRIC2:
                        {
                            ...
                            retval = get_ipCidrRouteMetric2 (data_context, &retval_len);
                            snmp_set_var_typed_value (var, ASN_INTEGER, (const u_char *) retval, retval_len);
                        }
                        break;
                    ...
                    case COLUMN_IPCIDRROUTEMETRIC3:
                        {
                            ...
                            retval = get_ipCidrRouteMetric3 (data_context, &retval_len);
                            snmp_set_var_typed_value (var, ASN_INTEGER, (const u_char *) retval, retval_len);
                        }
                        break;
                    ...
                    case COLUMN_IPCIDRROUTEMETRIC4:
                        {
                            ...
                            retval = get_ipCidrRouteMetric4 (data_context, &retval_len);
                            snmp_set_var_typed_value (var, ASN_INTEGER, (const u_char *) retval, retval_len);
                        }
                        break;
                    ...
                    case COLUMN_IPCIDRROUTEMETRIC5:
                        {
                            ...
                            retval = get_ipCidrRouteMetric5 (data_context, &retval_len);
                            snmp_set_var_typed_value (var, ASN_INTEGER, (const u_char *) retval, retval_len);
                        }
                        break;
                    ...
                    case COLUMN_IPCIDRROUTESTATUS:
                        {
                            ...
                            retval = get_ipCidrRouteStatus (data_context, &retval_len);
                            snmp_set_var_typed_value (var, ASN_INTEGER, (const u_char *) retval, retval_len);
                        }
                        break;
                    ...
                    default:
                        ...
                        snmp_log (LOG_ERR, "problem encountered in ipCidrRouteTable_handler: unknown column\n");
                }
                break;
            ...
            case MODE_SET_RESERVE1:
                ...
                switch (table_info->colnum)
                {
                    case COLUMN_IPCIDRROUTEIFINDEX:
                        {
                            int ret = check_ipCidrRouteIfIndex (request->requestvb->type,
                    ...
                    case COLUMN_IPCIDRROUTETYPE:
                        {
                            int ret = check_ipCidrRouteType (request->requestvb->type,
                                                             (long *) request->requestvb->val.string,
                                                             request->requestvb->val_len);
                    ...
                    case COLUMN_IPCIDRROUTEINFO:
                        {
                            int ret = check_ipCidrRouteInfo (request->requestvb->type,
                    ...
                    case COLUMN_IPCIDRROUTENEXTHOPAS:
                        {
                            int ret = check_ipCidrRouteNextHopAS (request->requestvb->type,
                                                                  (long *) request->requestvb->val.string,
                                                                  request->requestvb->val_len);
                    ...
                    case COLUMN_IPCIDRROUTEMETRIC1:
                        {
                            int ret = check_ipCidrRouteMetric1 (request->requestvb->type,
                                                                (long *) request->requestvb->val.string,
                                                                request->requestvb->val_len);
                    ...
                    case COLUMN_IPCIDRROUTEMETRIC2:
                        {
                            int ret = check_ipCidrRouteMetric2 (request->requestvb->type,
                                                                (long *) request->requestvb->val.string,
                                                                request->requestvb->val_len);
                    ...
                    case COLUMN_IPCIDRROUTEMETRIC3:
                        {
                            int ret = check_ipCidrRouteMetric3 (request->requestvb->type,
                                                                (long *) request->requestvb->val.string,
                                                                request->requestvb->val_len);
                    ...
                    case COLUMN_IPCIDRROUTEMETRIC4:
                        {
                            int ret = check_ipCidrRouteMetric4 (request->requestvb->type,
                                                                (long *) request->requestvb->val.string,
                                                                request->requestvb->val_len);
                    ...
                    case COLUMN_IPCIDRROUTEMETRIC5:
                        {
                            int ret = check_ipCidrRouteMetric5 (request->requestvb->type,
                                                                (long *) request->requestvb->val.string,
                                                                request->requestvb->val_len);
                    ...
                    case COLUMN_IPCIDRROUTESTATUS:
                        {
                            int ret = check_ipCidrRouteStatus (request->requestvb->type,
                                                               (long *) request->requestvb->val.string,
                                                               request->requestvb->val_len);
                    ...
                    case COLUMN_IPCIDRROUTEIFINDEX:
                        {
                            ...
                            if (retval)
                            {
                                ...
                                ui->len = retval_len;
                                memdup ((u_char **) & ui->ptr, (u_char *) retval, ui->len);
            ...
            case MODE_SET_ACTION:
                ...
                switch (table_info->colnum)
                {
                    case COLUMN_IPCIDRROUTEIFINDEX:
                        {
                            int ret = set_ipCidrRouteIfIndex (data_context,
                                                              (long *) request->requestvb->val.string,
                                                              request->requestvb->val_len);
                    ...
                    case COLUMN_IPCIDRROUTENEXTHOPAS:
                        {
                            int ret = set_ipCidrRouteNextHopAS (data_context,
                                                                (long *) request->requestvb->val.string,
                                                                request->requestvb->val_len);
                    ...
                    case COLUMN_IPCIDRROUTEMETRIC1:
                        {
                            int ret = set_ipCidrRouteMetric1 (data_context,
                                                              (long *) request->requestvb->val.string,
                                                              request->requestvb->val_len);
                    ...
                    case COLUMN_IPCIDRROUTEMETRIC2:
                        {
                            int ret = set_ipCidrRouteMetric2 (data_context,
                                                              (long *) request->requestvb->val.string,
                                                              request->requestvb->val_len);
                    ...
                    case COLUMN_IPCIDRROUTEMETRIC3:
                        {
                            int ret = set_ipCidrRouteMetric3 (data_context,
                                                              (long *) request->requestvb->val.string,
                                                              request->requestvb->val_len);
                    ...
                    case COLUMN_IPCIDRROUTEMETRIC4:
                        {
                            int ret = set_ipCidrRouteMetric4 (data_context,
                                                              (long *) request->requestvb->val.string,
                                                              request->requestvb->val_len);
                    ...
                    case COLUMN_IPCIDRROUTEMETRIC5:
                        {
                            int ret = set_ipCidrRouteMetric5 (data_context,
                                                              (long *) request->requestvb->val.string,
                                                              request->requestvb->val_len);
                    ...
                    case COLUMN_IPCIDRROUTESTATUS:
                        {
                            int ret = set_ipCidrRouteStatus (data_context,
                                                             (long *) request->requestvb->val.string,
                                                             request->requestvb->val_len);
                    ...
                    case COLUMN_IPCIDRROUTEIFINDEX:
                        {
                            ...
                            retval = set_ipCidrRouteIfIndex (data_context, ui->ptr, ui->len);
                            if (retval)
                            {
                    ...
                    case COLUMN_IPCIDRROUTETYPE:
                        {
                            ...
                            ui = netsnmp_oid_stash_get_data (undoStorage, suffix, suffix_len);
                            retval = set_ipCidrRouteType (data_context, ui->ptr, ui->len);
                            if (retval)
                            {
                                netsnmp_set_request_error (reqinfo, requests, SNMP_ERR_UNDOFAILED);
                            }
                    ...
                    case COLUMN_IPCIDRROUTEINFO:
                        {
                            ...
                            ui = netsnmp_oid_stash_get_data (undoStorage, suffix, suffix_len);
                            retval = set_ipCidrRouteInfo (data_context, ui->ptr, ui->len);
                            if (retval)
                            {
                                netsnmp_set_request_error (reqinfo, requests, SNMP_ERR_UNDOFAILED);
                            }
                    ...
                    case COLUMN_IPCIDRROUTENEXTHOPAS:
                        {
                            ...
                            ui = netsnmp_oid_stash_get_data (undoStorage, suffix, suffix_len);
                            retval = set_ipCidrRouteNextHopAS (data_context, ui->ptr, ui->len);
                            if (retval)
                            {
                                netsnmp_set_request_error (reqinfo, requests, SNMP_ERR_UNDOFAILED);
                            }
                    ...
                    case COLUMN_IPCIDRROUTEMETRIC1:
                        {
                            ...
                            ui = netsnmp_oid_stash_get_data (undoStorage, suffix, suffix_len);
                            retval = set_ipCidrRouteMetric1 (data_context, ui->ptr, ui->len);
                            if (retval)
                            {
                                netsnmp_set_request_error (reqinfo, requests, SNMP_ERR_UNDOFAILED);
                            }
                    ...
                    case COLUMN_IPCIDRROUTEMETRIC2:
                        {
                            ...
                            ui = netsnmp_oid_stash_get_data (undoStorage, suffix, suffix_len);
                            retval = set_ipCidrRouteMetric2 (data_context, ui->ptr, ui->len);
                            if (retval)
                            {
                                netsnmp_set_request_error (reqinfo, requests, SNMP_ERR_UNDOFAILED);
                            }
                    ...
                    case COLUMN_IPCIDRROUTEMETRIC3:
                        {
                            ...
                            ui = netsnmp_oid_stash_get_data (undoStorage, suffix, suffix_len);
                            retval = set_ipCidrRouteMetric3 (data_context, ui->ptr, ui->len);
                            if (retval)
                            {
                                netsnmp_set_request_error (reqinfo, requests, SNMP_ERR_UNDOFAILED);
                            }
                    ...
                    case COLUMN_IPCIDRROUTEMETRIC4:
                        {
                            ...
                            ui = netsnmp_oid_stash_get_data (undoStorage, suffix, suffix_len);
                            retval = set_ipCidrRouteMetric4 (data_context, ui->ptr, ui->len);
                            if (retval)
                            {
                                netsnmp_set_request_error (reqinfo, requests, SNMP_ERR_UNDOFAILED);
                            }
                    ...
                    case COLUMN_IPCIDRROUTEMETRIC5:
                        {
                            ...
                            ui = netsnmp_oid_stash_get_data (undoStorage, suffix, suffix_len);
                            retval = set_ipCidrRouteMetric5 (data_context, ui->ptr, ui->len);
                            if (retval)
                            {
                                netsnmp_set_request_error (reqinfo, requests, SNMP_ERR_UNDOFAILED);
                            }
                    ...
                    case COLUMN_IPCIDRROUTESTATUS:
                        {
                            ...
                            ui = netsnmp_oid_stash_get_data (undoStorage, suffix, suffix_len);
                            retval = set_ipCidrRouteStatus (data_context, ui->ptr, ui->len);
                            if (retval)
                            {
                                netsnmp_set_request_error (reqinfo, requests, SNMP_ERR_UNDOFAILED);
                            }
            ...
            default:
                snmp_log (LOG_ERR, "problem encountered in ipCidrRouteTable_handler: unsupported mode\n");
        }
    }
