     ...
     void initialize_table_nsTransactionTable (void)
{
     ...
     */
    my_handler = netsnmp_create_handler_registration ("nsTransactionTable", nsTransactionTable_handler,
     ...
     */
    DEBUGMSGTL (("initialize_table_nsTransactionTable", "Registering table nsTransactionTable as a table iterator\n"));
...
netsnmp_variable_list *nsTransactionTable_get_first_data_point (void **my_loop_context,
                                                                void **my_data_context,
                                                                netsnmp_variable_list
                                                                * put_index_data, netsnmp_iterator_info * iinfo)
{
    ...
    *my_data_context = (void *) agent_delegated_list;
    ...
    snmp_set_var_value (vptr,
                        (u_char *) & agent_delegated_list->pdu->transid, sizeof (agent_delegated_list->pdu->transid));
...
netsnmp_variable_list *nsTransactionTable_get_next_data_point (void **my_loop_context,
                                                               void **my_data_context,
                                                               netsnmp_variable_list
                                                               * put_index_data, netsnmp_iterator_info * iinfo)
{
    ...
    *my_data_context = (void *) alist;
    ...
    snmp_set_var_value (vptr, (u_char *) & alist->pdu->transid, sizeof (alist->pdu->transid));
    return put_index_data;
}
            ...
            case MODE_GET:
                switch (table_info->colnum)
                {
                    ...
                    case COLUMN_NSTRANSACTIONMODE:
                        snmp_set_var_typed_value (var, ASN_INTEGER, (u_char *) & asp->mode, sizeof (asp->mode));
                        break;
                    ...
                    default:
                         ...
                         */
                        snmp_log (LOG_ERR, "problem encountered in nsTransactionTable_handler: unknown column\n");
                }
                break;

            default:
                snmp_log (LOG_ERR, "problem encountered in nsTransactionTable_handler: unsupported mode\n");
        }
    }
