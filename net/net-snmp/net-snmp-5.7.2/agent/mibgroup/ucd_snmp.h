...
config_require (agent / extend) config_require (ucd - snmp / errormib) config_require (ucd - snmp / file)
...
config_require (ucd - snmp / vmstat) config_add_mib (UCD - SNMP - MIB) config_add_mib (UCD - DEMO - MIB)
