...
netsnmp_feature_require (ifTable_container_get) netsnmp_feature_require (ifTable_container_size)
 ...
 */
int ifXTable_rowreq_ctx_init (ifXTable_rowreq_ctx * rowreq_ctx, void *user_init_ctx)
{
 ...
 */
int ifName_get (ifXTable_rowreq_ctx * rowreq_ctx, char **ifName_val_ptr_ptr, size_t * ifName_val_ptr_len_ptr)
{
    size_t tmp_len;

   /** we should have a non-NULL pointer and enough storage */
    netsnmp_assert ((NULL != ifName_val_ptr_ptr) && (NULL != *ifName_val_ptr_ptr));
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ifInMulticastPkts_get (ifXTable_rowreq_ctx * rowreq_ctx, u_long * ifInMulticastPkts_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ifInBroadcastPkts_get (ifXTable_rowreq_ctx * rowreq_ctx, u_long * ifInBroadcastPkts_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ifOutMulticastPkts_get (ifXTable_rowreq_ctx * rowreq_ctx, u_long * ifOutMulticastPkts_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ifOutBroadcastPkts_get (ifXTable_rowreq_ctx * rowreq_ctx, u_long * ifOutBroadcastPkts_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ifHCInOctets_get (ifXTable_rowreq_ctx * rowreq_ctx, U64 * ifHCInOctets_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ifHCInUcastPkts_get (ifXTable_rowreq_ctx * rowreq_ctx, U64 * ifHCInUcastPkts_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ifHCInMulticastPkts_get (ifXTable_rowreq_ctx * rowreq_ctx, U64 * ifHCInMulticastPkts_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ifHCInBroadcastPkts_get (ifXTable_rowreq_ctx * rowreq_ctx, U64 * ifHCInBroadcastPkts_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ifHCOutOctets_get (ifXTable_rowreq_ctx * rowreq_ctx, U64 * ifHCOutOctets_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ifHCOutUcastPkts_get (ifXTable_rowreq_ctx * rowreq_ctx, U64 * ifHCOutUcastPkts_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ifHCOutMulticastPkts_get (ifXTable_rowreq_ctx * rowreq_ctx, U64 * ifHCOutMulticastPkts_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ifHCOutBroadcastPkts_get (ifXTable_rowreq_ctx * rowreq_ctx, U64 * ifHCOutBroadcastPkts_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ifLinkUpDownTrapEnable_get (ifXTable_rowreq_ctx * rowreq_ctx, u_long * ifLinkUpDownTrapEnable_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ifHighSpeed_get (ifXTable_rowreq_ctx * rowreq_ctx, u_long * ifHighSpeed_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ifPromiscuousMode_get (ifXTable_rowreq_ctx * rowreq_ctx, u_long * ifPromiscuousMode_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ifConnectorPresent_get (ifXTable_rowreq_ctx * rowreq_ctx, u_long * ifConnectorPresent_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    (*ifConnectorPresent_val_ptr) = rowreq_ctx->data.ifConnectorPresent ? TV_TRUE : TV_FALSE;
 ...
 *         in a pointer to static memory, obviously.)
 */
int ifAlias_get (ifXTable_rowreq_ctx * rowreq_ctx, char **ifAlias_val_ptr_ptr, size_t * ifAlias_val_ptr_len_ptr)
{

   /** we should have a non-NULL pointer and enough storage */
    netsnmp_assert ((NULL != ifAlias_val_ptr_ptr) && (NULL != *ifAlias_val_ptr_ptr));
        ...
        ((*ifAlias_val_ptr_len_ptr) < (rowreq_ctx->data.ifAlias_len * sizeof (rowreq_ctx->data.ifAlias[0]))))
    {
         ...
         */
        (*ifAlias_val_ptr_ptr) = (char *) malloc (rowreq_ctx->data.ifAlias_len * sizeof (rowreq_ctx->data.ifAlias[0]));
        if (NULL == (*ifAlias_val_ptr_ptr))
        {
            snmp_log (LOG_ERR, "could not allocate memory\n");
            return MFD_ERROR;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ifCounterDiscontinuityTime_get (ifXTable_rowreq_ctx * rowreq_ctx, u_long * ifCounterDiscontinuityTime_val_ptr)
{
