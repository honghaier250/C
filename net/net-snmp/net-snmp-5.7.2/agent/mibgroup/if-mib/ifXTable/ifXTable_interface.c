 ...
 */
void _ifXTable_initialize_interface (ifXTable_registration * reg_ptr, u_long flags)
{
    netsnmp_baby_steps_access_methods *access_multiplexer = &ifXTable_if_ctx.access_multiplexer;
     ...
     */
    DEBUGMSGTL (("ifXTable:init_ifXTable", "Registering ifXTable as a mibs-for-dummies table.\n"));
    handler = netsnmp_baby_steps_access_multiplexer_get (access_multiplexer);
    reginfo =
        netsnmp_handler_registration_create ("ifXTable", handler,
                                             ifXTable_oid, ifXTable_oid_size, HANDLER_CAN_BABY_STEP |
#if !(defined(NETSNMP_NO_WRITE_SUPPORT) || defined(NETSNMP_DISABLE_SET_SUPPORT))
                                             HANDLER_CAN_RWRITE
#else
                                             HANDLER_CAN_RONLY
     ...
     */
    handler =
        netsnmp_container_table_handler_get (tbl_info, ifXTable_if_ctx.container, TABLE_CONTAINER_KEY_NETSNMP_INDEX);
    netsnmp_inject_handler (reginfo, handler);
...
int ifXTable_index_to_oid (netsnmp_index * oid_idx, ifXTable_mib_index * mib_idx)
{
     ...
     * ifIndex(1)/InterfaceIndex/ASN_INTEGER/long(long)//l/A/w/e/R/d/H 
     */
    snmp_set_var_value (&var_ifIndex, (u_char *) & mib_idx->ifIndex, sizeof (mib_idx->ifIndex));


    err = build_oid_noalloc (oid_idx->oids, oid_idx->len, &oid_idx->len, NULL, 0, &var_ifIndex);
    if (err)
...
ifXTable_data *ifXTable_allocate_data (void)
{
    ...
    if (NULL == rtn)
    {
        snmp_log (LOG_ERR, "unable to malloc memory for new " "ifXTable_data.\n");
    }
                           ...
                           netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         */
        DEBUGMSGTL (("ifXTable", "error %d from " "ifXTable_pre_request\n", rc));
...
_mfd_ifXTable_post_request (netsnmp_mib_handler * handler,
                            ...
                            netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ifXTable_rowreq_ctx *rowreq_ctx = (ifXTable_rowreq_ctx *) netsnmp_container_table_row_extract (requests);
    ...
    if ((MFD_SUCCESS != packet_rc) && ifXTable_dirty_get ())
    {
         ...
         * the dirty flags.
         */
        snmp_log (LOG_WARNING, "ifXTable dirty flag set in post_request " "but status != SUCCESS.\n");
    }
...
_ifXTable_get_column (ifXTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
 ...
 */
NETSNMP_STATIC_INLINE int
_ifXTable_check_column (ifXTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    switch (column)
    {
        ...
        case COLUMN_IFHCOUTBROADCASTPKTS:
             ...
             */
        case COLUMN_IFLINKUPDOWNTRAPENABLE:
            rc = netsnmp_check_vb_type_and_size (var, ASN_INTEGER, sizeof (rowreq_ctx->data.ifLinkUpDownTrapEnable));
            /*
        ...
        case COLUMN_IFHIGHSPEED:
             ...
             */
        case COLUMN_IFPROMISCUOUSMODE:
            rc = netsnmp_check_vb_type_and_size (var, ASN_INTEGER, sizeof (rowreq_ctx->data.ifPromiscuousMode));
            /*
             * check that the value is one of defined enums 
             */
            if ((SNMPERR_SUCCESS == rc)
                && (*var->val.integer != TRUTHVALUE_TRUE) && (*var->val.integer != TRUTHVALUE_FALSE))
            {
                rc = SNMP_ERR_WRONGVALUE;
            }
            if (SNMPERR_SUCCESS != rc)
        ...
        case COLUMN_IFCONNECTORPRESENT:
             ...
             */
        case COLUMN_IFALIAS:
            rc = netsnmp_check_vb_type_and_max_size (var, ASN_OCTET_STR, sizeof (rowreq_ctx->data.ifAlias));
            /*
             * check defined range(s). 
             */
            if ((SNMPERR_SUCCESS == rc) && ((var->val_len < 0) || (var->val_len > 64)))
            {
                                  ...
                                  netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    DEBUGMSGTL (("internal:ifXTable:_mfd_ifXTable_check_dependencies", "called\n"));
    ...
    if (rc)
    {
        DEBUGMSGTL (("ifXTable:mfd", "error %d from " "ifXTable_check_dependencies\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
 ...
 */
NETSNMP_STATIC_INLINE int _ifXTable_undo_setup_column (ifXTable_rowreq_ctx * rowreq_ctx, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL (("internal:ifXTable:_ifXTable_undo_setup_column", "called for %d\n", column));
                          ...
                          netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("ifXTable:mfd", "error %d from " "ifXTable_undo_setup\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
    else
    {
        ...
        for (; requests; requests = requests->next)
        {
            ...
            if (MFD_SUCCESS != rc)
            {
                DEBUGMSGTL (("ifXTable:mfd", "error %d from " "ifXTable_undo_setup_column\n", rc));
                            ...
                            netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ifXTable:mfd", "error %d from " "ifXTable_undo_cleanup\n", rc));
    }
 ...
 */
NETSNMP_STATIC_INLINE int
_ifXTable_set_column (ifXTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL (("internal:ifXTable:_ifXTable_set_column", "called for %d\n", column));
                          ...
                          netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        if (MFD_SUCCESS != rc)
        {
            DEBUGMSGTL (("ifXTable:mfd", "error %d from " "ifXTable_set_column\n", rc));
            netsnmp_set_request_error (agtreq_info, requests, SNMP_VALIDATE_ERR (rc));
        }
    }                            /* for results */
                      ...
                      netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("ifXTable:mfd", "error %d from " "ifXTable_commit\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
                           ...
                           netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ifXTable:mfd", "error %d from " "ifXTable_undo_commit\n", rc));
    }
 ...
 */
NETSNMP_STATIC_INLINE int
_ifXTable_undo_column (ifXTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL (("internal:ifXTable:_ifXTable_undo_column", "called for %d\n", column));
                           ...
                           netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ifXTable:mfd", "error %d from " "ifXTable_undo\n", rc));
    }
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ifXTable_undo_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            /*
             * nothing we can do about it but log it
             */
            DEBUGMSGTL (("ifXTable:mfd", "error %d from " "ifXTable_undo_column\n", rc));
        }
    }                            /* for results */
...
static int _ifXTable_container_save_rows (int majorID, int minorID, void *serverarg, void *clientarg);

static void _ifXTable_container_row_restore (const char *token, char *buf);

static int _ifXTable_container_row_save (ifXTable_rowreq_ctx * rowreq_ctx, void *type);

static char *_ifXTable_container_col_restore (ifXTable_rowreq_ctx * rowreq_ctx, u_int col, char *buf);

static char *_ifXTable_container_col_save (ifXTable_rowreq_ctx * rowreq_ctx, u_int col, char *buf);
...
void ifXTable_container_init_persistence (netsnmp_container * container)
{
    ...
    register_config_handler (NULL, row_token, _ifXTable_container_row_restore, NULL, NULL);
    netsnmp_assert (container);
    memdup ((u_char **) & container_p, &container, sizeof (container));
    netsnmp_assert (container_p);
    rc = snmp_register_callback (SNMP_CALLBACK_LIBRARY,
                                 SNMP_CALLBACK_STORE_DATA, _ifXTable_container_save_rows, container_p);

    if (rc != SNMP_ERR_NOERROR)
        snmp_log (LOG_ERR, "error registering for STORE_DATA callback " "in _ifXTable_container_init_persistence\n");
}
...
#define MAX_ROW_SIZE (sizeof(row_token) + 1 +  \
    ...
    if (NULL == pos)
    {
        snmp_log (LOG_ERR, "error saving ifXTable row " "to persistent file\n");
        return SNMP_ERR_GENERR;
    }
    *pos++ = ' ';
    if (pos > max)
    {
        snmp_log (LOG_ERR, "error saving ifXTable row " "to persistent file (too long)\n");
        return SNMP_ERR_GENERR;
    }
    ...
    DEBUGMSGTL (("internal:ifXTable:_ifXTable_container_row_save", "saving line '%s'\n", buf));
...
static void _ifXTable_container_row_restore (const char *token, char *buf)
{
    ...
    DEBUGMSGTL (("internal:ifXTable:_ifXTable_container_row_restore", "parsing line '%s'\n", buf));
    ...
    if (NULL == buf)
    {
        snmp_log (LOG_ERR, "error reading row index in " "_ifXTable_container_row_restore\n");
        return;
    }
    rowreq_ctx = (ifXTable_rowreq_ctx *) CONTAINER_FIND (container, &index);
    if (NULL == rowreq_ctx)
    {
        snmp_log (LOG_DEBUG, "error finding row index in " "_ifXTable_container_row_restore\n");
        return;
    }
    ...
    while ((NULL != buf) && isdigit (*buf & 0xFF))
    {
         ...
         * parse value
         */
        DEBUGMSGTL (("_ifXTable_container_row_restore", "parsing column %d\n", col));
    ...
    DEBUGMSGTL (("internal:ifXTable:_ifXTable_container_row_restore", "inserting row\n"));
}
...
static char *_ifXTable_container_col_save (ifXTable_rowreq_ctx * rowreq_ctx, u_int col, char *buf)
{
    ...
    {
        snmp_log (LOG_ERR, "bad parameter in " "_ifXTable_container_col_save\n");
        return NULL;
    }

    DEBUGMSGTL (("internal:ifXTable:_ifXTable_container_col_save", "processing column %d\n", col));
    ...
    switch (col)
    {
        ...
        case COLUMN_IFALIAS:
            ...
            buf = read_config_save_octet_string (buf,
                                                 (u_char *) rowreq_ctx->data.ifAlias, rowreq_ctx->data.ifAlias_len);
            break;

        default:

            /** We shouldn't get here */
            snmp_log (LOG_ERR, "unknown column %d in " "_ifXTable_container_col_save\n", col);
            return NULL;
    }
...
static char *_ifXTable_container_col_restore (ifXTable_rowreq_ctx * rowreq_ctx, u_int col, char *buf)
{
    ...
    if ((NULL == rowreq_ctx) || (NULL == buf))
    {
        snmp_log (LOG_ERR, "bad parameter in " "_ifXTable_container_col_restore\n");
        return NULL;
    }

    DEBUGMSGTL (("verbose:ifXTable:_ifXTable_container_col_restore", "processing column %d\n", col));
    ...
    switch (col)
    {
        ...
        case COLUMN_IFLINKUPDOWNTRAPENABLE:
            ...
            buf = read_config_read_memory (ASN_INTEGER, buf, (char *) &rowreq_ctx->data.ifLinkUpDownTrapEnable, &len);
            break;
        ...
        default:
            ...
            /** We shouldn't get here */
            snmp_log (LOG_ERR, "unknown column %d in " "_ifXTable_container_col_restore\n", col);
            return NULL;
    }
