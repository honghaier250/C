...
{
    netsnmp_baby_steps_access_methods *access_multiplexer = &ifTable_if_ctx.access_multiplexer;
     ...
     */
    DEBUGMSGTL (("ifTable:init_ifTable", "Registering ifTable as a mibs-for-dummies table.\n"));
    handler = netsnmp_baby_steps_access_multiplexer_get (access_multiplexer);
    reginfo =
        netsnmp_handler_registration_create ("ifTable", handler, ifTable_oid, ifTable_oid_size, HANDLER_CAN_BABY_STEP |
#if !(defined(NETSNMP_NO_WRITE_SUPPORT) || defined(NETSNMP_DISABLE_SET_SUPPORT))
                                             HANDLER_CAN_RWRITE
#else
                                             HANDLER_CAN_RONLY
     ...
     */
    handler =
        netsnmp_container_table_handler_get (tbl_info, ifTable_if_ctx.container, TABLE_CONTAINER_KEY_NETSNMP_INDEX);
    netsnmp_inject_handler (reginfo, handler);
...
ifTable_data *ifTable_allocate_data (void)
{
    ...
    if (NULL == rtn)
    {
        snmp_log (LOG_ERR, "unable to malloc memory for new " "ifTable_data.\n");
    }
...
ifTable_rowreq_ctx *ifTable_allocate_rowreq_ctx (void *user_init_ctx)
{
    ...
    if (NULL == rowreq_ctx)
    {
        snmp_log (LOG_ERR, "Couldn't allocate memory for a " "ifTable_rowreq_ctx.\n");
        return NULL;
    }
    ...
    {
        if (SNMPERR_SUCCESS != ifTable_rowreq_ctx_init (rowreq_ctx, user_init_ctx))
        {
                          ...
                          netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         */
        DEBUGMSGTL (("ifTable", "error %d from " "ifTable_pre_request\n", rc));
...
_mfd_ifTable_post_request (netsnmp_mib_handler * handler,
                           ...
                           netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ifTable_rowreq_ctx *rowreq_ctx = (ifTable_rowreq_ctx *) netsnmp_container_table_row_extract (requests);
    ...
    if ((MFD_SUCCESS != packet_rc) && ifTable_dirty_get ())
    {
         ...
         * the dirty flags.
         */
        snmp_log (LOG_WARNING, "ifTable dirty flag set in post_request " "but status != SUCCESS.\n");
    }
 ...
 */
NETSNMP_STATIC_INLINE int _ifTable_get_column (ifTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
...
_ifTable_check_column (ifTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL (("internal:ifTable:_ifTable_check_column", "called for %d\n", column));
    ...
    switch (column)
    {
         ...
         ** will ensure that there is no data overflow. */
            ...
            if ((SNMPERR_SUCCESS == rc)
                ...
                && (*var->val.integer != IFADMINSTATUS_DOWN) && (*var->val.integer != IFADMINSTATUS_TESTING))
            {
                                 ...
                                 netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    DEBUGMSGTL (("internal:ifTable:_mfd_ifTable_check_dependencies", "called\n"));
    ...
    if (rc)
    {
        DEBUGMSGTL (("ifTable:mfd", "error %d from " "ifTable_check_dependencies\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
 ...
 */
NETSNMP_STATIC_INLINE int _ifTable_undo_setup_column (ifTable_rowreq_ctx * rowreq_ctx, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL (("internal:ifTable:_ifTable_undo_setup_column", "called for %d\n", column));
    ...
    if (NULL == rowreq_ctx->undo)
    {
        ...
        else
        {
            rowreq_ctx->undo->ifentry =
                netsnmp_access_interface_entry_create (rowreq_ctx->data.ifentry->name, rowreq_ctx->data.ifentry->index);
            ...
            {
                netsnmp_access_interface_entry_copy (rowreq_ctx->undo->ifentry, rowreq_ctx->data.ifentry);
                         ...
                         netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("ifTable:mfd", "error %d from " "ifTable_undo_setup\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
    else
    {
        ...
        for (; requests; requests = requests->next)
        {
            ...
            if (MFD_SUCCESS != rc)
            {
                DEBUGMSGTL (("ifTable:mfd", "error %d from " "ifTable_undo_setup_column\n", rc));
                           ...
                           netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ifTable:mfd", "error %d from " "ifTable_undo_cleanup\n", rc));
    }
 ...
 * Set the value for a particular column
 */
NETSNMP_STATIC_INLINE int _ifTable_set_column (ifTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL (("internal:ifTable:_ifTable_set_column", "called for %d\n", column));
                         ...
                         netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        if (MFD_SUCCESS != rc)
        {
            DEBUGMSGTL (("ifTable:mfd", "error %d from " "ifTable_set_column\n", rc));
            netsnmp_set_request_error (agtreq_info, requests, SNMP_VALIDATE_ERR (rc));
        }
    }                            /* for results */
                     ...
                     netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("ifTable:mfd", "error %d from " "ifTable_commit\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
                          ...
                          netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ifTable:mfd", "error %d from " "ifTable_undo_commit\n", rc));
    }
 ...
 */
NETSNMP_STATIC_INLINE int
_ifTable_undo_column (ifTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL (("internal:ifTable:_ifTable_undo_column", "called for %d\n", column));
                          ...
                          netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        if (MFD_SUCCESS != rc)
        {
             ...
             * nothing we can do about it but log it
             */
            DEBUGMSGTL (("ifTable:mfd", "error %d from " "ifTable_undo_column\n", rc));
        }
    }                            /* for results */
...
void _ifTable_container_init (ifTable_interface_ctx * if_ctx)
{
    ...
    if_ctx->cache = netsnmp_cache_create (30,    /* timeout in seconds */
                                          _cache_load, _cache_free, ifTable_oid, ifTable_oid_size);
    ...
    if (NULL == if_ctx->container)
    {
        snmp_log (LOG_ERR, "error creating container in " "ifTable_container_init\n");
        return;
    }
