...
netsnmp_feature_require (table_build_result) netsnmp_feature_require (table_dataset)
...
void init_testhandler (void)
{
    ...
    netsnmp_register_instance (netsnmp_create_handler_registration
                               ("myInstance", my_test_instance_handler, my_instance_oid, 5, HANDLER_CAN_RWRITE));

    netsnmp_register_ulong_instance ("myulong", my_data_ulong_instance, 4, &my_ulong, NULL);
    ...
    my_test = netsnmp_create_handler_registration ("myTable",
                                                   my_test_table_handler, my_table_oid, 4, HANDLER_CAN_RONLY);
    if (!my_test)
        return;
    ...
    netsnmp_table_row_add_index (row, ASN_OCTET_STR, "partridge", strlen ("partridge"));
    ...
    ind1 = 2;
    netsnmp_table_row_add_index (row, ASN_INTEGER, &ind1, sizeof (ind1));
    netsnmp_table_row_add_index (row, ASN_OCTET_STR, "turtle", strlen ("turtle"));
    row->data = (void *) "doves";
    netsnmp_table_data_add_row (table, row);
    ...
    netsnmp_register_read_only_table_data
        (netsnmp_create_handler_registration
         ("12days", my_data_table_handler, my_data_table_oid, 4, HANDLER_CAN_RONLY), table, table_info);
                 ...
                 netsnmp_agent_request_info * reqinfo, netsnmp_request_info * requests)
{
    ...
    while (requests)
    {
        ...
        {
            case MODE_GET:
                if (netsnmp_oid_equals (var->name, var->name_length, myoid1, 6) == 0)
                {
                    snmp_set_var_typed_value (var, ASN_INTEGER, (u_char *) & accesses, sizeof (accesses));
                    return SNMP_ERR_NOERROR;
                }
                break;

            case MODE_GETNEXT:
                if (snmp_oid_compare (var->name, var->name_length, myoid1, 6) < 0)
                {
                       ...
                       netsnmp_agent_request_info * reqinfo, netsnmp_request_info * requests)
{
    ...
    netsnmp_table_registration_info * handler_reg_info = (netsnmp_table_registration_info *) handler->prev->myvoid;
                ...
                if (x <= MAX_COLONE)
                {
                    ...
                    *(table_info->indexes->next_variable->val.integer) = y;
                    netsnmp_table_build_result (reginfo, requests,
                                                table_info, ASN_INTEGER, (u_char *) & result, sizeof (result));
                }
            ...
            case MODE_GET:
                ...
                {                /* valid request if ASN_NULL */
                    ...
                    if (table_info->colnum == RESULT_COLUMN &&
                        ...
                        *(table_info->indexes->next_variable->val.integer) <= MAX_COLTWO)
                    {
                        ...
                        snmp_set_var_typed_value (var, ASN_INTEGER, (u_char *) & result, sizeof (result));
                    }
                }
                break;
                          ...
                          netsnmp_agent_request_info * reqinfo, netsnmp_request_info * requests)
{
    ...
    {
        case MODE_GET:
            snmp_set_var_typed_value (requests->requestvb, ASN_UNSIGNED, (u_char *) & accesses, sizeof (accesses));
            break;
        ...
        case MODE_SET_RESERVE2:
             ...
             */
            memdup ((u_char **) & accesses_cache, (u_char *) & accesses, sizeof (accesses));
            ...
            netsnmp_request_add_list_data (requests,
                                           netsnmp_create_data_list (TESTHANDLER_SET_NAME, accesses_cache, free));
            break;
        ...
        case MODE_SET_UNDO:
            accesses = *((u_long *) netsnmp_request_get_list_data (requests, TESTHANDLER_SET_NAME));
            break;
                       ...
                       netsnmp_agent_request_info * reqinfo, netsnmp_request_info * requests)
{
    ...
    while (requests)
    {
        ...
        netsnmp_table_data_build_result (reginfo, reqinfo, requests, row,
                                         table_info->colnum, ASN_OCTET_STR, column3, strlen (column3));
        requests = requests->next;
    }
    return SNMP_ERR_NOERROR;
}
