 ...
 */
int inetCidrRouteTable_init_data (inetCidrRouteTable_registration * inetCidrRouteTable_reg)
{
    DEBUGMSGTL (("verbose:inetCidrRouteTable:inetCidrRouteTable_init_data", "called\n"));
 ...
 */
void inetCidrRouteTable_container_init (netsnmp_container ** container_ptr_ptr, netsnmp_cache * cache)
{
    DEBUGMSGTL (("verbose:inetCidrRouteTable:inetCidrRouteTable_container_init", "called\n"));

    if (NULL == container_ptr_ptr)
    {
        snmp_log (LOG_ERR, "bad container param to inetCidrRouteTable_container_init\n");
        return;
    }
    ...
    *container_ptr_ptr = NULL;
    ...
    if (NULL == cache)
    {
        snmp_log (LOG_ERR, "bad cache param to inetCidrRouteTable_container_init\n");
        return;
    }
...
static void _snarf_route_entry (netsnmp_route_entry * route_entry, netsnmp_container * container)
{
    ...
    if ((NULL != rowreq_ctx) &&
        (MFD_SUCCESS == inetCidrRouteTable_indexes_set
         (rowreq_ctx, route_entry->rt_dest_type,
          ...
          route_entry->rt_nexthop_type, (char *) route_entry->rt_nexthop, route_entry->rt_nexthop_len)))
    {
    ...
    else
    {
        if (rowreq_ctx)
        {
            snmp_log (LOG_ERR, "error setting index while loading " "inetCidrRoute cache.\n");
...
void inetCidrRouteTable_container_shutdown (netsnmp_container * container_ptr)
{
    ...
    {
        snmp_log (LOG_ERR, "bad params to inetCidrRouteTable_container_shutdown\n");
        return;
    }
...
int inetCidrRouteTable_container_load (netsnmp_container * container)
{
     ...
     */
    CONTAINER_FOR_EACH (route_container, (netsnmp_container_obj_func *) _snarf_route_entry, container);

    /*
     * free the container. we've either claimed each ifentry, or released it,
     * so the dal function doesn't need to clear the container.
     */
    netsnmp_access_route_container_free (route_container, NETSNMP_ACCESS_ROUTE_FREE_DONT_CLEAR);
...
{
    DEBUGMSGTL (("verbose:inetCidrRouteTable:inetCidrRouteTable_row_prep", "called\n"));
    ...
    if (MFD_ROW_CREATED & rowreq_ctx->rowreq_flags)
    {
        memcpy (rowreq_ctx->data->rt_dest,
                rowreq_ctx->tbl_idx.inetCidrRouteDest, rowreq_ctx->tbl_idx.inetCidrRouteDest_len);
        ...
        memcpy (rowreq_ctx->data->rt_nexthop,
                rowreq_ctx->tbl_idx.inetCidrRouteNextHop, rowreq_ctx->tbl_idx.inetCidrRouteNextHop_len);
...
{
    DEBUGMSGTL (("verbose:inetCidrRouteTable:inetCidrRouteDest_check_index", "called\n"));
 ...
 * If there a no other checks you need to do, simply return MFD_SUCCESS.
 */
int inetCidrRouteNextHopType_check_index (inetCidrRouteTable_rowreq_ctx * rowreq_ctx)
{
...
inetCidrRouteTable_validate_index (inetCidrRouteTable_registration *
                                   inetCidrRouteTable_reg, inetCidrRouteTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;
    ...
    {
        DEBUGMSGTL (("inetCidrRouteTable:validate_index", "ipv4/v6 cross routing not supported\n"));
    ...
    if (((INETADDRESSTYPE_IPV4 ==
        ...
        ((INETADDRESSTYPE_IPV6 ==
          rowreq_ctx->tbl_idx.inetCidrRouteDestType) && (16 != rowreq_ctx->tbl_idx.inetCidrRouteDest_len)))
    {
        DEBUGMSGTL (("inetCidrRouteTable:validate_index", "dest addr type/size mismatch\n"));
        return MFD_CANNOT_CREATE_EVER;
    }
    /*
     * InetAddress
    ...
    if (((INETADDRESSTYPE_IPV4 ==
        ...
        ||
        ((INETADDRESSTYPE_IPV6 ==
          rowreq_ctx->tbl_idx.inetCidrRouteNextHopType) && (16 != rowreq_ctx->tbl_idx.inetCidrRouteNextHop_len)))
    {
        DEBUGMSGTL (("inetCidrRouteTable:validate_index", "next hop addr type/size mismatch\n"));
        return MFD_CANNOT_CREATE_EVER;
    }
