 ...
 */
     ...
     static void _inetCidrRouteTable_container_init (inetCidrRouteTable_interface_ctx * if_ctx);

     static void _inetCidrRouteTable_container_shutdown (inetCidrRouteTable_interface_ctx * if_ctx);
...
inetCidrRouteTable_registration *inetCidrRouteTable_registration_set (inetCidrRouteTable_registration * newreg)
{
...
NETSNMP_STATIC_INLINE int _inetCidrRouteTable_check_indexes (inetCidrRouteTable_rowreq_ctx * rowreq_ctx);
 ...
 */
void _inetCidrRouteTable_initialize_interface (inetCidrRouteTable_registration * reg_ptr, u_long flags)
{
    netsnmp_baby_steps_access_methods *access_multiplexer = &inetCidrRouteTable_if_ctx.access_multiplexer;

    netsnmp_table_registration_info *tbl_info = &inetCidrRouteTable_if_ctx.tbl_info;
    ...
    {
        snmp_log (LOG_ERR, "could not initialize container for inetCidrRouteTable\n");
        return;
    }
    ...
    reginfo =
        netsnmp_handler_registration_create ("inetCidrRouteTable", handler,
                                             inetCidrRouteTable_oid, inetCidrRouteTable_oid_size, HANDLER_CAN_BABY_STEP
    ...
    handler =
        netsnmp_container_table_handler_get (tbl_info,
                                             inetCidrRouteTable_if_ctx.container, TABLE_CONTAINER_KEY_NETSNMP_INDEX);
    netsnmp_inject_handler (reginfo, handler);
 ...
 */
void _inetCidrRouteTable_shutdown_interface (inetCidrRouteTable_registration * reg_ptr)
{
    /*
 ...
 */
int inetCidrRouteTable_index_to_oid (netsnmp_index * oid_idx, inetCidrRouteTable_mib_index * mib_idx)
{
    ...
    memset (&var_inetCidrRouteNextHopType, 0x00, sizeof (var_inetCidrRouteNextHopType));
    ...
    snmp_set_var_value (&var_inetCidrRouteDestType,
                        (u_char *) & mib_idx->inetCidrRouteDestType, sizeof (mib_idx->inetCidrRouteDestType));
    ...
    snmp_set_var_value (&var_inetCidrRoutePfxLen,
                        (u_char *) & mib_idx->inetCidrRoutePfxLen, sizeof (mib_idx->inetCidrRoutePfxLen));
    ...
    snmp_set_var_value (&var_inetCidrRouteNextHopType,
                        (u_char *) & mib_idx->inetCidrRouteNextHopType, sizeof (mib_idx->inetCidrRouteNextHopType));
    ...
    err = build_oid_noalloc (oid_idx->oids, oid_idx->len, &oid_idx->len, NULL, 0, &var_inetCidrRouteDestType);
    if (err)
 ...
 */
int inetCidrRouteTable_index_from_oid (netsnmp_index * oid_idx, inetCidrRouteTable_mib_index * mib_idx)
{
    int err = SNMP_ERR_NOERROR;
     ...
     */
    err = parse_oid_indexes (oid_idx->oids, oid_idx->len, &var_inetCidrRouteDestType);
    if (err == SNMP_ERR_NOERROR)
    {
        ...
        {
            memcpy (mib_idx->inetCidrRouteDest, var_inetCidrRouteDest.val.string, var_inetCidrRouteDest.val_len);
            mib_idx->inetCidrRouteDest_len = var_inetCidrRouteDest.val_len / sizeof (mib_idx->inetCidrRouteDest[0]);
        }
         ...
         */
        if (var_inetCidrRoutePolicy.val_len > sizeof (mib_idx->inetCidrRoutePolicy))
            err = SNMP_ERR_GENERR;
        else
        {
            memcpy (mib_idx->inetCidrRoutePolicy, var_inetCidrRoutePolicy.val.string, var_inetCidrRoutePolicy.val_len);
            mib_idx->inetCidrRoutePolicy_len =
                var_inetCidrRoutePolicy.val_len / sizeof (mib_idx->inetCidrRoutePolicy[0]);
        }
         ...
         */
        if (var_inetCidrRouteNextHop.val_len > sizeof (mib_idx->inetCidrRouteNextHop))
            err = SNMP_ERR_GENERR;
        else
        {
            memcpy (mib_idx->inetCidrRouteNextHop,
                    var_inetCidrRouteNextHop.val.string, var_inetCidrRouteNextHop.val_len);
            mib_idx->inetCidrRouteNextHop_len =
                var_inetCidrRouteNextHop.val_len / sizeof (mib_idx->inetCidrRouteNextHop[0]);
        }
 ...
 */
inetCidrRouteTable_rowreq_ctx *inetCidrRouteTable_allocate_rowreq_ctx (inetCidrRouteTable_data * data,
                                                                       void *user_init_ctx)
{
    inetCidrRouteTable_rowreq_ctx *rowreq_ctx = SNMP_MALLOC_TYPEDEF (inetCidrRouteTable_rowreq_ctx);

    DEBUGMSGTL (("internal:inetCidrRouteTable:inetCidrRouteTable_allocate_rowreq_ctx", "called\n"));

    if (NULL == rowreq_ctx)
    {
        snmp_log (LOG_ERR, "Couldn't allocate memory for a " "inetCidrRouteTable_rowreq_ctx.\n");
        return NULL;
    }
    else
    {
    ...
    {
        if (SNMPERR_SUCCESS != inetCidrRouteTable_rowreq_ctx_init (rowreq_ctx, user_init_ctx))
        {
 ...
 */
void inetCidrRouteTable_release_rowreq_ctx (inetCidrRouteTable_rowreq_ctx * rowreq_ctx)
{
                                     ...
                                     netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    {
        DEBUGMSGTL (("internal:inetCidrRouteTable", "skipping additional pre_request\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         */
        DEBUGMSGTL (("inetCidrRouteTable", "error %d from " "inetCidrRouteTable_pre_request\n", rc));
                                      ...
                                      netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    {
        DEBUGMSGTL (("internal:inetCidrRouteTable", "waiting for last post_request\n"));
        return SNMP_ERR_NOERROR;
    }
    ...
    if ((MFD_SUCCESS != packet_rc) && inetCidrRouteTable_dirty_get ())
    {
         ...
         * the dirty flags.
         */
        snmp_log (LOG_WARNING, "inetCidrRouteTable dirty flag set in post_request " "but status != SUCCESS.\n");
    }
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("inetCidrRouteTable", "error %d from " "inetCidrRouteTable_post_request\n", rc));
    }
 ...
 * wrapper
 */
static inetCidrRouteTable_rowreq_ctx *_mfd_inetCidrRouteTable_rowreq_from_index (netsnmp_index * oid_idx, int *rc_ptr)
{
...
_inetCidrRouteTable_get_column (inetCidrRouteTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    ...
    switch (column)
    {
        ...
        case COLUMN_INETCIDRROUTENEXTHOPAS:
            ...
            rc = inetCidrRouteNextHopAS_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        default:
            snmp_log (LOG_ERR, "unknown column %d in _inetCidrRouteTable_get_column\n", column);
            break;
    }
                                    ...
                                    netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _inetCidrRouteTable_get_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            if (MFD_SKIP == rc)
            {
...
NETSNMP_STATIC_INLINE int _inetCidrRouteTable_check_indexes (inetCidrRouteTable_rowreq_ctx * rowreq_ctx)
{
    ...
    if ((SNMPERR_SUCCESS == rc)
        ...
        && (rowreq_ctx->tbl_idx.inetCidrRouteDestType !=
            INETADDRESSTYPE_IPV6Z) && (rowreq_ctx->tbl_idx.inetCidrRouteDestType != INETADDRESSTYPE_DNS))
    {
     ...
     */
    if ((SNMPERR_SUCCESS == rc)
        && ((rowreq_ctx->tbl_idx.inetCidrRouteDest_len < 0) || (rowreq_ctx->tbl_idx.inetCidrRouteDest_len > 255)))
    {
     ...
     */
    if ((SNMPERR_SUCCESS == rc)
        && ((rowreq_ctx->tbl_idx.inetCidrRoutePfxLen < 0) || (rowreq_ctx->tbl_idx.inetCidrRoutePfxLen > 2040)))
    {
        rc = SNMP_ERR_WRONGVALUE;
    }
    if (MFD_SUCCESS != rc)
    ...
    if ((SNMPERR_SUCCESS == rc)
        ...
        && (rowreq_ctx->tbl_idx.inetCidrRouteNextHopType !=
            INETADDRESSTYPE_IPV4Z)
        && (rowreq_ctx->tbl_idx.inetCidrRouteNextHopType !=
            INETADDRESSTYPE_IPV6Z) && (rowreq_ctx->tbl_idx.inetCidrRouteNextHopType != INETADDRESSTYPE_DNS))
    {
        rc = SNMP_ERR_WRONGVALUE;
    }
    if (MFD_SUCCESS != rc)
     ...
     */
    if ((SNMPERR_SUCCESS == rc)
        && ((rowreq_ctx->tbl_idx.inetCidrRouteNextHop_len < 0) || (rowreq_ctx->tbl_idx.inetCidrRouteNextHop_len > 255)))
    {
        rc = SNMP_ERR_WRONGLENGTH;
    }
    if (MFD_SUCCESS != rc)
 ...
 */
NETSNMP_STATIC_INLINE int
_inetCidrRouteTable_check_column (inetCidrRouteTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    switch (column)
    {
        ...
        case COLUMN_INETCIDRROUTEIFINDEX:
             ...
             * check defined range(s). 
             */
            if ((SNMPERR_SUCCESS == rc) && ((*var->val.integer < 0) || (*var->val.integer > 2147483647)))
            {
                rc = SNMP_ERR_WRONGVALUE;
            }
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("inetCidrRouteTable:_inetCidrRouteTable_check_column:inetCidrRouteIfIndex",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = inetCidrRouteIfIndex_check_value (rowreq_ctx, *((long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from inetCidrRouteIfIndex_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_INETCIDRROUTETYPE:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("inetCidrRouteTable:_inetCidrRouteTable_check_column:inetCidrRouteType",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = inetCidrRouteType_check_value (rowreq_ctx, *((u_long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from inetCidrRouteType_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_INETCIDRROUTENEXTHOPAS:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("inetCidrRouteTable:_inetCidrRouteTable_check_column:inetCidrRouteNextHopAS",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = inetCidrRouteNextHopAS_check_value (rowreq_ctx, *((u_long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from inetCidrRouteNextHopAS_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_INETCIDRROUTEMETRIC1:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("inetCidrRouteTable:_inetCidrRouteTable_check_column:inetCidrRouteMetric1",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = inetCidrRouteMetric1_check_value (rowreq_ctx, *((long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from inetCidrRouteMetric1_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_INETCIDRROUTEMETRIC2:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("inetCidrRouteTable:_inetCidrRouteTable_check_column:inetCidrRouteMetric2",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = inetCidrRouteMetric2_check_value (rowreq_ctx, *((long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from inetCidrRouteMetric2_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_INETCIDRROUTEMETRIC3:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("inetCidrRouteTable:_inetCidrRouteTable_check_column:inetCidrRouteMetric3",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = inetCidrRouteMetric3_check_value (rowreq_ctx, *((long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from inetCidrRouteMetric3_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_INETCIDRROUTEMETRIC4:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("inetCidrRouteTable:_inetCidrRouteTable_check_column:inetCidrRouteMetric4",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = inetCidrRouteMetric4_check_value (rowreq_ctx, *((long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from inetCidrRouteMetric4_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_INETCIDRROUTEMETRIC5:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("inetCidrRouteTable:_inetCidrRouteTable_check_column:inetCidrRouteMetric5",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = inetCidrRouteMetric5_check_value (rowreq_ctx, *((long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from inetCidrRouteMetric5_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_INETCIDRROUTESTATUS:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("inetCidrRouteTable:_inetCidrRouteTable_check_column:inetCidrRouteStatus",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = inetCidrRouteStatus_check_value (rowreq_ctx, *((u_long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from inetCidrRouteStatus_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        default:
            ...
            rc = SNMP_ERR_GENERR;
            snmp_log (LOG_ERR, "unknown column %d in _inetCidrRouteTable_check_column\n", column);
    }
                                       ...
                                       * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _inetCidrRouteTable_check_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            netsnmp_request_set_error (requests, SNMP_VALIDATE_ERR (rc));
            break;
                                            ...
                                            * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (rc)
    {
        DEBUGMSGTL (("inetCidrRouteTable:mfd", "error %d from " "inetCidrRouteTable_check_dependencies\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
 ...
 */
NETSNMP_STATIC_INLINE int _inetCidrRouteTable_undo_setup_column (inetCidrRouteTable_rowreq_ctx * rowreq_ctx, int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    switch (column)
    {
        ...
        default:
            snmp_log (LOG_ERR, "unknown column %d in _inetCidrRouteTable_undo_setup_column\n", column);
            break;
    }
                                    ...
                                    netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("inetCidrRouteTable:mfd", "error %d from " "inetCidrRouteTable_undo_setup\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
    else
    {
        ...
        for (; requests; requests = requests->next)
        {
            ...
            if (MFD_SUCCESS != rc)
            {
                DEBUGMSGTL (("inetCidrRouteTable:mfd", "error %d from " "inetCidrRouteTable_undo_setup_column\n", rc));
                                      ...
                                      netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("inetCidrRouteTable:mfd", "error %d from " "inetCidrRouteTable_undo_cleanup\n", rc));
    }
 ...
 */
NETSNMP_STATIC_INLINE int
_inetCidrRouteTable_set_column (inetCidrRouteTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    switch (column)
    {
        ...
        case COLUMN_INETCIDRROUTEIFINDEX:
            rowreq_ctx->column_set_flags |= COLUMN_INETCIDRROUTEIFINDEX_FLAG;
            rc = inetCidrRouteIfIndex_set (rowreq_ctx, *((long *) var->val.string));
            break;
        ...
        case COLUMN_INETCIDRROUTENEXTHOPAS:
            rowreq_ctx->column_set_flags |= COLUMN_INETCIDRROUTENEXTHOPAS_FLAG;
            rc = inetCidrRouteNextHopAS_set (rowreq_ctx, *((u_long *) var->val.string));
            break;
        ...
        case COLUMN_INETCIDRROUTEMETRIC1:
            rowreq_ctx->column_set_flags |= COLUMN_INETCIDRROUTEMETRIC1_FLAG;
            rc = inetCidrRouteMetric1_set (rowreq_ctx, *((long *) var->val.string));
            break;
        ...
        case COLUMN_INETCIDRROUTEMETRIC2:
            rowreq_ctx->column_set_flags |= COLUMN_INETCIDRROUTEMETRIC2_FLAG;
            rc = inetCidrRouteMetric2_set (rowreq_ctx, *((long *) var->val.string));
            break;
        ...
        case COLUMN_INETCIDRROUTEMETRIC3:
            rowreq_ctx->column_set_flags |= COLUMN_INETCIDRROUTEMETRIC3_FLAG;
            rc = inetCidrRouteMetric3_set (rowreq_ctx, *((long *) var->val.string));
            break;
        ...
        case COLUMN_INETCIDRROUTEMETRIC4:
            rowreq_ctx->column_set_flags |= COLUMN_INETCIDRROUTEMETRIC4_FLAG;
            rc = inetCidrRouteMetric4_set (rowreq_ctx, *((long *) var->val.string));
            break;
        ...
        case COLUMN_INETCIDRROUTEMETRIC5:
            rowreq_ctx->column_set_flags |= COLUMN_INETCIDRROUTEMETRIC5_FLAG;
            rc = inetCidrRouteMetric5_set (rowreq_ctx, *((long *) var->val.string));
            break;
        ...
        case COLUMN_INETCIDRROUTESTATUS:
            rowreq_ctx->column_set_flags |= COLUMN_INETCIDRROUTESTATUS_FLAG;
            rc = inetCidrRouteStatus_set (rowreq_ctx, *((u_long *) var->val.string));
            break;

        default:
            snmp_log (LOG_ERR, "unknown column %d in _inetCidrRouteTable_set_column\n", column);
            rc = SNMP_ERR_GENERR;
            break;
    }
                                    ...
                                    netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _inetCidrRouteTable_set_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            DEBUGMSGTL (("inetCidrRouteTable:mfd", "error %d from " "inetCidrRouteTable_set_column\n", rc));
            netsnmp_set_request_error (agtreq_info, requests, SNMP_VALIDATE_ERR (rc));
        }
    }                            /* for results */
                                ...
                                netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("inetCidrRouteTable:mfd", "error %d from " "inetCidrRouteTable_commit\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
                                     ...
                                     netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("inetCidrRouteTable:mfd", "error %d from " "inetCidrRouteTable_undo_commit\n", rc));
    }

    if (rowreq_ctx->rowreq_flags & MFD_ROW_DIRTY)
    {
        snmp_log (LOG_WARNING, "inetCidrRouteTable row dirty flag still set after undo_commit\n");
                                     ...
                                     netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("inetCidrRouteTable:mfd", "error %d from " "inetCidrRouteTable_undo\n", rc));
    }
 ...
 * @internal
 */
static void _container_item_free (inetCidrRouteTable_rowreq_ctx * rowreq_ctx, void *context)
{
    DEBUGMSGTL (("internal:inetCidrRouteTable:_container_item_free", "called\n"));
...
static void _container_free (netsnmp_container * container)
{
    ...
    if (NULL == container)
    {
        snmp_log (LOG_ERR, "invalid container in inetCidrRouteTable_container_free\n");
        return;
    }
 ...
 */
void _inetCidrRouteTable_container_init (inetCidrRouteTable_interface_ctx * if_ctx)
{
    ...
    {
        if_ctx->container = netsnmp_container_find ("inetCidrRouteTable:table_container");
        if (NULL == if_ctx->container)
        {
            snmp_log (LOG_ERR, "error creating container in " "inetCidrRouteTable_container_init\n");
            return;
        }
    }
    ...
    netsnmp_binary_array_options_set (if_ctx->container, 1, CONTAINER_KEY_ALLOW_DUPLICATES);
 ...
 */
void _inetCidrRouteTable_container_shutdown (inetCidrRouteTable_interface_ctx * if_ctx)
{
...
inetCidrRouteTable_rowreq_ctx *inetCidrRouteTable_row_find_by_mib_index (inetCidrRouteTable_mib_index * mib_idx)
{
    inetCidrRouteTable_rowreq_ctx *rowreq_ctx;
    ...
    rowreq_ctx = (inetCidrRouteTable_rowreq_ctx *) CONTAINER_FIND (inetCidrRouteTable_if_ctx.container, &oid_idx);
