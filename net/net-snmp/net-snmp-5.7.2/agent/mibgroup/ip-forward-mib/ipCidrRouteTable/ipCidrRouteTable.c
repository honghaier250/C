...
void initialize_table_ipCidrRouteTable (void)
{
     ...
     */
    ipCidrRouteTable_user_context_p = netsnmp_create_data_list ("ipCidrRouteTable", NULL, NULL);
 ...
 */
int ipCidrRouteTable_rowreq_ctx_init (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, void *user_init_ctx)
{
 ...
 *
 */
void ipCidrRouteTable_rowreq_ctx_cleanup (ipCidrRouteTable_rowreq_ctx * rowreq_ctx)
{
 ...
 */
int ipCidrRouteTable_post_request (ipCidrRouteTable_registration * user_context, int rc)
{
...
ipCidrRouteTable_data *ipCidrRouteTable_allocate_data (void)
{
    ...
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteTable_allocate_data", "called\n"));

    if (NULL == rtn)
    {
        snmp_log (LOG_ERR, "unable to malloc memory for new " "ipCidrRouteTable_data.\n");
    }
...
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteTable_release_data", "called\n"));
...
ipCidrRouteTable_indexes_set_tbl_idx (ipCidrRouteTable_mib_index * tbl_idx,
                                      ...
                                      long ipCidrRouteTos_val, u_long ipCidrRouteNextHop_val)
{
...
ipCidrRouteTable_indexes_set (ipCidrRouteTable_rowreq_ctx * rowreq_ctx,
                              u_long ipCidrRouteDest_val,
                              u_long ipCidrRouteMask_val, long ipCidrRouteTos_val, u_long ipCidrRouteNextHop_val)
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteTable_indexes_set", "called\n"));

    if (MFD_SUCCESS !=
        ipCidrRouteTable_indexes_set_tbl_idx (&rowreq_ctx->tbl_idx,
                                              ipCidrRouteDest_val,
                                              ipCidrRouteMask_val, ipCidrRouteTos_val, ipCidrRouteNextHop_val))
        return MFD_ERROR;
    ...
    if (0 != ipCidrRouteTable_index_to_oid (&rowreq_ctx->oid_idx, &rowreq_ctx->tbl_idx))
    {
        return MFD_ERROR;
    }
 ...
 */
int ipCidrRouteIfIndex_get (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long *ipCidrRouteIfIndex_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipCidrRouteType_get (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, u_long * ipCidrRouteType_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipCidrRouteProto_get (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, u_long * ipCidrRouteProto_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipCidrRouteAge_get (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long *ipCidrRouteAge_val_ptr)
{
...
ipCidrRouteInfo_get (ipCidrRouteTable_rowreq_ctx * rowreq_ctx,
                     oid ** ipCidrRouteInfo_val_ptr_ptr, size_t * ipCidrRouteInfo_val_ptr_len_ptr)
{

   /** we should have a non-NULL pointer and enough storage */
    netsnmp_assert ((NULL != ipCidrRouteInfo_val_ptr_ptr) && (NULL != *ipCidrRouteInfo_val_ptr_ptr));
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipCidrRouteNextHopAS_get (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long *ipCidrRouteNextHopAS_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteNextHopAS_get", "called\n"));
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipCidrRouteMetric1_get (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long *ipCidrRouteMetric1_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipCidrRouteMetric2_get (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long *ipCidrRouteMetric2_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipCidrRouteMetric3_get (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long *ipCidrRouteMetric3_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipCidrRouteMetric4_get (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long *ipCidrRouteMetric4_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipCidrRouteMetric5_get (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long *ipCidrRouteMetric5_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipCidrRouteStatus_get (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, u_long * ipCidrRouteStatus_val_ptr)
{
...
int ipCidrRouteTable_undo_setup (ipCidrRouteTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteTable_undo_setup", "called\n"));
...
int ipCidrRouteTable_undo_cleanup (ipCidrRouteTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteTable_undo_cleanup", "called\n"));
...
int ipCidrRouteTable_commit (ipCidrRouteTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteTable_commit", "called\n"));
    ...
    if (save_flags & COLUMN_IPCIDRROUTEIFINDEX_FLAG)
    {
        ...
        if (-1 == rc)
        {
            snmp_log (LOG_ERR, "ipCidrRouteTable column ipCidrRouteIfIndex commit failed\n");
        }
        else
        {
            /*
    ...
    if (save_flags & COLUMN_IPCIDRROUTETYPE_FLAG)
    {
        ...
        if (-1 == rc)
        {
            snmp_log (LOG_ERR, "ipCidrRouteTable column ipCidrRouteType commit failed\n");
        }
        else
        {
            /*
    ...
    if (save_flags & COLUMN_IPCIDRROUTEINFO_FLAG)
    {
        ...
        if (-1 == rc)
        {
            snmp_log (LOG_ERR, "ipCidrRouteTable column ipCidrRouteInfo commit failed\n");
        }
        else
        {
            /*
    ...
    if (save_flags & COLUMN_IPCIDRROUTENEXTHOPAS_FLAG)
    {
        ...
        if (-1 == rc)
        {
            snmp_log (LOG_ERR, "ipCidrRouteTable column ipCidrRouteNextHopAS commit failed\n");
        }
        else
        {
            /*
    ...
    if (save_flags & COLUMN_IPCIDRROUTEMETRIC1_FLAG)
    {
        ...
        if (-1 == rc)
        {
            snmp_log (LOG_ERR, "ipCidrRouteTable column ipCidrRouteMetric1 commit failed\n");
        }
        else
        {
            /*
    ...
    if (save_flags & COLUMN_IPCIDRROUTEMETRIC2_FLAG)
    {
        ...
        if (-1 == rc)
        {
            snmp_log (LOG_ERR, "ipCidrRouteTable column ipCidrRouteMetric2 commit failed\n");
        }
        else
        {
            /*
    ...
    if (save_flags & COLUMN_IPCIDRROUTEMETRIC3_FLAG)
    {
        ...
        if (-1 == rc)
        {
            snmp_log (LOG_ERR, "ipCidrRouteTable column ipCidrRouteMetric3 commit failed\n");
        }
        else
        {
            /*
    ...
    if (save_flags & COLUMN_IPCIDRROUTEMETRIC4_FLAG)
    {
        ...
        if (-1 == rc)
        {
            snmp_log (LOG_ERR, "ipCidrRouteTable column ipCidrRouteMetric4 commit failed\n");
        }
        else
        {
            /*
    ...
    if (save_flags & COLUMN_IPCIDRROUTEMETRIC5_FLAG)
    {
        ...
        if (-1 == rc)
        {
            snmp_log (LOG_ERR, "ipCidrRouteTable column ipCidrRouteMetric5 commit failed\n");
        }
        else
        {
            /*
    ...
    if (save_flags & COLUMN_IPCIDRROUTESTATUS_FLAG)
    {
        ...
        if (-1 == rc)
        {
            snmp_log (LOG_ERR, "ipCidrRouteTable column ipCidrRouteStatus commit failed\n");
        }
        else
        {
            /*
 ...
 *
 */
int ipCidrRouteIfIndex_check_value (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long ipCidrRouteIfIndex_val)
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteIfIndex_check_value", "called\n"));
...
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteIfIndex_undo_setup", "called\n"));
 ...
 *        A long containing the new value.
 */
int ipCidrRouteIfIndex_set (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long ipCidrRouteIfIndex_val)
{
...
int ipCidrRouteIfIndex_undo (ipCidrRouteTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteIfIndex_undo", "called\n"));
 ...
 *
 */
int ipCidrRouteType_check_value (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, u_long ipCidrRouteType_val)
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteType_check_value", "called\n"));
...
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteType_undo_setup", "called\n"));
 ...
 *        A long containing the new value.
 */
int ipCidrRouteType_set (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, u_long ipCidrRouteType_val)
{
...
ipCidrRouteInfo_check_value (ipCidrRouteTable_rowreq_ctx * rowreq_ctx,
                             oid * ipCidrRouteInfo_val_ptr, size_t ipCidrRouteInfo_val_ptr_len)
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteInfo_check_value", "called\n"));
...
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteInfo_undo_setup", "called\n"));
 ...
 *
 */
int ipCidrRouteNextHopAS_check_value (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long ipCidrRouteNextHopAS_val)
{
...
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteNextHopAS_undo_setup", "called\n"));
 ...
 *        A long containing the new value.
 */
int ipCidrRouteNextHopAS_set (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long ipCidrRouteNextHopAS_val)
{

    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteNextHopAS_set", "called\n"));
...
int ipCidrRouteNextHopAS_undo (ipCidrRouteTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteNextHopAS_undo", "called\n"));
 ...
 *
 */
int ipCidrRouteMetric1_check_value (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long ipCidrRouteMetric1_val)
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteMetric1_check_value", "called\n"));
...
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteMetric1_undo_setup", "called\n"));
 ...
 *        A long containing the new value.
 */
int ipCidrRouteMetric1_set (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long ipCidrRouteMetric1_val)
{
...
int ipCidrRouteMetric1_undo (ipCidrRouteTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteMetric1_undo", "called\n"));
 ...
 *
 */
int ipCidrRouteMetric2_check_value (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long ipCidrRouteMetric2_val)
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteMetric2_check_value", "called\n"));
...
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteMetric2_undo_setup", "called\n"));
 ...
 *        A long containing the new value.
 */
int ipCidrRouteMetric2_set (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long ipCidrRouteMetric2_val)
{
...
int ipCidrRouteMetric2_undo (ipCidrRouteTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteMetric2_undo", "called\n"));
 ...
 *
 */
int ipCidrRouteMetric3_check_value (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long ipCidrRouteMetric3_val)
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteMetric3_check_value", "called\n"));
...
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteMetric3_undo_setup", "called\n"));
 ...
 *        A long containing the new value.
 */
int ipCidrRouteMetric3_set (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long ipCidrRouteMetric3_val)
{
...
int ipCidrRouteMetric3_undo (ipCidrRouteTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteMetric3_undo", "called\n"));
 ...
 *
 */
int ipCidrRouteMetric4_check_value (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long ipCidrRouteMetric4_val)
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteMetric4_check_value", "called\n"));
...
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteMetric4_undo_setup", "called\n"));
 ...
 *        A long containing the new value.
 */
int ipCidrRouteMetric4_set (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long ipCidrRouteMetric4_val)
{
...
int ipCidrRouteMetric4_undo (ipCidrRouteTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteMetric4_undo", "called\n"));
 ...
 *
 */
int ipCidrRouteMetric5_check_value (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long ipCidrRouteMetric5_val)
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteMetric5_check_value", "called\n"));
...
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteMetric5_undo_setup", "called\n"));
 ...
 *        A long containing the new value.
 */
int ipCidrRouteMetric5_set (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, long ipCidrRouteMetric5_val)
{
...
int ipCidrRouteMetric5_undo (ipCidrRouteTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteMetric5_undo", "called\n"));
 ...
 *
 */
int ipCidrRouteStatus_check_value (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, u_long ipCidrRouteStatus_val)
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteStatus_check_value", "called\n"));
...
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteStatus_undo_setup", "called\n"));
 ...
 *        A long containing the new value.
 */
int ipCidrRouteStatus_set (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, u_long ipCidrRouteStatus_val)
{
