 ...
 */
     ...
     static void _ipCidrRouteTable_container_init (ipCidrRouteTable_interface_ctx * if_ctx);

     static void _ipCidrRouteTable_container_shutdown (ipCidrRouteTable_interface_ctx * if_ctx);
...
ipCidrRouteTable_registration *ipCidrRouteTable_registration_set (ipCidrRouteTable_registration * newreg)
{
...
_ipCidrRouteTable_undo_column (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column);
#endif                            /* NETSNMP_NO_WRITE_SUPPORT || NETSNMP_DISABLE_SET_SUPPORT */

NETSNMP_STATIC_INLINE int _ipCidrRouteTable_check_indexes (ipCidrRouteTable_rowreq_ctx * rowreq_ctx);
 ...
 */
void _ipCidrRouteTable_initialize_interface (ipCidrRouteTable_registration * reg_ptr, u_long flags)
{
    netsnmp_baby_steps_access_methods *access_multiplexer = &ipCidrRouteTable_if_ctx.access_multiplexer;

    netsnmp_table_registration_info *tbl_info = &ipCidrRouteTable_if_ctx.tbl_info;
    ...
    {
        snmp_log (LOG_ERR, "could not initialize container for ipCidrRouteTable\n");
        return;
    }
    ...
    handler =
        netsnmp_container_table_handler_get (tbl_info,
                                             ipCidrRouteTable_if_ctx.container, TABLE_CONTAINER_KEY_NETSNMP_INDEX);
    netsnmp_inject_handler (reginfo, handler);
 ...
 */
void _ipCidrRouteTable_shutdown_interface (ipCidrRouteTable_registration * reg_ptr)
{
    /*
 ...
 */
int ipCidrRouteTable_index_to_oid (netsnmp_index * oid_idx, ipCidrRouteTable_mib_index * mib_idx)
{
    ...
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteTable_index_to_oid", "called\n"));

    /*
     * ipCidrRouteDest(1)/IPADDR/ASN_IPADDRESS/u_long(u_long)//l/A/w/e/r/d/h 
     */
    snmp_set_var_value (&var_ipCidrRouteDest, (u_char *) & mib_idx->ipCidrRouteDest, sizeof (mib_idx->ipCidrRouteDest));

    /*
     * ipCidrRouteMask(2)/IPADDR/ASN_IPADDRESS/u_long(u_long)//l/A/w/e/r/d/h 
     */
    snmp_set_var_value (&var_ipCidrRouteMask, (u_char *) & mib_idx->ipCidrRouteMask, sizeof (mib_idx->ipCidrRouteMask));

    /*
     * ipCidrRouteTos(3)/INTEGER32/ASN_INTEGER/long(long)//l/A/w/e/R/d/h 
     */
    snmp_set_var_value (&var_ipCidrRouteTos, (u_char *) & mib_idx->ipCidrRouteTos, sizeof (mib_idx->ipCidrRouteTos));

    /*
     * ipCidrRouteNextHop(4)/IPADDR/ASN_IPADDRESS/u_long(u_long)//l/A/w/e/r/d/h 
     */
    snmp_set_var_value (&var_ipCidrRouteNextHop,
                        (u_char *) & mib_idx->ipCidrRouteNextHop, sizeof (mib_idx->ipCidrRouteNextHop));


    err = build_oid_noalloc (oid_idx->oids, oid_idx->len, &oid_idx->len, NULL, 0, &var_ipCidrRouteDest);
    if (err)
 ...
 */
int ipCidrRouteTable_index_from_oid (netsnmp_index * oid_idx, ipCidrRouteTable_mib_index * mib_idx)
{
    int err = SNMP_ERR_NOERROR;
    ...
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteTable_index_from_oid", "called\n"));
 ...
 */
ipCidrRouteTable_rowreq_ctx *ipCidrRouteTable_allocate_rowreq_ctx (ipCidrRouteTable_data * data, void *user_init_ctx)
{
    ipCidrRouteTable_rowreq_ctx *rowreq_ctx = SNMP_MALLOC_TYPEDEF (ipCidrRouteTable_rowreq_ctx);

    DEBUGMSGTL (("internal:ipCidrRouteTable:ipCidrRouteTable_allocate_rowreq_ctx", "called\n"));

    if (NULL == rowreq_ctx)
    {
        snmp_log (LOG_ERR, "Couldn't allocate memory for a " "ipCidrRouteTable_rowreq_ctx.\n");
        return NULL;
    }
    else
    {
    ...
    {
        if (SNMPERR_SUCCESS != ipCidrRouteTable_rowreq_ctx_init (rowreq_ctx, user_init_ctx))
        {
 ...
 */
void ipCidrRouteTable_release_rowreq_ctx (ipCidrRouteTable_rowreq_ctx * rowreq_ctx)
{
                                   ...
                                   netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    {
        DEBUGMSGTL (("internal:ipCidrRouteTable", "skipping additional pre_request\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         */
        DEBUGMSGTL (("ipCidrRouteTable", "error %d from " "ipCidrRouteTable_pre_request\n", rc));
                                    ...
                                    netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    {
        DEBUGMSGTL (("internal:ipCidrRouteTable", "waiting for last post_request\n"));
        return SNMP_ERR_NOERROR;
    }
    ...
    if ((MFD_SUCCESS != packet_rc) && ipCidrRouteTable_dirty_get ())
    {
         ...
         * the dirty flags.
         */
        snmp_log (LOG_WARNING, "ipCidrRouteTable dirty flag set in post_request " "but status != SUCCESS.\n");
    }

    rc = ipCidrRouteTable_post_request (ipCidrRouteTable_if_ctx.user_ctx, packet_rc);
    if (MFD_SUCCESS != rc)
    {
        /*
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ipCidrRouteTable", "error %d from " "ipCidrRouteTable_post_request\n", rc));
    }
 ...
 * wrapper
 */
static ipCidrRouteTable_rowreq_ctx *_mfd_ipCidrRouteTable_rowreq_from_index (netsnmp_index * oid_idx, int *rc_ptr)
{
 ...
 */
NETSNMP_STATIC_INLINE int
_ipCidrRouteTable_get_column (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    ...
    switch (column)
    {
        ...
        case COLUMN_IPCIDRROUTEINFO:
            ...
            rc = ipCidrRouteInfo_get (rowreq_ctx, (oid **) & var->val.string, &var->val_len);
            break;
        ...
        default:
            snmp_log (LOG_ERR, "unknown column %d in _ipCidrRouteTable_get_column\n", column);
            break;
    }
                                  ...
                                  netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipCidrRouteTable_get_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            if (MFD_SKIP == rc)
            {
...
NETSNMP_STATIC_INLINE int _ipCidrRouteTable_check_indexes (ipCidrRouteTable_rowreq_ctx * rowreq_ctx)
{
    ...
    if ((SNMPERR_SUCCESS == rc)
        && ((rowreq_ctx->tbl_idx.ipCidrRouteTos < 0) || (rowreq_ctx->tbl_idx.ipCidrRouteTos > 2147483647)))
    {
 ...
 */
NETSNMP_STATIC_INLINE int
_ipCidrRouteTable_check_column (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL (("internal:ipCidrRouteTable:_ipCidrRouteTable_check_column", "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_IPCIDRROUTEIFINDEX:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipCidrRouteTable:_ipCidrRouteTable_check_column:ipCidrRouteIfIndex",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = ipCidrRouteIfIndex_check_value (rowreq_ctx, *((long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from ipCidrRouteIfIndex_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_IPCIDRROUTETYPE:
            ...
            if ((SNMPERR_SUCCESS == rc)
                ...
                && (*var->val.integer != IPCIDRROUTETYPE_LOCAL) && (*var->val.integer != IPCIDRROUTETYPE_REMOTE))
            {
                rc = SNMP_ERR_WRONGVALUE;
            }
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipCidrRouteTable:_ipCidrRouteTable_check_column:ipCidrRouteType",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = ipCidrRouteType_check_value (rowreq_ctx, *((u_long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from ipCidrRouteType_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_IPCIDRROUTEINFO:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipCidrRouteTable:_ipCidrRouteTable_check_column:ipCidrRouteInfo",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = ipCidrRouteInfo_check_value (rowreq_ctx, (oid *) var->val.string, var->val_len);
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from ipCidrRouteInfo_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_IPCIDRROUTENEXTHOPAS:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipCidrRouteTable:_ipCidrRouteTable_check_column:ipCidrRouteNextHopAS",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = ipCidrRouteNextHopAS_check_value (rowreq_ctx, *((long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from ipCidrRouteNextHopAS_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_IPCIDRROUTEMETRIC1:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipCidrRouteTable:_ipCidrRouteTable_check_column:ipCidrRouteMetric1",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = ipCidrRouteMetric1_check_value (rowreq_ctx, *((long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from ipCidrRouteMetric1_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_IPCIDRROUTEMETRIC2:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipCidrRouteTable:_ipCidrRouteTable_check_column:ipCidrRouteMetric2",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = ipCidrRouteMetric2_check_value (rowreq_ctx, *((long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from ipCidrRouteMetric2_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_IPCIDRROUTEMETRIC3:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipCidrRouteTable:_ipCidrRouteTable_check_column:ipCidrRouteMetric3",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = ipCidrRouteMetric3_check_value (rowreq_ctx, *((long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from ipCidrRouteMetric3_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_IPCIDRROUTEMETRIC4:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipCidrRouteTable:_ipCidrRouteTable_check_column:ipCidrRouteMetric4",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = ipCidrRouteMetric4_check_value (rowreq_ctx, *((long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from ipCidrRouteMetric4_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_IPCIDRROUTEMETRIC5:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipCidrRouteTable:_ipCidrRouteTable_check_column:ipCidrRouteMetric5",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = ipCidrRouteMetric5_check_value (rowreq_ctx, *((long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from ipCidrRouteMetric5_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_IPCIDRROUTESTATUS:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipCidrRouteTable:_ipCidrRouteTable_check_column:ipCidrRouteStatus",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = ipCidrRouteStatus_check_value (rowreq_ctx, *((u_long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from ipCidrRouteStatus_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        default:
            ...
            rc = SNMP_ERR_GENERR;
            snmp_log (LOG_ERR, "unknown column %d in _ipCidrRouteTable_check_column\n", column);
    }
                                     ...
                                     netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipCidrRouteTable_check_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            netsnmp_request_set_error (requests, SNMP_VALIDATE_ERR (rc));
            break;
 ...
 */
NETSNMP_STATIC_INLINE int _ipCidrRouteTable_undo_setup_column (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    switch (column)
    {
        ...
        default:
            snmp_log (LOG_ERR, "unknown column %d in _ipCidrRouteTable_undo_setup_column\n", column);
            break;
    }
                                  ...
                                  netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("ipCidrRouteTable:mfd", "error %d from " "ipCidrRouteTable_undo_setup\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
    else
    {
        ...
        for (; requests; requests = requests->next)
        {
            ...
            if (MFD_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipCidrRouteTable:mfd", "error %d from " "ipCidrRouteTable_undo_setup_column\n", rc));
                                    ...
                                    netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ipCidrRouteTable:mfd", "error %d from " "ipCidrRouteTable_undo_cleanup\n", rc));
    }
 ...
 */
NETSNMP_STATIC_INLINE int
_ipCidrRouteTable_set_column (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL (("internal:ipCidrRouteTable:_ipCidrRouteTable_set_column", "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_IPCIDRROUTEINFO:
            rowreq_ctx->column_set_flags |= COLUMN_IPCIDRROUTEINFO_FLAG;
            rc = ipCidrRouteInfo_set (rowreq_ctx, (oid *) var->val.string, var->val_len);
            break;
        ...
        case COLUMN_IPCIDRROUTENEXTHOPAS:
            rowreq_ctx->column_set_flags |= COLUMN_IPCIDRROUTENEXTHOPAS_FLAG;
            rc = ipCidrRouteNextHopAS_set (rowreq_ctx, *((long *) var->val.string));
            break;
        ...
        default:
            snmp_log (LOG_ERR, "unknown column %d in _ipCidrRouteTable_set_column\n", column);
            rc = SNMP_ERR_GENERR;
            break;
    }
                                  ...
                                  netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipCidrRouteTable_set_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            DEBUGMSGTL (("ipCidrRouteTable:mfd", "error %d from " "ipCidrRouteTable_set_column\n", rc));
            netsnmp_set_request_error (agtreq_info, requests, SNMP_VALIDATE_ERR (rc));
        }
    }                            /* for results */
                              ...
                              netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    DEBUGMSGTL (("internal:ipCidrRouteTable:_mfd_ipCidrRouteTable_commit", "called\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("ipCidrRouteTable:mfd", "error %d from " "ipCidrRouteTable_commit\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
                                   ...
                                   netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ipCidrRouteTable:mfd", "error %d from " "ipCidrRouteTable_undo_commit\n", rc));
    }

    if (rowreq_ctx->rowreq_flags & MFD_ROW_DIRTY)
    {
        snmp_log (LOG_WARNING, "ipCidrRouteTable row dirty flag still set after undo_commit\n");
...
_ipCidrRouteTable_undo_column (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    ...
    DEBUGMSGTL (("internal:ipCidrRouteTable:_ipCidrRouteTable_undo_column", "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        default:
            snmp_log (LOG_ERR, "unknown column %d in _ipCidrRouteTable_undo_column\n", column);
            break;
    }
                                   ...
                                   netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ipCidrRouteTable:mfd", "error %d from " "ipCidrRouteTable_undo\n", rc));
    }
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipCidrRouteTable_undo_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            /*
             * nothing we can do about it but log it
             */
            DEBUGMSGTL (("ipCidrRouteTable:mfd", "error %d from " "ipCidrRouteTable_undo_column\n", rc));
        }
    }                            /* for results */
 ...
 * @internal
 */
static void _container_item_free (ipCidrRouteTable_rowreq_ctx * rowreq_ctx, void *context)
{
...
static void _container_free (netsnmp_container * container)
{
    ...
    if (NULL == container)
    {
        snmp_log (LOG_ERR, "invalid container in ipCidrRouteTable_container_free\n");
        return;
    }
...
void _ipCidrRouteTable_container_init (ipCidrRouteTable_interface_ctx * if_ctx)
{
    ...
    if_ctx->cache = netsnmp_cache_create (IPCIDRROUTETABLE_CACHE_TIMEOUT,
                                          _cache_load, _cache_free, ipCidrRouteTable_oid, ipCidrRouteTable_oid_size);
    ...
    {
        if_ctx->container = netsnmp_container_find ("ipCidrRouteTable:table_container");
        if (NULL == if_ctx->container)
        {
            snmp_log (LOG_ERR, "error creating container in " "ipCidrRouteTable_container_init\n");
            return;
        }
    }
 ...
 */
void _ipCidrRouteTable_container_shutdown (ipCidrRouteTable_interface_ctx * if_ctx)
{
...
ipCidrRouteTable_rowreq_ctx *ipCidrRouteTable_row_find_by_mib_index (ipCidrRouteTable_mib_index * mib_idx)
{
    ipCidrRouteTable_rowreq_ctx *rowreq_ctx;
    ...
    rowreq_ctx = (ipCidrRouteTable_rowreq_ctx *) CONTAINER_FIND (ipCidrRouteTable_if_ctx.container, &oid_idx);
