 ...
 */
int ipCidrRouteTable_init_data (ipCidrRouteTable_registration * ipCidrRouteTable_reg)
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteTable_init_data", "called\n"));
 ...
 */
void ipCidrRouteTable_container_init (netsnmp_container ** container_ptr_ptr, netsnmp_cache * cache)
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteTable_container_init", "called\n"));

    if (NULL == container_ptr_ptr)
    {
        snmp_log (LOG_ERR, "bad container param to ipCidrRouteTable_container_init\n");
        return;
    }
    ...
    *container_ptr_ptr = NULL;
    ...
    if (NULL == cache)
    {
        snmp_log (LOG_ERR, "bad cache param to ipCidrRouteTable_container_init\n");
        return;
    }
...
static void _snarf_route_entry (netsnmp_route_entry * route_entry, netsnmp_container * container)
{
    ...
    if ((NULL != rowreq_ctx) &&
        (MFD_SUCCESS == ipCidrRouteTable_indexes_set
         (rowreq_ctx, *((u_long *) route_entry->rt_dest),
          route_entry->rt_mask, route_entry->rt_tos, *((u_long *) route_entry->rt_nexthop))))
    {
    ...
    else
    {
        if (rowreq_ctx)
        {
            snmp_log (LOG_ERR, "error setting index while loading " "ipCidrRoute cache.\n");
...
void ipCidrRouteTable_container_shutdown (netsnmp_container * container_ptr)
{
    ...
    {
        snmp_log (LOG_ERR, "bad params to ipCidrRouteTable_container_shutdown\n");
        return;
    }
...
int ipCidrRouteTable_container_load (netsnmp_container * container)
{
     ...
     * the container.
     */
    route_container = netsnmp_access_route_container_load (NULL, NETSNMP_ACCESS_ROUTE_LOAD_IPV4_ONLY);
...
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteTable_row_prep", "called\n"));
...
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteDest_check_index", "called\n"));
...
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteMask_check_index", "called\n"));
...
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteTos_check_index", "called\n"));
...
{
    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteNextHop_check_index", "called\n"));
...
ipCidrRouteTable_validate_index (ipCidrRouteTable_registration *
                                 ipCidrRouteTable_reg, ipCidrRouteTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL (("verbose:ipCidrRouteTable:ipCidrRouteTable_validate_index", "called\n"));
    ...
    if (1)
    {
        snmp_log (LOG_WARNING, "invalid index for a new row in the " "ipCidrRouteTable table.\n");
        /*
