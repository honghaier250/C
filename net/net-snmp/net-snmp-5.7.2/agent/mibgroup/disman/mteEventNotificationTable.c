     ...
     void initialize_table_mteEventNotificationTable (void)
{
     ...
     * Adding indexes
     */
    DEBUGMSGTL (("initialize_table_mteEventNotificationTable", "adding indexes to table mteEventNotificationTable\n"));
    ...
    netsnmp_table_set_multi_add_default_row (mteEventNotif_table_set,
                                             ...
                                             COLUMN_MTEEVENTNOTIFICATIONOBJECTS, ASN_OCTET_STR, 1, NULL, 0, 0);
