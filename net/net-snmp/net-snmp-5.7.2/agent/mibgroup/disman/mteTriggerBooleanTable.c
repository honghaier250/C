...
void init_mteTriggerBooleanTable (void)
{
    ...
    REGISTER_MIB ("mteTriggerBooleanTable",
                  mteTriggerBooleanTable_variables, variable2, mteTriggerBooleanTable_variables_oid);
                                     ...
                                     size_t var_val_len, u_char * statP, oid * name, size_t name_len)
{
    ...
    switch (action)
    {
        ...
        case ACTION:
            ...
            StorageTmp->mteTriggerBooleanObjectsOwner = netsnmp_strdup_and_null (var_val, var_val_len);
                                ...
                                u_char var_val_type, size_t var_val_len, u_char * statP, oid * name, size_t name_len)
{
    ...
    switch (action)
    {
        ...
        case ACTION:
            ...
            StorageTmp->mteTriggerBooleanObjects = netsnmp_strdup_and_null (var_val, var_val_len);
                                   ...
                                   u_char var_val_type, size_t var_val_len, u_char * statP, oid * name, size_t name_len)
{
    ...
    switch (action)
    {
        ...
        case ACTION:
            ...
            StorageTmp->mteTriggerBooleanEventOwner = netsnmp_strdup_and_null (var_val, var_val_len);
