...
void init_expScalars (void)
{
    ...
    netsnmp_register_scalar_group (netsnmp_create_handler_registration ("expResource",
    ...
    switch (reqinfo->mode)
    {
        case MODE_GET:
            ...
            switch (obj)
            {
                ...
                default:
                    snmp_log (LOG_ERR, "unknown object (%d) in handle_expResourceGroup\n", (int) obj);
        ...
        default:
             ...
             */
            snmp_log (LOG_ERR, "unknown mode (%d) in handle_expResourceGroup\n", reqinfo->mode);
            return SNMP_ERR_GENERR;
    }
