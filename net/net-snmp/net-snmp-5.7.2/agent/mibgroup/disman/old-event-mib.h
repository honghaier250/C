...
config_require (disman / mteEventTable) config_require (disman / mteEventNotificationTable)
...
config_exclude (disman / event / mteObjectsTable) config_exclude (disman / event / mteObjectsConf)
