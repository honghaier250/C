...
void init_mteTriggerExistenceTable (void)
{
    ...
    REGISTER_MIB ("mteTriggerExistenceTable",
                  mteTriggerExistenceTable_variables, variable2, mteTriggerExistenceTable_variables_oid);
 ...
 */
unsigned char *var_mteTriggerExistenceTable (struct variable *vp,
                                             oid * name,
                               ...
                               u_char var_val_type, size_t var_val_len, u_char * statP, oid * name, size_t name_len)
{
    ...
    switch (action)
    {
        case RESERVE1:
            ...
            {
                fprintf (stderr, "write to mteTriggerExistenceTest not ASN_OCTET_STR\n");
                                  ...
                                  u_char var_val_type, size_t var_val_len, u_char * statP, oid * name, size_t name_len)
{
    ...
    switch (action)
    {
        case RESERVE1:
            if (var_val_type != ASN_OCTET_STR)
            {
                fprintf (stderr, "write to mteTriggerExistenceStartup not ASN_OCTET_STR\n");
                return SNMP_ERR_WRONGTYPE;
            }
            if (StorageTmp->storageType != ST_NONVOLATILE)
                return SNMP_ERR_NOTWRITABLE;
