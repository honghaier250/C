...
netsnmp_feature_require (table_tdata) netsnmp_feature_require (date_n_time) netsnmp_feature_require (check_vb_uint)
#ifndef NETSNMP_NO_WRITE_SUPPORT
    netsnmp_feature_require (check_vb_type_and_max_size)
netsnmp_feature_require (check_vb_oid)
netsnmp_feature_require (check_vb_truthvalue) netsnmp_feature_require (table_tdata_insert_row)
     ...
     void init_schedTable (void)
{
    ...
    reg = netsnmp_create_handler_registration ("schedTable",
                                               schedTable_handler,
                                               schedTable_oid, schedTable_oid_len, HANDLER_CAN_RWRITE);
    ...
    switch (reqinfo->mode)
    {
        ...
        case MODE_GET:
            for (request = requests; request; request = request->next)
            {
                ...
                entry = (struct schedTable_entry *) netsnmp_tdata_extract_entry (request);
                ...
                switch (tinfo->colnum)
                {
                    ...
                    case COLUMN_SCHEDINTERVAL:
                        snmp_set_var_typed_integer (request->requestvb, ASN_UNSIGNED, entry->schedInterval);
                        break;
                    ...
                    case COLUMN_SCHEDDAY:
                        snmp_set_var_typed_value (request->requestvb, ASN_OCTET_STR,
                                                  entry->schedDay, sizeof (entry->schedDay));
                        break;
                    case COLUMN_SCHEDHOUR:
                        snmp_set_var_typed_value (request->requestvb, ASN_OCTET_STR,
                                                  entry->schedHour, sizeof (entry->schedHour));
                        break;
                    ...
                    case COLUMN_SCHEDCONTEXTNAME:
                        snmp_set_var_typed_value (request->requestvb, ASN_OCTET_STR,
                                                  entry->schedContextName, strlen (entry->schedContextName));
                        break;
                    ...
                    case COLUMN_SCHEDVALUE:
                        snmp_set_var_typed_integer (request->requestvb, ASN_INTEGER, entry->schedValue);
                        break;
                    case COLUMN_SCHEDTYPE:
                        snmp_set_var_typed_integer (request->requestvb, ASN_INTEGER, entry->schedType);
                        break;
                    case COLUMN_SCHEDADMINSTATUS:
                        ret = (entry->flags & SCHEDULE_FLAG_ENABLED) ? TV_TRUE : TV_FALSE;
                    ...
                    case COLUMN_SCHEDFAILURES:
                        snmp_set_var_typed_integer (request->requestvb, ASN_COUNTER, entry->schedFailures);
                        break;
                    case COLUMN_SCHEDLASTFAILURE:
                        snmp_set_var_typed_integer (request->requestvb, ASN_INTEGER, entry->schedLastFailure);
                        break;
                    ...
                    case COLUMN_SCHEDSTORAGETYPE:
                        snmp_set_var_typed_integer (request->requestvb, ASN_INTEGER, entry->schedStorageType);
                        break;
                    case COLUMN_SCHEDROWSTATUS:
                        ret = (entry->flags & SCHEDULE_FLAG_ACTIVE) ? TV_TRUE : TV_FALSE;
                        snmp_set_var_typed_integer (request->requestvb, ASN_INTEGER, ret);
                        break;
                    case COLUMN_SCHEDTRIGGERS:
                        snmp_set_var_typed_integer (request->requestvb, ASN_COUNTER, entry->schedTriggers);
                        break;
                }
            }
            break;
        ...
        case MODE_SET_RESERVE1:
            for (request = requests; request; request = request->next)
            {
                ...
                {
                    case COLUMN_SCHEDDESCR:
                        ret = netsnmp_check_vb_type_and_max_size (request->requestvb, ASN_OCTET_STR, SCHED_STR2_LEN);
                    ...
                    case COLUMN_SCHEDINTERVAL:
                        ...
                        break;
                    case COLUMN_SCHEDWEEKDAY:
                        ret = netsnmp_check_vb_type_and_size (request->requestvb, ASN_OCTET_STR, 1);
                    ...
                    case COLUMN_SCHEDMINUTE:
                        ...
                        break;
                    case COLUMN_SCHEDCONTEXTNAME:
                        ret = netsnmp_check_vb_type_and_max_size (request->requestvb, ASN_OCTET_STR, SCHED_STR1_LEN);
                        if (ret != SNMP_ERR_NOERROR)
                        {
                            netsnmp_set_request_error (reqinfo, request, ret);
                            return SNMP_ERR_NOERROR;
                    ...
                    case COLUMN_SCHEDVALUE:
                        ...
                        break;
                    case COLUMN_SCHEDTYPE:
                        ret = netsnmp_check_vb_int_range (request->requestvb, SCHED_TYPE_PERIODIC, SCHED_TYPE_ONESHOT);
                        if (ret != SNMP_ERR_NOERROR)
                        {
                            netsnmp_set_request_error (reqinfo, request, ret);
                            return SNMP_ERR_NOERROR;
                    ...
                    case COLUMN_SCHEDADMINSTATUS:
                        ...
                        break;
                    case COLUMN_SCHEDSTORAGETYPE:
                        ret = netsnmp_check_vb_int_range (request->requestvb, ST_NONE, ST_READONLY);
                        ...
                        break;
                    case COLUMN_SCHEDROWSTATUS:
                        ret = netsnmp_check_vb_rowstatus (request->requestvb, (entry ? RS_ACTIVE : RS_NONEXISTENT));
                    ...
                    case COLUMN_SCHEDROWSTATUS:
                        switch (*request->requestvb->val.integer)
                        {
                            ...
                            case RS_CREATEANDWAIT:
                                ...
                                memcpy (owner, tinfo->indexes->val.string, tinfo->indexes->val_len);
                    ...
                    case COLUMN_SCHEDROWSTATUS:
                        switch (*request->requestvb->val.integer)
                        {
                            ...
                            case RS_CREATEANDWAIT:
                                ...
                                {
                                    row = (netsnmp_tdata_row *) netsnmp_tdata_extract_row (request);
            ...
            for (request = requests; request; request = request->next)
            {
                ...
                switch (tinfo->colnum)
                {
                    case COLUMN_SCHEDDESCR:
                        ...
                        memcpy (entry->schedDescr, request->requestvb->val.string, request->requestvb->val_len);
                        break;
                    case COLUMN_SCHEDINTERVAL:
                    ...
                    case COLUMN_SCHEDDAY:
                        ...
                        memcpy (entry->schedDay, request->requestvb->val.string, request->requestvb->val_len);
                        recalculate = 1;
                        break;
                    case COLUMN_SCHEDHOUR:
                    ...
                    case COLUMN_SCHEDMINUTE:
                        ...
                        memcpy (entry->schedMinute, request->requestvb->val.string, request->requestvb->val_len);
                        recalculate = 1;
                        break;
                    case COLUMN_SCHEDCONTEXTNAME:
                        memset (entry->schedContextName, 0, sizeof (entry->schedContextName));
                        memcpy (entry->schedContextName, request->requestvb->val.string, request->requestvb->val_len);
                        break;
                    case COLUMN_SCHEDVARIABLE:
                        memset (entry->schedVariable, 0, sizeof (entry->schedVariable));
                        memcpy (entry->schedVariable, request->requestvb->val.string, request->requestvb->val_len);
                        entry->schedVariable_len = request->requestvb->val_len / sizeof (oid);
                        break;
                    case COLUMN_SCHEDVALUE:
                    ...
                    case COLUMN_SCHEDROWSTATUS:
                        switch (*request->requestvb->val.integer)
                        {
                            ...
                            case RS_CREATEANDGO:
                                ...
                                entry->session = netsnmp_iquery_pdu_session (reqinfo->asp->pdu);
                                break;
                            case RS_CREATEANDWAIT:
                                entry->flags |= SCHEDULE_FLAG_VALID;
                                entry->session = netsnmp_iquery_pdu_session (reqinfo->asp->pdu);
