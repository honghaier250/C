...
config_require (disman / event / mteObjectsTable) config_require (disman / event / mteObjectsConf)
...
config_exclude (disman / mteEventTable) config_exclude (disman / mteEventNotificationTable)
