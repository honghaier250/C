...
oid expErrorTable_variables_oid[] = { 1, 3, 6, 1, 2, 1, 90, 1, 2, 2 };
...
void init_expErrorTable (void)
{
     ...
     */
    REGISTER_MIB ("expErrorTable", expErrorTable_variables, variable2, expErrorTable_variables_oid);
...
unsigned char *var_expErrorTable (struct variable *vp,
