...
int proc_v4 (char *, ssize_t, struct timeval *, time_t,
             ...
             unsigned long *, unsigned long, int, int, int, struct pingProbeHistoryTable_data *, pid_t);
void send_v4 (int, pid_t, int, int, char *);

void readloop (struct pingCtlTable_data *, struct addrinfo *,
               int, unsigned long *, unsigned long *, unsigned long *, pid_t);
void sig_alrm (int);
...
int pinger (int, int, int, char *, struct sockaddr_in6 *, int *,
            ...
            int *, int *, __u16 *, long *, long *, long *, long *, int *, int *, int *, struct timeval *);
void sock_setbufs (int, int, int);

void setup (int, int, int, int, int, int, int, char *, int *, struct timeval *, int *, int *);

void main_loop (struct pingCtlTable_data *, int, int, __u8 *,
                int, int, char *, struct sockaddr_in6 *, int,
                int, char *, int, int, int, int, char *, int *, struct timeval *, int *, int *);
int gather_statistics (int *, struct pingCtlTable_data *,
                       ...
                       long long *, int *, int *, int *, struct pingProbeHistoryTable_data *);
void finish (int, char *, int, int, int *, struct timeval *,
             int *, long *, long *, long *, long *, long *,
             long *, long *, long *, long long *, long long *, int *, struct timeval *);
void status (int, int *, long *, long *, long *, long *, long *, long long *, long long *);
...
int receive_error_msg (int, struct sockaddr_in6 *, int, int *, long *);

int send_v6 (int, int, char *, struct sockaddr_in6 *, int, int, char *, int *, long *, int *);
