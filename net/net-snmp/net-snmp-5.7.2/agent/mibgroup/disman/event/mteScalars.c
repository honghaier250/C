...
void init_mteScalars (void)
{
    ...
    netsnmp_register_scalar_group (netsnmp_create_handler_registration ("mteResource", handle_mteResourceGroup,
                                                                        mteResource_oid, OID_LENGTH (mteResource_oid),
                                                                        HANDLER_CAN_RONLY),
                                   MTE_RESOURCE_SAMPLE_MINFREQ, MTE_RESOURCE_SAMPLE_LACKS);

    netsnmp_register_scalar (netsnmp_create_handler_registration ("mteTriggerFailures",
        ...
        case MODE_GET:
            ...
            switch (obj)
            {
                ...
                case MTE_RESOURCE_SAMPLE_MAX_INST:
                    ...
                    snmp_set_var_typed_value (requests->requestvb, ASN_UNSIGNED, (u_char *) & value, sizeof (value));
                    break;
                ...
                case MTE_RESOURCE_SAMPLE_INSTANCES:
                    ...
                    value = 0;
#endif
                    snmp_set_var_typed_value (requests->requestvb, ASN_GAUGE, (u_char *) & value, sizeof (value));
                    break;
                ...
                default:
                    snmp_log (LOG_ERR, "unknown object (%d) in handle_mteResourceGroup\n", (int) obj);
    ...
    switch (reqinfo->mode)
    {
        case MODE_GET:
            snmp_set_var_typed_value (requests->requestvb, ASN_COUNTER,
                                      (u_char *) & mteTriggerFailures, sizeof (mteTriggerFailures));
            break;
        ...
        default:
             ...
             */
            snmp_log (LOG_ERR, "unknown mode (%d) in handle_mteTriggerFailures\n", reqinfo->mode);
            return SNMP_ERR_GENERR;
    }
