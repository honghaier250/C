            ...
            for (request = requests; request; request = request->next)
            {
                ...
                switch (tinfo->colnum)
                {
                    case COLUMN_MTETRIGGEREXISTENCETEST:
                        snmp_set_var_typed_value (request->requestvb, ASN_OCTET_STR, (u_char *) & entry->mteTExTest, 1);
                        break;
                    ...
                    case COLUMN_MTETRIGGEREXISTENCEOBJECTSOWNER:
                        snmp_set_var_typed_value (request->requestvb, ASN_OCTET_STR,
                                                  (u_char *) entry->mteTExObjOwner, strlen (entry->mteTExObjOwner));
                        break;
                    case COLUMN_MTETRIGGEREXISTENCEOBJECTS:
                        snmp_set_var_typed_value (request->requestvb, ASN_OCTET_STR,
                                                  (u_char *) entry->mteTExObjects, strlen (entry->mteTExObjects));
                        break;
                    case COLUMN_MTETRIGGEREXISTENCEEVENTOWNER:
                        snmp_set_var_typed_value (request->requestvb, ASN_OCTET_STR,
                                                  (u_char *) entry->mteTExEvOwner, strlen (entry->mteTExEvOwner));
                        break;
                    case COLUMN_MTETRIGGEREXISTENCEEVENT:
                        snmp_set_var_typed_value (request->requestvb, ASN_OCTET_STR,
                                                  (u_char *) entry->mteTExEvent, strlen (entry->mteTExEvent));
                        break;
                }
            }
            break;
            ...
            for (request = requests; request; request = request->next)
            {
                ...
                switch (tinfo->colnum)
                {
                    ...
                    case COLUMN_MTETRIGGEREXISTENCEOBJECTSOWNER:
                        ...
                        memcpy (entry->mteTExObjOwner, request->requestvb->val.string, request->requestvb->val_len);
                        break;
                    case COLUMN_MTETRIGGEREXISTENCEOBJECTS:
                        memset (entry->mteTExObjects, 0, sizeof (entry->mteTExObjects));
                        memcpy (entry->mteTExObjects, request->requestvb->val.string, request->requestvb->val_len);
                        break;
                    case COLUMN_MTETRIGGEREXISTENCEEVENTOWNER:
                        memset (entry->mteTExEvOwner, 0, sizeof (entry->mteTExEvOwner));
                        memcpy (entry->mteTExEvOwner, request->requestvb->val.string, request->requestvb->val_len);
                        break;
                    case COLUMN_MTETRIGGEREXISTENCEEVENT:
                        memset (entry->mteTExEvent, 0, sizeof (entry->mteTExEvent));
                        memcpy (entry->mteTExEvent, request->requestvb->val.string, request->requestvb->val_len);
                        break;
                }
            }
            break;
