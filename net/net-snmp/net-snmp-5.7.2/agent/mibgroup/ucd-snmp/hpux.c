...
void int_hpux (void)
{
    ...
    REGISTER_MIB ("ucd-snmp/hpux:hptrap", hptrap_variables, variable2, hptrap_variables_oid);
...
int
writeHP (int action, u_char * var_val, u_char var_val_type, int var_val_len, u_char * statP, oid * name, int name_len)
{
