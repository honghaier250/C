 ...
 */
int netsnmp_access_scopezone_container_arch_load (netsnmp_container * container, u_int load_flags)
{
    int rc1 = 0;
...
#define PROCFILE "/proc/net/if_inet6"
    ...
    while (fgets (line, sizeof (line), in))
    {
        ...
        {
            DEBUGMSGTL (("access:scopezone:container", "The address is not link-local, skipping\n"));
            continue;
        }
        /* 
        ...
        {
            DEBUGMSGTL (("access:scopezone:container", "The interface was already inserted, skipping\n"));
            continue;
        }
