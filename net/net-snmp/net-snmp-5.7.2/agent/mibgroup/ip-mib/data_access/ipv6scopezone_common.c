 ...
 * the header file.
 */
extern int netsnmp_access_scopezone_container_arch_load (netsnmp_container * container, u_int load_flags);

extern void netsnmp_access_scopezone_arch_init (void);
 ...
 */
netsnmp_container *netsnmp_access_scopezone_container_load (netsnmp_container * container, u_int load_flags)
{
    int rc;
    ...
    if (0 != rc)
    {
        netsnmp_access_scopezone_container_free (container, NETSNMP_ACCESS_SCOPEZONE_FREE_NOFLAGS);
        container = NULL;
    }
...
void netsnmp_access_scopezone_container_free (netsnmp_container * container, u_int free_flags)
{
...
{
    netsnmp_v6scopezone_entry *entry = SNMP_MALLOC_TYPEDEF (netsnmp_v6scopezone_entry);
