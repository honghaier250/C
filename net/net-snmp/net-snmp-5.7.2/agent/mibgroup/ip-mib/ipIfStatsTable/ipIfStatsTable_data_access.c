 ...
 */
void ipIfStatsTable_container_init (netsnmp_container ** container_ptr_ptr, netsnmp_cache * cache)
{
    DEBUGMSGTL (("verbose:ipIfStatsTable:ipIfStatsTable_container_init", "called\n"));

    if (NULL == container_ptr_ptr)
    {
        snmp_log (LOG_ERR, "bad container param to ipIfStatsTable_container_init\n");
        return;
    }
     ...
     * assigned...
     */
    *container_ptr_ptr = netsnmp_container_find ("ipIfStatsTable:table_container");
    if (NULL != *container_ptr_ptr)
    {
 ...
 */
static void _check_for_updates (ipIfStatsTable_rowreq_ctx * rowreq_ctx, netsnmp_container * stats)
{
    ...
    else
    {
         ...
         */
        netsnmp_access_systemstats_entry_update (rowreq_ctx->data, ifstats_entry);
 ...
 * add new entry
 */
static void _add_new (netsnmp_systemstats_entry * ifstats_entry, netsnmp_container * container)
{
    ...
    if ((NULL != rowreq_ctx)
        && (MFD_SUCCESS == ipIfStatsTable_indexes_set (rowreq_ctx, ifstats_entry->index[0], ifstats_entry->index[1])))
    {
    ...
    else
    {
        if (NULL != rowreq_ctx)
        {
            snmp_log (LOG_ERR, "error setting index while loading " "ipIfStatsTable cache.\n");
            ipIfStatsTable_release_rowreq_ctx (rowreq_ctx);
        }
        else
        {
            snmp_log (LOG_ERR, "memory allocation failed while loading " "ipIfStatsTable cache.\n");
            netsnmp_access_systemstats_entry_free (ifstats_entry);
        }
    }
}
...
{
    DEBUGMSGTL (("verbose:ipIfStatsTable:ipIfStatsTable_container_shutdown", "called\n"));
...
int ipIfStatsTable_container_load (netsnmp_container * container)
{
    ...
    DEBUGMSGTL (("verbose:ipIfStatsTable:ipIfStatsTable_container_load", "called\n"));
