...
#include "ipIfStatsTable.h"
     ...
     */
    void _ipIfStatsTable_initialize_interface (ipIfStatsTable_registration * user_ctx, u_long flags);
    ...
    int ipIfStatsTable_container_size (void);
      ...
      ipIfStatsTable_rowreq_ctx * ipIfStatsTable_allocate_rowreq_ctx (ipIfStatsTable_data *, void *);
