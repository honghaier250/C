...
void initialize_table_ipIfStatsTable (void)
{
    ...
    DEBUGMSGTL (("verbose:ipIfStatsTable:initialize_table_ipIfStatsTable", "called\n"));
     ...
     */
    ipIfStatsTable_user_context_p = netsnmp_create_data_list ("ipIfStatsTable", NULL, NULL);
 ...
 */
int ipIfStatsTable_rowreq_ctx_init (ipIfStatsTable_rowreq_ctx * rowreq_ctx, void *user_init_ctx)
{
    DEBUGMSGTL (("verbose:ipIfStatsTable:ipIfStatsTable_rowreq_ctx_init", "called\n"));
...
{
    DEBUGMSGTL (("verbose:ipIfStatsTable:ipIfStatsTable_rowreq_ctx_cleanup", "called\n"));
...
{
    DEBUGMSGTL (("verbose:ipIfStatsTable:ipIfStatsTable_pre_request", "called\n"));
 ...
 */
int ipIfStatsTable_post_request (ipIfStatsTable_registration * user_context, int rc)
{
    DEBUGMSGTL (("verbose:ipIfStatsTable:ipIfStatsTable_post_request", "called\n"));
