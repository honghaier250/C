 ...
 */
     ...
     static void _ipIfStatsTable_container_shutdown (ipIfStatsTable_interface_ctx * if_ctx);
...
ipIfStatsTable_registration *ipIfStatsTable_registration_set (ipIfStatsTable_registration * newreg)
{
 ...
 */
void _ipIfStatsTable_initialize_interface (ipIfStatsTable_registration * reg_ptr, u_long flags)
{
    netsnmp_baby_steps_access_methods *access_multiplexer = &ipIfStatsTable_if_ctx.access_multiplexer;
    ...
    {
        snmp_log (LOG_ERR, "could not initialize container for ipIfStatsTable\n");
        return;
    }
     ...
     */
    DEBUGMSGTL (("ipIfStatsTable:init_ipIfStatsTable", "Registering ipIfStatsTable as a mibs-for-dummies table.\n"));
    handler = netsnmp_baby_steps_access_multiplexer_get (access_multiplexer);
    reginfo =
        netsnmp_handler_registration_create ("ipIfStatsTable", handler,
                                             ipIfStatsTable_oid,
                                             ipIfStatsTable_oid_size, HANDLER_CAN_BABY_STEP | HANDLER_CAN_RONLY);
    if (NULL == reginfo)
    {
    ...
    handler =
        netsnmp_container_table_handler_get (tbl_info,
                                             ipIfStatsTable_if_ctx.container, TABLE_CONTAINER_KEY_NETSNMP_INDEX);
    netsnmp_inject_handler (reginfo, handler);
 ...
 */
int ipIfStatsTable_index_to_oid (netsnmp_index * oid_idx, ipIfStatsTable_mib_index * mib_idx)
{
    ...
    DEBUGMSGTL (("verbose:ipIfStatsTable:ipIfStatsTable_index_to_oid", "called\n"));

    /*
     * ipIfStatsIPVersion(1)/InetVersion/ASN_INTEGER/long(u_long)//l/a/w/E/r/d/h 
     */
    snmp_set_var_value (&var_ipIfStatsIPVersion,
                        (u_char *) & mib_idx->ipIfStatsIPVersion, sizeof (mib_idx->ipIfStatsIPVersion));

    /*
     * ipIfStatsIfIndex(2)/InterfaceIndex/ASN_INTEGER/long(long)//l/a/w/e/R/d/H 
     */
    snmp_set_var_value (&var_ipIfStatsIfIndex,
                        (u_char *) & mib_idx->ipIfStatsIfIndex, sizeof (mib_idx->ipIfStatsIfIndex));


    err = build_oid_noalloc (oid_idx->oids, oid_idx->len, &oid_idx->len, NULL, 0, &var_ipIfStatsIPVersion);
    if (err)
 ...
 */
int ipIfStatsTable_index_from_oid (netsnmp_index * oid_idx, ipIfStatsTable_mib_index * mib_idx)
{
    int err = SNMP_ERR_NOERROR;
    ...
    DEBUGMSGTL (("verbose:ipIfStatsTable:ipIfStatsTable_index_from_oid", "called\n"));
 ...
 */
ipIfStatsTable_rowreq_ctx *ipIfStatsTable_allocate_rowreq_ctx (ipIfStatsTable_data * data, void *user_init_ctx)
{
    ipIfStatsTable_rowreq_ctx *rowreq_ctx = SNMP_MALLOC_TYPEDEF (ipIfStatsTable_rowreq_ctx);

    DEBUGMSGTL (("internal:ipIfStatsTable:ipIfStatsTable_allocate_rowreq_ctx", "called\n"));

    if (NULL == rowreq_ctx)
    {
        snmp_log (LOG_ERR, "Couldn't allocate memory for a " "ipIfStatsTable_rowreq_ctx.\n");
        return NULL;
    }
    else
    {
    ...
    {
        if (SNMPERR_SUCCESS != ipIfStatsTable_rowreq_ctx_init (rowreq_ctx, user_init_ctx))
        {
                                 ...
                                 netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    DEBUGMSGTL (("internal:ipIfStatsTable:_mfd_ipIfStatsTable_pre_request", "called\n"));

    if (1 != netsnmp_row_merge_status_first (reginfo, agtreq_info))
    {
        DEBUGMSGTL (("internal:ipIfStatsTable", "skipping additional pre_request\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         */
        DEBUGMSGTL (("ipIfStatsTable", "error %d from " "ipIfStatsTable_pre_request\n", rc));
                                  ...
                                  netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    DEBUGMSGTL (("internal:ipIfStatsTable:_mfd_ipIfStatsTable_post_request", "called\n"));
    ...
    {
        DEBUGMSGTL (("internal:ipIfStatsTable", "waiting for last post_request\n"));
        return SNMP_ERR_NOERROR;
    }
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ipIfStatsTable", "error %d from " "ipIfStatsTable_post_request\n", rc));
    }
...
_ipIfStatsTable_get_column (ipIfStatsTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL (("internal:ipIfStatsTable:_mfd_ipIfStatsTable_get_column", "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_IPIFSTATSHCINRECEIVES:
            ...
            rc = ipIfStatsHCInReceives_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSINUNKNOWNPROTOS:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipIfStatsInUnknownProtos_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSINTRUNCATEDPKTS:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipIfStatsInTruncatedPkts_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSINFORWDATAGRAMS:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipIfStatsInForwDatagrams_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSHCINFORWDATAGRAMS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipIfStatsHCInForwDatagrams_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSHCINDELIVERS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipIfStatsHCInDelivers_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSHCOUTREQUESTS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipIfStatsHCOutRequests_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSOUTFORWDATAGRAMS:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipIfStatsOutForwDatagrams_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSHCOUTFORWDATAGRAMS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipIfStatsHCOutForwDatagrams_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSHCOUTTRANSMITS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipIfStatsHCOutTransmits_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSHCINMCASTPKTS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipIfStatsHCInMcastPkts_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSHCINMCASTOCTETS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipIfStatsHCInMcastOctets_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSHCOUTMCASTPKTS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipIfStatsHCOutMcastPkts_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSHCOUTMCASTOCTETS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipIfStatsHCOutMcastOctets_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSHCINBCASTPKTS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipIfStatsHCInBcastPkts_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSHCOUTBCASTPKTS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipIfStatsHCOutBcastPkts_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPIFSTATSDISCONTINUITYTIME:
            ...
            rc = ipIfStatsDiscontinuityTime_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        default:
            if (IPIFSTATSTABLE_MIN_COL <= column && column <= IPIFSTATSTABLE_MAX_COL)
            {
            ...
            {
                snmp_log (LOG_ERR, "unknown column %d in _ipIfStatsTable_get_column\n", column);
            }
            break;
    }
                                ...
                                netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    DEBUGMSGTL (("internal:ipIfStatsTable:_mfd_ipIfStatsTable_get_values", "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipIfStatsTable_get_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            if (MFD_SKIP == rc)
            {
 ...
 * @internal
 */
static void _container_item_free (ipIfStatsTable_rowreq_ctx * rowreq_ctx, void *context)
{
...
static void _container_free (netsnmp_container * container)
{
    ...
    if (NULL == container)
    {
        snmp_log (LOG_ERR, "invalid container in ipIfStatsTable_container_free\n");
        return;
    }
...
{
    DEBUGMSGTL (("internal:ipIfStatsTable:_ipIfStatsTable_container_init", "called\n"));
    ...
    if (NULL == if_ctx->container)
        if_ctx->container = netsnmp_container_find ("ipIfStatsTable:table_container");
    if (NULL == if_ctx->container)
    {
        snmp_log (LOG_ERR, "error creating container in " "ipIfStatsTable_container_init\n");
        return;
    }
...
ipIfStatsTable_rowreq_ctx *ipIfStatsTable_row_find_by_mib_index (ipIfStatsTable_mib_index * mib_idx)
{
