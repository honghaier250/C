...
ipDefaultRouterTable_data *ipDefaultRouterTable_allocate_data (void)
{
    ...
    if (NULL == rtn)
    {
        snmp_log (LOG_ERR, "unable to malloc memory for new " "ipDefaultRouterTable_data.\n");
    }
                                  ...
                                  size_t ipDefaultRouterAddress_val_ptr_len, long ipDefaultRouterIfIndex_val)
{
    ...
    if (MFD_SUCCESS !=
        ipDefaultRouterTable_indexes_set_tbl_idx (&rowreq_ctx->tbl_idx,
                                                  ipDefaultRouterAddressType_val,
                                                  ipDefaultRouterAddress_val_ptr,
                                                  ipDefaultRouterAddress_val_ptr_len, ipDefaultRouterIfIndex_val))
        return MFD_ERROR;
    ...
    if (0 != ipDefaultRouterTable_index_to_oid (&rowreq_ctx->oid_idx, &rowreq_ctx->tbl_idx))
    {
        return MFD_ERROR;
    }
 ...
 */
int ipDefaultRouterLifetime_get (ipDefaultRouterTable_rowreq_ctx * rowreq_ctx, u_long * ipDefaultRouterLifetime_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:ipDefaultRouterTable:ipDefaultRouterLifetime_get", "called\n"));
 ...
 */
int
ipDefaultRouterPreference_get (ipDefaultRouterTable_rowreq_ctx * rowreq_ctx, u_long * ipDefaultRouterPreference_val_ptr)
{
