...
{
    DEBUGMSGTL (("verbose:ipDefaultRouterTable:init_ipDefaultRouterTable", "called\n"));
...
void initialize_table_ipDefaultRouterTable (void)
{
     ...
     */
    ipDefaultRouterTable_user_context_p = netsnmp_create_data_list ("ipDefaultRouterTable", NULL, NULL);
 ...
 */
int ipDefaultRouterTable_rowreq_ctx_init (ipDefaultRouterTable_rowreq_ctx * rowreq_ctx, void *user_init_ctx)
{
 ...
 *
 */
void ipDefaultRouterTable_rowreq_ctx_cleanup (ipDefaultRouterTable_rowreq_ctx * rowreq_ctx)
{
 ...
 */
int ipDefaultRouterTable_pre_request (ipDefaultRouterTable_registration * user_context)
{
 ...
 */
int ipDefaultRouterTable_post_request (ipDefaultRouterTable_registration * user_context, int rc)
{
