 ...
 */
     ...
     static void _ipv6InterfaceTable_container_init (ipv6InterfaceTable_interface_ctx * if_ctx);

     static void _ipv6InterfaceTable_container_shutdown (ipv6InterfaceTable_interface_ctx * if_ctx);
...
ipv6InterfaceTable_registration *ipv6InterfaceTable_registration_get (void)
{
    return ipv6InterfaceTable_if_ctx.user_ctx;
}

ipv6InterfaceTable_registration *ipv6InterfaceTable_registration_set (ipv6InterfaceTable_registration * newreg)
{
    ipv6InterfaceTable_registration *old = ipv6InterfaceTable_if_ctx.user_ctx;
 ...
 * table.
 */
void ipv6InterfaceTable_lastChange_set (u_long table_changed)
{
...
_ipv6InterfaceTable_undo_column (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column);
#endif
 ...
 */
void _ipv6InterfaceTable_initialize_interface (ipv6InterfaceTable_registration * reg_ptr, u_long flags)
{
    netsnmp_baby_steps_access_methods *access_multiplexer = &ipv6InterfaceTable_if_ctx.access_multiplexer;

    netsnmp_table_registration_info *tbl_info = &ipv6InterfaceTable_if_ctx.tbl_info;
    ...
    {
        snmp_log (LOG_ERR, "could not initialize container for ipv6InterfaceTable\n");
        return;
    }
     ...
     */
    access_multiplexer->object_lookup = _mfd_ipv6InterfaceTable_object_lookup;
    ...
    access_multiplexer->post_request = _mfd_ipv6InterfaceTable_post_request;
     ...
     */
    access_multiplexer->object_syntax_checks = _mfd_ipv6InterfaceTable_check_objects;
    access_multiplexer->undo_setup = _mfd_ipv6InterfaceTable_undo_setup;
    access_multiplexer->undo_cleanup = _mfd_ipv6InterfaceTable_undo_cleanup;
    ...
    access_multiplexer->irreversible_commit = _mfd_ipv6InterfaceTable_irreversible_commit;
#endif
    ...
    reginfo =
        netsnmp_handler_registration_create ("ipv6InterfaceTable", handler,
                                             ipv6InterfaceTable_oid, ipv6InterfaceTable_oid_size, HANDLER_CAN_BABY_STEP
#ifndef NETSNMP_DISABLE_SET_SUPPORT
                                             | HANDLER_CAN_RWRITE
#endif
        );
    ...
    handler =
        netsnmp_container_table_handler_get (tbl_info,
                                             ipv6InterfaceTable_if_ctx.container, TABLE_CONTAINER_KEY_NETSNMP_INDEX);
    netsnmp_inject_handler (reginfo, handler);
     ...
     */
    {
        ...
        netsnmp_register_watched_scalar2 (netsnmp_create_handler_registration
                                          ...
                                          netsnmp_create_watcher_info ((void
                                                                        *)
                                                                       &ipv6InterfaceTable_if_ctx.last_changed,
                                                                       sizeof
                                                                       (u_long), ASN_TIMETICKS, WATCHER_FIXED_SIZE));
    }
 ...
 */
void _ipv6InterfaceTable_shutdown_interface (ipv6InterfaceTable_registration * reg_ptr)
{
    /*
...
void ipv6InterfaceTable_valid_columns_set (netsnmp_column_info * vc)
{
                                     ...
                                     netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    {
        DEBUGMSGTL (("internal:ipv6InterfaceTable", "skipping additional pre_request\n"));
        return SNMP_ERR_NOERROR;
    }

    rc = ipv6InterfaceTable_pre_request (ipv6InterfaceTable_if_ctx.user_ctx);
    if (MFD_SUCCESS != rc)
    {
        /*
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ipv6InterfaceTable", "error %d from " "ipv6InterfaceTable_pre_request\n", rc));
                                      ...
                                      netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    {
        DEBUGMSGTL (("internal:ipv6InterfaceTable", "waiting for last post_request\n"));
        return SNMP_ERR_NOERROR;
    }
    ...
    if ((MFD_SUCCESS != packet_rc) && ipv6InterfaceTable_dirty_get ())
    {
         ...
         * the dirty flags.
         */
        snmp_log (LOG_WARNING, "ipv6InterfaceTable dirty flag set in post_request " "but status != SUCCESS.\n");
    }

    rc = ipv6InterfaceTable_post_request (ipv6InterfaceTable_if_ctx.user_ctx, packet_rc);
    if (MFD_SUCCESS != rc)
    {
        /*
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ipv6InterfaceTable", "error %d from " "ipv6InterfaceTable_post_request\n", rc));
    }
                                       ...
                                       * agtreq_info, netsnmp_request_info * requests)
{
    ...
    ipv6InterfaceTable_rowreq_ctx *rowreq_ctx = netsnmp_container_table_row_extract (requests);
 ...
 */
NETSNMP_STATIC_INLINE int
_ipv6InterfaceTable_get_column (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    ...
    switch (column)
    {
        ...
        case COLUMN_IPV6INTERFACEREASMMAXSIZE:
            ...
            rc = ipv6InterfaceReasmMaxSize_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPV6INTERFACEIDENTIFIER:
            ...
            rc = ipv6InterfaceIdentifier_get (rowreq_ctx, (char **) &var->val.string, &var->val_len);
            break;
        ...
        case COLUMN_IPV6INTERFACEENABLESTATUS:
            ...
            rc = ipv6InterfaceEnableStatus_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPV6INTERFACEREACHABLETIME:
            var->val_len = sizeof (u_long);
            var->type = ASN_UNSIGNED;
            rc = ipv6InterfaceReachableTime_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPV6INTERFACERETRANSMITTIME:
            var->val_len = sizeof (u_long);
            var->type = ASN_UNSIGNED;
            rc = ipv6InterfaceRetransmitTime_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPV6INTERFACEFORWARDING:
            var->val_len = sizeof (u_long);
            var->type = ASN_INTEGER;
            rc = ipv6InterfaceForwarding_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        default:
            ...
            {
                snmp_log (LOG_ERR, "unknown column %d in _ipv6InterfaceTable_get_column\n", column);
            }
            break;
    }
                                    ...
                                    netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipv6InterfaceTable_get_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            if (MFD_SKIP == rc)
            {
 ...
 */
NETSNMP_STATIC_INLINE int
_ipv6InterfaceTable_check_column (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    switch (column)
    {
        ...
        case COLUMN_IPV6INTERFACEIDENTIFIER:
             ...
             */
        case COLUMN_IPV6INTERFACEENABLESTATUS:
            rc = netsnmp_check_vb_type_and_size (var, ASN_INTEGER, sizeof (rowreq_ctx->data.ipv6InterfaceEnableStatus));
            /*
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipv6InterfaceTable:_ipv6InterfaceTable_check_column:ipv6InterfaceEnableStatus",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = ipv6InterfaceEnableStatus_check_value (rowreq_ctx, *((u_long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from ipv6InterfaceEnableStatus_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_IPV6INTERFACERETRANSMITTIME:
             ...
             */
        case COLUMN_IPV6INTERFACEFORWARDING:
            rc = netsnmp_check_vb_type_and_size (var, ASN_INTEGER, sizeof (rowreq_ctx->data.ipv6InterfaceForwarding));
            /*
             * check that the value is one of defined enums 
             */
            if ((SNMPERR_SUCCESS == rc)
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipv6InterfaceTable:_ipv6InterfaceTable_check_column:ipv6InterfaceForwarding",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = ipv6InterfaceForwarding_check_value (rowreq_ctx, *((u_long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from ipv6InterfaceForwarding_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        default:
            ...
            rc = SNMP_ERR_GENERR;
            snmp_log (LOG_ERR, "unknown column %d in _ipv6InterfaceTable_check_column\n", column);
    }
                                       ...
                                       * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipv6InterfaceTable_check_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            netsnmp_request_set_error (requests, SNMP_VALIDATE_ERR (rc));
            break;
 ...
 */
NETSNMP_STATIC_INLINE int _ipv6InterfaceTable_undo_setup_column (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx, int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    switch (column)
    {
             ...
             */
        case COLUMN_IPV6INTERFACEENABLESTATUS:
            rowreq_ctx->column_set_flags |= COLUMN_IPV6INTERFACEENABLESTATUS_FLAG;
             ...
             */
        case COLUMN_IPV6INTERFACEFORWARDING:
            rowreq_ctx->column_set_flags |= COLUMN_IPV6INTERFACEFORWARDING_FLAG;
            rc = ipv6InterfaceForwarding_undo_setup (rowreq_ctx);
            break;

        default:
            snmp_log (LOG_ERR, "unknown column %d in _ipv6InterfaceTable_undo_setup_column\n", column);
            break;
    }
                                    ...
                                    netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("ipv6InterfaceTable:mfd", "error %d from " "ipv6InterfaceTable_undo_setup\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
    else
    {
        ...
        for (; requests; requests = requests->next)
        {
            ...
            rc = _ipv6InterfaceTable_undo_setup_column (rowreq_ctx, tri->colnum);
            if (MFD_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipv6InterfaceTable:mfd", "error %d from " "ipv6InterfaceTable_undo_setup_column\n", rc));
                                      ...
                                      netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ipv6InterfaceTable:mfd", "error %d from " "ipv6InterfaceTable_undo_cleanup\n", rc));
    }
 ...
 */
NETSNMP_STATIC_INLINE int
_ipv6InterfaceTable_set_column (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    switch (column)
    {
        ...
        case COLUMN_IPV6INTERFACEENABLESTATUS:
            rowreq_ctx->column_set_flags |= COLUMN_IPV6INTERFACEENABLESTATUS_FLAG;
            rc = ipv6InterfaceEnableStatus_set (rowreq_ctx, *((u_long *) var->val.string));
            break;
        ...
        case COLUMN_IPV6INTERFACEFORWARDING:
            rowreq_ctx->column_set_flags |= COLUMN_IPV6INTERFACEFORWARDING_FLAG;
            rc = ipv6InterfaceForwarding_set (rowreq_ctx, *((u_long *) var->val.string));
            break;

        default:
            snmp_log (LOG_ERR, "unknown column %d in _ipv6InterfaceTable_set_column\n", column);
            rc = SNMP_ERR_GENERR;
            break;
    }
                                    ...
                                    netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipv6InterfaceTable_set_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            DEBUGMSGTL (("ipv6InterfaceTable:mfd", "error %d from " "ipv6InterfaceTable_set_column\n", rc));
            netsnmp_set_request_error (agtreq_info, requests, SNMP_VALIDATE_ERR (rc));
        }
    }                            /* for results */
                                ...
                                netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("ipv6InterfaceTable:mfd", "error %d from " "ipv6InterfaceTable_commit\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
                                     ...
                                     netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ipv6InterfaceTable:mfd", "error %d from " "ipv6InterfaceTable_undo_commit\n", rc));
    }

    if (rowreq_ctx->rowreq_flags & MFD_ROW_DIRTY)
    {
        snmp_log (LOG_WARNING, "ipv6InterfaceTable row dirty flag still set after undo_commit\n");
...
_ipv6InterfaceTable_undo_column (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    ...
    switch (column)
    {
        ...
        default:
            snmp_log (LOG_ERR, "unknown column %d in _ipv6InterfaceTable_undo_column\n", column);
            break;
    }
                                     ...
                                     netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ipv6InterfaceTable:mfd", "error %d from " "ipv6InterfaceTable_undo\n", rc));
    }
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipv6InterfaceTable_undo_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            /*
             * nothing we can do about it but log it
             */
            DEBUGMSGTL (("ipv6InterfaceTable:mfd", "error %d from " "ipv6InterfaceTable_undo_column\n", rc));
        }
    }                            /* for results */
...
static void _container_free (netsnmp_container * container)
{
    ...
    if (NULL == container)
    {
        snmp_log (LOG_ERR, "invalid container in ipv6InterfaceTable_container_free\n");
        return;
    }
 ...
 */
void _ipv6InterfaceTable_container_init (ipv6InterfaceTable_interface_ctx * if_ctx)
{
    ...
    if (NULL == if_ctx->container)
        if_ctx->container = netsnmp_container_find ("ipv6InterfaceTable:table_container");
    if (NULL == if_ctx->container)
    {
        snmp_log (LOG_ERR, "error creating container in " "ipv6InterfaceTable_container_init\n");
        return;
    }
 ...
 */
void _ipv6InterfaceTable_container_shutdown (ipv6InterfaceTable_interface_ctx * if_ctx)
{
...
ipv6InterfaceTable_rowreq_ctx *ipv6InterfaceTable_row_find_by_mib_index (ipv6InterfaceTable_mib_index * mib_idx)
{
    ...
    rowreq_ctx = CONTAINER_FIND (ipv6InterfaceTable_if_ctx.container, &oid_idx);
