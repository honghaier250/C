...
const int ipv6InterfaceTable_oid_size = OID_LENGTH (ipv6InterfaceTable_oid);
...
{
    DEBUGMSGTL (("verbose:ipv6InterfaceTable:init_ipv6InterfaceTable", "called\n"));
...
void initialize_table_ipv6InterfaceTable (void)
{
     ...
     */
    ipv6InterfaceTable_user_context_p = netsnmp_create_data_list ("ipv6InterfaceTable", NULL, NULL);
     ...
     */
    _ipv6InterfaceTable_initialize_interface (ipv6InterfaceTable_user_context_p, flags);
...
void shutdown_table_ipv6InterfaceTable (void)
{
     ...
     */
    _ipv6InterfaceTable_shutdown_interface (ipv6InterfaceTable_user_context_p);
 ...
 */
int ipv6InterfaceTable_rowreq_ctx_init (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx, void *user_init_ctx)
{
 ...
 * @param rowreq_ctx
 */
void ipv6InterfaceTable_rowreq_ctx_cleanup (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx)
{
 ...
 */
int ipv6InterfaceTable_pre_request (ipv6InterfaceTable_registration * user_context)
{
 ...
 */
int ipv6InterfaceTable_post_request (ipv6InterfaceTable_registration * user_context, int rc)
{
 ...
 */
int
ipv6InterfaceReasmMaxSize_get (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx, u_long * ipv6InterfaceReasmMaxSize_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:ipv6InterfaceTable:ipv6InterfaceReasmMaxSize_get", "called\n"));

    netsnmp_assert (NULL != rowreq_ctx);

    if (!(rowreq_ctx->data.ifentry->ns_flags & NETSNMP_INTERFACE_FLAGS_HAS_V6_REASMMAX))
        return MFD_SKIP;
     ...
     */
    (*ipv6InterfaceReasmMaxSize_val_ptr) = rowreq_ctx->data.ipv6InterfaceReasmMaxSize;
...
ipv6InterfaceIdentifier_get (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx,
                             ...
                             size_t * ipv6InterfaceIdentifier_val_ptr_len_ptr)
{

   /** we should have a non-NULL pointer and enough storage */
    netsnmp_assert ((NULL != ipv6InterfaceIdentifier_val_ptr_ptr) && (NULL != *ipv6InterfaceIdentifier_val_ptr_ptr));
    ...
    if ((NULL == (*ipv6InterfaceIdentifier_val_ptr_ptr)) ||
        ((*ipv6InterfaceIdentifier_val_ptr_len_ptr) <
         (rowreq_ctx->data.ipv6InterfaceIdentifier_len * sizeof (rowreq_ctx->data.ipv6InterfaceIdentifier[0]))))
    {
        /*
 ...
 */
int
ipv6InterfaceEnableStatus_get (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx, u_long * ipv6InterfaceEnableStatus_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:ipv6InterfaceTable:ipv6InterfaceEnableStatus_get", "called\n"));
     ...
     */
    (*ipv6InterfaceEnableStatus_val_ptr) = rowreq_ctx->data.ipv6InterfaceEnableStatus;
 ...
 */
int
ipv6InterfaceReachableTime_get (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx, u_long * ipv6InterfaceReachableTime_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
     ...
     */
    (*ipv6InterfaceReachableTime_val_ptr) = rowreq_ctx->data.ipv6InterfaceReachableTime;
...
ipv6InterfaceRetransmitTime_get (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx,
                                 u_long * ipv6InterfaceRetransmitTime_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
     ...
     */
    (*ipv6InterfaceRetransmitTime_val_ptr) = rowreq_ctx->data.ipv6InterfaceRetransmitTime;
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipv6InterfaceForwarding_get (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx, u_long * ipv6InterfaceForwarding_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
     ...
     */
    (*ipv6InterfaceForwarding_val_ptr) = (rowreq_ctx->data.ipv6InterfaceForwarding) ? 1 : 2;
 ...
 */
int ipv6InterfaceTable_undo_setup (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL (("verbose:ipv6InterfaceTable:ipv6InterfaceTable_undo_setup", "called\n"));
 ...
 * @retval MFD_ERROR   : error. set will fail.
 */
int ipv6InterfaceTable_undo (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL (("verbose:ipv6InterfaceTable:ipv6InterfaceTable_undo", "called\n"));
 ...
 */
int ipv6InterfaceTable_undo_cleanup (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;
 ...
 * @retval MFD_ERROR   : error
 */
int ipv6InterfaceTable_commit (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    int save_flags;

    DEBUGMSGTL (("verbose:ipv6InterfaceTable:ipv6InterfaceTable_commit", "called\n"));
    ...
    if (save_flags & COLUMN_IPV6INTERFACEENABLESTATUS_FLAG)
    {
        ...
        if (-1 == rc)
        {
            snmp_log (LOG_ERR, "ipv6InterfaceTable column ipv6InterfaceEnableStatus commit failed\n");
        }
        else
        {
            /*
    ...
    if (save_flags & COLUMN_IPV6INTERFACEFORWARDING_FLAG)
    {
        ...
        if (-1 == rc)
        {
            snmp_log (LOG_ERR, "ipv6InterfaceTable column ipv6InterfaceForwarding commit failed\n");
        }
        else
        {
            /*
 ...
 * @retval MFD_ERROR   : error
 */
int ipv6InterfaceTable_undo_commit (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;
 ...
 */
int
ipv6InterfaceEnableStatus_check_value (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx, u_long ipv6InterfaceEnableStatus_val)
{
 ...
 */
int ipv6InterfaceEnableStatus_undo_setup (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx)
{
 ...
 *        A long containing the new value.
 */
int ipv6InterfaceEnableStatus_set (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx, u_long ipv6InterfaceEnableStatus_val)
{

    DEBUGMSGTL (("verbose:ipv6InterfaceTable:ipv6InterfaceEnableStatus_set", "called\n"));
     ...
     */
    rowreq_ctx->data.ipv6InterfaceEnableStatus = ipv6InterfaceEnableStatus_val;
 ...
 *        Pointer to the users context.
 */
int ipv6InterfaceEnableStatus_undo (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx)
{
     ...
     */
    rowreq_ctx->data.ipv6InterfaceEnableStatus = rowreq_ctx->undo->ipv6InterfaceEnableStatus;
 ...
 *
 */
int ipv6InterfaceForwarding_check_value (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx, u_long ipv6InterfaceForwarding_val)
{
 ...
 * won't be done unless it is necessary.
 */
int ipv6InterfaceForwarding_undo_setup (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx)
{
     ...
     */
    rowreq_ctx->undo->ipv6InterfaceForwarding = rowreq_ctx->data.ipv6InterfaceForwarding;
 ...
 *        A long containing the new value.
 */
int ipv6InterfaceForwarding_set (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx, u_long ipv6InterfaceForwarding_val)
{
 ...
 *        Pointer to the users context.
 */
int ipv6InterfaceForwarding_undo (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx)
{

    DEBUGMSGTL (("verbose:ipv6InterfaceTable:ipv6InterfaceForwarding_undo", "called\n"));
     ...
     */
    rowreq_ctx->data.ipv6InterfaceForwarding = rowreq_ctx->undo->ipv6InterfaceForwarding;
