 ...
 */
int ipv6InterfaceTable_init_data (ipv6InterfaceTable_registration * ipv6InterfaceTable_reg)
{
    DEBUGMSGTL (("verbose:ipv6InterfaceTable:ipv6InterfaceTable_init_data", "called\n"));
 ...
 */
void ipv6InterfaceTable_container_init (netsnmp_container ** container_ptr_ptr)
{
    DEBUGMSGTL (("verbose:ipv6InterfaceTable:ipv6InterfaceTable_container_init", "called\n"));

    if (NULL == container_ptr_ptr)
    {
        snmp_log (LOG_ERR, "bad container param to ipv6InterfaceTable_container_init\n");
        return;
    }
 ...
 */
void ipv6InterfaceTable_check_entry_for_updates (const ifTable_rowreq_ctx * ift_rrc, netsnmp_interface_entry * entry)
{
    ...
    DEBUGMSGTL (("verbose:ipv6InterfaceTable:check_entry_for_updates", "called\n"));
    ...
    else
    {
         ...
         */
        if ((NULL == entry) || (0 == (entry->ns_flags & NETSNMP_INTERFACE_FLAGS_HAS_IPV6)))
        {
            /*
             * no
             */
        ...
        else
        {
            ...
            if (/** retransmit */
                   ((entry->ns_flags & NETSNMP_INTERFACE_FLAGS_HAS_V6_RETRANSMIT)
                    && (entry->retransmit_v6 != ift_rrc->data.ifentry->retransmit_v6)) ||

                /** reasm */
                   ((entry->ns_flags & NETSNMP_INTERFACE_FLAGS_HAS_V6_REASMMAX)
                    && (entry->reasm_max_v6 != ift_rrc->data.ifentry->reasm_max_v6)) ||
                ...
                /** if id */
                   ((entry->ns_flags & NETSNMP_INTERFACE_FLAGS_HAS_V6_IFID)
                    ...
                    ((entry->v6_if_id_len !=
                     ...
                     || (0 != memcmp (entry->v6_if_id, ift_rrc->data.ifentry->v6_if_id, entry->v6_if_id_len)))) ||
 ...
 */
void ipv6InterfaceTable_container_shutdown (netsnmp_container * container_ptr)
{
    DEBUGMSGTL (("verbose:ipv6InterfaceTable:ipv6InterfaceTable_container_shutdown", "called\n"));

    if (NULL == container_ptr)
    {
        snmp_log (LOG_ERR, "bad params to ipv6InterfaceTable_container_shutdown\n");
        return;
    }
 ...
 *
 */
int ipv6InterfaceTable_container_load (netsnmp_container * container)
{
    ...
    while (1)
    {
        ...
        if (MFD_SUCCESS != ipv6InterfaceTable_indexes_set (rowreq_ctx, ipv6InterfaceIfIndex))
        {
            snmp_log (LOG_ERR, "error setting index while loading " "ipv6InterfaceTable data.\n");
 ...
 * @retval MFD_ERROR       : other error.
 */
int ipv6InterfaceTable_row_prep (ipv6InterfaceTable_rowreq_ctx * rowreq_ctx)
{
    DEBUGMSGTL (("verbose:ipv6InterfaceTable:ipv6InterfaceTable_row_prep", "called\n"));
