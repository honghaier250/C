...
const int ipv4InterfaceTable_oid_size = OID_LENGTH (ipv4InterfaceTable_oid);
...
{
    DEBUGMSGTL (("verbose:ipv4InterfaceTable:init_ipv4InterfaceTable", "called\n"));
...
void initialize_table_ipv4InterfaceTable (void)
{
     ...
     */
    ipv4InterfaceTable_user_context_p = netsnmp_create_data_list ("ipv4InterfaceTable", NULL, NULL);
     ...
     */
    _ipv4InterfaceTable_initialize_interface (ipv4InterfaceTable_user_context_p, flags);
...
void shutdown_table_ipv4InterfaceTable (void)
{
     ...
     */
    _ipv4InterfaceTable_shutdown_interface (ipv4InterfaceTable_user_context_p);
 ...
 */
int ipv4InterfaceTable_rowreq_ctx_init (ipv4InterfaceTable_rowreq_ctx * rowreq_ctx, void *user_init_ctx)
{
 ...
 *
 */
void ipv4InterfaceTable_rowreq_ctx_cleanup (ipv4InterfaceTable_rowreq_ctx * rowreq_ctx)
{
 ...
 */
int ipv4InterfaceTable_pre_request (ipv4InterfaceTable_registration * user_context)
{
 ...
 */
int ipv4InterfaceTable_post_request (ipv4InterfaceTable_registration * user_context, int rc)
{
 ...
 */
int ipv4InterfaceReasmMaxSize_get (ipv4InterfaceTable_rowreq_ctx * rowreq_ctx, long *ipv4InterfaceReasmMaxSize_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
     ...
     */
    (*ipv4InterfaceReasmMaxSize_val_ptr) = rowreq_ctx->data.ipv4InterfaceReasmMaxSize;
 ...
 */
int
ipv4InterfaceEnableStatus_get (ipv4InterfaceTable_rowreq_ctx * rowreq_ctx, u_long * ipv4InterfaceEnableStatus_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:ipv4InterfaceTable:ipv4InterfaceEnableStatus_get", "called\n"));
     ...
     */
    (*ipv4InterfaceEnableStatus_val_ptr) = rowreq_ctx->data.ipv4InterfaceEnableStatus;
...
ipv4InterfaceRetransmitTime_get (ipv4InterfaceTable_rowreq_ctx * rowreq_ctx,
                                 u_long * ipv4InterfaceRetransmitTime_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
     ...
     */
    (*ipv4InterfaceRetransmitTime_val_ptr) = rowreq_ctx->data.ipv4InterfaceRetransmitTime;
 ...
 */
int ipv4InterfaceTable_undo_setup (ipv4InterfaceTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL (("verbose:ipv4InterfaceTable:ipv4InterfaceTable_undo_setup", "called\n"));
 ...
 * @retval MFD_ERROR   : error. set will fail.
 */
int ipv4InterfaceTable_undo (ipv4InterfaceTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL (("verbose:ipv4InterfaceTable:ipv4InterfaceTable_undo", "called\n"));
 ...
 */
int ipv4InterfaceTable_undo_cleanup (ipv4InterfaceTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;
 ...
 * @retval MFD_ERROR   : error
 */
int ipv4InterfaceTable_commit (ipv4InterfaceTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    int save_flags;

    DEBUGMSGTL (("verbose:ipv4InterfaceTable:ipv4InterfaceTable_commit", "called\n"));
    ...
    if (save_flags & COLUMN_IPV4INTERFACEENABLESTATUS_FLAG)
    {
        ...
        if (-1 == rc)
        {
            snmp_log (LOG_ERR, "ipv4InterfaceTable column ipv4InterfaceEnableStatus commit failed\n");
        }
        else
        {
            /*
 ...
 * @retval MFD_ERROR   : error
 */
int ipv4InterfaceTable_undo_commit (ipv4InterfaceTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;
 ...
 */
int
ipv4InterfaceEnableStatus_check_value (ipv4InterfaceTable_rowreq_ctx * rowreq_ctx, u_long ipv4InterfaceEnableStatus_val)
{
     ...
     */
    if (rowreq_ctx->data.ifentry->ns_flags & NETSNMP_INTERFACE_FLAGS_CAN_DOWN_PROTOCOL);
    else
 ...
 */
int ipv4InterfaceEnableStatus_undo_setup (ipv4InterfaceTable_rowreq_ctx * rowreq_ctx)
{
     ...
     */
    rowreq_ctx->undo->ipv4InterfaceEnableStatus = rowreq_ctx->data.ipv4InterfaceEnableStatus;
 ...
 *        A long containing the new value.
 */
int ipv4InterfaceEnableStatus_set (ipv4InterfaceTable_rowreq_ctx * rowreq_ctx, u_long ipv4InterfaceEnableStatus_val)
{

    DEBUGMSGTL (("verbose:ipv4InterfaceTable:ipv4InterfaceEnableStatus_set", "called\n"));
     ...
     */
    rowreq_ctx->data.ipv4InterfaceEnableStatus = ipv4InterfaceEnableStatus_val;
 ...
 *        Pointer to the users context.
 */
int ipv4InterfaceEnableStatus_undo (ipv4InterfaceTable_rowreq_ctx * rowreq_ctx)
{
     ...
     */
    rowreq_ctx->data.ipv4InterfaceEnableStatus = rowreq_ctx->undo->ipv4InterfaceEnableStatus;
