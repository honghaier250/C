 ...
 */
     ...
     static void _ipv4InterfaceTable_container_init (ipv4InterfaceTable_interface_ctx * if_ctx);

     static void _ipv4InterfaceTable_container_shutdown (ipv4InterfaceTable_interface_ctx * if_ctx);
...
ipv4InterfaceTable_registration *ipv4InterfaceTable_registration_get (void)
{
    return ipv4InterfaceTable_if_ctx.user_ctx;
}

ipv4InterfaceTable_registration *ipv4InterfaceTable_registration_set (ipv4InterfaceTable_registration * newreg)
{
    ipv4InterfaceTable_registration *old = ipv4InterfaceTable_if_ctx.user_ctx;
 ...
 * table.
 */
void ipv4InterfaceTable_lastChange_set (u_long table_changed)
{
...
_ipv4InterfaceTable_undo_column (ipv4InterfaceTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column);
#endif
 ...
 */
void _ipv4InterfaceTable_initialize_interface (ipv4InterfaceTable_registration * reg_ptr, u_long flags)
{
    netsnmp_baby_steps_access_methods *access_multiplexer = &ipv4InterfaceTable_if_ctx.access_multiplexer;

    netsnmp_table_registration_info *tbl_info = &ipv4InterfaceTable_if_ctx.tbl_info;
    ...
    {
        snmp_log (LOG_ERR, "could not initialize container for ipv4InterfaceTable\n");
        return;
    }
     ...
     */
    access_multiplexer->object_lookup = _mfd_ipv4InterfaceTable_object_lookup;
    ...
    access_multiplexer->post_request = _mfd_ipv4InterfaceTable_post_request;
     ...
     */
    access_multiplexer->object_syntax_checks = _mfd_ipv4InterfaceTable_check_objects;
    access_multiplexer->undo_setup = _mfd_ipv4InterfaceTable_undo_setup;
    access_multiplexer->undo_cleanup = _mfd_ipv4InterfaceTable_undo_cleanup;
    ...
    access_multiplexer->irreversible_commit = _mfd_ipv4InterfaceTable_irreversible_commit;
#endif
    ...
    reginfo =
        netsnmp_handler_registration_create ("ipv4InterfaceTable", handler,
                                             ipv4InterfaceTable_oid, ipv4InterfaceTable_oid_size, HANDLER_CAN_BABY_STEP
#ifndef NETSNMP_DISABLE_SET_SUPPORT
                                             | HANDLER_CAN_RWRITE
#endif
        );
    ...
    handler =
        netsnmp_container_table_handler_get (tbl_info,
                                             ipv4InterfaceTable_if_ctx.container, TABLE_CONTAINER_KEY_NETSNMP_INDEX);
    netsnmp_inject_handler (reginfo, handler);
     ...
     */
    {
        ...
        netsnmp_register_watched_scalar2 (netsnmp_create_handler_registration
                                          ...
                                          netsnmp_create_watcher_info ((void
                                                                        *)
                                                                       &ipv4InterfaceTable_if_ctx.last_changed,
                                                                       sizeof
 ...
 */
void _ipv4InterfaceTable_shutdown_interface (ipv4InterfaceTable_registration * reg_ptr)
{
    /*
...
void ipv4InterfaceTable_valid_columns_set (netsnmp_column_info * vc)
{
...
ipv4InterfaceTable_data *ipv4InterfaceTable_allocate_data (void)
{
    ipv4InterfaceTable_data *rtn = SNMP_MALLOC_TYPEDEF (ipv4InterfaceTable_data);

    DEBUGMSGTL (("verbose:ipv4InterfaceTable:ipv4InterfaceTable_allocate_data", "called\n"));

    if (NULL == rtn)
    {
        snmp_log (LOG_ERR, "unable to malloc memory for new " "ipv4InterfaceTable_data.\n");
    }
                                     ...
                                     netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    {
        DEBUGMSGTL (("internal:ipv4InterfaceTable", "skipping additional pre_request\n"));
        return SNMP_ERR_NOERROR;
    }

    rc = ipv4InterfaceTable_pre_request (ipv4InterfaceTable_if_ctx.user_ctx);
    if (MFD_SUCCESS != rc)
    {
        /*
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ipv4InterfaceTable", "error %d from " "ipv4InterfaceTable_pre_request\n", rc));
                                      ...
                                      netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    {
        DEBUGMSGTL (("internal:ipv4InterfaceTable", "waiting for last post_request\n"));
        return SNMP_ERR_NOERROR;
    }
    ...
    if ((MFD_SUCCESS != packet_rc) && ipv4InterfaceTable_dirty_get ())
    {
         ...
         * the dirty flags.
         */
        snmp_log (LOG_WARNING, "ipv4InterfaceTable dirty flag set in post_request " "but status != SUCCESS.\n");
    }

    rc = ipv4InterfaceTable_post_request (ipv4InterfaceTable_if_ctx.user_ctx, packet_rc);
    if (MFD_SUCCESS != rc)
    {
        /*
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ipv4InterfaceTable", "error %d from " "ipv4InterfaceTable_post_request\n", rc));
    }
                                       ...
                                       * agtreq_info, netsnmp_request_info * requests)
{
    ...
    ipv4InterfaceTable_rowreq_ctx *rowreq_ctx = netsnmp_container_table_row_extract (requests);
 ...
 */
NETSNMP_STATIC_INLINE int
_ipv4InterfaceTable_get_column (ipv4InterfaceTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    ...
    switch (column)
    {
        ...
        case COLUMN_IPV4INTERFACEREASMMAXSIZE:
            ...
            rc = ipv4InterfaceReasmMaxSize_get (rowreq_ctx, (long *) var->val.string);
            break;
        ...
        case COLUMN_IPV4INTERFACEENABLESTATUS:
            ...
            var->type = ASN_INTEGER;
            rc = ipv4InterfaceEnableStatus_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPV4INTERFACERETRANSMITTIME:
            ...
            rc = ipv4InterfaceRetransmitTime_get (rowreq_ctx, (u_long *) var->val.string);
            break;

        default:
            snmp_log (LOG_ERR, "unknown column %d in _ipv4InterfaceTable_get_column\n", column);
            break;
    }
                                    ...
                                    netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipv4InterfaceTable_get_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            if (MFD_SKIP == rc)
            {
 ...
 */
NETSNMP_STATIC_INLINE int
_ipv4InterfaceTable_check_column (ipv4InterfaceTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    switch (column)
    {
        ...
        case COLUMN_IPV4INTERFACEREASMMAXSIZE:
             ...
             */
        case COLUMN_IPV4INTERFACEENABLESTATUS:
            rc = netsnmp_check_vb_type_and_size (var, ASN_INTEGER, sizeof (rowreq_ctx->data.ipv4InterfaceEnableStatus));
            /*
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipv4InterfaceTable:_ipv4InterfaceTable_check_column:ipv4InterfaceEnableStatus",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = ipv4InterfaceEnableStatus_check_value (rowreq_ctx, *((u_long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from ipv4InterfaceEnableStatus_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        default:
            ...
            rc = SNMP_ERR_GENERR;
            snmp_log (LOG_ERR, "unknown column %d in _ipv4InterfaceTable_check_column\n", column);
    }
                                       ...
                                       * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipv4InterfaceTable_check_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            netsnmp_request_set_error (requests, SNMP_VALIDATE_ERR (rc));
            break;
 ...
 */
NETSNMP_STATIC_INLINE int _ipv4InterfaceTable_undo_setup_column (ipv4InterfaceTable_rowreq_ctx * rowreq_ctx, int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    switch (column)
    {
             ...
             */
        case COLUMN_IPV4INTERFACEENABLESTATUS:
            rowreq_ctx->column_set_flags |= COLUMN_IPV4INTERFACEENABLESTATUS_FLAG;
            rc = ipv4InterfaceEnableStatus_undo_setup (rowreq_ctx);
            break;

        default:
            snmp_log (LOG_ERR, "unknown column %d in _ipv4InterfaceTable_undo_setup_column\n", column);
            break;
    }
                                    ...
                                    netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("ipv4InterfaceTable:mfd", "error %d from " "ipv4InterfaceTable_undo_setup\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
    else
    {
        ...
        for (; requests; requests = requests->next)
        {
            ...
            rc = _ipv4InterfaceTable_undo_setup_column (rowreq_ctx, tri->colnum);
            if (MFD_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipv4InterfaceTable:mfd", "error %d from " "ipv4InterfaceTable_undo_setup_column\n", rc));
                                      ...
                                      netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ipv4InterfaceTable:mfd", "error %d from " "ipv4InterfaceTable_undo_cleanup\n", rc));
    }
 ...
 */
NETSNMP_STATIC_INLINE int
_ipv4InterfaceTable_set_column (ipv4InterfaceTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    switch (column)
    {
        ...
        case COLUMN_IPV4INTERFACEENABLESTATUS:
            rowreq_ctx->column_set_flags |= COLUMN_IPV4INTERFACEENABLESTATUS_FLAG;
            rc = ipv4InterfaceEnableStatus_set (rowreq_ctx, *((u_long *) var->val.string));
            break;

        default:
            snmp_log (LOG_ERR, "unknown column %d in _ipv4InterfaceTable_set_column\n", column);
            rc = SNMP_ERR_GENERR;
            break;
    }
                                    ...
                                    netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipv4InterfaceTable_set_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            DEBUGMSGTL (("ipv4InterfaceTable:mfd", "error %d from " "ipv4InterfaceTable_set_column\n", rc));
            netsnmp_set_request_error (agtreq_info, requests, SNMP_VALIDATE_ERR (rc));
        }
    }                            /* for results */
                                ...
                                netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("ipv4InterfaceTable:mfd", "error %d from " "ipv4InterfaceTable_commit\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
                                     ...
                                     netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ipv4InterfaceTable:mfd", "error %d from " "ipv4InterfaceTable_undo_commit\n", rc));
    }

    if (rowreq_ctx->rowreq_flags & MFD_ROW_DIRTY)
    {
        snmp_log (LOG_WARNING, "ipv4InterfaceTable row dirty flag still set after undo_commit\n");
...
_ipv4InterfaceTable_undo_column (ipv4InterfaceTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    ...
    switch (column)
    {
        ...
        default:
            snmp_log (LOG_ERR, "unknown column %d in _ipv4InterfaceTable_undo_column\n", column);
            break;
    }
                                     ...
                                     netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ipv4InterfaceTable:mfd", "error %d from " "ipv4InterfaceTable_undo\n", rc));
    }
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipv4InterfaceTable_undo_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            /*
             * nothing we can do about it but log it
             */
            DEBUGMSGTL (("ipv4InterfaceTable:mfd", "error %d from " "ipv4InterfaceTable_undo_column\n", rc));
        }
    }                            /* for results */
...
static void _container_free (netsnmp_container * container)
{
    ...
    if (NULL == container)
    {
        snmp_log (LOG_ERR, "invalid container in ipv4InterfaceTable_container_free\n");
        return;
    }
 ...
 */
void _ipv4InterfaceTable_container_init (ipv4InterfaceTable_interface_ctx * if_ctx)
{
    ...
    if (NULL == if_ctx->container)
        if_ctx->container = netsnmp_container_find ("ipv4InterfaceTable:table_container");
    if (NULL == if_ctx->container)
    {
        snmp_log (LOG_ERR, "error creating container in " "ipv4InterfaceTable_container_init\n");
        return;
    }
 ...
 */
void _ipv4InterfaceTable_container_shutdown (ipv4InterfaceTable_interface_ctx * if_ctx)
{
...
ipv4InterfaceTable_rowreq_ctx *ipv4InterfaceTable_row_find_by_mib_index (ipv4InterfaceTable_mib_index * mib_idx)
{
    ...
    rowreq_ctx = CONTAINER_FIND (ipv4InterfaceTable_if_ctx.container, &oid_idx);
