 ...
 */
     int inetNetToMediaTable_init_data (inetNetToMediaTable_registration * inetNetToMediaTable_reg)
{
 ...
 */
static void _add_or_update_arp_entry (netsnmp_arp_entry * arp_entry, netsnmp_container * container)
{
    ...
    if ((NULL != rowreq_ctx) &&
        (MFD_SUCCESS == inetNetToMediaTable_indexes_set
         (rowreq_ctx, rowreq_ctx->data->if_index, inetAddressType,
          (char *) rowreq_ctx->data->arp_ipaddress, rowreq_ctx->data->arp_ipaddress_len)))
    {
    ...
    else
    {
        if (rowreq_ctx)
        {
            snmp_log (LOG_ERR, "error setting index while loading " "inetNetToMediaTable cache.\n");
            inetNetToMediaTable_release_rowreq_ctx (rowreq_ctx);
        }
        else
            netsnmp_access_arp_entry_free (arp_entry);
 ...
 */
static void _collect_invalid_arp_ctx (inetNetToMediaTable_rowreq_ctx * ctx, _collect_ctx * cctx)
{
...
static void _arp_hook_gc (netsnmp_arp_access * access)
{
    ...
    CONTAINER_FOR_EACH (container, (netsnmp_container_obj_func *) _collect_invalid_arp_ctx, &cctx);
 ...
 */
void inetNetToMediaTable_container_init (netsnmp_container ** container_ptr_ptr, netsnmp_cache * cache)
{
    DEBUGMSGTL (("verbose:inetNetToMediaTable:inetNetToMediaTable_container_init", "called\n"));

    if (NULL == container_ptr_ptr)
    {
        snmp_log (LOG_ERR, "bad container param to inetNetToMediaTable_container_init\n");
        return;
    }
    ...
    *container_ptr_ptr = NULL;
    ...
    if (NULL == cache)
    {
        snmp_log (LOG_ERR, "bad cache param to inetNetToMediaTable_container_init\n");
        return;
    }

    arp_access = netsnmp_access_arp_create (NETSNMP_ACCESS_ARP_CREATE_NOFLAGS,
                                            _arp_hook_update,
                                            _arp_hook_gc, &cache->timeout, &cache->flags, &cache->expired);
    if (arp_access == NULL)
    {
        snmp_log (LOG_ERR, "unable to create arp access in inetNetToMediaTable_container_init\n");
        return;
    }
...
void inetNetToMediaTable_container_shutdown (netsnmp_container * container_ptr)
{
    ...
    {
        snmp_log (LOG_ERR, "bad params to inetNetToMediaTable_container_shutdown\n");
        return;
    }
...
{
    DEBUGMSGTL (("verbose:inetNetToMediaTable:inetNetToMediaTable_row_prep", "called\n"));
 ...
 */
int inetNetToMediaIfIndex_check_index (inetNetToMediaTable_rowreq_ctx * rowreq_ctx)
{
 ...
 * If there a no other checks you need to do, simply return MFD_SUCCESS.
 */
int inetNetToMediaNetAddressType_check_index (inetNetToMediaTable_rowreq_ctx * rowreq_ctx)
{
 ...
 * If there a no other checks you need to do, simply return MFD_SUCCESS.
 */
int inetNetToMediaNetAddress_check_index (inetNetToMediaTable_rowreq_ctx * rowreq_ctx)
{
...
inetNetToMediaTable_validate_index (inetNetToMediaTable_registration *
                                    inetNetToMediaTable_reg, inetNetToMediaTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;
    ...
    if (1)
    {
        snmp_log (LOG_WARNING, "invalid index for a new row in the " "inetNetToMediaTable table.\n");
        /*
