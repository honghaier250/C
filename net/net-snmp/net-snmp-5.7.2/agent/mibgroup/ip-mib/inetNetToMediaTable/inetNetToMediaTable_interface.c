 ...
 */
     ...
     static void _inetNetToMediaTable_container_init (inetNetToMediaTable_interface_ctx * if_ctx);

     static void _inetNetToMediaTable_container_shutdown (inetNetToMediaTable_interface_ctx * if_ctx);
...
inetNetToMediaTable_registration *inetNetToMediaTable_registration_set (inetNetToMediaTable_registration * newreg)
{
...
_inetNetToMediaTable_undo_column (inetNetToMediaTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column);
#endif                            /* NETSNMP_NO_WRITE_SUPPORT || NETSNMP_DISABLE_SET_SUPPORT */

NETSNMP_STATIC_INLINE int _inetNetToMediaTable_check_indexes (inetNetToMediaTable_rowreq_ctx * rowreq_ctx);
...
{
    netsnmp_baby_steps_access_methods *access_multiplexer = &inetNetToMediaTable_if_ctx.access_multiplexer;

    netsnmp_table_registration_info *tbl_info = &inetNetToMediaTable_if_ctx.tbl_info;
    ...
    {
        snmp_log (LOG_ERR, "could not initialize container for inetNetToMediaTable\n");
        return;
    }
    ...
    reginfo =
        netsnmp_handler_registration_create ("inetNetToMediaTable", handler,
                                             ...
                                             inetNetToMediaTable_oid_size, HANDLER_CAN_BABY_STEP
    ...
    handler =
        netsnmp_container_table_handler_get (tbl_info,
                                             inetNetToMediaTable_if_ctx.container, TABLE_CONTAINER_KEY_NETSNMP_INDEX);
    netsnmp_inject_handler (reginfo, handler);
 ...
 */
void _inetNetToMediaTable_shutdown_interface (inetNetToMediaTable_registration * reg_ptr)
{
    /*
 ...
 */
int inetNetToMediaTable_index_to_oid (netsnmp_index * oid_idx, inetNetToMediaTable_mib_index * mib_idx)
{
    ...
    memset (&var_inetNetToMediaNetAddressType, 0x00, sizeof (var_inetNetToMediaNetAddressType));
    var_inetNetToMediaNetAddressType.type = ASN_INTEGER;
    memset (&var_inetNetToMediaNetAddress, 0x00, sizeof (var_inetNetToMediaNetAddress));
    ...
    var_inetNetToMediaNetAddressType.next_variable = &var_inetNetToMediaNetAddress;
    ...
    snmp_set_var_value (&var_inetNetToMediaIfIndex,
                        (u_char *) & mib_idx->inetNetToMediaIfIndex, sizeof (mib_idx->inetNetToMediaIfIndex));
    ...
    err = build_oid_noalloc (oid_idx->oids, oid_idx->len, &oid_idx->len, NULL, 0, &var_inetNetToMediaIfIndex);
    if (err)
 ...
 */
int inetNetToMediaTable_index_from_oid (netsnmp_index * oid_idx, inetNetToMediaTable_mib_index * mib_idx)
{
    int err = SNMP_ERR_NOERROR;
     ...
     */
    err = parse_oid_indexes (oid_idx->oids, oid_idx->len, &var_inetNetToMediaIfIndex);
    if (err == SNMP_ERR_NOERROR)
    {
         ...
         */
        if (var_inetNetToMediaNetAddress.val_len > sizeof (mib_idx->inetNetToMediaNetAddress))
            err = SNMP_ERR_GENERR;
        else
        {
            memcpy (mib_idx->inetNetToMediaNetAddress,
                    var_inetNetToMediaNetAddress.val.string, var_inetNetToMediaNetAddress.val_len);
            mib_idx->inetNetToMediaNetAddress_len =
                var_inetNetToMediaNetAddress.val_len / sizeof (mib_idx->inetNetToMediaNetAddress[0]);
        }
 ...
 */
inetNetToMediaTable_rowreq_ctx *inetNetToMediaTable_allocate_rowreq_ctx (inetNetToMediaTable_data * data,
                                                                         void *user_init_ctx)
{
    inetNetToMediaTable_rowreq_ctx *rowreq_ctx = SNMP_MALLOC_TYPEDEF (inetNetToMediaTable_rowreq_ctx);

    DEBUGMSGTL (("internal:inetNetToMediaTable:inetNetToMediaTable_allocate_rowreq_ctx", "called\n"));

    if (NULL == rowreq_ctx)
    {
        snmp_log (LOG_ERR, "Couldn't allocate memory for a " "inetNetToMediaTable_rowreq_ctx.\n");
        return NULL;
    }
    else
    {
    ...
    {
        if (SNMPERR_SUCCESS != inetNetToMediaTable_rowreq_ctx_init (rowreq_ctx, user_init_ctx))
        {
 ...
 */
void inetNetToMediaTable_release_rowreq_ctx (inetNetToMediaTable_rowreq_ctx * rowreq_ctx)
{
                                      ...
                                      netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    {
        DEBUGMSGTL (("internal:inetNetToMediaTable", "skipping additional pre_request\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         */
        DEBUGMSGTL (("inetNetToMediaTable", "error %d from " "inetNetToMediaTable_pre_request\n", rc));
                                       ...
                                       * agtreq_info, netsnmp_request_info * requests)
{
    ...
    {
        DEBUGMSGTL (("internal:inetNetToMediaTable", "waiting for last post_request\n"));
        return SNMP_ERR_NOERROR;
    }
    ...
    if ((MFD_SUCCESS != packet_rc) && inetNetToMediaTable_dirty_get ())
    {
         ...
         * the dirty flags.
         */
        snmp_log (LOG_WARNING, "inetNetToMediaTable dirty flag set in post_request " "but status != SUCCESS.\n");
    }
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("inetNetToMediaTable", "error %d from " "inetNetToMediaTable_post_request\n", rc));
    }
 ...
 * wrapper
 */
static inetNetToMediaTable_rowreq_ctx *_mfd_inetNetToMediaTable_rowreq_from_index (netsnmp_index * oid_idx, int *rc_ptr)
{
 ...
 */
NETSNMP_STATIC_INLINE int
_inetNetToMediaTable_get_column (inetNetToMediaTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    ...
    switch (column)
    {
        ...
        case COLUMN_INETNETTOMEDIAPHYSADDRESS:
            ...
            rc = inetNetToMediaPhysAddress_get (rowreq_ctx, (char **) &var->val.string, &var->val_len);
            break;
        ...
        case COLUMN_INETNETTOMEDIALASTUPDATED:
            ...
            rc = inetNetToMediaLastUpdated_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_INETNETTOMEDIAROWSTATUS:
            var->val_len = sizeof (u_long);
            var->type = ASN_INTEGER;
            rc = inetNetToMediaRowStatus_get (rowreq_ctx, (u_long *) var->val.string);
            break;

        default:
            snmp_log (LOG_ERR, "unknown column %d in _inetNetToMediaTable_get_column\n", column);
            break;
    }
                                     ...
                                     netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _inetNetToMediaTable_get_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            if (MFD_SKIP == rc)
            {
...
NETSNMP_STATIC_INLINE int _inetNetToMediaTable_check_indexes (inetNetToMediaTable_rowreq_ctx * rowreq_ctx)
{
    ...
    if ((SNMPERR_SUCCESS == rc)
        ...
        && (rowreq_ctx->tbl_idx.inetNetToMediaNetAddressType !=
            INETADDRESSTYPE_IPV6Z) && (rowreq_ctx->tbl_idx.inetNetToMediaNetAddressType != INETADDRESSTYPE_DNS))
    {
        rc = SNMP_ERR_WRONGVALUE;
    }
    if (MFD_SUCCESS != rc)
 ...
 */
NETSNMP_STATIC_INLINE int
_inetNetToMediaTable_check_column (inetNetToMediaTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    switch (column)
    {
        ...
        case COLUMN_INETNETTOMEDIAPHYSADDRESS:
             ...
             * check defined range(s). 
             */
            if ((SNMPERR_SUCCESS == rc) && ((var->val_len < 0) || (var->val_len > 65535)))
            {
                rc = SNMP_ERR_WRONGLENGTH;
            }
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("inetNetToMediaTable:_inetNetToMediaTable_check_column:inetNetToMediaPhysAddress",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = inetNetToMediaPhysAddress_check_value (rowreq_ctx, (char *) var->val.string, var->val_len);
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from inetNetToMediaPhysAddress_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_INETNETTOMEDIATYPE:
            ...
            if ((SNMPERR_SUCCESS == rc)
                ...
                && (*var->val.integer != INETNETTOMEDIATYPE_STATIC) && (*var->val.integer != INETNETTOMEDIATYPE_LOCAL))
            {
                rc = SNMP_ERR_WRONGVALUE;
            }
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("inetNetToMediaTable:_inetNetToMediaTable_check_column:inetNetToMediaType",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = inetNetToMediaType_check_value (rowreq_ctx, *((u_long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from inetNetToMediaType_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_INETNETTOMEDIAROWSTATUS:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("inetNetToMediaTable:_inetNetToMediaTable_check_column:inetNetToMediaRowStatus",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = inetNetToMediaRowStatus_check_value (rowreq_ctx, *((u_long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from inetNetToMediaRowStatus_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        default:
            ...
            rc = SNMP_ERR_GENERR;
            snmp_log (LOG_ERR, "unknown column %d in _inetNetToMediaTable_check_column\n", column);
    }
                                        ...
                                        * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _inetNetToMediaTable_check_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            netsnmp_request_set_error (requests, SNMP_VALIDATE_ERR (rc));
            break;
                                             ...
                                             * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (rc)
    {
        DEBUGMSGTL (("inetNetToMediaTable:mfd", "error %d from " "inetNetToMediaTable_check_dependencies\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
 ...
 */
NETSNMP_STATIC_INLINE int
_inetNetToMediaTable_undo_setup_column (inetNetToMediaTable_rowreq_ctx * rowreq_ctx, int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    switch (column)
    {
        ...
        default:
            snmp_log (LOG_ERR, "unknown column %d in _inetNetToMediaTable_undo_setup_column\n", column);
            break;
    }
                                     ...
                                     netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("inetNetToMediaTable:mfd", "error %d from " "inetNetToMediaTable_undo_setup\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
    else
    {
        ...
        for (; requests; requests = requests->next)
        {
            ...
            rc = _inetNetToMediaTable_undo_setup_column (rowreq_ctx, tri->colnum);
            if (MFD_SUCCESS != rc)
            {
                                       ...
                                       * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("inetNetToMediaTable:mfd", "error %d from " "inetNetToMediaTable_undo_cleanup\n", rc));
    }
 ...
 */
NETSNMP_STATIC_INLINE int
_inetNetToMediaTable_set_column (inetNetToMediaTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    switch (column)
    {
        ...
        case COLUMN_INETNETTOMEDIAPHYSADDRESS:
            rowreq_ctx->column_set_flags |= COLUMN_INETNETTOMEDIAPHYSADDRESS_FLAG;
            rc = inetNetToMediaPhysAddress_set (rowreq_ctx, (char *) var->val.string, var->val_len);
            break;
        ...
        case COLUMN_INETNETTOMEDIATYPE:
            rowreq_ctx->column_set_flags |= COLUMN_INETNETTOMEDIATYPE_FLAG;
            rc = inetNetToMediaType_set (rowreq_ctx, *((u_long *) var->val.string));
            break;
        ...
        case COLUMN_INETNETTOMEDIAROWSTATUS:
            rowreq_ctx->column_set_flags |= COLUMN_INETNETTOMEDIAROWSTATUS_FLAG;
            rc = inetNetToMediaRowStatus_set (rowreq_ctx, *((u_long *) var->val.string));
            break;

        default:
            snmp_log (LOG_ERR, "unknown column %d in _inetNetToMediaTable_set_column\n", column);
            rc = SNMP_ERR_GENERR;
            break;
    }
                                     ...
                                     netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _inetNetToMediaTable_set_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            DEBUGMSGTL (("inetNetToMediaTable:mfd", "error %d from " "inetNetToMediaTable_set_column\n", rc));
            netsnmp_set_request_error (agtreq_info, requests, SNMP_VALIDATE_ERR (rc));
        }
    }                            /* for results */
                                 ...
                                 netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("inetNetToMediaTable:mfd", "error %d from " "inetNetToMediaTable_commit\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
                                      ...
                                      netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("inetNetToMediaTable:mfd", "error %d from " "inetNetToMediaTable_undo_commit\n", rc));
    }

    if (rowreq_ctx->rowreq_flags & MFD_ROW_DIRTY)
    {
        snmp_log (LOG_WARNING, "inetNetToMediaTable row dirty flag still set after undo_commit\n");
...
_inetNetToMediaTable_undo_column (inetNetToMediaTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    ...
    switch (column)
    {
        ...
        default:
            snmp_log (LOG_ERR, "unknown column %d in _inetNetToMediaTable_undo_column\n", column);
            break;
    }
                                      ...
                                      netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("inetNetToMediaTable:mfd", "error %d from " "inetNetToMediaTable_undo\n", rc));
    }
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _inetNetToMediaTable_undo_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            /*
             * nothing we can do about it but log it
             */
            DEBUGMSGTL (("inetNetToMediaTable:mfd", "error %d from " "inetNetToMediaTable_undo_column\n", rc));
        }
    }                            /* for results */
 ...
 * @internal
 */
static void _container_item_free (inetNetToMediaTable_rowreq_ctx * rowreq_ctx, void *context)
{
    DEBUGMSGTL (("internal:inetNetToMediaTable:_container_item_free", "called\n"));
...
static void _container_free (netsnmp_container * container)
{
    ...
    if (NULL == container)
    {
        snmp_log (LOG_ERR, "invalid container in inetNetToMediaTable_container_free\n");
        return;
    }
 ...
 */
void _inetNetToMediaTable_container_init (inetNetToMediaTable_interface_ctx * if_ctx)
{
    ...
    if_ctx->cache = netsnmp_cache_create (30,    /* timeout in seconds */
                                          ...
                                          inetNetToMediaTable_oid, inetNetToMediaTable_oid_size);
    ...
    {
        if_ctx->container = netsnmp_container_find ("inetNetToMediaTable:table_container");
        if (if_ctx->container)
            if_ctx->container->container_name = strdup ("inetNetToMediaTable");
    }
    if (NULL == if_ctx->container)
    {
        snmp_log (LOG_ERR, "error creating container in " "inetNetToMediaTable_container_init\n");
        return;
    }
 ...
 */
void _inetNetToMediaTable_container_shutdown (inetNetToMediaTable_interface_ctx * if_ctx)
{
...
inetNetToMediaTable_rowreq_ctx *inetNetToMediaTable_row_find_by_mib_index (inetNetToMediaTable_mib_index * mib_idx)
{
    inetNetToMediaTable_rowreq_ctx *rowreq_ctx;
    ...
    rowreq_ctx = (inetNetToMediaTable_rowreq_ctx *) CONTAINER_FIND (inetNetToMediaTable_if_ctx.container, &oid_idx);
