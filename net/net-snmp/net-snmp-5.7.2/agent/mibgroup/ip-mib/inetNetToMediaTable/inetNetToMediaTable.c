...
{
    DEBUGMSGTL (("verbose:inetNetToMediaTable:init_inetNetToMediaTable", "called\n"));
...
void initialize_table_inetNetToMediaTable (void)
{
     ...
     */
    inetNetToMediaTable_user_context_p = netsnmp_create_data_list ("inetNetToMediaTable", NULL, NULL);
 ...
 */
int inetNetToMediaTable_rowreq_ctx_init (inetNetToMediaTable_rowreq_ctx * rowreq_ctx, void *user_init_ctx)
{
 ...
 *
 */
void inetNetToMediaTable_rowreq_ctx_cleanup (inetNetToMediaTable_rowreq_ctx * rowreq_ctx)
{
 ...
 */
int inetNetToMediaTable_pre_request (inetNetToMediaTable_registration * user_context)
{
 ...
 */
int inetNetToMediaTable_post_request (inetNetToMediaTable_registration * user_context, int rc)
{
...
inetNetToMediaTable_data *inetNetToMediaTable_allocate_data (void)
{
    ...
    if (NULL == rtn)
    {
        snmp_log (LOG_ERR, "unable to malloc memory for new " "inetNetToMediaTable_data.\n");
    }
...
inetNetToMediaTable_indexes_set_tbl_idx (inetNetToMediaTable_mib_index *
                                         ...
                                         char
                                         *inetNetToMediaNetAddress_val_ptr, size_t inetNetToMediaNetAddress_val_ptr_len)
{
...
inetNetToMediaTable_indexes_set (inetNetToMediaTable_rowreq_ctx *
                                 ...
                                 char *inetNetToMediaNetAddress_val_ptr, size_t inetNetToMediaNetAddress_val_ptr_len)
{
    ...
    if (0 != inetNetToMediaTable_index_to_oid (&rowreq_ctx->oid_idx, &rowreq_ctx->tbl_idx))
    {
        return MFD_ERROR;
    }
                               ...
                               size_t * inetNetToMediaPhysAddress_val_ptr_len_ptr)
{
   ...
   /** we should have a non-NULL pointer and enough storage */
    ...
    memcpy ((*inetNetToMediaPhysAddress_val_ptr_ptr),
            rowreq_ctx->data->arp_physaddress, rowreq_ctx->data->arp_physaddress_len);
 ...
 */
int
inetNetToMediaLastUpdated_get (inetNetToMediaTable_rowreq_ctx * rowreq_ctx, u_long * inetNetToMediaLastUpdated_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int inetNetToMediaType_get (inetNetToMediaTable_rowreq_ctx * rowreq_ctx, u_long * inetNetToMediaType_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:inetNetToMediaTable:inetNetToMediaType_get", "called\n"));
 ...
 * @retval MFD_ERROR           : Any other error
 */
int inetNetToMediaState_get (inetNetToMediaTable_rowreq_ctx * rowreq_ctx, u_long * inetNetToMediaState_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:inetNetToMediaTable:inetNetToMediaState_get", "called\n"));
 ...
 * @retval MFD_ERROR           : Any other error
 */
int inetNetToMediaRowStatus_get (inetNetToMediaTable_rowreq_ctx * rowreq_ctx, u_long * inetNetToMediaRowStatus_val_ptr)
{
...
int inetNetToMediaTable_undo (inetNetToMediaTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:inetNetToMediaTable:inetNetToMediaTable_undo", "called\n"));
...
int inetNetToMediaTable_commit (inetNetToMediaTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:inetNetToMediaTable:inetNetToMediaTable_commit", "called\n"));
    ...
    if (save_flags & COLUMN_INETNETTOMEDIAPHYSADDRESS_FLAG)
    {
        ...
        if (-1 == rc)
        {
            snmp_log (LOG_ERR, "inetNetToMediaTable column inetNetToMediaPhysAddress commit failed\n");
        }
        else
        {
            /*
    ...
    if (save_flags & COLUMN_INETNETTOMEDIATYPE_FLAG)
    {
        ...
        if (-1 == rc)
        {
            snmp_log (LOG_ERR, "inetNetToMediaTable column inetNetToMediaType commit failed\n");
        }
        else
        {
            /*
    ...
    if (save_flags & COLUMN_INETNETTOMEDIAROWSTATUS_FLAG)
    {
        ...
        if (-1 == rc)
        {
            snmp_log (LOG_ERR, "inetNetToMediaTable column inetNetToMediaRowStatus commit failed\n");
        }
        else
        {
            /*
...
inetNetToMediaPhysAddress_check_value (inetNetToMediaTable_rowreq_ctx *
                                       rowreq_ctx, char
                                       *inetNetToMediaPhysAddress_val_ptr, size_t inetNetToMediaPhysAddress_val_ptr_len)
{
 ...
 */
int inetNetToMediaPhysAddress_undo_setup (inetNetToMediaTable_rowreq_ctx * rowreq_ctx)
{
...
inetNetToMediaPhysAddress_set (inetNetToMediaTable_rowreq_ctx * rowreq_ctx,
                               char *inetNetToMediaPhysAddress_val_ptr, size_t inetNetToMediaPhysAddress_val_ptr_len)
{
 ...
 *
 */
int inetNetToMediaType_check_value (inetNetToMediaTable_rowreq_ctx * rowreq_ctx, u_long inetNetToMediaType_val)
{
 ...
 *        A long containing the new value.
 */
int inetNetToMediaType_set (inetNetToMediaTable_rowreq_ctx * rowreq_ctx, u_long inetNetToMediaType_val)
{

    DEBUGMSGTL (("verbose:inetNetToMediaTable:inetNetToMediaType_set", "called\n"));
...
int inetNetToMediaType_undo (inetNetToMediaTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:inetNetToMediaTable:inetNetToMediaType_undo", "called\n"));
 ...
 */
int
inetNetToMediaRowStatus_check_value (inetNetToMediaTable_rowreq_ctx * rowreq_ctx, u_long inetNetToMediaRowStatus_val)
{
 ...
 * won't be done unless it is necessary.
 */
int inetNetToMediaRowStatus_undo_setup (inetNetToMediaTable_rowreq_ctx * rowreq_ctx)
{
 ...
 *        A long containing the new value.
 */
int inetNetToMediaRowStatus_set (inetNetToMediaTable_rowreq_ctx * rowreq_ctx, u_long inetNetToMediaRowStatus_val)
{

    DEBUGMSGTL (("verbose:inetNetToMediaTable:inetNetToMediaRowStatus_set", "called\n"));
...
int inetNetToMediaRowStatus_undo (inetNetToMediaTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:inetNetToMediaTable:inetNetToMediaRowStatus_undo", "called\n"));
 ...
 */
int inetNetToMediaTable_check_dependencies (inetNetToMediaTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;
    ...
    if (rowreq_ctx->column_set_flags & COLUMN_INETNETTOMEDIAROWSTATUS_FLAG)
    {
         ...
         */
        rc = check_rowstatus_transition (rowreq_ctx->inetNetToMediaRowStatus_undo, rowreq_ctx->inetNetToMediaRowStatus);
        if (MFD_SUCCESS != rc)
            return rc;
            ...
            else if (ROWSTATUS_CREATEANDGO == rowreq_ctx->inetNetToMediaRowStatus)
            {
                    ...
                    != INETNETTOMEDIATABLE_REQUIRED_COLS)
                {
                    DEBUGMSGTL (("inetNetToMediaTable",
                                 ...
                                 rowreq_ctx->column_set_flags, INETNETTOMEDIATABLE_REQUIRED_COLS));
        ...
        else
        {
            ...
            if (ROWSTATUS_DESTROY == rowreq_ctx->inetNetToMediaRowStatus)
            {
                if (rowreq_ctx->column_set_flags & ~COLUMN_INETNETTOMEDIAROWSTATUS_FLAG)
                {
                    DEBUGMSGTL (("inetNetToMediaTable", "destroy must be only varbind for row\n"));
    ...
    else
    {
        ...
        if (rowreq_ctx->rowreq_flags & MFD_ROW_CREATED)
        {
            DEBUGMSGTL (("inetNetToMediaTable", "must use RowStatus to create rows\n"));
            return MFD_CANNOT_CREATE_NOW;
        }
    }                            /* row status not set */
