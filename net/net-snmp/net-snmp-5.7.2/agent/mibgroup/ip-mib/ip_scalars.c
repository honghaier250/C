...
#include "ip_scalars.h"
     int handle_ipForwarding (netsnmp_mib_handler * handler,
                              netsnmp_handler_registration * reginfo,
                              netsnmp_agent_request_info * reqinfo, netsnmp_request_info * requests);

     int handle_ipDefaultTTL (netsnmp_mib_handler * handler,
                              netsnmp_handler_registration * reginfo,
                              netsnmp_agent_request_info * reqinfo, netsnmp_request_info * requests);

     int handle_ipv6IpForwarding (netsnmp_mib_handler * handler,
                                  netsnmp_handler_registration * reginfo,
                                  netsnmp_agent_request_info * reqinfo, netsnmp_request_info * requests);

     int ipAddressSpinLockValue;

     int handle_ipAddressSpinLock (netsnmp_mib_handler * handler,
                                   netsnmp_handler_registration * reginfo,
                                   netsnmp_agent_request_info * reqinfo, netsnmp_request_info * requests);
     ...
     void init_ip_scalars (void)
{
    ...
    netsnmp_register_num_file_instance
        ("ipReasmTimeout",
         ...
         "/proc/sys/net/ipv4/ipfrag_time", ASN_INTEGER, HANDLER_CAN_RONLY, NULL, NULL);

    netsnmp_register_scalar (netsnmp_create_handler_registration
                             ("ipForwarding", handle_ipForwarding,
                              ipForwarding_oid, OID_LENGTH (ipForwarding_oid), HANDLER_CAN_RWRITE));

    netsnmp_register_scalar (netsnmp_create_handler_registration
                             ("ipv6IpForwarding", handle_ipv6IpForwarding,
                              ipv6IpForwarding_oid, OID_LENGTH (ipv6IpForwarding_oid), HANDLER_CAN_RWRITE));

    netsnmp_register_scalar (netsnmp_create_handler_registration
                             ("ipAddressSpinLock", handle_ipAddressSpinLock,
                              ipAddressSpinLock_oid, OID_LENGTH (ipAddressSpinLock_oid), HANDLER_CAN_RWRITE));
    ...
    netsnmp_register_num_file_instance
        ("ipv6IpDefaultHopLimit",
         ...
         "/proc/sys/net/ipv6/conf/default/hop_limit", ASN_INTEGER, HANDLER_CAN_RWRITE, NULL, NULL);

    netsnmp_register_num_file_instance
        ("ipDefaultTTL",
         ipDefaultTTL_oid, OID_LENGTH (ipDefaultTTL_oid),
         "/proc/sys/net/ipv4/ip_default_ttl", ASN_INTEGER, HANDLER_CAN_RWRITE, NULL, NULL);
    ...
    switch (reqinfo->mode)
    {
        ...
        case MODE_SET_RESERVE2:
            ...
            else
            {
                ...
                memdup ((u_char **) & value_save, (u_char *) & value, sizeof (value));
                if (NULL == value_save)
                    netsnmp_set_request_error (reqinfo, requests, SNMP_ERR_RESOURCEUNAVAILABLE);
                else
                    netsnmp_request_add_list_data (requests, netsnmp_create_data_list ("ipfw", value_save, free));
            }
            break;
    ...
    switch (reqinfo->mode)
    {
        ...
        case MODE_GET:
            snmp_set_var_typed_value (requests->requestvb, ASN_INTEGER,
                                      (u_char *) & ipAddressSpinLockValue, sizeof (ipAddressSpinLockValue));
            break;
