 ...
 */
     ...
     static void _ipSystemStatsTable_container_init (ipSystemStatsTable_interface_ctx * if_ctx);

     static void _ipSystemStatsTable_container_shutdown (ipSystemStatsTable_interface_ctx * if_ctx);
...
ipSystemStatsTable_registration *ipSystemStatsTable_registration_set (ipSystemStatsTable_registration * newreg)
{
 ...
 */
void _ipSystemStatsTable_initialize_interface (ipSystemStatsTable_registration * reg_ptr, u_long flags)
{
    netsnmp_baby_steps_access_methods *access_multiplexer = &ipSystemStatsTable_if_ctx.access_multiplexer;

    netsnmp_table_registration_info *tbl_info = &ipSystemStatsTable_if_ctx.tbl_info;
    ...
    {
        snmp_log (LOG_ERR, "could not initialize container for ipSystemStatsTable\n");
        return;
    }
    ...
    handler =
        netsnmp_container_table_handler_get (tbl_info,
                                             ipSystemStatsTable_if_ctx.container, TABLE_CONTAINER_KEY_NETSNMP_INDEX);
    netsnmp_inject_handler (reginfo, handler);
 ...
 */
void _ipSystemStatsTable_shutdown_interface (ipSystemStatsTable_registration * reg_ptr)
{
    /*
 ...
 */
int ipSystemStatsTable_index_to_oid (netsnmp_index * oid_idx, ipSystemStatsTable_mib_index * mib_idx)
{
     ...
     * set up varbinds
     */
    memset (&var_ipSystemStatsIPVersion, 0x00, sizeof (var_ipSystemStatsIPVersion));
    ...
    snmp_set_var_value (&var_ipSystemStatsIPVersion,
                        (u_char *) & mib_idx->ipSystemStatsIPVersion, sizeof (mib_idx->ipSystemStatsIPVersion));


    err = build_oid_noalloc (oid_idx->oids, oid_idx->len, &oid_idx->len, NULL, 0, &var_ipSystemStatsIPVersion);
    if (err)
 ...
 */
int ipSystemStatsTable_index_from_oid (netsnmp_index * oid_idx, ipSystemStatsTable_mib_index * mib_idx)
{
    int err = SNMP_ERR_NOERROR;
     ...
     */
    err = parse_oid_indexes (oid_idx->oids, oid_idx->len, &var_ipSystemStatsIPVersion);
 ...
 */
ipSystemStatsTable_rowreq_ctx *ipSystemStatsTable_allocate_rowreq_ctx (ipSystemStatsTable_data * data,
                                                                       void *user_init_ctx)
{
    ipSystemStatsTable_rowreq_ctx *rowreq_ctx = SNMP_MALLOC_TYPEDEF (ipSystemStatsTable_rowreq_ctx);

    DEBUGMSGTL (("internal:ipSystemStatsTable:ipSystemStatsTable_allocate_rowreq_ctx", "called\n"));

    if (NULL == rowreq_ctx)
    {
        snmp_log (LOG_ERR, "Couldn't allocate memory for a " "ipSystemStatsTable_rowreq_ctx.\n");
        return NULL;
    }
    else
    {
    ...
    {
        if (SNMPERR_SUCCESS != ipSystemStatsTable_rowreq_ctx_init (rowreq_ctx, user_init_ctx))
        {
 ...
 */
void ipSystemStatsTable_release_rowreq_ctx (ipSystemStatsTable_rowreq_ctx * rowreq_ctx)
{
                                     ...
                                     netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    {
        DEBUGMSGTL (("internal:ipSystemStatsTable", "skipping additional pre_request\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         */
        DEBUGMSGTL (("ipSystemStatsTable", "error %d from " "ipSystemStatsTable_pre_request\n", rc));
                                      ...
                                      netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    {
        DEBUGMSGTL (("internal:ipSystemStatsTable", "waiting for last post_request\n"));
        return SNMP_ERR_NOERROR;
    }
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ipSystemStatsTable", "error %d from " "ipSystemStatsTable_post_request\n", rc));
    }
...
_ipSystemStatsTable_get_column (ipSystemStatsTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    ...
    switch (column)
    {
        ...
        case COLUMN_IPSYSTEMSTATSHCINRECEIVES:
            ...
            rc = ipSystemStatsHCInReceives_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSHCINOCTETS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipSystemStatsHCInOctets_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSINHDRERRORS:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipSystemStatsInHdrErrors_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSINADDRERRORS:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipSystemStatsInAddrErrors_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSINUNKNOWNPROTOS:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipSystemStatsInUnknownProtos_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSINTRUNCATEDPKTS:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipSystemStatsInTruncatedPkts_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSINFORWDATAGRAMS:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipSystemStatsInForwDatagrams_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSHCINFORWDATAGRAMS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipSystemStatsHCInForwDatagrams_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSHCINDELIVERS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipSystemStatsHCInDelivers_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSOUTREQUESTS:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipSystemStatsOutRequests_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSHCOUTREQUESTS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipSystemStatsHCOutRequests_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSOUTNOROUTES:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipSystemStatsOutNoRoutes_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSOUTFORWDATAGRAMS:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipSystemStatsOutForwDatagrams_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSHCOUTFORWDATAGRAMS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipSystemStatsHCOutForwDatagrams_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSOUTDISCARDS:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipSystemStatsOutDiscards_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSOUTFRAGREQDS:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipSystemStatsOutFragReqds_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSOUTFRAGFAILS:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipSystemStatsOutFragFails_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSOUTFRAGCREATES:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipSystemStatsOutFragCreates_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSOUTTRANSMITS:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipSystemStatsOutTransmits_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSHCOUTTRANSMITS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipSystemStatsHCOutTransmits_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSHCOUTOCTETS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipSystemStatsHCOutOctets_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSINMCASTPKTS:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipSystemStatsInMcastPkts_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSHCINMCASTPKTS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipSystemStatsHCInMcastPkts_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSINMCASTOCTETS:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipSystemStatsInMcastOctets_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSHCINMCASTOCTETS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipSystemStatsHCInMcastOctets_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSOUTMCASTPKTS:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipSystemStatsOutMcastPkts_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSHCOUTMCASTPKTS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipSystemStatsHCOutMcastPkts_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSOUTMCASTOCTETS:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipSystemStatsOutMcastOctets_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSHCOUTMCASTOCTETS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipSystemStatsHCOutMcastOctets_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSINBCASTPKTS:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipSystemStatsInBcastPkts_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSHCINBCASTPKTS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipSystemStatsHCInBcastPkts_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSOUTBCASTPKTS:
            var->val_len = sizeof (u_long);
            var->type = ASN_COUNTER;
            rc = ipSystemStatsOutBcastPkts_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSHCOUTBCASTPKTS:
            var->val_len = sizeof (U64);
            var->type = ASN_COUNTER64;
            rc = ipSystemStatsHCOutBcastPkts_get (rowreq_ctx, (U64 *) var->val.string);
            break;
        ...
        case COLUMN_IPSYSTEMSTATSDISCONTINUITYTIME:
            ...
            rc = ipSystemStatsDiscontinuityTime_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        default:
            snmp_log (LOG_ERR, "unknown column %d in _ipSystemStatsTable_get_column\n", column);
            break;
    }
                                    ...
                                    netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipSystemStatsTable_get_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            if (MFD_SKIP == rc)
            {
 ...
 * @internal
 */
static void _container_item_free (ipSystemStatsTable_rowreq_ctx * rowreq_ctx, void *context)
{
    DEBUGMSGTL (("internal:ipSystemStatsTable:_container_item_free", "called\n"));
...
static void _container_free (netsnmp_container * container)
{
    ...
    if (NULL == container)
    {
        snmp_log (LOG_ERR, "invalid container in ipSystemStatsTable_container_free\n");
        return;
    }
 ...
 */
void _ipSystemStatsTable_container_init (ipSystemStatsTable_interface_ctx * if_ctx)
{
    ...
    if_ctx->cache = netsnmp_cache_create (30,    /* timeout in seconds */
                                          ...
                                          ipSystemStatsTable_oid, ipSystemStatsTable_oid_size);
    ...
    if (NULL == if_ctx->container)
        if_ctx->container = netsnmp_container_find ("ipSystemStatsTable:table_container");
    if (NULL == if_ctx->container)
    {
        snmp_log (LOG_ERR, "error creating container in " "ipSystemStatsTable_container_init\n");
        return;
    }
 ...
 */
void _ipSystemStatsTable_container_shutdown (ipSystemStatsTable_interface_ctx * if_ctx)
{
...
ipSystemStatsTable_rowreq_ctx *ipSystemStatsTable_row_find_by_mib_index (ipSystemStatsTable_mib_index * mib_idx)
{
    ...
    rowreq_ctx = (ipSystemStatsTable_rowreq_ctx *) CONTAINER_FIND (ipSystemStatsTable_if_ctx.container, &oid_idx);
