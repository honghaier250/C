 ...
 */
int ipSystemStatsTable_init_data (ipSystemStatsTable_registration * ipSystemStatsTable_reg)
{
    DEBUGMSGTL (("verbose:ipSystemStatsTable:ipSystemStatsTable_init_data", "called\n"));
 ...
 */
void ipSystemStatsTable_container_init (netsnmp_container ** container_ptr_ptr, netsnmp_cache * cache)
{
    DEBUGMSGTL (("verbose:ipSystemStatsTable:ipSystemStatsTable_container_init", "called\n"));

    if (NULL == container_ptr_ptr)
    {
        snmp_log (LOG_ERR, "bad container param to ipSystemStatsTable_container_init\n");
        return;
    }
    ...
    *container_ptr_ptr = netsnmp_container_find ("ipSystemStatsTable:table_container");
    ...
    if (NULL == cache)
    {
        snmp_log (LOG_ERR, "bad cache param to ipSystemStatsTable_container_init\n");
        return;
    }
 ...
 */
static void _check_for_updates (ipSystemStatsTable_rowreq_ctx * rowreq_ctx, netsnmp_container * stats)
{
    /*
    ...
    else
    {
         ...
         */
        netsnmp_access_systemstats_entry_update (rowreq_ctx->data, systemstats_entry);
        ...
        if (1 == rowreq_ctx->known_missing)
        {
            ...
            rowreq_ctx->ipSystemStatsDiscontinuityTime = netsnmp_get_agent_uptime ();
        }
 ...
 * add new entry
 */
static void _add_new (netsnmp_systemstats_entry * systemstats_entry, netsnmp_container * container)
{
    ...
    if ((NULL != rowreq_ctx)
        && (MFD_SUCCESS == ipSystemStatsTable_indexes_set (rowreq_ctx, systemstats_entry->index[0])))
    {
    ...
    else
    {
        if (NULL != rowreq_ctx)
        {
            snmp_log (LOG_ERR, "error setting index while loading " "ipSystemStatsTable cache.\n");
            ipSystemStatsTable_release_rowreq_ctx (rowreq_ctx);
        }
        else
        {
            snmp_log (LOG_ERR, "memory allocation failed while loading " "ipSystemStatsTable cache.\n");
            netsnmp_access_systemstats_entry_free (systemstats_entry);
        }
    }
}
...
void ipSystemStatsTable_container_shutdown (netsnmp_container * container_ptr)
{
    ...
    {
        snmp_log (LOG_ERR, "bad params to ipSystemStatsTable_container_shutdown\n");
        return;
    }
...
{
    netsnmp_container *stats = netsnmp_access_systemstats_container_load (NULL, 0);


    DEBUGMSGTL (("verbose:ipSystemStatsTable:ipSystemStatsTable_cache_load", "called\n"));
     ...
     */
    CONTAINER_FOR_EACH (container, (netsnmp_container_obj_func *) _check_for_updates, stats);
     ...
     */
    netsnmp_access_systemstats_container_free (stats, NETSNMP_ACCESS_SYSTEMSTATS_FREE_DONT_CLEAR);
...
{
    DEBUGMSGTL (("verbose:ipSystemStatsTable:ipSystemStatsTable_row_prep", "called\n"));
