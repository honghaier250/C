 ...
 */
int ipv6ScopeZoneIndexTable_init_data (ipv6ScopeZoneIndexTable_registration * ipv6ScopeZoneIndexTable_reg)
{
 ...
 */
void ipv6ScopeZoneIndexTable_container_init (netsnmp_container ** container_ptr_ptr, netsnmp_cache * cache)
{
    DEBUGMSGTL (("verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexTable_container_init", "called\n"));

    if (NULL == container_ptr_ptr)
    {
        snmp_log (LOG_ERR, "bad container param to ipv6ScopeZoneIndexTable_container_init\n");
        return;
    }
    ...
    *container_ptr_ptr = NULL;
    if (NULL == cache)
    {
        snmp_log (LOG_ERR, "bad cache param to ipv6ScopeZoneIndexTable_container_init\n");
        return;
    }
 ...
 */
void ipv6ScopeZoneIndexTable_container_shutdown (netsnmp_container * container_ptr)
{
    DEBUGMSGTL (("verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexTable_container_shutdown", "called\n"));

    if (NULL == container_ptr)
    {
        snmp_log (LOG_ERR, "bad params to ipv6ScopeZoneIndexTable_container_shutdown\n");
        return;
    }
 ...
 *
 */
static void _snarf_zoneindex_entry (netsnmp_v6scopezone_entry * scopezone_entry, netsnmp_container * container)
{
    ...
    if ((NULL != rowreq_ctx) &&
        (MFD_SUCCESS == ipv6ScopeZoneIndexTable_indexes_set (rowreq_ctx, rowreq_ctx->data->index)))
    {
    ...
    else
    {
        if (rowreq_ctx)
        {
            snmp_log (LOG_ERR, "error setting index while loading " "ipv6ScopeZoneIndexTable cache.\n");
...
int ipv6ScopeZoneIndexTable_container_load (netsnmp_container * container)
{
    ...
    if (NULL == zoneindex)
    {
        DEBUGMSGTL (("ipv6ScopeZoneIndexTable:container_load", "couldn't get scopezone iterator\n"));
    ...
    CONTAINER_FOR_EACH (zoneindex, (netsnmp_container_obj_func *) _snarf_zoneindex_entry, container);
    /*
 ...
 * @retval MFD_ERROR       : other error.
 */
int ipv6ScopeZoneIndexTable_row_prep (ipv6ScopeZoneIndexTable_rowreq_ctx * rowreq_ctx)
{
