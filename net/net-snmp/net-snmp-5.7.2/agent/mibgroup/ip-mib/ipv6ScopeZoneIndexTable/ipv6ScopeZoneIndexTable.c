...
const int ipv6ScopeZoneIndexTable_oid_size = OID_LENGTH (ipv6ScopeZoneIndexTable_oid);
...
void initialize_table_ipv6ScopeZoneIndexTable (void)
{
     ...
     */
    ipv6ScopeZoneIndexTable_user_context_p = netsnmp_create_data_list ("ipv6ScopeZoneIndexTable", NULL, NULL);
 ...
 */
int ipv6ScopeZoneIndexTable_pre_request (ipv6ScopeZoneIndexTable_registration * user_context)
{
 ...
 */
int ipv6ScopeZoneIndexTable_post_request (ipv6ScopeZoneIndexTable_registration * user_context, int rc)
{
...
ipv6ScopeZoneIndexTable_data *ipv6ScopeZoneIndexTable_allocate_data (void)
{
    ...
    if (NULL == rtn)
    {
        snmp_log (LOG_ERR, "unable to malloc memory for new " "ipv6ScopeZoneIndexTable_data.\n");
    }
...
int ipv6ScopeZoneIndexTable_indexes_set_tbl_idx
    (ipv6ScopeZoneIndexTable_mib_index * tbl_idx, long ipv6ScopeZoneIndexIfIndex_val)
{
...
ipv6ScopeZoneIndexTable_indexes_set (ipv6ScopeZoneIndexTable_rowreq_ctx *
                                     rowreq_ctx, long ipv6ScopeZoneIndexIfIndex_val)
{
    DEBUGMSGTL (("verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexTable_indexes_set", "called\n"));

    if (MFD_SUCCESS !=
        ipv6ScopeZoneIndexTable_indexes_set_tbl_idx (&rowreq_ctx->tbl_idx, ipv6ScopeZoneIndexIfIndex_val))
        return MFD_ERROR;
    ...
    if (0 != ipv6ScopeZoneIndexTable_index_to_oid (&rowreq_ctx->oid_idx, &rowreq_ctx->tbl_idx))
    {
        return MFD_ERROR;
    }
...
ipv6ScopeZoneIndexLinkLocal_get (ipv6ScopeZoneIndexTable_rowreq_ctx *
                                 rowreq_ctx, u_long * ipv6ScopeZoneIndexLinkLocal_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipv6ScopeZoneIndex3_get (ipv6ScopeZoneIndexTable_rowreq_ctx * rowreq_ctx, u_long * ipv6ScopeZoneIndex3_val_ptr)
{
...
ipv6ScopeZoneIndexAdminLocal_get (ipv6ScopeZoneIndexTable_rowreq_ctx *
                                  rowreq_ctx, u_long * ipv6ScopeZoneIndexAdminLocal_val_ptr)
{
...
ipv6ScopeZoneIndexSiteLocal_get (ipv6ScopeZoneIndexTable_rowreq_ctx *
                                 rowreq_ctx, u_long * ipv6ScopeZoneIndexSiteLocal_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipv6ScopeZoneIndex6_get (ipv6ScopeZoneIndexTable_rowreq_ctx * rowreq_ctx, u_long * ipv6ScopeZoneIndex6_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndex6_get", "called\n"));
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipv6ScopeZoneIndex7_get (ipv6ScopeZoneIndexTable_rowreq_ctx * rowreq_ctx, u_long * ipv6ScopeZoneIndex7_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndex7_get", "called\n"));
...
ipv6ScopeZoneIndexOrganizationLocal_get (ipv6ScopeZoneIndexTable_rowreq_ctx
                                         * rowreq_ctx, u_long * ipv6ScopeZoneIndexOrganizationLocal_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipv6ScopeZoneIndex9_get (ipv6ScopeZoneIndexTable_rowreq_ctx * rowreq_ctx, u_long * ipv6ScopeZoneIndex9_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndex9_get", "called\n"));
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipv6ScopeZoneIndexA_get (ipv6ScopeZoneIndexTable_rowreq_ctx * rowreq_ctx, u_long * ipv6ScopeZoneIndexA_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipv6ScopeZoneIndexB_get (ipv6ScopeZoneIndexTable_rowreq_ctx * rowreq_ctx, u_long * ipv6ScopeZoneIndexB_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexB_get", "called\n"));
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipv6ScopeZoneIndexC_get (ipv6ScopeZoneIndexTable_rowreq_ctx * rowreq_ctx, u_long * ipv6ScopeZoneIndexC_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexC_get", "called\n"));
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipv6ScopeZoneIndexD_get (ipv6ScopeZoneIndexTable_rowreq_ctx * rowreq_ctx, u_long * ipv6ScopeZoneIndexD_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:ipv6ScopeZoneIndexTable:ipv6ScopeZoneIndexD_get", "called\n"));
