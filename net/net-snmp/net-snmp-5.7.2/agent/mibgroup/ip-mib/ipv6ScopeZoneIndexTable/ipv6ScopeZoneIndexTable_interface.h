...
#include "ipv6ScopeZoneIndexTable.h"
     ...
     */
    void _ipv6ScopeZoneIndexTable_initialize_interface (ipv6ScopeZoneIndexTable_registration * user_ctx, u_long flags);
    void _ipv6ScopeZoneIndexTable_shutdown_interface (ipv6ScopeZoneIndexTable_registration * user_ctx);
