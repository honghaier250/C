...
{
    DEBUGMSGTL (("verbose:ipAddressPrefixTable:init_ipAddressPrefixTable", "called\n"));
...
void initialize_table_ipAddressPrefixTable (void)
{
     ...
     */
    ipAddressPrefixTable_user_context_p = netsnmp_create_data_list ("ipAddressPrefixTable", NULL, NULL);
 ...
 */
int ipAddressPrefixTable_rowreq_ctx_init (ipAddressPrefixTable_rowreq_ctx * rowreq_ctx, void *user_init_ctx)
{
 ...
 *
 */
void ipAddressPrefixTable_rowreq_ctx_cleanup (ipAddressPrefixTable_rowreq_ctx * rowreq_ctx)
{
 ...
 */
int ipAddressPrefixTable_pre_request (ipAddressPrefixTable_registration * user_context)
{
 ...
 */
int ipAddressPrefixTable_post_request (ipAddressPrefixTable_registration * user_context, int rc)
{
 ...
 */
int ipAddressPrefixOrigin_get (ipAddressPrefixTable_rowreq_ctx * rowreq_ctx, u_long * ipAddressPrefixOrigin_val_ptr)
{
 ...
 */
int
ipAddressPrefixOnLinkFlag_get (ipAddressPrefixTable_rowreq_ctx * rowreq_ctx, u_long * ipAddressPrefixOnLinkFlag_val_ptr)
{
...
ipAddressPrefixAdvPreferredLifetime_get (ipAddressPrefixTable_rowreq_ctx *
                                         rowreq_ctx, u_long * ipAddressPrefixAdvPreferredLifetime_val_ptr)
{
...
ipAddressPrefixAdvValidLifetime_get (ipAddressPrefixTable_rowreq_ctx *
                                     rowreq_ctx, u_long * ipAddressPrefixAdvValidLifetime_val_ptr)
{
