...
netsnmp_feature_require (ipaddress_common_copy_utilities) netsnmp_feature_require (ipaddress_prefix_copy)
 ...
 */
     int ipAddressPrefixTable_init_data (ipAddressPrefixTable_registration * ipAddressPrefixTable_reg)
{
 ...
 */
void ipAddressPrefixTable_container_init (netsnmp_container ** container_ptr_ptr, netsnmp_cache * cache)
{
    DEBUGMSGTL (("verbose:ipAddressPrefixTable:ipAddressPrefixTable_container_init", "called\n"));

    if (NULL == container_ptr_ptr)
    {
        snmp_log (LOG_ERR, "bad container param to ipAddressPrefixTable_container_init\n");
        return;
    }
    ...
    *container_ptr_ptr = NULL;
    ...
    if (NULL == cache)
    {
        snmp_log (LOG_ERR, "bad cache param to ipAddressPrefixTable_container_init\n");
        return;
    }
...
void ipAddressPrefixTable_container_shutdown (netsnmp_container * container_ptr)
{
    ...
    {
        snmp_log (LOG_ERR, "bad params to ipAddressPrefixTable_container_shutdown\n");
        return;
    }
...
int ipAddressPrefixTable_container_load (netsnmp_container * container)
{
    ...
    {
        DEBUGMSGTL (("ipAddressPrefixTable:container_load", "couldn't get ipAddress container\n"));
    ...
    if (NULL == addr_container)
    {
        DEBUGMSGTL (("ipAddressPrefixTable:container_load", "couldn't get ipAddress iterator\n"));
        return MFD_RESOURCE_UNAVAILABLE;
    }
     ...
     * the container.
     */
    for (addr_rowreq_ctx = ITERATOR_FIRST (addr_it); addr_rowreq_ctx; addr_rowreq_ctx = ITERATOR_NEXT (addr_it))
    {
        ...
        netsnmp_ipaddress_prefix_copy (tmp_pfx,
                                       ...
                                       addr_rowreq_ctx->data->ia_address_len, addr_rowreq_ctx->data->ia_prefix_len);
        ...
        {
            snmp_log (LOG_ERR, "error setting index while loading " "ipAddressPrefixTable data.\n");
        ...
        netsnmp_ipaddress_prefix_origin_copy (&rowreq_ctx->data.ipAddressPrefixOrigin,
                                              ...
                                              addr_rowreq_ctx->data->flags, addr_rowreq_ctx->tbl_idx.ipAddressAddrType);
