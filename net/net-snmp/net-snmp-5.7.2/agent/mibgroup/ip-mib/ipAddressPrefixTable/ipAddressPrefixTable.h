...
#define MAX_ipAddressPrefixTable_IDX_LEN     118
    ...
    void ipAddressPrefixTable_rowreq_ctx_cleanup (ipAddressPrefixTable_rowreq_ctx * rowreq_ctx);
      ...
      ipAddressPrefixTable_rowreq_ctx
        * ipAddressPrefixTable_row_find_by_mib_index (ipAddressPrefixTable_mib_index * mib_idx);
 ...
 **********************************************************************/
    ...
    int ipAddressPrefixOrigin_get (ipAddressPrefixTable_rowreq_ctx *
                                   rowreq_ctx, u_long * ipAddressPrefixOrigin_val_ptr);
    int ipAddressPrefixOnLinkFlag_get (ipAddressPrefixTable_rowreq_ctx *
                                       rowreq_ctx, u_long * ipAddressPrefixOnLinkFlag_val_ptr);
