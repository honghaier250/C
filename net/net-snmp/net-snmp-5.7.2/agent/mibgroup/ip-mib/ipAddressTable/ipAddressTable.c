...
netsnmp_feature_require (ipaddress_entry_copy) netsnmp_feature_require (ipaddress_prefix_copy)
...
void initialize_table_ipAddressTable (void)
{
    ...
    DEBUGMSGTL (("verbose:ipAddressTable:initialize_table_ipAddressTable", "called\n"));
 ...
 */
int ipAddressTable_rowreq_ctx_init (ipAddressTable_rowreq_ctx * rowreq_ctx, void *user_init_ctx)
{
    DEBUGMSGTL (("verbose:ipAddressTable:ipAddressTable_rowreq_ctx_init", "called\n"));
...
{
    DEBUGMSGTL (("verbose:ipAddressTable:ipAddressTable_pre_request", "called\n"));
 ...
 */
int ipAddressTable_post_request (ipAddressTable_registration * user_context, int rc)
{
    DEBUGMSGTL (("verbose:ipAddressTable:ipAddressTable_post_request", "called\n"));
...
ipAddressTable_data *ipAddressTable_allocate_data (void)
{
    ...
    if (NULL == rtn)
    {
        snmp_log (LOG_ERR, "unable to malloc memory for new " "ipAddressTable_data.\n");
    }
...
{
    DEBUGMSGTL (("verbose:ipAddressTable:ipAddressTable_release_data", "called\n"));
 ...
 */
int ipAddressAddrType_map (long *mib_ipAddressAddrType_val_ptr, long raw_ipAddressAddrType_val)
{
...
ipAddressTable_indexes_set_tbl_idx (ipAddressTable_mib_index * tbl_idx,
                                    ...
                                    u_char * ipAddressAddr_val_ptr, size_t ipAddressAddr_val_ptr_len)
{
...
ipAddressTable_indexes_set (ipAddressTable_rowreq_ctx * rowreq_ctx,
                            ...
                            u_char * ipAddressAddr_val_ptr, size_t ipAddressAddr_val_ptr_len)
{
    DEBUGMSGTL (("verbose:ipAddressTable:ipAddressTable_indexes_set", "called\n"));

    if (MFD_SUCCESS !=
        ipAddressTable_indexes_set_tbl_idx (&rowreq_ctx->tbl_idx,
                                            ipAddressAddrType_val, ipAddressAddr_val_ptr, ipAddressAddr_val_ptr_len))
        return MFD_ERROR;
    ...
    if (0 != ipAddressTable_index_to_oid (&rowreq_ctx->oid_idx, &rowreq_ctx->tbl_idx))
    {
        return MFD_ERROR;
    }
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipAddressIfIndex_get (ipAddressTable_rowreq_ctx * rowreq_ctx, long *ipAddressIfIndex_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipAddressType_get (ipAddressTable_rowreq_ctx * rowreq_ctx, u_long * ipAddressType_val_ptr)
{
...
ipAddressPrefix_get (ipAddressTable_rowreq_ctx * rowreq_ctx,
                     oid ** ipAddressPrefix_val_ptr_ptr, size_t * ipAddressPrefix_val_ptr_len_ptr)
{
   ...
   /** we should have a non-NULL pointer and enough storage */
    netsnmp_assert ((NULL != ipAddressPrefix_val_ptr_ptr) && (NULL != *ipAddressPrefix_val_ptr_ptr));
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipAddressOrigin_get (ipAddressTable_rowreq_ctx * rowreq_ctx, u_long * ipAddressOrigin_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipAddressStatus_get (ipAddressTable_rowreq_ctx * rowreq_ctx, u_long * ipAddressStatus_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipAddressCreated_get (ipAddressTable_rowreq_ctx * rowreq_ctx, u_long * ipAddressCreated_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipAddressLastChanged_get (ipAddressTable_rowreq_ctx * rowreq_ctx, u_long * ipAddressLastChanged_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipAddressRowStatus_get (ipAddressTable_rowreq_ctx * rowreq_ctx, u_long * ipAddressRowStatus_val_ptr)
{
 ...
 * @retval MFD_ERROR           : Any other error
 */
int ipAddressStorageType_get (ipAddressTable_rowreq_ctx * rowreq_ctx, u_long * ipAddressStorageType_val_ptr)
{
...
int ipAddressTable_undo_setup (ipAddressTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:ipAddressTable:ipAddressTable_undo_setup", "called\n"));
     ...
     */
    rc = netsnmp_access_ipaddress_entry_copy (rowreq_ctx->undo, rowreq_ctx->data);
...
int ipAddressTable_undo_cleanup (ipAddressTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:ipAddressTable:ipAddressTable_undo_cleanup", "called\n"));
...
int ipAddressTable_undo_commit (ipAddressTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:ipAddressTable:ipAddressTable_undo_commit", "called\n"));
 ...
 *
 */
int ipAddressIfIndex_check_value (ipAddressTable_rowreq_ctx * rowreq_ctx, long ipAddressIfIndex_val)
{
    DEBUGMSGTL (("verbose:ipAddressTable:ipAddressIfIndex_check_value", "called\n"));
 ...
 *        A long containing the new value.
 */
int ipAddressIfIndex_set (ipAddressTable_rowreq_ctx * rowreq_ctx, long ipAddressIfIndex_val)
{
 ...
 *
 */
int ipAddressType_check_value (ipAddressTable_rowreq_ctx * rowreq_ctx, u_long ipAddressType_val)
{
    DEBUGMSGTL (("verbose:ipAddressTable:ipAddressType_check_value", "called\n"));
 ...
 *        A long containing the new value.
 */
int ipAddressType_set (ipAddressTable_rowreq_ctx * rowreq_ctx, u_long ipAddressType_val)
{
 ...
 *
 */
int ipAddressStatus_check_value (ipAddressTable_rowreq_ctx * rowreq_ctx, u_long ipAddressStatus_val)
{
    DEBUGMSGTL (("verbose:ipAddressTable:ipAddressStatus_check_value", "called\n"));
 ...
 *        A long containing the new value.
 */
int ipAddressStatus_set (ipAddressTable_rowreq_ctx * rowreq_ctx, u_long ipAddressStatus_val)
{
 ...
 *
 */
int ipAddressRowStatus_check_value (ipAddressTable_rowreq_ctx * rowreq_ctx, u_long ipAddressRowStatus_val)
{
    int rc;

    DEBUGMSGTL (("verbose:ipAddressTable:ipAddressRowStatus_check_value", "called\n"));
    ...
    rc = check_rowstatus_transition (rowreq_ctx->ipAddressRowStatus, ipAddressRowStatus_val);
    if (MFD_SUCCESS != rc)
    {
 ...
 *        A long containing the new value.
 */
int ipAddressRowStatus_set (ipAddressTable_rowreq_ctx * rowreq_ctx, u_long ipAddressRowStatus_val)
{
 ...
 *
 */
int ipAddressStorageType_check_value (ipAddressTable_rowreq_ctx * rowreq_ctx, u_long ipAddressStorageType_val)
{
    int rc;

    DEBUGMSGTL (("verbose:ipAddressTable:ipAddressStorageType_check_value", "called\n"));
     ...
     */
    rc = check_storage_transition (rowreq_ctx->data->ia_storagetype, ipAddressStorageType_val);
    if (MFD_SUCCESS != rc)
        return rc;
 ...
 *        A long containing the new value.
 */
int ipAddressStorageType_set (ipAddressTable_rowreq_ctx * rowreq_ctx, u_long ipAddressStorageType_val)
{
...
int ipAddressStorageType_undo (ipAddressTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:ipAddressTable:ipAddressStorageType_undo", "called\n"));
...
int ipAddressTable_check_dependencies (ipAddressTable_rowreq_ctx * rowreq_ctx)
{
    ...
    if (rowreq_ctx->column_set_flags & COLUMN_IPADDRESSROWSTATUS_FLAG)
    {
        ...
        if (rowreq_ctx->rowreq_flags & MFD_ROW_CREATED)
        {
            ...
            {
                if ((rowreq_ctx->column_set_flags & IPADDRESSTABLE_REQUIRED_COLS) != IPADDRESSTABLE_REQUIRED_COLS)
                {
                    DEBUGMSGTL (("ipAddressTable",
                                 "required columns missing (0x%0x != 0x%0x)\n",
                                 rowreq_ctx->column_set_flags, IPADDRESSTABLE_REQUIRED_COLS));
        ...
        else
        {
            ...
            if (ROWSTATUS_DESTROY == rowreq_ctx->ipAddressRowStatus)
            {
                if (rowreq_ctx->column_set_flags & ~COLUMN_IPADDRESSROWSTATUS_FLAG)
                {
                    DEBUGMSGTL (("ipAddressTable", "destroy must be only varbind for row\n"));
                    return MFD_NOT_VALID_NOW;
                }
                rowreq_ctx->rowreq_flags |= MFD_ROW_DELETED;
    ...
    else
    {
        ...
        if (rowreq_ctx->rowreq_flags & MFD_ROW_CREATED)
        {
            DEBUGMSGTL (("ipAddressTable", "must use RowStatus to create rows\n"));
            return MFD_CANNOT_CREATE_NOW;
        }
    }                            /* row status not set */
