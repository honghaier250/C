 ...
 */
     ...
     static void _ipAddressTable_container_shutdown (ipAddressTable_interface_ctx * if_ctx);
...
ipAddressTable_registration *ipAddressTable_registration_set (ipAddressTable_registration * newreg)
{
...
_ipAddressTable_undo_column (ipAddressTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column);
#endif                            /* NETSNMP_NO_WRITE_SUPPORT || NETSNMP_DISABLE_SET_SUPPORT */

NETSNMP_STATIC_INLINE int _ipAddressTable_check_indexes (ipAddressTable_rowreq_ctx * rowreq_ctx);
 ...
 */
void _ipAddressTable_initialize_interface (ipAddressTable_registration * reg_ptr, u_long flags)
{
    netsnmp_baby_steps_access_methods *access_multiplexer = &ipAddressTable_if_ctx.access_multiplexer;
    ...
    {
        snmp_log (LOG_ERR, "could not initialize container for ipAddressTable\n");
        return;
    }
     ...
     */
    DEBUGMSGTL (("ipAddressTable:init_ipAddressTable", "Registering ipAddressTable as a mibs-for-dummies table.\n"));
    handler = netsnmp_baby_steps_access_multiplexer_get (access_multiplexer);
    reginfo =
        netsnmp_handler_registration_create ("ipAddressTable", handler,
                                             ipAddressTable_oid, ipAddressTable_oid_size, HANDLER_CAN_BABY_STEP
    ...
    handler =
        netsnmp_container_table_handler_get (tbl_info,
                                             ipAddressTable_if_ctx.container, TABLE_CONTAINER_KEY_NETSNMP_INDEX);
    netsnmp_inject_handler (reginfo, handler);
 ...
 */
int ipAddressTable_index_to_oid (netsnmp_index * oid_idx, ipAddressTable_mib_index * mib_idx)
{
    ...
    DEBUGMSGTL (("verbose:ipAddressTable:ipAddressTable_index_to_oid", "called\n"));

    /*
     * ipAddressAddrType(1)/InetAddressType/ASN_INTEGER/long(u_long)//l/a/w/E/r/d/h 
     */
    snmp_set_var_value (&var_ipAddressAddrType,
                        (u_char *) & mib_idx->ipAddressAddrType, sizeof (mib_idx->ipAddressAddrType));
    ...
    err = build_oid_noalloc (oid_idx->oids, oid_idx->len, &oid_idx->len, NULL, 0, &var_ipAddressAddrType);
    if (err)
 ...
 */
int ipAddressTable_index_from_oid (netsnmp_index * oid_idx, ipAddressTable_mib_index * mib_idx)
{
    int err = SNMP_ERR_NOERROR;
    ...
    DEBUGMSGTL (("verbose:ipAddressTable:ipAddressTable_index_from_oid", "called\n"));
    ...
    if (err == SNMP_ERR_NOERROR)
    {
        ...
        {
            memcpy (mib_idx->ipAddressAddr, var_ipAddressAddr.val.string, var_ipAddressAddr.val_len);
            mib_idx->ipAddressAddr_len = var_ipAddressAddr.val_len / sizeof (mib_idx->ipAddressAddr[0]);
        }
 ...
 */
ipAddressTable_rowreq_ctx *ipAddressTable_allocate_rowreq_ctx (ipAddressTable_data * data, void *user_init_ctx)
{
    ipAddressTable_rowreq_ctx *rowreq_ctx = SNMP_MALLOC_TYPEDEF (ipAddressTable_rowreq_ctx);

    DEBUGMSGTL (("internal:ipAddressTable:ipAddressTable_allocate_rowreq_ctx", "called\n"));

    if (NULL == rowreq_ctx)
    {
        snmp_log (LOG_ERR, "Couldn't allocate memory for a " "ipAddressTable_rowreq_ctx.\n");
        return NULL;
    }
    else
    {
    ...
    {
        if (SNMPERR_SUCCESS != ipAddressTable_rowreq_ctx_init (rowreq_ctx, user_init_ctx))
        {
                                 ...
                                 netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    DEBUGMSGTL (("internal:ipAddressTable:_mfd_ipAddressTable_pre_request", "called\n"));

    if (1 != netsnmp_row_merge_status_first (reginfo, agtreq_info))
    {
        DEBUGMSGTL (("internal:ipAddressTable", "skipping additional pre_request\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         */
        DEBUGMSGTL (("ipAddressTable", "error %d from " "ipAddressTable_pre_request\n", rc));
                                  ...
                                  netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    DEBUGMSGTL (("internal:ipAddressTable:_mfd_ipAddressTable_post_request", "called\n"));
    ...
    {
        DEBUGMSGTL (("internal:ipAddressTable", "waiting for last post_request\n"));
        return SNMP_ERR_NOERROR;
    }
    ...
    if ((MFD_SUCCESS != packet_rc) && ipAddressTable_dirty_get ())
    {
         ...
         * the dirty flags.
         */
        snmp_log (LOG_WARNING, "ipAddressTable dirty flag set in post_request " "but status != SUCCESS.\n");
    }
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ipAddressTable", "error %d from " "ipAddressTable_post_request\n", rc));
    }
 ...
 * wrapper
 */
static ipAddressTable_rowreq_ctx *_mfd_ipAddressTable_rowreq_from_index (netsnmp_index * oid_idx, int *rc_ptr)
{
 ...
 */
NETSNMP_STATIC_INLINE int
_ipAddressTable_get_column (ipAddressTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL (("internal:ipAddressTable:_mfd_ipAddressTable_get_column", "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_IPADDRESSPREFIX:
            ...
            rc = ipAddressPrefix_get (rowreq_ctx, (oid **) & var->val.string, &var->val_len);
            break;
        ...
        default:
            snmp_log (LOG_ERR, "unknown column %d in _ipAddressTable_get_column\n", column);
            break;
    }
                                ...
                                netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    DEBUGMSGTL (("internal:ipAddressTable:_mfd_ipAddressTable_get_values", "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipAddressTable_get_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            if (MFD_SKIP == rc)
            {
...
NETSNMP_STATIC_INLINE int _ipAddressTable_check_indexes (ipAddressTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("internal:ipAddressTable:_ipAddressTable_check_indexes", "called\n"));
     ...
     */
    if ((SNMPERR_SUCCESS == rc)
        && ((rowreq_ctx->tbl_idx.ipAddressAddr_len < 0) || (rowreq_ctx->tbl_idx.ipAddressAddr_len > 255)))
    {
     ...
     */
    return ipAddressTable_validate_index (ipAddressTable_if_ctx.user_ctx, rowreq_ctx);
 ...
 */
NETSNMP_STATIC_INLINE int
_ipAddressTable_check_column (ipAddressTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL (("internal:ipAddressTable:_ipAddressTable_check_column", "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_IPADDRESSIFINDEX:
             ...
             * check defined range(s). 
             */
            if ((SNMPERR_SUCCESS == rc) && ((*var->val.integer < 1) || (*var->val.integer > 2147483647)))
            {
                rc = SNMP_ERR_WRONGVALUE;
            }
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipAddressTable:_ipAddressTable_check_column:ipAddressIfIndex",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = ipAddressIfIndex_check_value (rowreq_ctx, *((long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from ipAddressIfIndex_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_IPADDRESSTYPE:
            ...
            if ((SNMPERR_SUCCESS == rc)
                ...
                && (*var->val.integer != IPADDRESSTYPE_ANYCAST) && (*var->val.integer != IPADDRESSTYPE_BROADCAST))
            {
                rc = SNMP_ERR_WRONGVALUE;
            }
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipAddressTable:_ipAddressTable_check_column:ipAddressType",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = ipAddressType_check_value (rowreq_ctx, *((u_long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from ipAddressType_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_IPADDRESSSTATUS:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipAddressTable:_ipAddressTable_check_column:ipAddressStatus",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = ipAddressStatus_check_value (rowreq_ctx, *((u_long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from ipAddressStatus_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_IPADDRESSROWSTATUS:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipAddressTable:_ipAddressTable_check_column:ipAddressRowStatus",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = ipAddressRowStatus_check_value (rowreq_ctx, *((u_long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from ipAddressRowStatus_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_IPADDRESSSTORAGETYPE:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipAddressTable:_ipAddressTable_check_column:ipAddressStorageType",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = ipAddressStorageType_check_value (rowreq_ctx, *((u_long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from ipAddressStorageType_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        default:
            ...
            rc = SNMP_ERR_GENERR;
            snmp_log (LOG_ERR, "unknown column %d in _ipAddressTable_check_column\n", column);
    }
                                   ...
                                   netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipAddressTable_check_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            netsnmp_request_set_error (requests, SNMP_VALIDATE_ERR (rc));
            break;
                                        ...
                                        * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (rc)
    {
        DEBUGMSGTL (("ipAddressTable:mfd", "error %d from " "ipAddressTable_check_dependencies\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
 ...
 */
NETSNMP_STATIC_INLINE int _ipAddressTable_undo_setup_column (ipAddressTable_rowreq_ctx * rowreq_ctx, int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    switch (column)
    {
        ...
        default:
            snmp_log (LOG_ERR, "unknown column %d in _ipAddressTable_undo_setup_column\n", column);
            break;
    }
                                ...
                                netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    DEBUGMSGTL (("internal:ipAddressTable:_mfd_ipAddressTable_undo_setup", "called\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("ipAddressTable:mfd", "error %d from " "ipAddressTable_undo_setup\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
    else
    {
        ...
        for (; requests; requests = requests->next)
        {
            ...
            if (MFD_SUCCESS != rc)
            {
                DEBUGMSGTL (("ipAddressTable:mfd", "error %d from " "ipAddressTable_undo_setup_column\n", rc));
                                  ...
                                  netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    DEBUGMSGTL (("internal:ipAddressTable:_mfd_ipAddressTable_undo_cleanup", "called\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ipAddressTable:mfd", "error %d from " "ipAddressTable_undo_cleanup\n", rc));
    }
 ...
 */
NETSNMP_STATIC_INLINE int
_ipAddressTable_set_column (ipAddressTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL (("internal:ipAddressTable:_ipAddressTable_set_column", "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_IPADDRESSROWSTATUS:
            rowreq_ctx->column_set_flags |= COLUMN_IPADDRESSROWSTATUS_FLAG;
            rc = ipAddressRowStatus_set (rowreq_ctx, *((u_long *) var->val.string));
            break;
        ...
        case COLUMN_IPADDRESSSTORAGETYPE:
            rowreq_ctx->column_set_flags |= COLUMN_IPADDRESSSTORAGETYPE_FLAG;
            rc = ipAddressStorageType_set (rowreq_ctx, *((u_long *) var->val.string));
            break;

        default:
            snmp_log (LOG_ERR, "unknown column %d in _ipAddressTable_set_column\n", column);
            rc = SNMP_ERR_GENERR;
            break;
    }
                                ...
                                netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    DEBUGMSGTL (("internal:ipAddressTable:_mfd_ipAddressTable_set_values", "called\n"));
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipAddressTable_set_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            DEBUGMSGTL (("ipAddressTable:mfd", "error %d from " "ipAddressTable_set_column\n", rc));
            netsnmp_set_request_error (agtreq_info, requests, SNMP_VALIDATE_ERR (rc));
        }
    }                            /* for results */
                            ...
                            netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    DEBUGMSGTL (("internal:ipAddressTable:_mfd_ipAddressTable_commit", "called\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("ipAddressTable:mfd", "error %d from " "ipAddressTable_commit\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
                                 ...
                                 netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    DEBUGMSGTL (("internal:ipAddressTable:_mfd_ipAddressTable_undo_commit", "called\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ipAddressTable:mfd", "error %d from " "ipAddressTable_undo_commit\n", rc));
    }

    if (rowreq_ctx->rowreq_flags & MFD_ROW_DIRTY)
    {
        snmp_log (LOG_WARNING, "ipAddressTable row dirty flag still set after undo_commit\n");
...
_ipAddressTable_undo_column (ipAddressTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    ...
    DEBUGMSGTL (("internal:ipAddressTable:_ipAddressTable_undo_column", "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        default:
            snmp_log (LOG_ERR, "unknown column %d in _ipAddressTable_undo_column\n", column);
            break;
    }
                                 ...
                                 netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    DEBUGMSGTL (("internal:ipAddressTable:_mfd_ipAddressTable_undo_values", "called\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("ipAddressTable:mfd", "error %d from " "ipAddressTable_undo\n", rc));
    }
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _ipAddressTable_undo_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            /*
             * nothing we can do about it but log it
             */
            DEBUGMSGTL (("ipAddressTable:mfd", "error %d from " "ipAddressTable_undo_column\n", rc));
        }
    }                            /* for results */
 ...
 * @internal
 */
static void _container_item_free (ipAddressTable_rowreq_ctx * rowreq_ctx, void *context)
{
...
static void _container_free (netsnmp_container * container)
{
    ...
    if (NULL == container)
    {
        snmp_log (LOG_ERR, "invalid container in ipAddressTable_container_free\n");
        return;
    }
...
{
    DEBUGMSGTL (("internal:ipAddressTable:_ipAddressTable_container_init", "called\n"));
    ...
    if (NULL == if_ctx->container)
        if_ctx->container = netsnmp_container_find ("ipAddressTable:table_container");
    if (NULL == if_ctx->container)
    {
        snmp_log (LOG_ERR, "error creating container in " "ipAddressTable_container_init\n");
        return;
    }
...
ipAddressTable_rowreq_ctx *ipAddressTable_row_find_by_mib_index (ipAddressTable_mib_index * mib_idx)
{
    ipAddressTable_rowreq_ctx *rowreq_ctx;
