...
netsnmp_feature_require (table_dataset) netsnmp_feature_require (date_n_time)
...
static void netsnmp_notif_log_remove_oldest (int count)
{
    ...
    for (; count && deleterow; deleterow = tmprow, --count)
    {
        ...
        DEBUGIF ("9:notification_log")
        {
            ...
            DEBUGMSGOID (("9:notification_log", deleterow->index_oid, deleterow->index_oid_len));
        ...
        for (; deletevarrow; deletevarrow = tmprow)
        {
            ...
            tmprow = netsnmp_table_data_set_get_next_row (nlmLogVarTable, deletevarrow);

            DEBUGIF ("9:notification_log")
            {
                DEBUGMSGTL (("9:notification_log", "         :"));
                DEBUGMSGOID (("9:notification_log", deletevarrow->index_oid, deletevarrow->index_oid_len));
                DEBUGMSG (("9:notification_log", "\n"));
            }
            if ((deleterow->index_oid_len == deletevarrow->index_oid_len - 1) &&
                snmp_oid_compare (deleterow->index_oid,
                                  deleterow->index_oid_len, deletevarrow->index_oid, deleterow->index_oid_len) == 0)
            {
                DEBUGMSGTL (("9:notification_log", "    deleting varbind\n"));
                netsnmp_table_dataset_remove_and_delete_row (nlmLogVarTable, deletevarrow);
            }
            else
                break;
        }
...
static void check_log_size (unsigned int clientreg, void *clientarg)
{
    ...
    for (row = netsnmp_table_data_set_get_first_row (nlmLogTable);
         row; row = netsnmp_table_data_set_get_next_row (nlmLogTable, row))
    {
...
static void initialize_table_nlmLogVariableTable (const char *context)
{
    ...
    netsnmp_table_set_add_default_row (table_set, COLUMN_NLMLOGVARIABLEID, ASN_OBJECT_ID, 0, NULL, 0);
    /*
    ...
    netsnmp_table_set_add_default_row (table_set, COLUMN_NLMLOGVARIABLEVALUETYPE, ASN_INTEGER, 0, NULL, 0);
    /*
    ...
    netsnmp_table_set_add_default_row (table_set, COLUMN_NLMLOGVARIABLECOUNTER32VAL, ASN_COUNTER, 0, NULL, 0);
    /*
    ...
    netsnmp_table_set_add_default_row (table_set, COLUMN_NLMLOGVARIABLEUNSIGNED32VAL, ASN_UNSIGNED, 0, NULL, 0);
    /*
    ...
    netsnmp_table_set_add_default_row (table_set, COLUMN_NLMLOGVARIABLETIMETICKSVAL, ASN_TIMETICKS, 0, NULL, 0);
    /*
    ...
    netsnmp_table_set_add_default_row (table_set, COLUMN_NLMLOGVARIABLEINTEGER32VAL, ASN_INTEGER, 0, NULL, 0);
    /*
    ...
    netsnmp_table_set_add_default_row (table_set, COLUMN_NLMLOGVARIABLEOCTETSTRINGVAL, ASN_OCTET_STR, 0, NULL, 0);
    /*
    ...
    netsnmp_table_set_add_default_row (table_set, COLUMN_NLMLOGVARIABLEIPADDRESSVAL, ASN_IPADDRESS, 0, NULL, 0);
    /*
    ...
    netsnmp_table_set_add_default_row (table_set, COLUMN_NLMLOGVARIABLEOIDVAL, ASN_OBJECT_ID, 0, NULL, 0);
    /*
    ...
    netsnmp_table_set_add_default_row (table_set, COLUMN_NLMLOGVARIABLECOUNTER64VAL, ASN_COUNTER64, 0, NULL, 0);
    /*
    ...
    netsnmp_table_set_add_default_row (table_set, COLUMN_NLMLOGVARIABLEOPAQUEVAL, ASN_OPAQUE, 0, NULL, 0);
    ...
    reginfo =
        netsnmp_create_handler_registration ("nlmLogVariableTable",
                                             NULL,
                                             nlmLogVariableTable_oid, nlmLogVariableTable_oid_len, HANDLER_CAN_RWRITE);
    if (NULL != context)
...
static void initialize_table_nlmLogTable (const char *context)
{
    ...
    netsnmp_table_set_add_default_row (nlmLogTable, COLUMN_NLMLOGTIME, ASN_TIMETICKS, 0, NULL, 0);
    /*
    ...
    netsnmp_table_set_add_default_row (nlmLogTable, COLUMN_NLMLOGDATEANDTIME, ASN_OCTET_STR, 0, NULL, 0);
    /*
    ...
    netsnmp_table_set_add_default_row (nlmLogTable, COLUMN_NLMLOGENGINEID, ASN_OCTET_STR, 0, NULL, 0);
    /*
    ...
    netsnmp_table_set_add_default_row (nlmLogTable, COLUMN_NLMLOGENGINETADDRESS, ASN_OCTET_STR, 0, NULL, 0);
    /*
    ...
    netsnmp_table_set_add_default_row (nlmLogTable, COLUMN_NLMLOGENGINETDOMAIN, ASN_OBJECT_ID, 0, NULL, 0);
    /*
    ...
    netsnmp_table_set_add_default_row (nlmLogTable, COLUMN_NLMLOGCONTEXTENGINEID, ASN_OCTET_STR, 0, NULL, 0);
    /*
    ...
    netsnmp_table_set_add_default_row (nlmLogTable, COLUMN_NLMLOGCONTEXTNAME, ASN_OCTET_STR, 0, NULL, 0);
    /*
    ...
    netsnmp_table_set_add_default_row (nlmLogTable, COLUMN_NLMLOGNOTIFICATIONID, ASN_OBJECT_ID, 0, NULL, 0);
    ...
    reginfo =
        netsnmp_create_handler_registration ("nlmLogTable", NULL,
                                             nlmLogTable_oid, nlmLogTable_oid_len, HANDLER_CAN_RWRITE);
    if (NULL != context)
        reginfo->contextName = strdup (context);
...
void init_notification_log (void)
{
    ...
    context = netsnmp_ds_get_string (NETSNMP_DS_APPLICATION_ID, NETSNMP_DS_NOTIF_LOG_CTX);
    ...
    netsnmp_register_read_only_counter32_instance_context
        ("nlmStatsGlobalNotificationsLogged",
         ...
         OID_LENGTH (my_nlmStatsGlobalNotificationsLogged_oid), &num_received, NULL, context);

    netsnmp_register_read_only_counter32_instance_context
        ("nlmStatsGlobalNotificationsBumped",
         my_nlmStatsGlobalNotificationsBumped_oid,
         OID_LENGTH (my_nlmStatsGlobalNotificationsBumped_oid), &num_deleted, NULL, context);

    netsnmp_register_ulong_instance_context ("nlmConfigGlobalEntryLimit",
                                             my_nlmConfigGlobalEntryLimit_oid,
                                             OID_LENGTH
                                             (my_nlmConfigGlobalEntryLimit_oid),
                                             &max_logged, notification_log_config_handler, context);

    netsnmp_register_ulong_instance_context ("nlmConfigGlobalAgeOut",
                                             my_nlmConfigGlobalAgeOut_oid,
                                             OID_LENGTH
                                             (my_nlmConfigGlobalAgeOut_oid),
                                             &max_age, notification_log_config_handler, context);
     ...
     * disable flag 
     */
    apptype = netsnmp_ds_get_string (NETSNMP_DS_LIBRARY_ID, NETSNMP_DS_LIB_APPTYPE);
    ...
    netsnmp_ds_register_config (ASN_INTEGER,
                                ...
                                "notificationLogMax", NETSNMP_DS_APPLICATION_ID, NETSNMP_DS_AGENT_NOTIF_LOG_MAX);
#endif

    REGISTER_SYSOR_ENTRY (nlm_module_oid, "The MIB module for logging SNMP Notifications.");
}
...
void log_notification (netsnmp_pdu * pdu, netsnmp_transport * transport)
{
    ...
    if (!nlmLogVarTable || netsnmp_ds_get_boolean (NETSNMP_DS_APPLICATION_ID, NETSNMP_DS_APP_DONT_LOG))
    {
        return;
    }
     ...
     */
    netsnmp_table_row_add_index (row, ASN_OCTET_STR, "default", strlen ("default"));
    ...
    netsnmp_set_row_column (row, COLUMN_NLMLOGTIME, ASN_TIMETICKS, &tmpl, sizeof (tmpl));
    time (&timetnow);
    logdate = date_n_time (&timetnow, &logdate_size);
    netsnmp_set_row_column (row, COLUMN_NLMLOGDATEANDTIME, ASN_OCTET_STR, logdate, logdate_size);
    netsnmp_set_row_column (row, COLUMN_NLMLOGENGINEID, ASN_OCTET_STR, pdu->securityEngineID, pdu->securityEngineIDLen);
    if (transport && transport->domain == netsnmpUDPDomain)
    {
        ...
        if (addr)
        {
            ...
            netsnmp_set_row_column (row, COLUMN_NLMLOGENGINETADDRESS,
                                    ASN_OCTET_STR, buf, sizeof (in_addr_t) + sizeof (addr->sin_port));
        }
    }
    if (transport)
        netsnmp_set_row_column (row, COLUMN_NLMLOGENGINETDOMAIN,
                                ASN_OBJECT_ID, transport->domain, sizeof (oid) * transport->domain_length);
    netsnmp_set_row_column (row, COLUMN_NLMLOGCONTEXTENGINEID,
                            ASN_OCTET_STR, pdu->contextEngineID, pdu->contextEngineIDLen);
    netsnmp_set_row_column (row, COLUMN_NLMLOGCONTEXTNAME, ASN_OCTET_STR, pdu->contextName, pdu->contextNameLen);

    if (pdu->command == SNMP_MSG_TRAP)
        pdu = convert_v1pdu_to_v2 (orig_pdu);
    for (vptr = pdu->variables; vptr; vptr = vptr->next_variable)
    {
        if (snmp_oid_compare (snmptrapoid, snmptrapoid_len, vptr->name, vptr->name_length) == 0)
        {
            netsnmp_set_row_column (row, COLUMN_NLMLOGNOTIFICATIONID, ASN_OBJECT_ID, vptr->val.string, vptr->val_len);
        }
        else
        {
             ...
             * indexes to the table 
             */
            netsnmp_table_row_add_index (myrow, ASN_OCTET_STR, "default", strlen ("default"));
            netsnmp_table_row_add_index (myrow, ASN_UNSIGNED, &default_num, sizeof (default_num));
            vbcount++;
            netsnmp_table_row_add_index (myrow, ASN_UNSIGNED, &vbcount, sizeof (vbcount));

            /*
             * OID 
             */
            netsnmp_set_row_column (myrow, COLUMN_NLMLOGVARIABLEID,
                                    ASN_OBJECT_ID, vptr->name, vptr->name_length * sizeof (oid));
            ...
            switch (vptr->type)
            {
                ...
                default:
                     ...
                     * unsupported 
                     */
                    DEBUGMSGTL (("notification_log", "skipping type %d\n", vptr->type));
                    (void) netsnmp_table_dataset_delete_row (myrow);
                    continue;
            }
            netsnmp_set_row_column (myrow, COLUMN_NLMLOGVARIABLEVALUETYPE, ASN_INTEGER, &tmpul, sizeof (tmpul));
            netsnmp_set_row_column (myrow, col, vptr->type, vptr->val.string, vptr->val_len);
            DEBUGMSGTL (("notification_log", "adding a row to the variables table\n"));
