...
config_add_mib (IF - MIB) config_add_mib (IP - MIB) config_add_mib (TCP - MIB) config_add_mib (UDP - MIB)
...
config_require (mibII / sysORTable) config_require (mibII / vacm_vars) config_require (mibII / vacm_conf)
...
config_require (target) config_require (agent_mibs) config_require (agentx) config_require (disman / event)
...
config_add_mib (NOTIFICATION - LOG - MIB) config_add_mib (DISMAN - EVENT - MIB)
#ifndef NETSNMP_NO_WRITE_SUPPORT
