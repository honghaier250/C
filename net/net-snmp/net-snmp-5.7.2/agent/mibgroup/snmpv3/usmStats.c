...
void init_usmStats (void)
{
    ...
    REGISTER_SYSOR_ENTRY (reg, "The management information definitions for the " "SNMP User-based Security Model.");
    REGISTER_MIB ("snmpv3/usmStats", usmStats_variables, variable2, usmStats_variables_oid);
}

u_char *var_usmStats (struct variable *vp,
