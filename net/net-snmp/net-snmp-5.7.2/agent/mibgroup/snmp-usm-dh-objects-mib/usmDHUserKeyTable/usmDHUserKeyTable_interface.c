...
netsnmp_feature_require (baby_steps) netsnmp_feature_require (check_all_requests_error)
 ...
 */
     ...
     static void _usmDHUserKeyTable_container_init (usmDHUserKeyTable_interface_ctx * if_ctx);

     static void _usmDHUserKeyTable_container_shutdown (usmDHUserKeyTable_interface_ctx * if_ctx);
...
usmDHUserKeyTable_registration *usmDHUserKeyTable_registration_get (void)
{
    return usmDHUserKeyTable_if_ctx.user_ctx;
}

usmDHUserKeyTable_registration *usmDHUserKeyTable_registration_set (usmDHUserKeyTable_registration * newreg)
{
    usmDHUserKeyTable_registration *old = usmDHUserKeyTable_if_ctx.user_ctx;
...
_usmDHUserKeyTable_undo_column (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column);
#endif
 ...
 */
void _usmDHUserKeyTable_initialize_interface (usmDHUserKeyTable_registration * reg_ptr, u_long flags)
{
    netsnmp_baby_steps_access_methods *access_multiplexer = &usmDHUserKeyTable_if_ctx.access_multiplexer;

    netsnmp_table_registration_info *tbl_info = &usmDHUserKeyTable_if_ctx.tbl_info;
    ...
    {
        snmp_log (LOG_ERR, "could not initialize container for usmDHUserKeyTable\n");
        return;
    }
     ...
     */
    access_multiplexer->object_lookup = _mfd_usmDHUserKeyTable_object_lookup;
     ...
     */
    access_multiplexer->object_syntax_checks = _mfd_usmDHUserKeyTable_check_objects;
    ...
    access_multiplexer->irreversible_commit = _mfd_usmDHUserKeyTable_irreversible_commit;

    /*
     * REQUIRED for tables with dependencies
     */
    access_multiplexer->consistency_checks = _mfd_usmDHUserKeyTable_check_dependencies;
#endif
    ...
    reginfo =
        netsnmp_handler_registration_create ("usmDHUserKeyTable", handler,
                                             usmDHUserKeyTable_oid, usmDHUserKeyTable_oid_size, HANDLER_CAN_BABY_STEP
#ifndef NETSNMP_DISABLE_SET_SUPPORT
                                             | HANDLER_CAN_RWRITE
#endif
        );
    ...
    handler =
        netsnmp_container_table_handler_get (tbl_info,
                                             usmDHUserKeyTable_if_ctx.container, TABLE_CONTAINER_KEY_NETSNMP_INDEX);
    netsnmp_inject_handler (reginfo, handler);
    ...
    {
        handler = netsnmp_cache_handler_get (usmDHUserKeyTable_if_ctx.cache);
        netsnmp_inject_handler (reginfo, handler);
    }
 ...
 */
void _usmDHUserKeyTable_shutdown_interface (usmDHUserKeyTable_registration * reg_ptr)
{
    /*
...
void usmDHUserKeyTable_valid_columns_set (netsnmp_column_info * vc)
{
 ...
 */
int usmDHUserKeyTable_index_to_oid (netsnmp_index * oid_idx, usmDHUserKeyTable_mib_index * mib_idx)
{
    ...
    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserKeyTable_index_to_oid", "called\n"));
    ...
    snmp_set_var_value (&var_usmUserEngineID,
                        ...
                        mib_idx->usmUserEngineID_len * sizeof (mib_idx->usmUserEngineID[0]));

    /*
     * usmUserName(2)/SnmpAdminString/ASN_OCTET_STR/char(char)//L/a/w/e/R/d/H 
     */
    snmp_set_var_value (&var_usmUserName, (u_char *) & mib_idx->usmUserName,
                        mib_idx->usmUserName_len * sizeof (mib_idx->usmUserName[0]));


    err = build_oid_noalloc (oid_idx->oids, oid_idx->len, &oid_idx->len, NULL, 0, &var_usmUserEngineID);
    if (err)
 ...
 */
int usmDHUserKeyTable_index_from_oid (netsnmp_index * oid_idx, usmDHUserKeyTable_mib_index * mib_idx)
{
    int err = SNMP_ERR_NOERROR;
     ...
     */
    err = parse_oid_indexes (oid_idx->oids, oid_idx->len, &var_usmUserEngineID);
    if (err == SNMP_ERR_NOERROR)
    {
        ...
        {
            memcpy (mib_idx->usmUserEngineID, var_usmUserEngineID.val.string, var_usmUserEngineID.val_len);
            mib_idx->usmUserEngineID_len = var_usmUserEngineID.val_len / sizeof (mib_idx->usmUserEngineID[0]);
        }
        /*
        ...
        {
            memcpy (mib_idx->usmUserName, var_usmUserName.val.string, var_usmUserName.val_len);
            mib_idx->usmUserName_len = var_usmUserName.val_len / sizeof (mib_idx->usmUserName[0]);
        }
 ...
 */
usmDHUserKeyTable_rowreq_ctx *usmDHUserKeyTable_allocate_rowreq_ctx (usmDHUserKeyTable_data * data, void *user_init_ctx)
{
    usmDHUserKeyTable_rowreq_ctx *rowreq_ctx = SNMP_MALLOC_TYPEDEF (usmDHUserKeyTable_rowreq_ctx);

    DEBUGMSGTL (("internal:usmDHUserKeyTable:usmDHUserKeyTable_allocate_rowreq_ctx", "called\n"));

    if (NULL == rowreq_ctx)
    {
        snmp_log (LOG_ERR, "Couldn't allocate memory for a " "usmDHUserKeyTable_rowreq_ctx.\n");
        return NULL;
    }
    else
    {
        ...
        else if (NULL == (rowreq_ctx->data = usmDHUserKeyTable_allocate_data ()))
        {
    ...
    {
        if (SNMPERR_SUCCESS != usmDHUserKeyTable_rowreq_ctx_init (rowreq_ctx, user_init_ctx))
        {
 ...
 */
void usmDHUserKeyTable_release_rowreq_ctx (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx)
{
                                    ...
                                    netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    {
        DEBUGMSGTL (("internal:usmDHUserKeyTable", "skipping additional pre_request\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         */
        DEBUGMSGTL (("usmDHUserKeyTable", "error %d from " "usmDHUserKeyTable_pre_request\n", rc));
...
_mfd_usmDHUserKeyTable_post_request (netsnmp_mib_handler * handler,
                                     ...
                                     netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    usmDHUserKeyTable_rowreq_ctx *rowreq_ctx = netsnmp_container_table_row_extract (requests);
    ...
    {
        DEBUGMSGTL (("internal:usmDHUserKeyTable", "waiting for last post_request\n"));
        return SNMP_ERR_NOERROR;
    }
    ...
    if ((MFD_SUCCESS != packet_rc) && usmDHUserKeyTable_dirty_get ())
    {
         ...
         * the dirty flags.
         */
        snmp_log (LOG_WARNING, "usmDHUserKeyTable dirty flag set in post_request " "but status != SUCCESS.\n");
    }

    rc = usmDHUserKeyTable_post_request (usmDHUserKeyTable_if_ctx.user_ctx, packet_rc);
    if (MFD_SUCCESS != rc)
    {
        /*
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("usmDHUserKeyTable", "error %d from " "usmDHUserKeyTable_post_request\n", rc));
    }
 ...
 */
NETSNMP_STATIC_INLINE int
_usmDHUserKeyTable_get_column (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    ...
    switch (column)
    {
        ...
        case COLUMN_USMDHUSERAUTHKEYCHANGE:
            ...
            rc = usmDHUserAuthKeyChange_get (rowreq_ctx, &var->val.string, &var->val_len);
            break;
        ...
        case COLUMN_USMDHUSEROWNAUTHKEYCHANGE:
            var->type = ASN_OCTET_STR;
            rc = usmDHUserOwnAuthKeyChange_get (rowreq_ctx, &var->val.string, &var->val_len);
            break;
        ...
        case COLUMN_USMDHUSERPRIVKEYCHANGE:
            var->type = ASN_OCTET_STR;
            rc = usmDHUserPrivKeyChange_get (rowreq_ctx, &var->val.string, &var->val_len);
            break;
        ...
        case COLUMN_USMDHUSEROWNPRIVKEYCHANGE:
            var->type = ASN_OCTET_STR;
            rc = usmDHUserOwnPrivKeyChange_get (rowreq_ctx, &var->val.string, &var->val_len);
            break;

        default:
            snmp_log (LOG_ERR, "unknown column %d in _usmDHUserKeyTable_get_column\n", column);
            break;
    }
                                   ...
                                   netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _usmDHUserKeyTable_get_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            if (MFD_SKIP == rc)
            {
 ...
 */
NETSNMP_STATIC_INLINE int
_usmDHUserKeyTable_check_column (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    switch (column)
    {
        ...
        case COLUMN_USMDHUSERAUTHKEYCHANGE:
            ...
            {
                DEBUGMSGTL (("usmDHUserKeyTable:_usmDHUserKeyTable_check_column:usmDHUserAuthKeyChange",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = usmDHUserAuthKeyChange_check_value (rowreq_ctx, var->val.string, var->val_len);
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from usmDHUserAuthKeyChange_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_USMDHUSEROWNAUTHKEYCHANGE:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("usmDHUserKeyTable:_usmDHUserKeyTable_check_column:usmDHUserOwnAuthKeyChange",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = usmDHUserOwnAuthKeyChange_check_value (rowreq_ctx, var->val.string, var->val_len);
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from usmDHUserOwnAuthKeyChange_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_USMDHUSERPRIVKEYCHANGE:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("usmDHUserKeyTable:_usmDHUserKeyTable_check_column:usmDHUserPrivKeyChange",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = usmDHUserPrivKeyChange_check_value (rowreq_ctx, var->val.string, var->val_len);
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from usmDHUserPrivKeyChange_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_USMDHUSEROWNPRIVKEYCHANGE:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("usmDHUserKeyTable:_usmDHUserKeyTable_check_column:usmDHUserOwnPrivKeyChange",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = usmDHUserOwnPrivKeyChange_check_value (rowreq_ctx, var->val.string, var->val_len);
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from usmDHUserOwnPrivKeyChange_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        default:
            ...
            rc = SNMP_ERR_GENERR;
            snmp_log (LOG_ERR, "unknown column %d in _usmDHUserKeyTable_check_column\n", column);
    }
                                      ...
                                      netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _usmDHUserKeyTable_check_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            netsnmp_request_set_error (requests, SNMP_VALIDATE_ERR (rc));
            break;
                                           ...
                                           * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (rc)
    {
        DEBUGMSGTL (("usmDHUserKeyTable:mfd", "error %d from " "usmDHUserKeyTable_check_dependencies\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
 ...
 */
NETSNMP_STATIC_INLINE int _usmDHUserKeyTable_undo_setup_column (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx, int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    switch (column)
    {
        ...
        case COLUMN_USMDHUSERAUTHKEYCHANGE:
             ...
             */
        case COLUMN_USMDHUSEROWNAUTHKEYCHANGE:
            rowreq_ctx->column_set_flags |= COLUMN_USMDHUSEROWNAUTHKEYCHANGE_FLAG;
        ...
        case COLUMN_USMDHUSERPRIVKEYCHANGE:
             ...
             */
        case COLUMN_USMDHUSEROWNPRIVKEYCHANGE:
            rowreq_ctx->column_set_flags |= COLUMN_USMDHUSEROWNPRIVKEYCHANGE_FLAG;
            rc = usmDHUserOwnPrivKeyChange_undo_setup (rowreq_ctx);
            break;

        default:
            snmp_log (LOG_ERR, "unknown column %d in _usmDHUserKeyTable_undo_setup_column\n", column);
            break;
    }
                                   ...
                                   netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("usmDHUserKeyTable:mfd", "error %d from " "usmDHUserKeyTable_undo_setup\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
    else
    {
        ...
        for (; requests; requests = requests->next)
        {
            ...
            rc = _usmDHUserKeyTable_undo_setup_column (rowreq_ctx, tri->colnum);
            if (MFD_SUCCESS != rc)
            {
                DEBUGMSGTL (("usmDHUserKeyTable:mfd", "error %d from " "usmDHUserKeyTable_undo_setup_column\n", rc));
                                     ...
                                     netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("usmDHUserKeyTable:mfd", "error %d from " "usmDHUserKeyTable_undo_cleanup\n", rc));
    }
 ...
 */
NETSNMP_STATIC_INLINE int
_usmDHUserKeyTable_set_column (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    int rc = SNMPERR_SUCCESS;

    DEBUGMSGTL (("internal:usmDHUserKeyTable:_usmDHUserKeyTable_set_column", "called for %d\n", column));
    ...
    switch (column)
    {
        ...
        case COLUMN_USMDHUSERAUTHKEYCHANGE:
            rowreq_ctx->column_set_flags |= COLUMN_USMDHUSERAUTHKEYCHANGE_FLAG;
            rc = usmDHUserAuthKeyChange_set (rowreq_ctx, var->val.string, var->val_len);
            break;
        ...
        case COLUMN_USMDHUSEROWNAUTHKEYCHANGE:
            rowreq_ctx->column_set_flags |= COLUMN_USMDHUSEROWNAUTHKEYCHANGE_FLAG;
            rc = usmDHUserOwnAuthKeyChange_set (rowreq_ctx, var->val.string, var->val_len);
            break;
        ...
        case COLUMN_USMDHUSERPRIVKEYCHANGE:
            rowreq_ctx->column_set_flags |= COLUMN_USMDHUSERPRIVKEYCHANGE_FLAG;
            rc = usmDHUserPrivKeyChange_set (rowreq_ctx, var->val.string, var->val_len);
            break;
        ...
        case COLUMN_USMDHUSEROWNPRIVKEYCHANGE:
            rowreq_ctx->column_set_flags |= COLUMN_USMDHUSEROWNPRIVKEYCHANGE_FLAG;
            rc = usmDHUserOwnPrivKeyChange_set (rowreq_ctx, var->val.string, var->val_len);
            break;

        default:
            snmp_log (LOG_ERR, "unknown column %d in _usmDHUserKeyTable_set_column\n", column);
            rc = SNMP_ERR_GENERR;
            break;
    }
                                   ...
                                   netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _usmDHUserKeyTable_set_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            DEBUGMSGTL (("usmDHUserKeyTable:mfd", "error %d from " "usmDHUserKeyTable_set_column\n", rc));
            netsnmp_set_request_error (agtreq_info, requests, SNMP_VALIDATE_ERR (rc));
        }
    }                            /* for results */
                               ...
                               netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    DEBUGMSGTL (("internal:usmDHUserKeyTable:_mfd_usmDHUserKeyTable_commit", "called\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("usmDHUserKeyTable:mfd", "error %d from " "usmDHUserKeyTable_commit\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
                                    ...
                                    netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("usmDHUserKeyTable:mfd", "error %d from " "usmDHUserKeyTable_undo_commit\n", rc));
    }

    if (rowreq_ctx->rowreq_flags & MFD_ROW_DIRTY)
    {
        snmp_log (LOG_WARNING, "usmDHUserKeyTable row dirty flag still set after undo_commit\n");
...
_usmDHUserKeyTable_undo_column (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx, netsnmp_variable_list * var, int column)
{
    ...
    switch (column)
    {
        ...
        default:
            snmp_log (LOG_ERR, "unknown column %d in _usmDHUserKeyTable_undo_column\n", column);
            break;
    }
                                    ...
                                    netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("usmDHUserKeyTable:mfd", "error %d from " "usmDHUserKeyTable_undo\n", rc));
    }
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _usmDHUserKeyTable_undo_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            /*
             * nothing we can do about it but log it
             */
            DEBUGMSGTL (("usmDHUserKeyTable:mfd", "error %d from " "usmDHUserKeyTable_undo_column\n", rc));
        }
    }                            /* for results */
                                            ...
                                            * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
        ...
        DEBUGMSGTL (("usmDHUserKeyTable:mfd", "error %d from " "usmDHUserKeyTable_irreversible_commit\n", rc));
    }
...
static int _cache_load (netsnmp_cache * cache, void *vmagic)
{
    ...
    {
        snmp_log (LOG_ERR, "invalid cache for usmDHUserKeyTable_cache_load\n");
        return -1;
    }
     ...
     * call user code
     */
    return usmDHUserKeyTable_container_load ((netsnmp_container *) cache->magic);
}                                /* _cache_load */
...
static void _cache_free (netsnmp_cache * cache, void *magic)
{
    ...
    if ((NULL == cache) || (NULL == cache->magic))
    {
        snmp_log (LOG_ERR, "invalid cache in usmDHUserKeyTable_cache_free\n");
        return;
    }
 ...
 * @internal
 */
static void _container_item_free (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx, void *context)
{
    DEBUGMSGTL (("internal:usmDHUserKeyTable:_container_item_free", "called\n"));
...
static void _container_free (netsnmp_container * container)
{
    ...
    if (NULL == container)
    {
        snmp_log (LOG_ERR, "invalid container in usmDHUserKeyTable_container_free\n");
        return;
    }
 ...
 */
void _usmDHUserKeyTable_container_init (usmDHUserKeyTable_interface_ctx * if_ctx)
{
    ...
    if_ctx->cache = netsnmp_cache_create (30,    /* timeout in seconds */
                                          _cache_load, _cache_free, usmDHUserKeyTable_oid, usmDHUserKeyTable_oid_size);
    ...
    if (NULL == if_ctx->container)
        if_ctx->container = netsnmp_container_find ("usmDHUserKeyTable:table_container");
    if (NULL == if_ctx->container)
    {
        snmp_log (LOG_ERR, "error creating container in " "usmDHUserKeyTable_container_init\n");
        return;
    }
 ...
 */
void _usmDHUserKeyTable_container_shutdown (usmDHUserKeyTable_interface_ctx * if_ctx)
{
...
usmDHUserKeyTable_rowreq_ctx *usmDHUserKeyTable_row_find_by_mib_index (usmDHUserKeyTable_mib_index * mib_idx)
{
    ...
    rowreq_ctx = CONTAINER_FIND (usmDHUserKeyTable_if_ctx.container, &oid_idx);
