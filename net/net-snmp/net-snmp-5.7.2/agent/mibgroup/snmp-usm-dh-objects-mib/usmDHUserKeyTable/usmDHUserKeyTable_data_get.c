...
int usmDHGetUserKeyChange (struct usmUser *user, int for_auth_key, u_char ** keyobj, size_t * keyobj_len)
{
    DH *dh;
...
usmDHUserKeyTable_data *usmDHUserKeyTable_allocate_data (void)
{
     ...
     */
    usmDHUserKeyTable_data *rtn = SNMP_MALLOC_TYPEDEF (usmDHUserKeyTable_data);

    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserKeyTable_allocate_data", "called\n"));

    if (NULL == rtn)
    {
        snmp_log (LOG_ERR, "unable to malloc memory for new " "usmDHUserKeyTable_data.\n");
    }
    /*
 ...
 */
void usmDHUserKeyTable_release_data (usmDHUserKeyTable_data * data)
{
    struct usmUser *user = data;

    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserKeyTable_release_data", "called\n"));
...
usmDHUserKeyTable_indexes_set_tbl_idx (usmDHUserKeyTable_mib_index *
                                       ...
                                       char *usmUserName_val_ptr, size_t usmUserName_val_ptr_len)
{
     ...
     */
    if ((NULL == tbl_idx->usmUserEngineID) || (tbl_idx->usmUserEngineID_len < (usmUserEngineID_val_ptr_len)))
    {
    ...
    memcpy (tbl_idx->usmUserEngineID, usmUserEngineID_val_ptr,
            usmUserEngineID_val_ptr_len * sizeof (usmUserEngineID_val_ptr[0]));
     ...
     */
    if ((NULL == tbl_idx->usmUserName) || (tbl_idx->usmUserName_len < (usmUserName_val_ptr_len)))
    {
        snmp_log (LOG_ERR, "not enough space for value\n");
        return MFD_ERROR;
    }
    tbl_idx->usmUserName_len = usmUserName_val_ptr_len;
    memcpy (tbl_idx->usmUserName, usmUserName_val_ptr, usmUserName_val_ptr_len * sizeof (usmUserName_val_ptr[0]));
...
usmDHUserKeyTable_indexes_set (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx,
                               ...
                               char *usmUserName_val_ptr, size_t usmUserName_val_ptr_len)
{
    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserKeyTable_indexes_set", "called\n"));

    if (MFD_SUCCESS !=
        usmDHUserKeyTable_indexes_set_tbl_idx (&rowreq_ctx->tbl_idx,
                                               usmUserEngineID_val_ptr,
                                               usmUserEngineID_val_ptr_len,
                                               usmUserName_val_ptr, usmUserName_val_ptr_len))
        return MFD_ERROR;
    ...
    if (0 != usmDHUserKeyTable_index_to_oid (&rowreq_ctx->oid_idx, &rowreq_ctx->tbl_idx))
    {
        return MFD_ERROR;
    }
                            ...
                            size_t * usmDHUserAuthKeyChange_val_ptr_len_ptr)
{
   ...
   /** we should have a non-NULL pointer and enough storage */
    netsnmp_assert ((NULL != usmDHUserAuthKeyChange_val_ptr_ptr) && (NULL != *usmDHUserAuthKeyChange_val_ptr_ptr));
    netsnmp_assert (NULL != usmDHUserAuthKeyChange_val_ptr_len_ptr);


    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserAuthKeyChange_get", "called\n"));
    ...
    return usmDHGetUserKeyChange (rowreq_ctx->data, 1,
                                  usmDHUserAuthKeyChange_val_ptr_ptr, usmDHUserAuthKeyChange_val_ptr_len_ptr);
...
usmDHUserOwnAuthKeyChange_get (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx,
                               ...
                               size_t * usmDHUserOwnAuthKeyChange_val_ptr_len_ptr)
{
   ...
   /** we should have a non-NULL pointer and enough storage */
    ...
    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserOwnAuthKeyChange_get", "called\n"));
    ...
    if (!rowreq_ctx || !usmDHUserOwnAuthKeyChange_val_ptr_len_ptr ||
        !usmDHUserOwnAuthKeyChange_val_ptr_ptr || !*usmDHUserOwnAuthKeyChange_val_ptr_ptr)
    {
        return MFD_ERROR;
    }

    return usmDHGetUserKeyChange (rowreq_ctx->data, 1,
                                  usmDHUserOwnAuthKeyChange_val_ptr_ptr, usmDHUserOwnAuthKeyChange_val_ptr_len_ptr);
                            ...
                            size_t * usmDHUserPrivKeyChange_val_ptr_len_ptr)
{
   ...
   /** we should have a non-NULL pointer and enough storage */
    netsnmp_assert ((NULL != usmDHUserPrivKeyChange_val_ptr_ptr) && (NULL != *usmDHUserPrivKeyChange_val_ptr_ptr));
    netsnmp_assert (NULL != usmDHUserPrivKeyChange_val_ptr_len_ptr);


    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserPrivKeyChange_get", "called\n"));
    ...
    if (!rowreq_ctx || !usmDHUserPrivKeyChange_val_ptr_len_ptr ||
        !usmDHUserPrivKeyChange_val_ptr_ptr || !*usmDHUserPrivKeyChange_val_ptr_ptr)
    {
        return MFD_ERROR;
    }

    return usmDHGetUserKeyChange (rowreq_ctx->data, 0,
                                  usmDHUserPrivKeyChange_val_ptr_ptr, usmDHUserPrivKeyChange_val_ptr_len_ptr);
...
usmDHUserOwnPrivKeyChange_get (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx,
                               ...
                               size_t * usmDHUserOwnPrivKeyChange_val_ptr_len_ptr)
{
   ...
   /** we should have a non-NULL pointer and enough storage */
    ...
    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserOwnPrivKeyChange_get", "called\n"));
    ...
    if (!rowreq_ctx || !usmDHUserOwnPrivKeyChange_val_ptr_len_ptr ||
        !usmDHUserOwnPrivKeyChange_val_ptr_ptr || !*usmDHUserOwnPrivKeyChange_val_ptr_ptr)
    {
        return MFD_ERROR;
    }

    return usmDHGetUserKeyChange (rowreq_ctx->data, 0,
                                  usmDHUserOwnPrivKeyChange_val_ptr_ptr, usmDHUserOwnPrivKeyChange_val_ptr_len_ptr);
