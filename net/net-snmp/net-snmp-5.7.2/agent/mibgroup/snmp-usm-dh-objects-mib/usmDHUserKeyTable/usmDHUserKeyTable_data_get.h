 ...
 **********************************************************************/
    ...
    int usmDHUserOwnAuthKeyChange_get (usmDHUserKeyTable_rowreq_ctx *
                                       rowreq_ctx,
                                       u_char
    ...
    int usmDHUserOwnPrivKeyChange_get (usmDHUserKeyTable_rowreq_ctx *
                                       rowreq_ctx,
                                       u_char
    ...
    int usmDHUserKeyTable_indexes_set_tbl_idx (usmDHUserKeyTable_mib_index *
                                               tbl_idx,
                                               u_char * usmUserEngineID_val_ptr,
                                               size_t
                                               usmUserEngineID_val_ptr_len,
                                               char *usmUserName_val_ptr, size_t usmUserName_val_ptr_len);
    int usmDHUserKeyTable_indexes_set (usmDHUserKeyTable_rowreq_ctx *
                                       rowreq_ctx,
                                       u_char * usmUserEngineID_val_ptr,
