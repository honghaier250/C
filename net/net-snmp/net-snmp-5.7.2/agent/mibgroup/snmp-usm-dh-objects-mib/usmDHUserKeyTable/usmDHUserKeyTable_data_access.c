...
{
    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserKeyTable_init_data", "called\n"));
...
void usmDHUserKeyTable_container_init (netsnmp_container ** container_ptr_ptr, netsnmp_cache * cache)
{
    ...
    {
        snmp_log (LOG_ERR, "bad container param to usmDHUserKeyTable_container_init\n");
        return;
    }
    ...
    *container_ptr_ptr = NULL;
    ...
    if (NULL == cache)
    {
        snmp_log (LOG_ERR, "bad cache param to usmDHUserKeyTable_container_init\n");
        return;
    }
...
void usmDHUserKeyTable_container_shutdown (netsnmp_container * container_ptr)
{
    ...
    {
        snmp_log (LOG_ERR, "bad params to usmDHUserKeyTable_container_shutdown\n");
        return;
    }
    ...
    for (; usmuser; usmuser = usmuser->next)
    {
        ...
        if (MFD_SUCCESS !=
            usmDHUserKeyTable_indexes_set (rowreq_ctx,
                                           usmuser->engineID,
                                           usmuser->engineIDLen, usmuser->name, strlen (usmuser->name)))
        {
            snmp_log (LOG_ERR, "error setting index while loading " "usmDHUserKeyTable data.\n");
...
{
    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserKeyTable_row_prep", "called\n"));
