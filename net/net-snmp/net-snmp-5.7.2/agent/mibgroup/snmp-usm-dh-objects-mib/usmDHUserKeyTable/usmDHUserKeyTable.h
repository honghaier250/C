...
#define MAX_usmDHUserKeyTable_IDX_LEN     66
     ...
     * function prototypes
     */
    int usmDHUserKeyTable_pre_request (usmDHUserKeyTable_registration * user_context);
    int usmDHUserKeyTable_post_request (usmDHUserKeyTable_registration * user_context, int rc);

    int usmDHUserKeyTable_rowreq_ctx_init (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx, void *user_init_ctx);
    void usmDHUserKeyTable_rowreq_ctx_cleanup (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx);
