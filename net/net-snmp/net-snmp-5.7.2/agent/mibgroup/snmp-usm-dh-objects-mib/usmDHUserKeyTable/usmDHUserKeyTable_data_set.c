...
int usmDHUserCheckValue (struct usmUser *user, int for_auth_key, u_char * val, size_t val_len)
{
    /*
    ...
    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserCheckValue", "called\n"));
    usmDHGetUserKeyChange (user, for_auth_key, &current_value, &current_value_len);
...
int usmDHSetKey (struct usmUser *user, int for_auth_key, u_char * val, size_t val_len)
{
    DH *dh;
 ...
 */
int usmDHUserKeyTable_undo_setup (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserKeyTable_undo_setup", "called\n"));
 ...
 * @retval MFD_ERROR   : error. set will fail.
 */
int usmDHUserKeyTable_undo (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserKeyTable_undo", "called\n"));
 ...
 */
int usmDHUserKeyTable_undo_cleanup (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserKeyTable_undo_cleanup", "called\n"));
 ...
 * @retval MFD_ERROR   : error
 */
int usmDHUserKeyTable_commit (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserKeyTable_commit", "called\n"));
 ...
 * @retval MFD_ERROR   : error
 */
int usmDHUserKeyTable_undo_commit (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;

    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserKeyTable_undo_commit", "called\n"));
 ...
 */
int usmDHUserKeyTable_irreversible_commit (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx)
{
    struct usmUser *user;
    ...
    if (flags & COLUMN_USMDHUSERAUTHKEYCHANGE_FLAG || flags & COLUMN_USMDHUSEROWNAUTHKEYCHANGE_FLAG)
    {
        /*
    ...
    if (flags & COLUMN_USMDHUSERPRIVKEYCHANGE_FLAG || flags & COLUMN_USMDHUSEROWNPRIVKEYCHANGE_FLAG)
    {
        /*
         * free the keychange objects so they reset to new values 
         */
...
usmDHUserAuthKeyChange_check_value (usmDHUserKeyTable_rowreq_ctx *
                                    rowreq_ctx,
                                    u_char * usmDHUserAuthKeyChange_val_ptr, size_t usmDHUserAuthKeyChange_val_ptr_len)
{
    ...
    return usmDHUserCheckValue (rowreq_ctx->data, 1,
                                usmDHUserAuthKeyChange_val_ptr, usmDHUserAuthKeyChange_val_ptr_len);
 ...
 */
int usmDHUserAuthKeyChange_undo_setup (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx)
{
    ...
    memdup (&undouser->authKey, rowreq_ctx->data->authKey, rowreq_ctx->data->authKeyLen);
                            ...
                            u_char * usmDHUserAuthKeyChange_val_ptr, size_t usmDHUserAuthKeyChange_val_ptr_len)
{
    ...
    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserAuthKeyChange_set", "called\n"));
     ...
     */
    usmDHSetKey (rowreq_ctx->data, 1, usmDHUserAuthKeyChange_val_ptr, usmDHUserAuthKeyChange_val_ptr_len);
 ...
 *        Pointer to the users context.
 */
int usmDHUserAuthKeyChange_undo (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx)
{
    struct usmUser *undouser;

    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserAuthKeyChange_undo", "called\n"));
                                       ...
                                       size_t usmDHUserOwnAuthKeyChange_val_ptr_len)
{
    ...
    return
        usmDHUserAuthKeyChange_check_value (rowreq_ctx,
                                            usmDHUserOwnAuthKeyChange_val_ptr, usmDHUserOwnAuthKeyChange_val_ptr_len);
 ...
 * won't be done unless it is necessary.
 */
int usmDHUserOwnAuthKeyChange_undo_setup (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx)
{
...
usmDHUserOwnAuthKeyChange_set (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx,
                               u_char * usmDHUserOwnAuthKeyChange_val_ptr, size_t usmDHUserOwnAuthKeyChange_val_ptr_len)
{

    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserOwnAuthKeyChange_set", "called\n"));
 ...
 *        Pointer to the users context.
 */
int usmDHUserOwnAuthKeyChange_undo (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx)
{

    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserOwnAuthKeyChange_undo", "called\n"));
...
usmDHUserPrivKeyChange_check_value (usmDHUserKeyTable_rowreq_ctx *
                                    rowreq_ctx,
                                    u_char * usmDHUserPrivKeyChange_val_ptr, size_t usmDHUserPrivKeyChange_val_ptr_len)
{
    ...
    return usmDHUserCheckValue (rowreq_ctx->data, 0,
                                usmDHUserPrivKeyChange_val_ptr, usmDHUserPrivKeyChange_val_ptr_len);
 ...
 * won't be done unless it is necessary.
 */
int usmDHUserPrivKeyChange_undo_setup (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx)
{
    struct usmUser *undouser;
    ...
    memdup (&undouser->privKey, rowreq_ctx->data->privKey, rowreq_ctx->data->privKeyLen);
                            ...
                            u_char * usmDHUserPrivKeyChange_val_ptr, size_t usmDHUserPrivKeyChange_val_ptr_len)
{
    ...
    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserPrivKeyChange_set", "called\n"));
     ...
     */
    usmDHSetKey (rowreq_ctx->data, 0, usmDHUserPrivKeyChange_val_ptr, usmDHUserPrivKeyChange_val_ptr_len);
 ...
 *        Pointer to the users context.
 */
int usmDHUserPrivKeyChange_undo (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx)
{
    struct usmUser *undouser;

    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserPrivKeyChange_undo", "called\n"));
                                       ...
                                       size_t usmDHUserOwnPrivKeyChange_val_ptr_len)
{
    ...
    return
        usmDHUserPrivKeyChange_check_value (rowreq_ctx,
                                            usmDHUserOwnPrivKeyChange_val_ptr, usmDHUserOwnPrivKeyChange_val_ptr_len);
 ...
 * won't be done unless it is necessary.
 */
int usmDHUserOwnPrivKeyChange_undo_setup (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx)
{
...
usmDHUserOwnPrivKeyChange_set (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx,
                               u_char * usmDHUserOwnPrivKeyChange_val_ptr, size_t usmDHUserOwnPrivKeyChange_val_ptr_len)
{

    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserOwnPrivKeyChange_set", "called\n"));
 ...
 *        Pointer to the users context.
 */
int usmDHUserOwnPrivKeyChange_undo (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx)
{

    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserOwnPrivKeyChange_undo", "called\n"));
 ...
 */
int usmDHUserKeyTable_check_dependencies (usmDHUserKeyTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;
