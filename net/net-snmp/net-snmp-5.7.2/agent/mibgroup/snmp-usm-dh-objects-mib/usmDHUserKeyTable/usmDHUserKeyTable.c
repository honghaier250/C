...
const int usmDHUserKeyTable_oid_size = OID_LENGTH (usmDHUserKeyTable_oid);
...
{
    DEBUGMSGTL (("verbose:usmDHUserKeyTable:init_usmDHUserKeyTable", "called\n"));
...
{
    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserKeyTable_pre_request", "called\n"));
...
{
    DEBUGMSGTL (("verbose:usmDHUserKeyTable:usmDHUserKeyTable_post_request", "called\n"));
