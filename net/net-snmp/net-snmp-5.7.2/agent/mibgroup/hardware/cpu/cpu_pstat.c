...
int netsnmp_cpu_arch_load (netsnmp_cache * cache, void *magic)
{
    ...
    cpu->sys2_ticks = (unsigned long long) psd.psd_cpu_time[CP_SYS] + psd.psd_cpu_time[CP_WAIT];
    ...
    for (i = 0; i < psd.psd_proc_cnt; i++)
    {
        ...
        cpu->sys2_ticks = (unsigned long long) psd.psd_mp_cpu_time[i][CP_SYS] + psd.psd_mp_cpu_time[i][CP_WAIT];
