...
agentx_realloc_build_int (u_char ** buf, size_t * buf_len, size_t * out_len,
                          int allow_realloc, unsigned int value, int network_order)
{
...
agentx_realloc_build_short (u_char ** buf, size_t * buf_len,
                            size_t * out_len, int allow_realloc, unsigned short value, int network_order)
{
...
agentx_realloc_build_oid (u_char ** buf, size_t * buf_len, size_t * out_len,
                          int allow_realloc, int inclusive, oid * name, size_t name_len, int network_order)
{
    ...
    *(*buf + *out_len) = (u_char) 0x00;
    ...
    DEBUGDUMPSETUP ("send", (*buf + ilen), 4);
    DEBUGMSG (("dumpv_send", "  # subids:\t%d (0x%.2X)\n", (int) name_len, (unsigned int) name_len));
    DEBUGPRINTINDENT ("dumpv_send");
    ...
    {
        if (!agentx_realloc_build_int (buf, buf_len, out_len, allow_realloc, name[i], network_order))
        {
            DEBUGINDENTLESS ();
            return 0;
        }
...
agentx_realloc_build_string (u_char ** buf, size_t * buf_len,
                             size_t * out_len, int allow_realloc, u_char * string, size_t string_len, int network_order)
{
    size_t ilen = *out_len, i = 0;
    ...
    if (!agentx_realloc_build_int (buf, buf_len, out_len, allow_realloc, string_len, network_order))
    {
        DEBUGINDENTLESS ();
        DEBUGINDENTLESS ();
        return 0;
...
agentx_realloc_build_double (u_char ** buf, size_t * buf_len,
                             size_t * out_len, int allow_realloc, double double_val, int network_order)
{
    union
    {
        double doubleVal;
    ...
    return agentx_realloc_build_string (buf, buf_len, out_len,
                                        allow_realloc, opaque_buffer, 3 + sizeof (double), network_order);
}

int
agentx_realloc_build_float (u_char ** buf, size_t * buf_len,
                            size_t * out_len, int allow_realloc, float float_val, int network_order)
{
    union
    {
        float floatVal;
    ...
    return agentx_realloc_build_string (buf, buf_len, out_len,
                                        allow_realloc, opaque_buffer, 3 + sizeof (float), network_order);
}
#endif

int
agentx_realloc_build_varbind (u_char ** buf, size_t * buf_len,
                              size_t * out_len, int allow_realloc, netsnmp_variable_list * vp, int network_order)
{
    DEBUGDUMPHEADER ("send", "VarBind");
    DEBUGDUMPHEADER ("send", "type");
#ifdef NETSNMP_WITH_OPAQUE_SPECIAL_TYPES
    if ((vp->type == ASN_OPAQUE_FLOAT) || (vp->type == ASN_OPAQUE_DOUBLE)
        || (vp->type == ASN_OPAQUE_I64) || (vp->type == ASN_OPAQUE_U64) || (vp->type == ASN_OPAQUE_COUNTER64))
    {
        if (!agentx_realloc_build_short
            (buf, buf_len, out_len, allow_realloc, (unsigned short) ASN_OPAQUE, network_order))
        {
            DEBUGINDENTLESS ();
            DEBUGINDENTLESS ();
            return 0;
    ...
    {
        if (!agentx_realloc_build_short
            (buf, buf_len, out_len, allow_realloc, (unsigned short) ASN_OBJECT_ID, network_order))
        {
            DEBUGINDENTLESS ();
            DEBUGINDENTLESS ();
            return 0;
    ...
    {
        if (!agentx_realloc_build_short
            (buf, buf_len, out_len, allow_realloc, (unsigned short) vp->type, network_order))
        {
            DEBUGINDENTLESS ();
            DEBUGINDENTLESS ();
            return 0;
    ...
    *(*buf + *out_len) = 0;
    ...
    if (!agentx_realloc_build_oid (buf, buf_len, out_len, allow_realloc, 0, vp->name, vp->name_length, network_order))
    {
        DEBUGINDENTLESS ();
        DEBUGINDENTLESS ();
        return 0;
    ...
    switch (vp->type)
    {
        ...
        case ASN_TIMETICKS:
        case ASN_UINTEGER:
            if (!agentx_realloc_build_int (buf, buf_len, out_len, allow_realloc, *(vp->val.integer), network_order))
            {
                DEBUGINDENTLESS ();
                DEBUGINDENTLESS ();
                return 0;
        ...
        case ASN_OPAQUE_FLOAT:
            ...
            if (!agentx_realloc_build_float (buf, buf_len, out_len, allow_realloc, *(vp->val.floatVal), network_order))
            {
                DEBUGINDENTLESS ();
                DEBUGINDENTLESS ();
                DEBUGINDENTLESS ();
        ...
        case ASN_OPAQUE_DOUBLE:
            ...
            if (!agentx_realloc_build_double
                (buf, buf_len, out_len, allow_realloc, *(vp->val.doubleVal), network_order))
            {
                DEBUGINDENTLESS ();
                DEBUGINDENTLESS ();
                DEBUGINDENTLESS ();
        ...
        case ASN_OPAQUE:
            if (!agentx_realloc_build_string
                (buf, buf_len, out_len, allow_realloc, vp->val.string, vp->val_len, network_order))
            {
                DEBUGINDENTLESS ();
                DEBUGINDENTLESS ();
                return 0;
        ...
        case ASN_PRIV_INCL_RANGE:
            if (!agentx_realloc_build_oid
                (buf, buf_len, out_len, allow_realloc, 1, vp->val.objid, vp->val_len / sizeof (oid), network_order))
            {
                DEBUGINDENTLESS ();
                DEBUGINDENTLESS ();
                return 0;
        ...
        case ASN_COUNTER64:
            if (network_order)
            {
                ...
                if (!agentx_realloc_build_int
                    ...
                    || !agentx_realloc_build_int (buf, buf_len, out_len,
                                                  allow_realloc, vp->val.counter64->low, network_order))
                {
                    DEBUGINDENTLESS ();
                    DEBUGINDENTLESS ();
                    DEBUGINDENTLESS ();
            ...
            else
            {
                ...
                if (!agentx_realloc_build_int
                    ...
                    || !agentx_realloc_build_int (buf, buf_len, out_len,
                                                  allow_realloc, vp->val.counter64->high, network_order))
                {
                    DEBUGINDENTLESS ();
                    DEBUGINDENTLESS ();
                    DEBUGINDENTLESS ();
...
int
agentx_realloc_build_header (u_char ** buf, size_t * buf_len, size_t * out_len, int allow_realloc, netsnmp_pdu * pdu)
{
    size_t ilen = *out_len;
    ...
    *(*buf + *out_len) = 0;
    ...
    if (!agentx_realloc_build_int (buf, buf_len, out_len, allow_realloc, pdu->sessid, network_order))
    {
        DEBUGINDENTLESS ();
        DEBUGINDENTLESS ();
        return 0;
    ...
    if (!agentx_realloc_build_int (buf, buf_len, out_len, allow_realloc, pdu->transid, network_order))
    {
        DEBUGINDENTLESS ();
        DEBUGINDENTLESS ();
        return 0;
    ...
    if (!agentx_realloc_build_int (buf, buf_len, out_len, allow_realloc, pdu->reqid, network_order))
    {
        DEBUGINDENTLESS ();
        DEBUGINDENTLESS ();
        return 0;
    ...
    if (!agentx_realloc_build_int (buf, buf_len, out_len, allow_realloc, 0, network_order))
    {
        DEBUGINDENTLESS ();
        DEBUGINDENTLESS ();
        return 0;
    ...
    if (pdu->flags & AGENTX_MSG_FLAG_NON_DEFAULT_CONTEXT)
    {
        ...
        if (!agentx_realloc_build_string
            (buf, buf_len, out_len, allow_realloc, pdu->community, pdu->community_len, network_order))
        {
            DEBUGINDENTLESS ();
            DEBUGINDENTLESS ();
            return 0;
...
_agentx_realloc_build (u_char ** buf, size_t * buf_len, size_t * out_len,
                       int allow_realloc, netsnmp_session * session, netsnmp_pdu * pdu)
{
    size_t ilen = *out_len;
    ...
    switch (pdu->command)
    {
        ...
        case AGENTX_MSG_OPEN:
            ...
            *(*buf + *out_len) = (u_char) pdu->time;
            ...
            if (!agentx_realloc_build_string
                (buf, buf_len, out_len, allow_realloc,
                 pdu->variables->val.string, pdu->variables->val_len, network_order))
            {
                DEBUGINDENTLESS ();
                DEBUGINDENTLESS ();
                return 0;
        ...
        case AGENTX_MSG_UNREGISTER:
            ...
            *(*buf + *out_len) = (u_char) 0;
            ...
            if (!agentx_realloc_build_oid
                (buf, buf_len, out_len, allow_realloc, 0, vp->name, vp->name_length, network_order))
            {
            ...
            if (pdu->range_subid)
            {
                ...
                if (!agentx_realloc_build_int
                    (buf, buf_len, out_len, allow_realloc, vp->val.objid[pdu->range_subid - 1], network_order))
                {
                    DEBUGINDENTLESS ();
                    DEBUGINDENTLESS ();
                    return 0;
        ...
        case AGENTX_MSG_GETBULK:
            ...
            if (!agentx_realloc_build_short
                (buf, buf_len, out_len, allow_realloc, (u_short) pdu->non_repeaters, network_order))
            {
                DEBUGINDENTLESS ();
                DEBUGINDENTLESS ();
                return 0;
            ...
            if (!agentx_realloc_build_short
                (buf, buf_len, out_len, allow_realloc, (u_short) pdu->max_repetitions, network_order))
            {
                DEBUGINDENTLESS ();
                DEBUGINDENTLESS ();
                return 0;
        ...
        case AGENTX_MSG_GETNEXT:
            ...
            for (vp = pdu->variables; vp != NULL; vp = vp->next_variable)
            {
                ...
                if (!agentx_realloc_build_oid
                    (buf, buf_len, out_len, allow_realloc, inc, vp->name, vp->name_length, network_order))
                {
                    DEBUGINDENTLESS ();
                    DEBUGINDENTLESS ();
                    return 0;
                ...
                if (!agentx_realloc_build_oid
                    (buf, buf_len, out_len, allow_realloc, 0, vp->val.objid, vp->val_len / sizeof (oid), network_order))
                {
                    DEBUGINDENTLESS ();
                    DEBUGINDENTLESS ();
                    return 0;
        ...
        case AGENTX_MSG_RESPONSE:
            pdu->flags &= ~(UCD_MSG_FLAG_EXPECT_RESPONSE);
            if (!agentx_realloc_build_int (buf, buf_len, out_len, allow_realloc, pdu->time, network_order))
            {
                DEBUGINDENTLESS ();
                return 0;
            }
            ...
            if (!agentx_realloc_build_short
                ...
                || !agentx_realloc_build_short (buf, buf_len, out_len,
                                                allow_realloc, (u_short) pdu->errindex, network_order))
            {
                DEBUGINDENTLESS ();
                return 0;
            }
        ...
        case AGENTX_MSG_TESTSET:
            ...
            for (vp = pdu->variables; vp != NULL; vp = vp->next_variable)
            {
                if (!agentx_realloc_build_varbind (buf, buf_len, out_len, allow_realloc, vp, network_order))
                {
                    DEBUGINDENTLESS ();
                    DEBUGINDENTLESS ();
                    return 0;
...
int
agentx_realloc_build (netsnmp_session * session, netsnmp_pdu * pdu, u_char ** buf, size_t * buf_len, size_t * out_len)
{
...
u_char *agentx_parse_oid (u_char * data, size_t * length, int *inc,
                          oid * oid_buf, size_t * oid_len, u_int network_byte_order)
{
    ...
    *length -= 4;
    ...
    {
        DEBUGMSGTL (("agentx", "Oversized Object ID (buf=%" NETSNMP_PRIz "d" " pdu=%d)\n", *oid_len, tmp_oid_len));
        DEBUGINDENTLESS ();
        return NULL;
    }
...
u_char *agentx_parse_string (u_char * data, size_t * length,
                             u_char * string, size_t * str_len, u_int network_byte_order)
{
    ...
    *length -= (len + 4);
    ...
    DEBUGIF ("dumpv_recv")
    {
        ...
        if (sprint_realloc_asciistring (&buf, &buf_len, &out_len, 1, string, len))
        {
                             ...
                             u_char * opaque_buf, size_t * opaque_len, u_int network_byte_order)
{
    ...
    u_char *buf;
#endif
    u_char *const cp = agentx_parse_string (data, length,
...
u_char *agentx_parse_varbind (u_char * data, size_t * length, int *type,
                              ...
                              u_char * data_buf, size_t * data_len, u_int network_byte_order)
{
    u_char *bufp = data;
    ...
    *length -= 4;
    ...
    bufp = agentx_parse_oid (bufp, length, NULL, oid_buf, oid_len, network_byte_order);
    if (bufp == NULL)
    {
        DEBUGINDENTLESS ();
        return NULL;
    ...
    switch (*type)
    {
        ...
        case ASN_OCTET_STR:
        case ASN_IPADDRESS:
            bufp = agentx_parse_string (bufp, length, data_buf, data_len, network_byte_order);
            break;

        case ASN_OPAQUE:
            bufp = agentx_parse_opaque (bufp, length, type, data_buf, data_len, network_byte_order);
            break;

        case ASN_PRIV_INCL_RANGE:
        case ASN_PRIV_EXCL_RANGE:
        case ASN_OBJECT_ID:
            bufp = agentx_parse_oid (bufp, length, NULL, (oid *) data_buf, data_len, network_byte_order);
            *data_len *= sizeof (oid);
            /*
...
u_char *agentx_parse_header (netsnmp_pdu * pdu, u_char * data, size_t * length)
{
    ...
    pdu->sessid = agentx_parse_int (bufp, pdu->flags & AGENTX_FLAGS_NETWORK_BYTE_ORDER);
    DEBUGINDENTLESS ();
    bufp += 4;

    DEBUGDUMPHEADER ("recv", "Transaction ID");
    pdu->transid = agentx_parse_int (bufp, pdu->flags & AGENTX_FLAGS_NETWORK_BYTE_ORDER);
    DEBUGINDENTLESS ();
    bufp += 4;

    DEBUGDUMPHEADER ("recv", "Packet ID");
    pdu->reqid = agentx_parse_int (bufp, pdu->flags & AGENTX_FLAGS_NETWORK_BYTE_ORDER);
    DEBUGINDENTLESS ();
    bufp += 4;
...
#define SNMPERR_INCOMPLETE_PACKET SNMPERR_ASN_PARSE_ERR
    ...
    if (pdu->flags & AGENTX_MSG_FLAG_NON_DEFAULT_CONTEXT)
    {
        ...
        snmp_clone_mem ((void **) &pdu->community, (void *) buffer, (unsigned) buf_len);
    ...
    switch (pdu->command)
    {
        case AGENTX_MSG_OPEN:
            ...
            *length -= 4;
            ...
            bufp = agentx_parse_oid (bufp, length, NULL,
                                     oid_buffer, &oid_buf_len, pdu->flags & AGENTX_FLAGS_NETWORK_BYTE_ORDER);
            DEBUGINDENTLESS ();
            if (bufp == NULL)
            {
                DEBUGINDENTLESS ();
            ...
            snmp_pdu_add_variable (pdu, oid_buffer, oid_buf_len, ASN_OCTET_STR, buffer, buf_len);
        ...
        case AGENTX_MSG_REGISTER:
            ...
            *length -= 4;
            ...
            if (pdu->range_subid)
            {
                range_bound = agentx_parse_int (bufp, pdu->flags & AGENTX_FLAGS_NETWORK_BYTE_ORDER);
                bufp += 4;
                *length -= 4;
        ...
        case AGENTX_MSG_GETBULK:
            ...
            pdu->non_repeaters = agentx_parse_short (bufp, pdu->flags & AGENTX_FLAGS_NETWORK_BYTE_ORDER);
            DEBUGINDENTLESS ();
            DEBUGDUMPHEADER ("recv", "Max-repeaters");
            pdu->max_repetitions = agentx_parse_short (bufp + 2, pdu->flags & AGENTX_FLAGS_NETWORK_BYTE_ORDER);
            DEBUGINDENTLESS ();
            bufp += 4;
            *length -= 4;
            /*
        ...
        case AGENTX_MSG_GET:
            ...
            while (*length > 0)
            {
                ...
                bufp = agentx_parse_oid (bufp, length, NULL,
                                         end_oid_buf, &end_oid_buf_len, pdu->flags & AGENTX_FLAGS_NETWORK_BYTE_ORDER);
                if (bufp == NULL)
                {
                    DEBUGINDENTLESS ();
                    DEBUGINDENTLESS ();
        ...
        case AGENTX_MSG_RESPONSE:
             ...
             * sysUpTime 
             */
            pdu->time = agentx_parse_int (bufp, pdu->flags & AGENTX_FLAGS_NETWORK_BYTE_ORDER);
            bufp += 4;
            *length -= 4;

            pdu->errstat = agentx_parse_short (bufp, pdu->flags & AGENTX_FLAGS_NETWORK_BYTE_ORDER);
        ...
        case AGENTX_MSG_TESTSET:
            ...
            while (*length > 0)
            {
                bufp = agentx_parse_varbind (bufp, length, &type,
                                             ...
                                             buffer, &buf_len, pdu->flags & AGENTX_FLAGS_NETWORK_BYTE_ORDER);
                if (bufp == NULL)
                {
                    DEBUGINDENTLESS ();
                    DEBUGINDENTLESS ();
                ...
                snmp_pdu_add_variable (pdu, oid_buffer, oid_buf_len, (u_char) type, buffer, buf_len);
...
int agentx_check_packet (u_char * packet, size_t packet_len)
{
    ...
    return agentx_parse_int (packet + 16, *(packet + 2) & AGENTX_FLAGS_NETWORK_BYTE_ORDER) + 20;
}
