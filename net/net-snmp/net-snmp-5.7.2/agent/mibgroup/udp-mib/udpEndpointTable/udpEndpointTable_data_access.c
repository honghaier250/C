...
{
    DEBUGMSGTL (("verbose:udpEndpointTable:udpEndpointTable_init_data", "called\n"));
 ...
 */
void udpEndpointTable_container_init (netsnmp_container ** container_ptr_ptr, netsnmp_cache * cache)
{
    DEBUGMSGTL (("verbose:udpEndpointTable:udpEndpointTable_container_init", "called\n"));

    if (NULL == container_ptr_ptr)
    {
        snmp_log (LOG_ERR, "bad container param to udpEndpointTable_container_init\n");
        return;
    }
    ...
    *container_ptr_ptr = NULL;
    ...
    if (NULL == cache)
    {
        snmp_log (LOG_ERR, "bad cache param to udpEndpointTable_container_init\n");
        return;
    }
...
void udpEndpointTable_container_shutdown (netsnmp_container * container_ptr)
{
    ...
    {
        snmp_log (LOG_ERR, "bad params to udpEndpointTable_container_shutdown\n");
        return;
    }
...
int udpEndpointTable_container_load (netsnmp_container * container)
{
    ...
    DEBUGMSGTL (("verbose:udpEndpointTable:udpEndpointTable_container_load", "called\n"));
         ...
         ep = (netsnmp_udp_endpoint_entry *) ITERATOR_NEXT (ep_it))
    {
        ...
        if (MFD_SUCCESS !=
            udpEndpointTable_indexes_set (rowreq_ctx,
                                          ...
                                          (char *) ep->rmt_addr, ep->rmt_addr_len, ep->rmt_port, ep->instance, ep->pid))
        {
            snmp_log (LOG_ERR, "error setting index while loading " "udpEndpointTable data.\n");
...
{
    DEBUGMSGTL (("verbose:udpEndpointTable:udpEndpointTable_row_prep", "called\n"));
