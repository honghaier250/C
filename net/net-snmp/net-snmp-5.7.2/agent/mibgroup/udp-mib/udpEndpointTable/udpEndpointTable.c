...
void initialize_table_udpEndpointTable (void)
{
     ...
     */
    udpEndpointTable_user_context_p = netsnmp_create_data_list ("udpEndpointTable", NULL, NULL);
...
{
    DEBUGMSGTL (("verbose:udpEndpointTable:udpEndpointTable_pre_request", "called\n"));
 ...
 */
int udpEndpointTable_post_request (udpEndpointTable_registration * user_context, int rc)
{
    DEBUGMSGTL (("verbose:udpEndpointTable:udpEndpointTable_post_request", "called\n"));
...
udpEndpointTable_indexes_set_tbl_idx (udpEndpointTable_mib_index * tbl_idx,
                                      ...
                                      *udpEndpointRemoteAddress_val_ptr,
                                      ...
                                      u_long udpEndpointInstance_val, u_long udpEndpointProcess_val)
{
...
udpEndpointTable_indexes_set (udpEndpointTable_rowreq_ctx * rowreq_ctx,
                              ...
                              u_long udpEndpointInstance_val, u_long udpEndpointProcess_val)
{
    DEBUGMSGTL (("verbose:udpEndpointTable:udpEndpointTable_indexes_set", "called\n"));
    ...
    if (0 != udpEndpointTable_index_to_oid (&rowreq_ctx->oid_idx, &rowreq_ctx->tbl_idx))
    {
        return MFD_ERROR;
    }
 ...
 */
int udpEndpointProcess_get (udpEndpointTable_rowreq_ctx * rowreq_ctx, u_long * udpEndpointProcess_val_ptr)
{
