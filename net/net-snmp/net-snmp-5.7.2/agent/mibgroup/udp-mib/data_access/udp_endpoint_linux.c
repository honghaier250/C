 ...
 */
static int _process_line_udp_ep (netsnmp_line_info * line_info, void *mem, struct netsnmp_line_process_info_s *lpi)
{
...
static int _load4 (netsnmp_container * container, u_int load_flags)
{
    ...
    container = netsnmp_file_text_parse (fp, container, PM_USER_FUNCTION, 0, &lpi);
