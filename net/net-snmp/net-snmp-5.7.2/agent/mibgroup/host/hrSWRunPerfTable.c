...
void initialize_table_hrSWRunPerfTable (void)
{
    ...
    reg =
        netsnmp_create_handler_registration ("hrSWRunPerfTable",
                                             ...
                                             hrSWRunPerfTable_oid, hrSWRunPerfTable_oid_len, HANDLER_CAN_RONLY);
    if (NULL == reg)
    {
            ...
            for (request = requests; request; request = request->next)
            {
                ...
                switch (table_info->colnum)
                {
                    case COLUMN_HRSWRUNPERFCPU:
                        snmp_set_var_typed_integer (request->requestvb, ASN_INTEGER, table_entry->hrSWRunPerfCPU);
                        break;
                    case COLUMN_HRSWRUNPERFMEM:
                        snmp_set_var_typed_integer (request->requestvb, ASN_INTEGER, table_entry->hrSWRunPerfMem);
                        break;
                    default:
                        /*
