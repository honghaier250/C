 ...
 */
     ...
     extern int netsnmp_arch_swrun_container_load (netsnmp_container * container, u_int load_flags);
 ...
 */
netsnmp_container *netsnmp_swrun_container_load (netsnmp_container * user_container, u_int load_flags)
{
    ...
    if (0 != rc)
    {
        ...
        {
            DEBUGMSGTL (("swrun:container:load", " discarding partial results\n"));
...
void netsnmp_swrun_container_free (netsnmp_container * container, u_int free_flags)
{
...
void netsnmp_swrun_container_free_items (netsnmp_container * container)
{
     ...
     * free all items.
     */
    CONTAINER_CLEAR (container, (netsnmp_container_obj_func *) _swrun_entry_release, NULL);
}
...
/**
 */
netsnmp_swrun_entry *netsnmp_swrun_entry_get_by_index (netsnmp_container * container, oid index)
{
    netsnmp_index tmp;
    ...
    if (NULL == container)
    {
        snmp_log (LOG_ERR, "invalid container for netsnmp_swrun_entry_get_by_index\n");
        return NULL;
    }
