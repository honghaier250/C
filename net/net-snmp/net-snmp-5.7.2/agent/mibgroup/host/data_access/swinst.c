 ...
 */
netsnmp_container *netsnmp_swinst_container_load (netsnmp_container * user_container, int flags)
{
...
void netsnmp_swinst_container_free (netsnmp_container * container, u_int free_flags)
{
    DEBUGMSGTL (("swinst:container", "free\n"));

    if (NULL == container)
    {
        snmp_log (LOG_ERR, "invalid container for netsnmp_swinst_container_free\n");
        return;
    }
...
void netsnmp_swinst_container_free_items (netsnmp_container * container)
{
    ...
    if (NULL == container)
    {
        snmp_log (LOG_ERR, "invalid container for netsnmp_swinst_container_free_items\n");
        return;
    }
     ...
     * free all items.
     */
    CONTAINER_CLEAR (container, (netsnmp_container_obj_func *) netsnmp_swinst_entry_free_cb, NULL);
}
 ...
 * free a row
 */
static void netsnmp_swinst_entry_free_cb (netsnmp_swinst_entry * entry, void *context)
{
    free (entry);
}
...
void netsnmp_swinst_entry_remove (netsnmp_container * container, netsnmp_swinst_entry * entry)
{
