...
void send_example_notification (unsigned int clientreg, void *clientarg)
{
     ...
     */
    oid notification_oid[] = { 1, 3, 6, 1, 4, 1, 8072, 2, 3, 0, 1 };
    ...
    snmp_varlist_add_variable (&notification_vars,
                               ...
                               ASN_INTEGER, (u_char *) & heartbeat_rate, sizeof (heartbeat_rate));
    ...
    if (heartbeat_rate < 30)
    {
        snmp_varlist_add_variable (&notification_vars,
                                   ...
                                   ASN_OCTET_STR, heartbeat_name, strlen (heartbeat_name));
    }
