...
void init_watched_string (void)
{
     ...
     */
    oid my_registration_oid[] = { 1, 3, 6, 1, 4, 1, 8072, 2, 1, 3, 0 };
     ...
     */
    DEBUGMSGTL (("example_string_instance", "Initalizing example string instance.  Default value = %s\n", my_string));
    ...
    netsnmp_init_watcher_info6 (&watcher_info, my_string, strlen (my_string),
                                ASN_OCTET_STR, watcher_flags, sizeof (my_string), NULL);
