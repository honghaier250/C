...
void init_example (void)
{
    ...
    snmpd_register_config_handler ("exampleint",
                                   example_parse_config_exampleint, example_free_config_exampleint, "exampleint value");
    snmpd_register_config_handler ("examplestr",
                                   example_parse_config_examplestr, example_free_config_examplestr, "examplestr value");
    snmpd_register_config_handler ("examplestring",
                                   example_parse_config_examplestr,
                                   example_free_config_examplestr, "examplestring value");
...
u_char *var_example (struct variable *vp,
...
#define MAX_EXAMPLE_INT    100
    ...
    switch (action)
    {
        case RESERVE1:
            ...
            {
                DEBUGMSGTL (("example", "wrong length %" NETSNMP_PRIz "u", var_val_len));
