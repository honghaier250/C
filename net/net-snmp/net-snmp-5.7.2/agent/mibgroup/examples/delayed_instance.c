...
void init_delayed_instance (void)
{
    ...
    my_test =
        netsnmp_create_handler_registration ("delayed_instance_example",
                                             ...
                                             my_delayed_oid, OID_LENGTH (my_delayed_oid), HANDLER_CAN_RWRITE);
    ...
    switch (reqinfo->mode)
    {
        ...
        default:
            ...
            snmp_alarm_register (delay_time,    /* seconds */
                                  ...
                                  * an alarm 
                                  */
                                 (void *) netsnmp_create_delegated_cache (handler, reginfo, reqinfo, requests, NULL));
            break;
...
void return_delayed_response (unsigned int clientreg, void *clientarg)
{
    ...
    switch (cache->reqinfo->mode)
    {
        ...
        case MODE_SET_RESERVE2:
             ...
             */
            memdup ((u_char **) & delay_time_cache, (u_char *) & delay_time, sizeof (delay_time));
            ...
            netsnmp_request_add_list_data (requests,
                                           ...
                                           (DELAYED_INSTANCE_SET_NAME, delay_time_cache, free));
            break;
        ...
        case MODE_SET_UNDO:
             ...
             */
            delay_time = *((u_long *) netsnmp_request_get_list_data (requests, DELAYED_INSTANCE_SET_NAME));
            break;
