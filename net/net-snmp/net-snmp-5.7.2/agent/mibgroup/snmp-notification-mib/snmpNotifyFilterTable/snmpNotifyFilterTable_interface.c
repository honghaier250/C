 ...
 */
     ...
     static void _snmpNotifyFilterTable_container_init (snmpNotifyFilterTable_interface_ctx * if_ctx);

     static void _snmpNotifyFilterTable_container_shutdown (snmpNotifyFilterTable_interface_ctx * if_ctx);
...
snmpNotifyFilterTable_registration *snmpNotifyFilterTable_registration_set (snmpNotifyFilterTable_registration * newreg)
{
...
_snmpNotifyFilterTable_undo_column (snmpNotifyFilterTable_rowreq_ctx *
                                    rowreq_ctx, netsnmp_variable_list * var, int column);
#endif

NETSNMP_STATIC_INLINE int _snmpNotifyFilterTable_check_indexes (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx);
 ...
 */
void _snmpNotifyFilterTable_initialize_interface (snmpNotifyFilterTable_registration * reg_ptr, u_long flags)
{
    netsnmp_baby_steps_access_methods *access_multiplexer = &snmpNotifyFilterTable_if_ctx.access_multiplexer;

    netsnmp_table_registration_info *tbl_info = &snmpNotifyFilterTable_if_ctx.tbl_info;
    ...
    {
        snmp_log (LOG_ERR, "could not initialize container for snmpNotifyFilterTable\n");
        return;
    }
    ...
    reginfo =
        netsnmp_handler_registration_create ("snmpNotifyFilterTable",
                                             ...
                                             snmpNotifyFilterTable_oid_size, HANDLER_CAN_BABY_STEP
#if !(defined(NETSNMP_NO_WRITE_SUPPORT) || defined(NETSNMP_DISABLE_SET_SUPPORT))
                                             | HANDLER_CAN_RWRITE
#endif
        );
    ...
    handler =
        netsnmp_container_table_handler_get (tbl_info,
                                             snmpNotifyFilterTable_if_ctx.container, TABLE_CONTAINER_KEY_NETSNMP_INDEX);
    netsnmp_inject_handler (reginfo, handler);
 ...
 */
void _snmpNotifyFilterTable_shutdown_interface (snmpNotifyFilterTable_registration * reg_ptr)
{
    /*
 ...
 */
int snmpNotifyFilterTable_index_to_oid (netsnmp_index * oid_idx, snmpNotifyFilterTable_mib_index * mib_idx)
{
     ...
     * set up varbinds
     */
    memset (&var_snmpNotifyFilterProfileName, 0x00, sizeof (var_snmpNotifyFilterProfileName));
    var_snmpNotifyFilterProfileName.type = ASN_OCTET_STR;
    memset (&var_snmpNotifyFilterSubtree, 0x00, sizeof (var_snmpNotifyFilterSubtree));
    var_snmpNotifyFilterSubtree.type = ASN_PRIV_IMPLIED_OBJECT_ID;

    /*
     * chain temp index varbinds together
     */
    var_snmpNotifyFilterProfileName.next_variable = &var_snmpNotifyFilterSubtree;
    ...
    err = build_oid_noalloc (oid_idx->oids, oid_idx->len, &oid_idx->len, NULL, 0, &var_snmpNotifyFilterProfileName);
    if (err)
 ...
 */
int snmpNotifyFilterTable_index_from_oid (netsnmp_index * oid_idx, snmpNotifyFilterTable_mib_index * mib_idx)
{
    int err = SNMP_ERR_NOERROR;
     ...
     */
    err = parse_oid_indexes (oid_idx->oids, oid_idx->len, &var_snmpNotifyFilterProfileName);
    if (err == SNMP_ERR_NOERROR)
    {
         ...
         */
        if (var_snmpNotifyFilterProfileName.val_len > sizeof (mib_idx->snmpNotifyFilterProfileName))
            err = SNMP_ERR_GENERR;
        else
        {
            memcpy (mib_idx->snmpNotifyFilterProfileName,
                    var_snmpNotifyFilterProfileName.val.string, var_snmpNotifyFilterProfileName.val_len);
            mib_idx->snmpNotifyFilterProfileName_len =
                var_snmpNotifyFilterProfileName.val_len / sizeof (mib_idx->snmpNotifyFilterProfileName[0]);
        }
        /*
         * NOTE: val_len is in bytes, snmpNotifyFilterSubtree_len might not be
         */
        if (var_snmpNotifyFilterSubtree.val_len > sizeof (mib_idx->snmpNotifyFilterSubtree))
            err = SNMP_ERR_GENERR;
        else
        {
            memcpy (mib_idx->snmpNotifyFilterSubtree,
                    var_snmpNotifyFilterSubtree.val.string, var_snmpNotifyFilterSubtree.val_len);
            mib_idx->snmpNotifyFilterSubtree_len =
                var_snmpNotifyFilterSubtree.val_len / sizeof (mib_idx->snmpNotifyFilterSubtree[0]);
        }
...
snmpNotifyFilterTable_data *snmpNotifyFilterTable_allocate_data (void)
{
    snmpNotifyFilterTable_data *rtn = SNMP_MALLOC_TYPEDEF (snmpNotifyFilterTable_data);

    DEBUGMSGTL (("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_allocate_data", "called\n"));

    if (NULL == rtn)
    {
        snmp_log (LOG_ERR, "unable to malloc memory for new " "snmpNotifyFilterTable_data.\n");
    }
 ...
 */
snmpNotifyFilterTable_rowreq_ctx *snmpNotifyFilterTable_allocate_rowreq_ctx (void *user_init_ctx)
{
    snmpNotifyFilterTable_rowreq_ctx *rowreq_ctx = SNMP_MALLOC_TYPEDEF (snmpNotifyFilterTable_rowreq_ctx);

    DEBUGMSGTL (("internal:snmpNotifyFilterTable:snmpNotifyFilterTable_allocate_rowreq_ctx", "called\n"));

    if (NULL == rowreq_ctx)
    {
        snmp_log (LOG_ERR, "Couldn't allocate memory for a " "snmpNotifyFilterTable_rowreq_ctx.\n");
        return NULL;
    }
    ...
    {
        if (SNMPERR_SUCCESS != snmpNotifyFilterTable_rowreq_ctx_init (rowreq_ctx, user_init_ctx))
        {
 ...
 */
void snmpNotifyFilterTable_release_rowreq_ctx (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx)
{
...
_mfd_snmpNotifyFilterTable_pre_request (netsnmp_mib_handler * handler, netsnmp_handler_registration
                                        ...
                                        * agtreq_info, netsnmp_request_info * requests)
{
    int rc;
    ...
    {
        DEBUGMSGTL (("internal:snmpNotifyFilterTable", "skipping additional pre_request\n"));
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         */
        DEBUGMSGTL (("snmpNotifyFilterTable", "error %d from " "snmpNotifyFilterTable_pre_request\n", rc));
                                         ...
                                         * agtreq_info, netsnmp_request_info * requests)
{
    ...
    {
        DEBUGMSGTL (("internal:snmpNotifyFilterTable", "waiting for last post_request\n"));
        return SNMP_ERR_NOERROR;
    }
    ...
    if ((MFD_SUCCESS != packet_rc) && snmpNotifyFilterTable_dirty_get ())
    {
         ...
         * the dirty flags.
         */
        snmp_log (LOG_WARNING, "snmpNotifyFilterTable dirty flag set in post_request " "but status != SUCCESS.\n");
    }
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("snmpNotifyFilterTable", "error %d from " "snmpNotifyFilterTable_post_request\n", rc));
    }
 ...
 * wrapper
 */
static snmpNotifyFilterTable_rowreq_ctx *_mfd_snmpNotifyFilterTable_rowreq_from_index (netsnmp_index * oid_idx,
                                                                                       int *rc_ptr)
{
                                   ...
                                   rowreq_ctx, netsnmp_variable_list * var, int column)
{
    ...
    switch (column)
    {
        ...
        case COLUMN_SNMPNOTIFYFILTERMASK:
            ...
            rc = snmpNotifyFilterMask_get (rowreq_ctx, (char **) &var->val.string, &var->val_len);
            break;
        ...
        case COLUMN_SNMPNOTIFYFILTERSTORAGETYPE:
            var->val_len = sizeof (u_long);
            var->type = ASN_INTEGER;
            rc = snmpNotifyFilterStorageType_get (rowreq_ctx, (u_long *) var->val.string);
            break;
        ...
        case COLUMN_SNMPNOTIFYFILTERROWSTATUS:
            var->val_len = sizeof (u_long);
            var->type = ASN_INTEGER;
            rc = snmpNotifyFilterRowStatus_get (rowreq_ctx, (u_long *) var->val.string);
            break;

        default:
            snmp_log (LOG_ERR, "unknown column %d in _snmpNotifyFilterTable_get_column\n", column);
            break;
    }
                                       ...
                                       * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _snmpNotifyFilterTable_get_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            if (MFD_SKIP == rc)
            {
                                     ...
                                     rowreq_ctx, netsnmp_variable_list * var, int column)
{
    ...
    switch (column)
    {
        ...
        case COLUMN_SNMPNOTIFYFILTERMASK:
             ...
             */
            if ((SNMPERR_SUCCESS == rc) && ((var->val_len < 0) || (var->val_len > 16)))
            {
                rc = SNMP_ERR_WRONGLENGTH;
            }
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("snmpNotifyFilterTable:_snmpNotifyFilterTable_check_column:snmpNotifyFilterMask",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = snmpNotifyFilterMask_check_value (rowreq_ctx, (char *) var->val.string, var->val_len);
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from snmpNotifyFilterMask_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
             ...
             */
        case COLUMN_SNMPNOTIFYFILTERTYPE:
            rc = netsnmp_check_vb_type_and_size (var, ASN_INTEGER, sizeof (rowreq_ctx->data.snmpNotifyFilterType));
            /*
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("snmpNotifyFilterTable:_snmpNotifyFilterTable_check_column:snmpNotifyFilterType",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = snmpNotifyFilterType_check_value (rowreq_ctx, *((u_long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from snmpNotifyFilterType_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_SNMPNOTIFYFILTERSTORAGETYPE:
            ...
            if ((SNMPERR_SUCCESS == rc)
                ...
                && (*var->val.integer != STORAGETYPE_PERMANENT) && (*var->val.integer != STORAGETYPE_READONLY))
            {
                rc = SNMP_ERR_WRONGVALUE;
            }
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("snmpNotifyFilterTable:_snmpNotifyFilterTable_check_column:snmpNotifyFilterStorageType",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = snmpNotifyFilterStorageType_check_value (rowreq_ctx, *((u_long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from snmpNotifyFilterStorageType_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        case COLUMN_SNMPNOTIFYFILTERROWSTATUS:
            ...
            if (SNMPERR_SUCCESS != rc)
            {
                DEBUGMSGTL (("snmpNotifyFilterTable:_snmpNotifyFilterTable_check_column:snmpNotifyFilterRowStatus",
                             "varbind validation failed (eg bad type or size)\n"));
            }
            else
            {
                rc = snmpNotifyFilterRowStatus_check_value (rowreq_ctx, *((u_long *) var->val.string));
                if ((MFD_SUCCESS != rc) && (MFD_NOT_VALID_EVER != rc) && (MFD_NOT_VALID_NOW != rc))
                {
                    snmp_log (LOG_ERR, "bad rc %d from snmpNotifyFilterRowStatus_check_value\n", rc);
                    rc = SNMP_ERR_GENERR;
                }
            }
            break;
        ...
        default:
            ...
            rc = SNMP_ERR_GENERR;
            snmp_log (LOG_ERR, "unknown column %d in _snmpNotifyFilterTable_check_column\n", column);
    }
                                          ...
                                          * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _snmpNotifyFilterTable_check_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (rc)
        {
            netsnmp_request_set_error (requests, SNMP_VALIDATE_ERR (rc));
            break;
                                               ...
                                               * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (rc)
    {
        DEBUGMSGTL (("snmpNotifyFilterTable:mfd", "error %d from " "snmpNotifyFilterTable_check_dependencies\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
 ...
 */
NETSNMP_STATIC_INLINE int
_snmpNotifyFilterTable_undo_setup_column (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx, int column)
{
    int rc = SNMPERR_SUCCESS;
    ...
    switch (column)
    {
        ...
        default:
            snmp_log (LOG_ERR, "unknown column %d in _snmpNotifyFilterTable_undo_setup_column\n", column);
            break;
    }
                                       ...
                                       * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("snmpNotifyFilterTable:mfd", "error %d from " "snmpNotifyFilterTable_undo_setup\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
    else
    {
        ...
        for (; requests; requests = requests->next)
        {
            ...
            rc = _snmpNotifyFilterTable_undo_setup_column (rowreq_ctx, tri->colnum);
            if (MFD_SUCCESS != rc)
            {
                                         ...
                                         * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("snmpNotifyFilterTable:mfd", "error %d from " "snmpNotifyFilterTable_undo_cleanup\n", rc));
    }
                                   ...
                                   rowreq_ctx, netsnmp_variable_list * var, int column)
{
    ...
    switch (column)
    {
        ...
        case COLUMN_SNMPNOTIFYFILTERMASK:
            rowreq_ctx->column_set_flags |= COLUMN_SNMPNOTIFYFILTERMASK_FLAG;
            rc = snmpNotifyFilterMask_set (rowreq_ctx, (char *) var->val.string, var->val_len);
            break;
        ...
        case COLUMN_SNMPNOTIFYFILTERTYPE:
            rowreq_ctx->column_set_flags |= COLUMN_SNMPNOTIFYFILTERTYPE_FLAG;
            rc = snmpNotifyFilterType_set (rowreq_ctx, *((u_long *) var->val.string));
            break;
        ...
        case COLUMN_SNMPNOTIFYFILTERSTORAGETYPE:
            rowreq_ctx->column_set_flags |= COLUMN_SNMPNOTIFYFILTERSTORAGETYPE_FLAG;
            rc = snmpNotifyFilterStorageType_set (rowreq_ctx, *((u_long *) var->val.string));
            break;
        ...
        case COLUMN_SNMPNOTIFYFILTERROWSTATUS:
            rowreq_ctx->column_set_flags |= COLUMN_SNMPNOTIFYFILTERROWSTATUS_FLAG;
            rc = snmpNotifyFilterRowStatus_set (rowreq_ctx, *((u_long *) var->val.string));
            break;

        default:
            snmp_log (LOG_ERR, "unknown column %d in _snmpNotifyFilterTable_set_column\n", column);
            rc = SNMP_ERR_GENERR;
            break;
    }
                                       ...
                                       * agtreq_info, netsnmp_request_info * requests)
{
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _snmpNotifyFilterTable_set_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            DEBUGMSGTL (("snmpNotifyFilterTable:mfd", "error %d from " "snmpNotifyFilterTable_set_column\n", rc));
            netsnmp_set_request_error (agtreq_info, requests, SNMP_VALIDATE_ERR (rc));
        }
    }                            /* for results */
                                   ...
                                   netsnmp_agent_request_info * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
        DEBUGMSGTL (("snmpNotifyFilterTable:mfd", "error %d from " "snmpNotifyFilterTable_commit\n", rc));
        netsnmp_request_set_error_all (requests, SNMP_VALIDATE_ERR (rc));
    }
                                        ...
                                        * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("snmpNotifyFilterTable:mfd", "error %d from " "snmpNotifyFilterTable_undo_commit\n", rc));
    }

    if (rowreq_ctx->rowreq_flags & MFD_ROW_DIRTY)
    {
        snmp_log (LOG_WARNING, "snmpNotifyFilterTable row dirty flag still set after undo_commit\n");
                                    ...
                                    rowreq_ctx, netsnmp_variable_list * var, int column)
{
    ...
    switch (column)
    {
        ...
        default:
            snmp_log (LOG_ERR, "unknown column %d in _snmpNotifyFilterTable_undo_column\n", column);
            break;
    }
                                        ...
                                        * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (MFD_SUCCESS != rc)
    {
         ...
         * nothing we can do about it but log it
         */
        DEBUGMSGTL (("snmpNotifyFilterTable:mfd", "error %d from " "snmpNotifyFilterTable_undo\n", rc));
    }
    ...
    for (; requests; requests = requests->next)
    {
        ...
        rc = _snmpNotifyFilterTable_undo_column (rowreq_ctx, requests->requestvb, tri->colnum);
        if (MFD_SUCCESS != rc)
        {
            /*
             * nothing we can do about it but log it
             */
            DEBUGMSGTL (("snmpNotifyFilterTable:mfd", "error %d from " "snmpNotifyFilterTable_undo_column\n", rc));
        }
    }                            /* for results */
                                                ...
                                                * agtreq_info, netsnmp_request_info * requests)
{
    ...
    if (rowreq_ctx->rowreq_flags & MFD_ROW_DELETED)
    {
        if (!(rowreq_ctx->rowreq_flags & MFD_ROW_CREATED))
            CONTAINER_REMOVE (snmpNotifyFilterTable_if_ctx.container, rowreq_ctx);
    }
    else
    {
 ...
 * @internal
 */
static void _container_item_free (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx, void *context)
{
    DEBUGMSGTL (("internal:snmpNotifyFilterTable:_container_item_free", "called\n"));
...
static void _container_free (netsnmp_container * container)
{
    ...
    if (NULL == container)
    {
        snmp_log (LOG_ERR, "invalid container in snmpNotifyFilterTable_container_free\n");
        return;
    }
 ...
 */
void _snmpNotifyFilterTable_container_init (snmpNotifyFilterTable_interface_ctx * if_ctx)
{
    ...
    if (NULL == if_ctx->container)
        if_ctx->container = netsnmp_container_find ("snmpNotifyFilterTable:table_container");
    if (NULL == if_ctx->container)
    {
        snmp_log (LOG_ERR, "error creating container in " "snmpNotifyFilterTable_container_init\n");
        return;
    }
 ...
 */
void _snmpNotifyFilterTable_container_shutdown (snmpNotifyFilterTable_interface_ctx * if_ctx)
{
...
static int _snmpNotifyFilterTable_container_save_rows (int majorID, int minorID, void *serverarg, void *clientarg);

static void _snmpNotifyFilterTable_container_row_restore (const char *token, char *buf);

static int _snmpNotifyFilterTable_container_row_save (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx, void *type);
 ...
 */
void snmpNotifyFilterTable_container_init_persistence (netsnmp_container * container)
{
    netsnmp_container **container_p;

    int rc;

    register_config_handler (NULL, row_token, _snmpNotifyFilterTable_container_row_restore, NULL, NULL);
    memdup ((u_char **) & container_p, &container, sizeof (container));
    netsnmp_assert (container_p);
    rc = snmp_register_callback (SNMP_CALLBACK_LIBRARY,
                                 SNMP_CALLBACK_STORE_DATA, _snmpNotifyFilterTable_container_save_rows, container_p);
...
static int _snmpNotifyFilterTable_container_save_rows (int majorID, int minorID, void *serverarg, void *clientarg)
{
    ...
    DEBUGMSGTL (("internal:snmpNotifyFilterTable:"
                 "_snmpNotifyFilterTable_container_save_rows", "saving %" NETSNMP_PRIz "u rows\n", CONTAINER_SIZE (c)));
     ...
     * save all rows
     */
    CONTAINER_FOR_EACH (c, (netsnmp_container_obj_func *) _snmpNotifyFilterTable_container_row_save, type);
...
#define MAX_ROW_SIZE (sizeof(row_token) + 1 +  \
    ...
    if (NULL == pos)
    {
        snmp_log (LOG_ERR, "error saving snmpNotifyFilterTable row " "to persistent file\n");
        return SNMP_ERR_GENERR;
    }
    *pos++ = ' ';
    if (pos > max)
    {
        snmp_log (LOG_ERR, "error saving snmpNotifyFilterTable row " "to persistent file (too long)\n");
        return SNMP_ERR_GENERR;
    }
     ...
     * add each column
     */
    for (i = SNMPNOTIFYFILTERTABLE_MIN_COL; i <= SNMPNOTIFYFILTERTABLE_MAX_COL; ++i)
    {
...
static void _snmpNotifyFilterTable_container_row_restore (const char *token, char *buf)
{
    ...
    {
        snmp_log (LOG_ERR, "unknown token in _snmpNotifyFilterTable_container_row_restore\n");
        return;
    }
    ...
    if (NULL == buf)
    {
        snmp_log (LOG_ERR, "error reading row index in " "_snmpNotifyFilterTable_container_row_restore\n");
        return;
    }
    rowreq_ctx = _mfd_snmpNotifyFilterTable_rowreq_from_index (&index, NULL);
    if (NULL == rowreq_ctx)
    {
        snmp_log (LOG_ERR, "error creating row index in " "_snmpNotifyFilterTable_container_row_restore\n");
        return;
    }
    ...
    while ((NULL != buf) && isdigit ((unsigned char) (*buf)))
    {
         ...
         * parse value
         */
        DEBUGMSGTL (("_snmpNotifyFilterTable_container_row_restore", "parsing column %d\n", col));
        buf = _snmpNotifyFilterTable_container_col_restore (rowreq_ctx, col, buf);
        ++found;
    }
    if (0 == found)
    {
        snmp_log (LOG_ERR, "error parsing snmpNotifyFilterTable row; no columns found");
        snmpNotifyFilterTable_release_rowreq_ctx (rowreq_ctx);
        return;
    }
    ...
    {
        snmp_log (LOG_ERR, "error parsing snmpNotifyFilterTable row around column %d", col);
        snmpNotifyFilterTable_release_rowreq_ctx (rowreq_ctx);
        return;
    }
 ...
 */
static char *_snmpNotifyFilterTable_container_col_save (snmpNotifyFilterTable_rowreq_ctx
                                                        * rowreq_ctx, u_int col, char *buf)
{
    if ((NULL == rowreq_ctx) || (NULL == buf))
    {
        snmp_log (LOG_ERR, "bad parameter in " "_snmpNotifyFilterTable_container_col_save\n");
        return NULL;
    }
    ...
    switch (col)
    {
        ...
        case COLUMN_SNMPNOTIFYFILTERSTORAGETYPE:
                                               /** StorageType = ASN_INTEGER */
            buf += sprintf (buf, "%ld", rowreq_ctx->data.snmpNotifyFilterStorageType);
            break;

        case COLUMN_SNMPNOTIFYFILTERROWSTATUS:
                                             /** RowStatus = ASN_INTEGER */
            buf += sprintf (buf, "%ld", rowreq_ctx->data.snmpNotifyFilterRowStatus);
            break;

        default:

            /** We shouldn't get here */
            snmp_log (LOG_ERR, "unknown column %d in " "_snmpNotifyFilterTable_container_col_save\n", col);
            return NULL;
    }
    ...
    (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx, u_int col, char *buf)
{
    ...
    if ((NULL == rowreq_ctx) || (NULL == buf))
    {
        snmp_log (LOG_ERR, "bad parameter in " "_snmpNotifyFilterTable_container_col_restore\n");
        return NULL;
    }
    ...
    switch (col)
    {
        ...
        case COLUMN_SNMPNOTIFYFILTERTYPE:
            ...
            buf = read_config_read_memory (ASN_INTEGER, buf, (char *) &rowreq_ctx->data.snmpNotifyFilterType, &len);
            break;
        ...
        default:
            ...
            /** We shouldn't get here */
            snmp_log (LOG_ERR, "unknown column %d in " "_snmpNotifyFilterTable_container_col_restore\n", col);
            return NULL;
    }
...
snmpNotifyFilterTable_rowreq_ctx *snmpNotifyFilterTable_row_find_by_mib_index (snmpNotifyFilterTable_mib_index
                                                                               * mib_idx)
{
    snmpNotifyFilterTable_rowreq_ctx *rowreq_ctx;
    ...
    rowreq_ctx = (snmpNotifyFilterTable_rowreq_ctx *) CONTAINER_FIND (snmpNotifyFilterTable_if_ctx.container, &oid_idx);
