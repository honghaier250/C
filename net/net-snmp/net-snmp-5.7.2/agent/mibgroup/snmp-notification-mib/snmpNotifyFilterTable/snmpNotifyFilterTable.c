...
const int snmpNotifyFilterTable_oid_size = OID_LENGTH (snmpNotifyFilterTable_oid);
...
{
    DEBUGMSGTL (("verbose:snmpNotifyFilterTable:init_snmpNotifyFilterTable", "called\n"));
...
void initialize_table_snmpNotifyFilterTable (void)
{
     ...
     */
    snmpNotifyFilterTable_user_context_p = netsnmp_create_data_list ("snmpNotifyFilterTable", NULL, NULL);
 ...
 */
int snmpNotifyFilterTable_rowreq_ctx_init (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx, void *user_init_ctx)
{
 ...
 * @param  rowreq_ctx
 */
void snmpNotifyFilterTable_rowreq_ctx_cleanup (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx)
{
 ...
 */
int snmpNotifyFilterTable_container_should_save (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx)
{
 ...
 */
int snmpNotifyFilterTable_pre_request (snmpNotifyFilterTable_registration * user_context)
{
 ...
 */
int snmpNotifyFilterTable_post_request (snmpNotifyFilterTable_registration * user_context, int rc)
{
    ...
    if (snmpNotifyFilterTable_dirty_get ())
    {
        ...
        if (MFD_SUCCESS == rc)
        {
             ...
             */
            snmp_store_needed (netsnmp_ds_get_string (NETSNMP_DS_LIBRARY_ID, NETSNMP_DS_LIB_APPTYPE));
        }
...
snmpNotifyFilterTable_indexes_set_tbl_idx (snmpNotifyFilterTable_mib_index *
                                           ...
                                           *snmpNotifyFilterProfileName_val_ptr,
                                           ...
                                           oid *
                                           snmpNotifyFilterSubtree_val_ptr, size_t snmpNotifyFilterSubtree_val_ptr_len)
{
...
snmpNotifyFilterTable_indexes_set (snmpNotifyFilterTable_rowreq_ctx *
                                   ...
                                   *snmpNotifyFilterProfileName_val_ptr,
                                   size_t
                                   snmpNotifyFilterProfileName_val_ptr_len,
                                   oid * snmpNotifyFilterSubtree_val_ptr, size_t snmpNotifyFilterSubtree_val_ptr_len)
{
    ...
    if (0 != snmpNotifyFilterTable_index_to_oid (&rowreq_ctx->oid_idx, &rowreq_ctx->tbl_idx))
    {
        return MFD_ERROR;
    }
...
snmpNotifyFilterMask_get (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx,
                          char **snmpNotifyFilterMask_val_ptr_ptr, size_t * snmpNotifyFilterMask_val_ptr_len_ptr)
{

   /** we should have a non-NULL pointer and enough storage */
    netsnmp_assert ((NULL != snmpNotifyFilterMask_val_ptr_ptr) && (NULL != *snmpNotifyFilterMask_val_ptr_ptr));
    netsnmp_assert (NULL != snmpNotifyFilterMask_val_ptr_len_ptr);


    DEBUGMSGTL (("verbose:snmpNotifyFilterTable:snmpNotifyFilterMask_get", "called\n"));
 ...
 * @retval MFD_ERROR           : Any other error
 */
int snmpNotifyFilterType_get (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx, u_long * snmpNotifyFilterType_val_ptr)
{
   ...
   /** we should have a non-NULL pointer */
    ...
    DEBUGMSGTL (("verbose:snmpNotifyFilterTable:snmpNotifyFilterType_get", "called\n"));
...
snmpNotifyFilterStorageType_get (snmpNotifyFilterTable_rowreq_ctx *
                                 rowreq_ctx, u_long * snmpNotifyFilterStorageType_val_ptr)
{
...
snmpNotifyFilterRowStatus_get (snmpNotifyFilterTable_rowreq_ctx *
                               rowreq_ctx, u_long * snmpNotifyFilterRowStatus_val_ptr)
{
 ...
 */
int snmpNotifyFilterTable_undo_setup (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;
...
int snmpNotifyFilterTable_undo (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:snmpNotifyFilterTable:snmpNotifyFilterTable_undo", "called\n"));
 ...
 */
int snmpNotifyFilterTable_undo_cleanup (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;
 ...
 * @retval MFD_ERROR   : error
 */
int snmpNotifyFilterTable_undo_commit (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;
 ...
 */
int snmpNotifyFilterMask_undo_setup (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx)
{
                          ...
                          char *snmpNotifyFilterMask_val_ptr, size_t snmpNotifyFilterMask_val_ptr_len)
{
    ...
    DEBUGMSGTL (("verbose:snmpNotifyFilterTable:snmpNotifyFilterMask_set", "called\n"));
     ...
     */
    memcpy (rowreq_ctx->data.snmpNotifyFilterMask, snmpNotifyFilterMask_val_ptr, snmpNotifyFilterMask_val_ptr_len);

    /** convert bytes to number of char */
    rowreq_ctx->data.snmpNotifyFilterMask_len =
        snmpNotifyFilterMask_val_ptr_len / sizeof (snmpNotifyFilterMask_val_ptr[0]);
...
int snmpNotifyFilterMask_undo (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:snmpNotifyFilterTable:snmpNotifyFilterMask_undo", "called\n"));
 ...
 *
 */
int snmpNotifyFilterType_check_value (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx, u_long snmpNotifyFilterType_val)
{
 ...
 * won't be done unless it is necessary.
 */
int snmpNotifyFilterType_undo_setup (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx)
{
 ...
 *        A long containing the new value.
 */
int snmpNotifyFilterType_set (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx, u_long snmpNotifyFilterType_val)
{

    DEBUGMSGTL (("verbose:snmpNotifyFilterTable:snmpNotifyFilterType_set", "called\n"));
...
int snmpNotifyFilterType_undo (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL (("verbose:snmpNotifyFilterTable:snmpNotifyFilterType_undo", "called\n"));
...
snmpNotifyFilterStorageType_check_value (snmpNotifyFilterTable_rowreq_ctx *
                                         rowreq_ctx, u_long snmpNotifyFilterStorageType_val)
{
 ...
 * won't be done unless it is necessary.
 */
int snmpNotifyFilterStorageType_undo_setup (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx)
{
 ...
 */
int
snmpNotifyFilterStorageType_set (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx, u_long snmpNotifyFilterStorageType_val)
{
 ...
 *        Pointer to the users context.
 */
int snmpNotifyFilterStorageType_undo (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx)
{
...
snmpNotifyFilterRowStatus_check_value (snmpNotifyFilterTable_rowreq_ctx *
                                       rowreq_ctx, u_long snmpNotifyFilterRowStatus_val)
{
 ...
 * won't be done unless it is necessary.
 */
int snmpNotifyFilterRowStatus_undo_setup (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx)
{
 ...
 *        A long containing the new value.
 */
int snmpNotifyFilterRowStatus_set (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx, u_long snmpNotifyFilterRowStatus_val)
{
 ...
 */
int snmpNotifyFilterTable_check_dependencies (snmpNotifyFilterTable_rowreq_ctx * rowreq_ctx)
{
    int rc = MFD_SUCCESS;
    ...
    if (rowreq_ctx->column_set_flags & COLUMN_SNMPNOTIFYFILTERROWSTATUS_FLAG)
    {
         ...
         */
        rc = check_rowstatus_transition (rowreq_ctx->undo->snmpNotifyFilterRowStatus,
        ...
        if (rowreq_ctx->rowreq_flags & MFD_ROW_CREATED)
        {
            ...
            else if (ROWSTATUS_CREATEANDGO == rowreq_ctx->data.snmpNotifyFilterRowStatus)
            {
                if ((rowreq_ctx->column_set_flags &
                     SNMPNOTIFYFILTERTABLE_REQUIRED_COLS) != SNMPNOTIFYFILTERTABLE_REQUIRED_COLS)
                {
                    DEBUGMSGTL (("snmpNotifyFilterTable",
                                 "required columns missing (0x%0x != 0x%0x)\n",
                                 rowreq_ctx->column_set_flags, SNMPNOTIFYFILTERTABLE_REQUIRED_COLS));
        ...
        else
        {
            ...
            if (ROWSTATUS_DESTROY == rowreq_ctx->data.snmpNotifyFilterRowStatus)
            {
                if (rowreq_ctx->column_set_flags & ~COLUMN_SNMPNOTIFYFILTERROWSTATUS_FLAG)
                {
                    DEBUGMSGTL (("snmpNotifyFilterTable", "destroy must be only varbind for row\n"));
    ...
    else
    {
        ...
        if (rowreq_ctx->rowreq_flags & MFD_ROW_CREATED)
        {
            DEBUGMSGTL (("snmpNotifyFilterTable", "must use RowStatus to create rows\n"));
            return MFD_CANNOT_CREATE_NOW;
        }
    }                            /* row status not set */
