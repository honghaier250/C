...
static oid vacmGroupName[MAX_OID_LEN] = { 1, 3, 6, 1, 6, 3, 16, 1, 2, 1, 3 }, vacmSec2GroupStatus[MAX_OID_LEN] =
...
{
1, 3, 6, 1, 6, 3, 16, 1, 5, 2, 1, 4}, vacmViewTreeFamilyStatus[MAX_OID_LEN] =
...
void
auth_oid (oid * it, size_t * len, const char *groupName, const char *prefix, int model, int level, const char *authtype)
{
    int i;
...
void access_oid (oid * it, size_t * len, const char *groupName, const char *prefix, int model, int level)
{
    int i;
