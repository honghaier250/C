...
#define ENGINEBOOT_MAX    2147483647    /* ((2^31)-1) */
    ...
    void netsnmp_check_definedness (const void *packet, size_t length);
      ...
      NETSNMP_IMPORT
        u_int netsnmp_binary_to_hex (u_char ** dest, size_t * dest_len,
                                     int allow_realloc, const u_char * input, size_t len);
    ...
    int netsnmp_hex_to_binary (u_char ** buf, size_t * buf_len,
                               size_t * offset, int allow_realloc, const char *hex, const char *delim);
    ...
    /* handles odd lengths */
      ...
      NETSNMP_IMPORT
        int snmp_decimal_to_binary (u_char ** buf, size_t * buf_len,
                                    size_t * out_len, int allow_realloc, const char *decimal);
#define snmp_cstrcat(b,l,o,a,s) snmp_strcat(b,l,o,a,(const u_char *)s)
    ...
    typedef const void *const_marker_t;
      ...
      NETSNMP_IMPORT void netsnmp_get_monotonic_clock (struct timeval *tv);
      NETSNMP_IMPORT void netsnmp_set_monotonic_marker (marker_t * pm);
    ...
    u_long uatime_diff (const_marker_t first, const_marker_t second);    /* 1/1000th sec */
      NETSNMP_IMPORT u_long uatime_hdiff (const_marker_t first, const_marker_t second);    /* 1/100th sec */
      NETSNMP_IMPORT int atime_ready (const_marker_t pm, int delta_ms);
    ...
    int timeval_tticks (const struct timeval *tv);
      NETSNMP_IMPORT char *netsnmp_getenv (const char *name);
      NETSNMP_IMPORT int netsnmp_setenv (const char *envname, const char *envval, int overwrite);
