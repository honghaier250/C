...
#define SNMP_TRANS_AES_AES128_PADSIZE   128    /* backwards compat */
    ...
    int sc_get_proper_priv_length (const oid * privtype, u_int privtype_len);
      ...
      NETSNMP_IMPORT int sc_init (void);
    ...
    int sc_check_keyed_hash (const oid * authtype,
                             ...
                             u_int keylen, const u_char * message, u_int msglen, const u_char * MAC, u_int maclen);
    ...
    int sc_hash (const oid * hashtype, size_t hashtypelen,
                 const u_char * buf, size_t buf_len, u_char * MAC, size_t * MAC_len);
    ...
    int sc_get_transform_type (oid * hashtype,
                               ...
                               int (**hash_fn) (const int mode,
                                                void **context,
                                                const u_char *
                                                data, const int data_len, u_char ** digest, size_t * digest_len));
