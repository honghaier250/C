...
/*  Some utility functions.  */
    ...
    int netsnmp_transport_send (netsnmp_transport * t, void *data, int len, void **opaque, int *olength);
    int netsnmp_transport_recv (netsnmp_transport * t, void *data, int len, void **opaque, int *olength);
...
/*  Free an netsnmp_transport.  */
      ...
      NETSNMP_IMPORT void netsnmp_transport_free (netsnmp_transport * t);
 ...
 */
    ...
    int netsnmp_tdomain_unregister (netsnmp_tdomain * domain);
      ...
      NETSNMP_IMPORT void netsnmp_clear_tdomain_list (void);
    ...
    typedef struct netsnmp_transport_config_s
    {
      ...
      NETSNMP_IMPORT netsnmp_transport_config * netsnmp_transport_create_config (char *key, char *value);
#ifdef __cplusplus
}
#endif
