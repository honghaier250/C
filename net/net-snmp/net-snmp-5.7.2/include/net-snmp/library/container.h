...
extern "C"
{
     ...
     * a container
     */
    typedef int (netsnmp_container_op) (struct netsnmp_container_s *, const void *data);

    /*
     * function returning an oject for an operation on an object and a
     * container
     */
    typedef void *(netsnmp_container_rtn) (struct netsnmp_container_s *, const void *data);
     ...
     */
      NETSNMP_IMPORT void netsnmp_container_init_list (void);
      NETSNMP_IMPORT void netsnmp_container_free_list (void);

    /*
     * register a new container factory
     */
    int netsnmp_container_register_with_compare (const char *name, netsnmp_factory * f, netsnmp_container_compare * c);
     ...
     * specific type.
     */
      NETSNMP_IMPORT netsnmp_container * netsnmp_container_find (const char *type_list);
    netsnmp_container *netsnmp_container_get (const char *type);

    /*
     * utility routines
     */
      NETSNMP_IMPORT void netsnmp_container_add_index (netsnmp_container * primary, netsnmp_container * new_index);
    ...
    /** first data element is a 'netsnmp_index' */
      NETSNMP_IMPORT int netsnmp_compare_netsnmp_index (const void *lhs, const void *rhs);
      NETSNMP_IMPORT int netsnmp_ncompare_netsnmp_index (const void *lhs, const void *rhs);
    ...
    /** for_each callback to call free on data item */
      NETSNMP_IMPORT void netsnmp_container_simple_free (void *data, void *context);
...
#define CONTAINER_FOR_EACH(x,f,c)   (x)->for_each(x,f,c)
     ...
     */
      NETSNMP_IMPORT int CONTAINER_INSERT (netsnmp_container * x, const void *k);

    /*
     * remove k from all containers
     */
      NETSNMP_IMPORT int CONTAINER_REMOVE (netsnmp_container * x, const void *k);

    /*
     * duplicate container
     */
      NETSNMP_IMPORT netsnmp_container * CONTAINER_DUP (netsnmp_container * x, void *ctx, u_int flags);
     ...
     */
      NETSNMP_IMPORT void CONTAINER_CLEAR (netsnmp_container * x, netsnmp_container_obj_func * f, void *c);
     ...
     * After calling this function, all containers should be empty.
     */
      NETSNMP_IMPORT void CONTAINER_FREE_ALL (netsnmp_container * x, void *c);

    /*
     * free all containers
     */
      NETSNMP_IMPORT int CONTAINER_FREE (netsnmp_container * x);

      NETSNMP_IMPORT netsnmp_container * SUBCONTAINER_FIND (netsnmp_container * x, const char *name);
    ...
    void netsnmp_init_container (netsnmp_container * c,
                                 ...
                                 netsnmp_container_op * ins, netsnmp_container_op * rem, netsnmp_container_rtn * fnd);
