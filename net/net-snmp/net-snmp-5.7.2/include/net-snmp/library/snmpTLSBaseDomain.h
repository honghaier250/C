...
#define VRFY_PARENT_WAS_OK 1
    ...
    SSL_CTX *sslctx_client_setup (const SSL_METHOD *, _netsnmpTLSBaseData * tlsbase);
    ...
    int netsnmp_tlsbase_session_init (struct netsnmp_transport_s *, struct snmp_session *sess);
