...
#define VACM_VIEW_ENUM_NAME "vacmviews"
    ...
    struct vacm_viewEntry
    {
      ...
      NETSNMP_IMPORT void vacm_destroyViewEntry (const char *, oid *, size_t);
      NETSNMP_IMPORT void vacm_destroyAllViewEntries (void);

#define VACM_MODE_FIND                0
#define VACM_MODE_IGNORE_MASK         1
#define VACM_MODE_CHECK_SUBTREE       2
      NETSNMP_IMPORT struct vacm_viewEntry *vacm_getViewEntry (const char *, oid *, size_t, int);
    /*
     ...
     */
      ...
      NETSNMP_IMPORT int vacm_checkSubtree (const char *, oid *, size_t);
     ...
     */
      ...
      NETSNMP_IMPORT void vacm_scanViewInit (void);
    /*
     ...
     */
      ...
      NETSNMP_IMPORT struct vacm_viewEntry *vacm_scanViewNext (void);
    /*
     ...
     */
      ...
      NETSNMP_IMPORT struct vacm_viewEntry *vacm_createViewEntry (const char *, oid *, size_t);
    /*
     ...
     */
      ...
      NETSNMP_IMPORT void vacm_destroyGroupEntry (int, const char *);
      NETSNMP_IMPORT void vacm_destroyAllGroupEntries (void);
      NETSNMP_IMPORT struct vacm_groupEntry *vacm_createGroupEntry (int, const char *);
      NETSNMP_IMPORT struct vacm_groupEntry *vacm_getGroupEntry (int, const char *);
      NETSNMP_IMPORT void vacm_scanGroupInit (void);
      NETSNMP_IMPORT struct vacm_groupEntry *vacm_scanGroupNext (void);

      NETSNMP_IMPORT void vacm_destroyAccessEntry (const char *, const char *, int, int);
      NETSNMP_IMPORT void vacm_destroyAllAccessEntries (void);
      NETSNMP_IMPORT struct vacm_accessEntry *vacm_createAccessEntry (const char *, const char *, int, int);
      NETSNMP_IMPORT struct vacm_accessEntry *vacm_getAccessEntry (const char *, const char *, int, int);
      NETSNMP_IMPORT void vacm_scanAccessInit (void);
      NETSNMP_IMPORT struct vacm_accessEntry *vacm_scanAccessNext (void);
    ...
    struct vacm_securityEntry *vacm_scanSecurityEntry (void);
      NETSNMP_IMPORT int vacm_is_configured (void);
    ...
    void vacm_save_group (struct vacm_groupEntry *group_entry, const char *token, const char *type);
      ...
      NETSNMP_IMPORT void vacm_parse_config_view (const char *token, const char *line);
      NETSNMP_IMPORT void vacm_parse_config_group (const char *token, const char *line);
      NETSNMP_IMPORT void vacm_parse_config_access (const char *token, const char *line);
      NETSNMP_IMPORT void vacm_parse_config_auth_access (const char *token, const char *line);

      NETSNMP_IMPORT int store_vacm (int majorID, int minorID, void *serverarg, void *clientarg);
