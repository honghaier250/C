...
#define NETSNMP_LARGE_FD_ZERO(fdset) \
    ...
    NETSNMP_IMPORT void netsnmp_large_fd_setfd (SOCKET fd, netsnmp_large_fd_set * fdset);
      NETSNMP_IMPORT void netsnmp_large_fd_clr (SOCKET fd, netsnmp_large_fd_set * fdset);
      NETSNMP_IMPORT int netsnmp_large_fd_is_set (SOCKET fd, netsnmp_large_fd_set * fdset);
 ...
 */
      NETSNMP_IMPORT
        int netsnmp_large_fd_set_select (int numfds, netsnmp_large_fd_set * readfds,
                                         ...
                                         netsnmp_large_fd_set * exceptfds, struct timeval *timeout);
