...
/** types */
    enum
    { NS_CERT_TYPE_UNKNOWN = 0, NS_CERT_TYPE_PEM, NS_CERT_TYPE_DER,
...
#define SNMPTLSFINGERPRINT_MAX_LEN   255
    ...
    int netsnmp_tls_fingerprint_build (int hash_type, const char *hex_fp,
                                       u_char ** tls_fp, size_t * tls_fp_len, int allow_realloc);
...
/** ine TLSTM_PARAMS_XXX                  0x08 */
    ...
    snmpTlstmParams *netsnmp_tlstmParams_create (const char *tag, int hashType, const char *fp, int fp_len);
...
/** ine TLSTM_ADDR_XXX                  0x08 */
    ...
    int netsnmp_tlstmAddr_restore_common (char **line, char *name,
                                          ...
                                          size_t * id_len, char *fp, size_t * fp_len, u_char * ht);
