...
extern "C"
{
    ...
    int netsnmp_dateandtime_set_buf_from_vars (u_char * buf, size_t * bufsize,
      ...
      NETSNMP_IMPORT u_char * date_n_time (const time_t *, size_t *);
...
#define ST_READONLY    5
      ...
      NETSNMP_IMPORT char check_rowstatus_transition (int old_val, int new_val);
      NETSNMP_IMPORT char check_rowstatus_with_storagetype_transition (int old_val, int new_val, int old_storage);
      NETSNMP_IMPORT char check_storage_transition (int old_val, int new_val);
