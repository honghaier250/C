...
#define SNMPADMINLENGTH 255
    ...
    NETSNMP_IMPORT char *uptime_string (u_long, char *);
    char *uptime_string_n (u_long, char *, size_t);
      NETSNMP_IMPORT void xdump (const void *, size_t, const char *);
      NETSNMP_IMPORT u_char * snmp_parse_var_op (u_char *, oid *, size_t *, u_char *, size_t *, u_char **, size_t *);
      NETSNMP_IMPORT u_char * snmp_build_var_op (u_char *, oid *, size_t *, u_char, size_t, u_char *, size_t *);
    ...
    int snmp_realloc_rbuild_var_op (u_char ** pkt,
                                    ...
                                    int allow_realloc,
                                    const oid * name,
                                    size_t * name_len, u_char value_type, u_char * value, size_t value_length);
#endif
