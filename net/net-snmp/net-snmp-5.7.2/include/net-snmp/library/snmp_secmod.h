 ...
 */
    ...
    typedef void (SecmodHandleReport) (void *sessp,
                                       ...
                                       netsnmp_session *, int result, netsnmp_pdu * origpdu);
 ...
 */
      NETSNMP_IMPORT struct snmp_secmod_def *find_sec_mod (int);
 ...
 */
    ...
    void init_secmod (void);
      NETSNMP_IMPORT void shutdown_secmod (void);

/*
 * clears the sec_mod list
 */
      NETSNMP_IMPORT void clear_sec_mod (void);
