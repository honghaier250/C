...
#define SE_DNE           -2
    ...
    int se_store_in_list (struct snmp_enum_list *, unsigned int major, unsigned int minor);
     ...
     */
      NETSNMP_IMPORT char *se_find_label_in_slist (const char *listname, int value);
      NETSNMP_IMPORT int se_find_value_in_slist (const char *listname, const char *label);
     ...
     * clear_snmp_enum() deallocates that memory.
     */
      NETSNMP_IMPORT int se_add_pair_to_slist (const char *listname, char *label, int value);
     ...
     */
    void se_store_enum_list (struct snmp_enum_list *new_list, const char *token, const char *type);
    ...
    int se_store_slist_callback (int majorID, int minorID, void *serverargs, void *clientargs);
     ...
     */
      NETSNMP_IMPORT void clear_snmp_enum (void);
