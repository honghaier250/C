...
/** @} */
    ...
    int netsnmp_register_watched_instance (netsnmp_handler_registration * reginfo, netsnmp_watcher_info * winfo);
    int netsnmp_register_watched_instance2 (netsnmp_handler_registration * reginfo, netsnmp_watcher_info * winfo);
    int netsnmp_register_watched_scalar (netsnmp_handler_registration * reginfo, netsnmp_watcher_info * winfo);
    int netsnmp_register_watched_scalar2 (netsnmp_handler_registration * reginfo, netsnmp_watcher_info * winfo);
...
#define WATCHER_HANDLER_NAME "watcher"
    ...
    netsnmp_watcher_info *netsnmp_init_watcher_info (netsnmp_watcher_info *, void *, size_t, u_char, int);
    ...
    netsnmp_watcher_info *netsnmp_create_watcher_info6 (void *, size_t, u_char, int, size_t, size_t *);
