...
/***********************************************************************/
    ...
    netsnmp_subtree *netsnmp_subtree_find (const oid *, size_t, netsnmp_subtree *, const char *context_name);
...
#define DEFAULT_MIB_PRIORITY        127
    ...
    int register_mib (const char *, struct variable *, size_t, size_t, const oid *, size_t);

    int register_mib_priority (const char *, struct variable *, size_t, size_t, const oid *, size_t, int);

    int register_mib_range (const char *, struct variable *,
                            size_t, size_t, const oid *, size_t, int, int, oid, netsnmp_session *);

    int register_mib_context (const char *, struct variable *,
                              size_t, size_t, const oid *, size_t,
                              int, int, oid, netsnmp_session *, const char *, int, int);

    int netsnmp_register_mib_table_row (const char *, struct variable *,
                                        size_t, size_t, oid *,
                                        size_t, int, int, netsnmp_session *, const char *, int, int);
    ...
    int netsnmp_unregister_mib_table_row (oid * mibloc, size_t mibloclen,
                                          int priority, int var_subid, oid range_ubound, const char *context);
 ...
 */
    ...
    int netsnmp_register_mib (const char *, struct variable *,
                              ...
                              const char *, int, int, struct netsnmp_handler_registration_s *, int);
