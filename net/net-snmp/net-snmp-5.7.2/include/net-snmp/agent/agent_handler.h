 ...
 */
    ...
    /** for handler's internal use */
        ...
        int (*access_method) (struct netsnmp_mib_handler_s *,
                              ...
                              struct netsnmp_agent_request_info_s *, struct netsnmp_request_info_s *);
 ...
 */
    ...
    netsnmp_handler_registration *netsnmp_handler_registration_create (const char *name,
                                                                       ...
                                                                       int modes);
    netsnmp_handler_registration *netsnmp_create_handler_registration (const char *name, Netsnmp_Node_Handler *
