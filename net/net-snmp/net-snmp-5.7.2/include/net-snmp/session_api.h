...
extern "C"
{
    ...
    NETSNMP_IMPORT void snmp_sess_init (netsnmp_session *);
     ...
     */
      NETSNMP_IMPORT netsnmp_session * snmp_open (netsnmp_session *);
     ...
     */
      NETSNMP_IMPORT int snmp_close (netsnmp_session *);
      NETSNMP_IMPORT int snmp_close_sessions (void);
     ...
     */
      NETSNMP_IMPORT int snmp_send (netsnmp_session *, netsnmp_pdu *);
     ...
     * The pdu is freed by snmp_send() unless a failure occured.
     */
      NETSNMP_IMPORT int snmp_async_send (netsnmp_session *, netsnmp_pdu *, netsnmp_callback, void *);
     ...
     */
      NETSNMP_IMPORT void snmp_read (fd_set *);
     ...
     * descriptor set.
     */
      NETSNMP_IMPORT void snmp_read2 (netsnmp_large_fd_set *);


      NETSNMP_IMPORT int snmp_synch_response (netsnmp_session *, netsnmp_pdu *, netsnmp_pdu **);
     ...
     * of sessions open)
     */
      NETSNMP_IMPORT int snmp_select_info (int *, fd_set *, struct timeval *, int *);
     ...
     */
      NETSNMP_IMPORT int snmp_select_info2 (int *, netsnmp_large_fd_set *, struct timeval *, int *);

#define NETSNMP_SELECT_NOFLAGS  0x00
#define NETSNMP_SELECT_NOALARMS 0x01
      NETSNMP_IMPORT int snmp_sess_select_info_flags (void *, int *, fd_set *, struct timeval *, int *, int);
    int snmp_sess_select_info2_flags (void *, int *, netsnmp_large_fd_set *, struct timeval *, int *, int);
     ...
     */
      ...
      NETSNMP_IMPORT void snmp_timeout (void);
     ...
     */
      ...
      NETSNMP_IMPORT void *snmp_sess_open (netsnmp_session *);
      NETSNMP_IMPORT void *snmp_sess_pointer (netsnmp_session *);
      NETSNMP_IMPORT netsnmp_session * snmp_sess_session (void *);
      NETSNMP_IMPORT netsnmp_session * snmp_sess_session_lookup (void *);
     ...
     */
      ...
      NETSNMP_IMPORT int snmp_sess_send (void *, netsnmp_pdu *);
      NETSNMP_IMPORT int snmp_sess_async_send (void *, netsnmp_pdu *, netsnmp_callback, void *);
      NETSNMP_IMPORT int snmp_sess_select_info (void *, int *, fd_set *, struct timeval *, int *);
      NETSNMP_IMPORT int snmp_sess_select_info2 (void *, int *, netsnmp_large_fd_set *, struct timeval *, int *);
    /*
     * Returns 0 if success, -1 if fail.
     */
      NETSNMP_IMPORT int snmp_sess_read (void *, fd_set *);
    /*
     ...
     */
      NETSNMP_IMPORT int snmp_sess_read2 (void *, netsnmp_large_fd_set *);
      NETSNMP_IMPORT void snmp_sess_timeout (void *);
      NETSNMP_IMPORT int snmp_sess_close (void *);

      NETSNMP_IMPORT int snmp_sess_synch_response (void *, netsnmp_pdu *, netsnmp_pdu **);
