    ...
    NETSNMP_IMPORT
      ...
      NETSNMP_IMPORT
        struct config_line *register_prenetsnmp_mib_handler (const char *filePrefix,
                                                             ...
                                                             void (*parser) (const char *, char *),
                                                             void (*releaser) (void), const char *usageLine);
      NETSNMP_IMPORT void unregister_config_handler (const char *filePrefix, const char *token);
    ...
    /* Application Handlers */
      ...
      NETSNMP_IMPORT
        struct config_line *register_app_prenetsnmp_mib_handler (const char *token,
                                                                 void (*parser) (const char *, char *),
                                                                 void (*releaser) (void), const char *usageLine);
      NETSNMP_IMPORT void unregister_app_config_handler (const char *token);

    /* Reading Config Files */
      NETSNMP_IMPORT void read_configs (void);
      NETSNMP_IMPORT void read_premib_configs (void);

    /* Help Strings and Errors */
      NETSNMP_IMPORT void read_config_print_usage (const char *lead);
      NETSNMP_IMPORT void config_perror (const char *);
      NETSNMP_IMPORT void config_pwarn (const char *);
