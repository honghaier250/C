 ...
 */
    netsnmp_systemstats_entry *netsnmp_access_systemstats_entry_create (int version, int if_index,
                                                                        const char *tableName);
 ...
 * update/compare
 */
    int netsnmp_access_systemstats_entry_update (netsnmp_systemstats_entry * old, netsnmp_systemstats_entry * new_val);
