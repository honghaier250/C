...
int test1 ()
{
    ...
    init_snmp ("testing");
    OKF (callback_called == 0,
         ("Callback shouldn't be called before registering it - it was called %d times\n", callback_called));
    sum += callback_called;

    callback_called = 0;
    register_app_config_handler ("testing", parse_config, test_callback, "module-name module-path");
    OKF (callback_called == 0,
         ("Callback shouldn't be called after registering it - it was called %d times\n", callback_called));
    sum += callback_called;

    callback_called = 0;
    unregister_app_config_handler ("testing");
    OKF (callback_called == 1,
         ("Callback should have been called once and only once after unregistering handler - it was called %d times\n",
          callback_called));
    sum += callback_called;
    ...
    OKF (callback_called == 0,
         ("Callback should have been called once and only once after shutdown - it was called %d times\n",
          callback_called));
    sum += callback_called;
...
int test2 (void)
{
    ...
    snmp_shutdown ("testing");
    OKF (callback_called == 1,
         ("Callback should have been called once and only once during shutdown - it was called %d times\n",
          callback_called));
    sum += callback_called;
...
int test3 (void)
{
    ...
    snmp_shutdown ("testing");
    OKF (callback_called == 0,
         ("Callback should not have been called during shutdown after unregistering handler - it was called %d times\n",
          callback_called));
    sum += callback_called;
