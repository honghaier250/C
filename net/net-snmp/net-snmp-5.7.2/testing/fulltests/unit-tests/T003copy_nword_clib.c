...

{
    ...
    ASSERT2 (strcmp (output, "The red rose") == 0, ("output = >%s<\n", output));
    ASSERT1 (run == NULL);
}

{
    ...
    ASSERT2 (run == input + 6, ("run = input + %" NETSNMP_PRIz "d\n", run - input));
    run = copy_nword (run, output, sizeof (output));
    ASSERT2 (strcmp (output, "red") == 0, ("output = >%s<\n", output));
    ASSERT2 (run == input + 10, ("run = input + %" NETSNMP_PRIz "d\n", run - input));
    run = copy_nword (run, output, sizeof (output));
...

{
    ...
    ASSERT2 (run == input + 44, ("run = input + %" NETSNMP_PRIz "d\n", run - input));
}
...

{
    ...
    ASSERT2 (strcmp (output, "The") == 0, ("output = >%s<\n", output));
    ASSERT2 (run == input + 5, ("run = input + %" NETSNMP_PRIz "d\n", run - input));
}

{
    ...
    ASSERT2 (run == input + 9, ("run = input + %" NETSNMP_PRIz "d\n", run - input));
}
