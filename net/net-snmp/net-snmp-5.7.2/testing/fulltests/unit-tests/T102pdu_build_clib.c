...
OKF ((rc == SNMPERR_SUCCESS), ("Building a GET PDU/packet should have worked: %d", rc));
#else                            /* NETSNMP_NOTIFY_ONLY */
OKF ((rc != SNMPERR_SUCCESS), ("Building a GET PDU/packet should have failed: %d", rc));
...
OKF ((rc == SNMPERR_SUCCESS), ("Building a SET PDU/packet should have succeeded: %d", rc));
#else                            /* NETSNMP_NO_WRITE_SUPPORT */
OKF ((rc != SNMPERR_SUCCESS), ("Building a SET PDU/packet should have failed: %d", rc));
...
OKF ((rc == SNMPERR_SUCCESS), ("Building an INFORM PDU/packet should have succeed: %d", rc));
