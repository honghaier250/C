...
extern int get_auth (int infd, Shishi ** handle, Shishi_ap ** ap,
                     ...
                     int *protoversion, int *cksumtype, char **cksum, int *cksumlen);

extern int readenc (Shishi * h, int sock, char *buf, int *len, shishi_ivector * iv, Shishi_key * enckey, int proto);
