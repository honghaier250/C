...
# Reproduce by: gnulib-tool --import --dir=. --local-dir=gl --lib=libgnu --source-base=lib --m4-base=m4 --doc-base=doc --tests-base=tests --aux-dir=build-aux --no-libtool --macro-prefix=gl alloca alloca-opt argp argp-version-etc autobuild dirfd dirname-lgpl error exit exitfail extensions fdl-1.3 filemode getcwd getline getopt-gnu getpass gettext gettext-h getusershell glob gnupload inttostr maintainer-makefile malloc mempcpy minmax obstack poll progname pty readline readutmp realloc regex setenv size_max snprintf stdbool stdint strcase strchrnul strerror strndup strnlen sysexits unistd-safer unlocked-io vasnprintf version-etc-fsf vsnprintf xalloc xalloc-die xgetcwd xgetdomainname xgethostname xsize
