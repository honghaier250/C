...
//  The inUserRefPtr parameter is passed back to the idle-wait callback
    ...
    OSErr MacSocket_socket (int *outSocketNum, const Boolean inDoThreadSwitching, const long inTimeoutTicks,
                            MacSocket_IdleWaitCallback inIdleWaitCallback, void *inUserRefPtr);
...
//  Call this to get error info from a socket
    ...
    void MacSocket_GetSocketErrorInfo (const int inSocketNum, int *outSocketErrCode, char *outSocketErrString,
