...
void keyDiversifyCryptoPro (gost_ctx * ctx,
                            const unsigned char *inputKey, const unsigned char *ukm, unsigned char *outputKey);
...
int keyWrapCryptoPro (gost_ctx * ctx,
                      ...
                      const unsigned char *ukm, const unsigned char *sessionKey, unsigned char *wrappedKey);
