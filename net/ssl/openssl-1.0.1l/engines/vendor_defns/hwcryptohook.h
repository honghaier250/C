...
typedef
    int HWCryptoHook_RandomBytes_t (HWCryptoHook_ContextHandle hwctx,
                                    unsigned char *buf, size_t len, const HWCryptoHook_ErrMsgBuf * errors);
...
typedef
    int HWCryptoHook_ModExp_t (HWCryptoHook_ContextHandle hwctx,
                               HWCryptoHook_MPI a,
                               HWCryptoHook_MPI p,
                               HWCryptoHook_MPI n, HWCryptoHook_MPI * r, const HWCryptoHook_ErrMsgBuf * errors);
...
typedef
    int HWCryptoHook_ModExpCRT_t (HWCryptoHook_ContextHandle hwctx,
                                  ...
                                  HWCryptoHook_MPI iqmp, HWCryptoHook_MPI * r, const HWCryptoHook_ErrMsgBuf * errors);
...
typedef
    int HWCryptoHook_RSAImmedPriv_t (HWCryptoHook_ContextHandle hwctx,
                                     ...
                                     HWCryptoHook_MPI * r, const HWCryptoHook_ErrMsgBuf * errors);
...
typedef
    int HWCryptoHook_RSALoadKey_t (HWCryptoHook_ContextHandle hwctx,
                                   ...
                                   const HWCryptoHook_ErrMsgBuf * errors, HWCryptoHook_PassphraseContext * ppctx);
...
typedef
    int HWCryptoHook_RSAGetPublicKey_t (HWCryptoHook_RSAKeyHandle k,
                                        HWCryptoHook_MPI * n,
                                        HWCryptoHook_MPI * e, const HWCryptoHook_ErrMsgBuf * errors);
...
typedef
    int HWCryptoHook_RSA_t (HWCryptoHook_MPI m,
                            HWCryptoHook_RSAKeyHandle k, HWCryptoHook_MPI * r, const HWCryptoHook_ErrMsgBuf * errors);
