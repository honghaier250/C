...
typedef void (SECURITYAPI * F_KEYRECORDREAD)
    (long *return_code,
     ...
     unsigned char *rule_array, unsigned char *key_label, long *key_token_length, unsigned char *key_token);

/* Random Number Generate */
typedef void (SECURITYAPI * F_RANDOMNUMBERGENERATE)
    (long *return_code,
     long *reason_code,
     long *exit_data_length, unsigned char *exit_data, unsigned char *form, unsigned char *random_number);
...
typedef void (SECURITYAPI * F_DIGITALSIGNATUREGENERATE)
    (long *return_code,
     ...
     long *hash_length,
     unsigned char *hash, long *signature_field_length, long *signature_bit_length, unsigned char *signature_field);
...
typedef void (SECURITYAPI * F_DIGITALSIGNATUREVERIFY) (long *return_code,
                                                       ...
                                                       long *hash_length,
                                                       unsigned char *hash,
                                                       long *signature_field_length, unsigned char *signature_field);
...
typedef void (SECURITYAPI * F_PUBLICKEYEXTRACT) (long *return_code,
                                                 ...
                                                 long *target_key_token_length, unsigned char *target_key_token);
...
typedef void (SECURITYAPI * F_PKAENCRYPT)
    (long *return_code,
     ...
     unsigned char *RSA_public_key, long *RSA_encipher_length, unsigned char *RSA_encipher);
...
typedef void (SECURITYAPI * F_PKADECRYPT)
    (long *return_code,
     ...
     long *data_struct_length,
     unsigned char *data_struct,
     long *RSA_private_key_length, unsigned char *RSA_private_key, long *key_value_length, unsigned char *key_value);
