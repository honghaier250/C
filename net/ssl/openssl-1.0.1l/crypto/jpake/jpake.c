...
JPAKE_CTX *JPAKE_CTX_new (const char *name, const char *peer_name,
                          const BIGNUM * p, const BIGNUM * g, const BIGNUM * q, const BIGNUM * secret)
{
...
static void zkp_hash (BIGNUM * h, const BIGNUM * zkpg, const JPAKE_STEP_PART * p, const char *proof_name)
{
 ...
 */
static void generate_zkp (JPAKE_STEP_PART * p, const BIGNUM * x, const BIGNUM * zkpg, JPAKE_CTX * ctx)
{
    BIGNUM *r = BN_new ();
...
static int verify_zkp (const JPAKE_STEP_PART * p, const BIGNUM * zkpg, JPAKE_CTX * ctx)
{
    BIGNUM *h = BN_new ();
...
static void generate_step_part (JPAKE_STEP_PART * p, const BIGNUM * x, const BIGNUM * g, JPAKE_CTX * ctx)
{
