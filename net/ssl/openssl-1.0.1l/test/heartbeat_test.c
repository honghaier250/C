...
static HEARTBEAT_TEST_FIXTURE set_up (const char *const test_case_name, const SSL_METHOD * meth)
{
...
static void print_payload (const char *const prefix, const unsigned char *payload, const int n)
{
    ...
    *payload++ = TLS1_HB_REQUEST;
    ...
    if (return_value != fixture.expected_return_value)
    {
        printf ("%s failed: expected return value %d, received %d\n",
                fixture.test_case_name, fixture.expected_return_value, return_value);
        result = 1;
    }
    ...
    else
    {
        ...
        {
            printf ("%s failed:\n  expected payload: \"%s\"\n  received: \"%s\"\n",
                    fixture.test_case_name, fixture.expected_return_payload, actual_payload);
            result = 1;
        }
...
int main (int argc, char *argv[])
{
    ...
    num_failed = test_dtls1_not_bleeding () +
        test_dtls1_not_bleeding_empty_payload () + test_dtls1_heartbleed () + test_dtls1_heartbleed_empty_payload () +
        ...
        test_tls1_not_bleeding_empty_payload () + test_tls1_heartbleed () + test_tls1_heartbleed_empty_payload () + 0;
