...
unsigned int buffer_adddata (buffer_t * buf, const unsigned char *ptr, unsigned int size);
 ...
 * too little data). */
unsigned int buffer_takedata (buffer_t * buf, unsigned char *ptr, unsigned int size);
