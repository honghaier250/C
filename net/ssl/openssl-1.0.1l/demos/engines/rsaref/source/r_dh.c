...
{
    int status;
    NN_DIGIT g[MAX_NN_DIGITS], p[MAX_NN_DIGITS], q[MAX_NN_DIGITS], t[MAX_NN_DIGITS], u[MAX_NN_DIGITS], v[MAX_NN_DIGITS];
...
{
    int status;
    NN_DIGIT g[MAX_NN_DIGITS], p[MAX_NN_DIGITS], x[MAX_NN_DIGITS], y[MAX_NN_DIGITS];
...
int R_ComputeDHAgreedKey(agreedKey, otherPublicValue, privateValue, privateValueLen, params)
     ...
     R_DH_PARAMS *params;        /* Diffie-Hellman parameters */
{
    NN_DIGIT p[MAX_NN_DIGITS], x[MAX_NN_DIGITS], y[MAX_NN_DIGITS], z[MAX_NN_DIGITS];
    unsigned int pDigits, xDigits;
