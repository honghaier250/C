...
Requires: sed
Source: http://trific.ath.cx/Ftp/enca/enca-1.16.tar.bz2
URL: http://trific.ath.cx/software/enca/
Packager: https://github.com/nijel/enca/issues
Vendor: Trific soft.
Prefix: %{_prefix}
...
%defattr(-,root,root)
%doc AUTHORS COPYING ChangeLog ChangeLog.prelib FAQ INSTALL ChangeLog.old README README.devel THANKS TODO
