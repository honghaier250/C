...
GST_BOILERPLATE(GstTimeOverlay, gst_time_overlay, GstTextOverlay, GST_TYPE_TEXT_OVERLAY);

static void gst_time_overlay_base_init(gpointer g_class)
{
    GstElementClass *element_class = GST_ELEMENT_CLASS(g_class);

    gst_element_class_set_details_simple(element_class, "Time overlay", "Filter/Editor/Video", "Overlays buffer time stamps on a video stream", "Tim-Philipp Müller <tim@centricular.net>");
}

static gchar *gst_time_overlay_render_time(GstTimeOverlay * overlay, GstClockTime time)
{
...
static gchar *gst_time_overlay_get_text(GstTextOverlay * overlay, GstBuffer * video_frame)
{
...
static void gst_time_overlay_class_init(GstTimeOverlayClass * klass)
{
...
static void gst_time_overlay_init(GstTimeOverlay * overlay, GstTimeOverlayClass * klass)
{
