...
static void gst_alsa_mixer_options_class_init(gpointer g_class, gpointer class_data);
...
GType gst_alsa_mixer_options_get_type(void)
{
    ...
    if (!opts_type)
    {
        ...
        opts_type = g_type_register_static(GST_TYPE_MIXER_OPTIONS, "GstAlsaMixerOptions", &opts_info, 0);
    }
...
GstMixerOptions *gst_alsa_mixer_options_new(snd_mixer_elem_t * element, gint track_num)
{
    ...
    opts = g_object_new(GST_ALSA_MIXER_OPTIONS_TYPE, "untranslated-label", label, "index", index, NULL);
