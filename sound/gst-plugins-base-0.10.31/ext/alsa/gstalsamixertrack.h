...
GstMixerTrack *gst_alsa_mixer_track_new(snd_mixer_elem_t * element, gint num, gint track_num, gint flags, gboolean sw,    /* is simple switch? */
                                        GstAlsaMixerTrack * shared_mute_track, gboolean label_append_capture);
