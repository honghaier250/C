...
static const GList *gst_alsa_device_property_probe_get_properties(GstPropertyProbe * probe)
{
...
static GList *gst_alsa_get_device_list(snd_pcm_stream_t stream)
{
    snd_ctl_t *handle;
    int card, dev;
...
static void gst_alsa_device_property_probe_probe_property(GstPropertyProbe * probe, guint prop_id, const GParamSpec * pspec)
{
...
static gboolean gst_alsa_device_property_probe_needs_probe(GstPropertyProbe * probe, guint prop_id, const GParamSpec * pspec)
{
    /* don't cache probed data */
    return TRUE;
}

static GValueArray *gst_alsa_device_property_probe_get_values(GstPropertyProbe * probe, guint prop_id, const GParamSpec * pspec)
{
...
static void gst_alsa_property_probe_interface_init(GstPropertyProbeInterface * iface)
{
