...
GST_START_TEST(test_timestamps)
{
    ...
    pipe_str = g_strdup_printf("audiotestsrc num-buffers=100" " ! audio/x-raw-int,rate=44100 ! audioconvert ! vorbisenc ! vorbisdec" " ! identity check-imperfect-timestamp=TRUE ! fakesink");
