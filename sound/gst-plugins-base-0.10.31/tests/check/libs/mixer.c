...
static void test_element_mixer_interface_init(GstMixerClass * klass)
{
...
GST_START_TEST(test_messages)
{
    ...
    GstElement *test_element = (GstElement *) g_object_new(TEST_ELEMENT_TYPE, NULL);
    ...
    fail_unless(gst_mixer_message_get_type(message) == GST_MIXER_MESSAGE_MUTE_TOGGLED);
    ...
    message = gst_bus_poll(bus, GST_MESSAGE_ELEMENT, GST_CLOCK_TIME_NONE);
    fail_if(message == NULL);
    fail_unless(gst_mixer_message_get_type(message) == GST_MIXER_MESSAGE_RECORD_TOGGLED);
    ...
    message = gst_bus_poll(bus, GST_MESSAGE_ELEMENT, GST_CLOCK_TIME_NONE);
    fail_if(message == NULL);
    fail_unless(gst_mixer_message_get_type(message) == GST_MIXER_MESSAGE_VOLUME_CHANGED);
    ...
    message = gst_bus_poll(bus, GST_MESSAGE_ELEMENT, GST_CLOCK_TIME_NONE);
    fail_if(message == NULL);
    fail_unless(gst_mixer_message_get_type(message) == GST_MIXER_MESSAGE_OPTION_CHANGED);
    ...
    message = gst_bus_poll(bus, GST_MESSAGE_ELEMENT, GST_CLOCK_TIME_NONE);
    fail_if(message == NULL);
    fail_unless(gst_mixer_message_get_type(message) == GST_MIXER_MESSAGE_OPTIONS_LIST_CHANGED);
    ...
    message = gst_bus_poll(bus, GST_MESSAGE_ELEMENT, GST_CLOCK_TIME_NONE);
    fail_if(message == NULL);
    fail_unless(gst_mixer_message_get_type(message) == GST_MIXER_MESSAGE_MIXER_CHANGED);
    gst_message_unref(message);
