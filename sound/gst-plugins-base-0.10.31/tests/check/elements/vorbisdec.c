...
static GstElement *setup_vorbisdec(void)
{
...
static void cleanup_vorbisdec(GstElement * vorbisdec)
{
...
GST_START_TEST(test_empty_identification_header)
{
    ...
    fail_unless(gst_element_set_state(vorbisdec, GST_STATE_PLAYING) == GST_STATE_CHANGE_SUCCESS, "could not set to playing");
...
GST_START_TEST(test_identification_header)
{
    ...
    fail_unless_equals_int(gst_tag_list_get_tag_size(tag_list, GST_TAG_ARTIST), 1);
...
GST_START_TEST(test_empty_vorbis_packet)
{
    ...
    vorbisdec = setup_vorbisdec();
    fail_unless_equals_int(gst_element_set_state(vorbisdec, GST_STATE_PLAYING), GST_STATE_CHANGE_SUCCESS);
...
static Suite *vorbisdec_suite(void)
{
