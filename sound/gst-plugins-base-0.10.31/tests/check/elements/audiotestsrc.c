...
static GstElement *setup_audiotestsrc(void)
{
...
static void cleanup_audiotestsrc(GstElement * audiotestsrc)
{
...
GST_START_TEST(test_all_waves)
{
    ...
    while (values[j].value_name)
    {
        ...
        fail_unless(gst_element_set_state(audiotestsrc, GST_STATE_PLAYING) == GST_STATE_CHANGE_SUCCESS, "could not set to playing");
...
static Suite *audiotestsrc_suite(void)
{
