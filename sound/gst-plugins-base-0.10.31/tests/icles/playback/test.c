...
static GstElement *gen_video_element(void)
{
    GstElement *element;
    GstElement *conv;
    GstElement *sink;
...
static GstElement *gen_audio_element(void)
{
    GstElement *element;
    GstElement *conv;
    GstElement *sink;
...
gint main(gint argc, gchar * argv[])
{
    ...
    g_signal_connect(G_OBJECT(decodebin), "new-decoded-pad", G_CALLBACK(cb_newpad), pipeline);
