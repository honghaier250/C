...
static gboolean resize_window(GstPipeline * pipeline)
{
...
static gboolean move_window(GstPipeline * pipeline)
{
    x += 5;
...
static gboolean toggle_events(GstXOverlay * ov)
{
...
static gboolean cycle_window(GstXOverlay * ov)
{
    XGCValues values;
    Window old_win = win;
    GC old_gc = gc;
...
#if 0
static gboolean terminate_playback(GstElement * pipeline)
{
...
static gboolean pause_playback(GstElement * pipeline)
{
...
static gboolean start_playback(GstElement * pipeline)
{
