...
static void have_subtitle(GstElement * appsink, App * app)
{
    GstBuffer *buffer;
    ...
    if (buffer)
    {
        ...
        g_message("received a subtitle at position %" GST_TIME_FORMAT ", running_time %" GST_TIME_FORMAT, GST_TIME_ARGS(position), GST_TIME_ARGS(running_time));
