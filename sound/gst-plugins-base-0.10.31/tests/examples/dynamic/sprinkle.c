 ...
 * adder */
static SourceInfo *add_source(gdouble freq)
{
    SourceInfo *info;
...
int main(int argc, char *argv[])
{
    ...
    caps = gst_caps_new_simple("audio/x-raw-int", "endianness", G_TYPE_INT, G_LITTLE_ENDIAN, "channels", G_TYPE_INT, 1, "width", G_TYPE_INT, 16, "depth", G_TYPE_INT, 16, "rate", G_TYPE_INT, 44100, "signed", G_TYPE_BOOLEAN, TRUE, NULL);
