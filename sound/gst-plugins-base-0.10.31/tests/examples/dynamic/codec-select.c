 ...
 * bin.
 */
static GstElement *make_encoder(const GstCaps * caps)
{
    GstElement *result;
...
static GstElement *make_pipeline(void)
{
    ...
    caps = gst_caps_from_string("audio/x-raw-int,signed=true,width=16,depth=16,rate=48000,channels=1");
    ...
    /* make caps */
    capslist[0] = gst_caps_from_string("audio/x-raw-int,signed=true,width=16,depth=16,rate=48000,channels=1");
    capslist[1] = gst_caps_from_string("audio/x-raw-int,signed=true,width=16,depth=16,rate=16000,channels=1");
    capslist[2] = gst_caps_from_string("audio/x-raw-int,signed=true,width=16,depth=16,rate=8000,channels=1");
...
static gboolean do_switch(GstElement * pipeline)
{
    gint rand;
    GstElement *select;
    gchar *name;
