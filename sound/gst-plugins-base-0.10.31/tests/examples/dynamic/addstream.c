...
static gboolean pause_play_stream(GstElement * bin, gint seconds)
{
    gboolean punch_in;
...
static gboolean perform_step(gpointer pstep)
{
    ...
    switch (step)
    {
        case 0:
            ...
            bin1 = create_stream("( v4l2src ! ffmpegcolorspace ! timeoverlay ! queue ! xvimagesink name=v4llive )");
        ...
        case 3:
            ...
            bin4 = create_stream("( videotestsrc ! timeoverlay ! ffmpegcolorspace ! ximagesink name=vtnonlive )");
        ...
        case 4:
            ...
            bin5 = create_stream("( videotestsrc is-live=1 ! timeoverlay ! ffmpegcolorspace ! ximagesink name=vtlive )");
