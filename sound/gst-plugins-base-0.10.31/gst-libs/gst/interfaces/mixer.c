...
GType gst_mixer_get_type(void)
{
    ...
    if (!gst_mixer_type)
    {
        ...
        gst_mixer_type = g_type_register_static(G_TYPE_INTERFACE, "GstMixer", &gst_mixer_info, 0);
        g_type_interface_add_prerequisite(gst_mixer_type, GST_TYPE_IMPLEMENTS_INTERFACE);
    }
...
static void gst_mixer_class_init(GstMixerClass * klass)
{
    ...
    if (!initialized)
    {
        gst_mixer_signals[SIGNAL_RECORD_TOGGLED] =
            g_signal_new("record-toggled", GST_TYPE_MIXER, G_SIGNAL_RUN_LAST, G_STRUCT_OFFSET(GstMixerClass, record_toggled), NULL, NULL, gst_interfaces_marshal_VOID__OBJECT_BOOLEAN, G_TYPE_NONE, 2, GST_TYPE_MIXER_TRACK, G_TYPE_BOOLEAN);
        gst_mixer_signals[SIGNAL_MUTE_TOGGLED] =
            g_signal_new("mute-toggled", GST_TYPE_MIXER, G_SIGNAL_RUN_LAST, G_STRUCT_OFFSET(GstMixerClass, mute_toggled), NULL, NULL, gst_interfaces_marshal_VOID__OBJECT_BOOLEAN, G_TYPE_NONE, 2, GST_TYPE_MIXER_TRACK, G_TYPE_BOOLEAN);
        gst_mixer_signals[SIGNAL_VOLUME_CHANGED] =
            g_signal_new("volume-changed", GST_TYPE_MIXER, G_SIGNAL_RUN_LAST, G_STRUCT_OFFSET(GstMixerClass, volume_changed), NULL, NULL, gst_interfaces_marshal_VOID__OBJECT_POINTER, G_TYPE_NONE, 2, GST_TYPE_MIXER_TRACK, G_TYPE_POINTER);
        gst_mixer_signals[SIGNAL_OPTION_CHANGED] =
            g_signal_new("option-changed", GST_TYPE_MIXER, G_SIGNAL_RUN_LAST, G_STRUCT_OFFSET(GstMixerClass, option_changed), NULL, NULL, gst_interfaces_marshal_VOID__OBJECT_STRING, G_TYPE_NONE, 2, GST_TYPE_MIXER_OPTIONS, G_TYPE_STRING);
...
void gst_mixer_mute_toggled(GstMixer * mixer, GstMixerTrack * track, gboolean mute)
{
    ...
    s = gst_structure_new(GST_MIXER_MESSAGE_NAME, "type", G_TYPE_STRING, "mute-toggled", "track", GST_TYPE_MIXER_TRACK, track, "mute", G_TYPE_BOOLEAN, mute, NULL);
...
void gst_mixer_record_toggled(GstMixer * mixer, GstMixerTrack * track, gboolean record)
{
    ...
    s = gst_structure_new(GST_MIXER_MESSAGE_NAME, "type", G_TYPE_STRING, "record-toggled", "track", GST_TYPE_MIXER_TRACK, track, "record", G_TYPE_BOOLEAN, record, NULL);
...
void gst_mixer_volume_changed(GstMixer * mixer, GstMixerTrack * track, gint * volumes)
{
    ...
    s = gst_structure_new(GST_MIXER_MESSAGE_NAME, "type", G_TYPE_STRING, "volume-changed", "track", GST_TYPE_MIXER_TRACK, track, NULL);
 ...
 * GstMixer interface, and the element needs to have been provided a bus.
 */
void gst_mixer_option_changed(GstMixer * mixer, GstMixerOptions * opts, const gchar * value)
{
    GstStructure *s;
    GstMessage *m;
    ...
    s = gst_structure_new(GST_MIXER_MESSAGE_NAME, "type", G_TYPE_STRING, "option-changed", "options", GST_TYPE_MIXER_OPTIONS, opts, "value", G_TYPE_STRING, value, NULL);
...
void gst_mixer_options_list_changed(GstMixer * mixer, GstMixerOptions * opts)
{
    ...
    s = gst_structure_new(GST_MIXER_MESSAGE_NAME, "type", G_TYPE_STRING, "options-list-changed", "options", GST_TYPE_MIXER_OPTIONS, opts, NULL);
...
void gst_mixer_mixer_changed(GstMixer * mixer)
{
    ...
    s = gst_structure_new(GST_MIXER_MESSAGE_NAME, "type", G_TYPE_STRING, "mixer-changed", NULL);
...
static gboolean gst_mixer_message_is_mixer_message(GstMessage * message)
{
