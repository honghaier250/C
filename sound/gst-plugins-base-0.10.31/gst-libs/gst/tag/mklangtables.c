...
static void dump_languages(void)
{
    GString *names;
    const char *s;
    int i, num_escaped;
...
static gboolean copy_attribute(gchar * dest, guint dest_len, const gchar ** attr_names, const gchar ** attr_vals, const gchar * needle)
{
...
static void xml_start_element(GMarkupParseContext * ctx, const gchar * element_name, const gchar ** attr_names, const gchar ** attr_vals, gpointer user_data, GError ** error)
{
    gchar name[256];
    IsoLang lang;
...
static void parse_iso_639_xml(const gchar * data, gsize len)
{
...
static gint languages_sort_func(IsoLang * l1, IsoLang * l2)
{
    if (l1 == l2)
        return 0;
