 ...
 */
typedef void (*XmpDeserializationFunc) (XmpTag * xmptag, GstTagList * taglist, const gchar * gst_tag, const gchar * xmp_tag_value, const gchar * str, GSList ** pending_tags);
...
static GstTagMergeMode xmp_tag_get_merge_mode(XmpTag * xmptag)
{
    switch (xmptag->type)
    {
...
static const gchar *xmp_tag_get_type_name(XmpTag * xmptag)
{
    switch (xmptag->type)
    {
        case GST_XMP_TAG_TYPE_SEQ:
...
static GstXmpSchema *gst_xmp_schema_new()
{
...
static void _gst_xmp_add_schema(const gchar * name, GstXmpSchema * schema)
{
    GQuark key;
...
static void _gst_xmp_schema_add_mapping(GstXmpSchema * schema, const gchar * gst_tag, GPtrArray * array)
{
    GQuark key;
...
static void _gst_xmp_schema_add_simple_mapping(GstXmpSchema * schema, const gchar * gst_tag, const gchar * xmp_tag, gint xmp_type, XmpSerializationFunc serialization_func, XmpDeserializationFunc deserialization_func)
{
    XmpTag *xmpinfo;
    GPtrArray *array;
 ...
 */
static GPtrArray *_xmp_tag_get_mapping(const gchar * gst_tag)
{
    GPtrArray *ret = NULL;
    GHashTableIter iter;
...
static const gchar *_gst_xmp_schema_get_mapping_reverse(GstXmpSchema * schema, const gchar * xmp_tag, XmpTag ** _xmp_tag)
{
    GHashTableIter iter;
    gpointer key, value;
...
static const gchar *_gst_xmp_tag_get_mapping_reverse(const gchar * xmp_tag, XmpTag ** _xmp_tag)
{
    GHashTableIter iter;
    gpointer key, value;
    const gchar *ret = NULL;
    ...
    while (!ret && g_hash_table_iter_next(&iter, &key, &value))
    {
        ret = _gst_xmp_schema_get_mapping_reverse((GstXmpSchema *) value, xmp_tag, _xmp_tag);
    }
    return ret;
}
...
static gchar *double_to_fraction_string(gdouble num)
{
    gint frac_n;
    gint frac_d;
...
static gchar *serialize_exif_gps_coordinate(const GValue * value, gchar pos, gchar neg)
{
    gdouble num;
    gchar c;
    gint integer;
...
static gchar *serialize_exif_latitude(const GValue * value)
{
    return serialize_exif_gps_coordinate(value, 'N', 'S');
}

static gchar *serialize_exif_longitude(const GValue * value)
{
    return serialize_exif_gps_coordinate(value, 'E', 'W');
}

static void deserialize_exif_gps_coordinate(XmpTag * xmptag, GstTagList * taglist, const gchar * gst_tag, const gchar * str, gchar pos, gchar neg)
{
    gdouble value = 0;
    gint d = 0, m = 0, s = 0;
    gdouble m2 = 0;
    ...
    gst_tag_list_add(taglist, xmp_tag_get_merge_mode(xmptag), gst_tag, value, NULL);
    return;
...
static void deserialize_exif_latitude(XmpTag * xmptag, GstTagList * taglist, const gchar * gst_tag, const gchar * xmp_tag, const gchar * str, GSList ** pending_tags)
{
    deserialize_exif_gps_coordinate(xmptag, taglist, gst_tag, str, 'N', 'S');
}

static void deserialize_exif_longitude(XmpTag * xmptag, GstTagList * taglist, const gchar * gst_tag, const gchar * xmp_tag, const gchar * str, GSList ** pending_tags)
{
    deserialize_exif_gps_coordinate(xmptag, taglist, gst_tag, str, 'E', 'W');
}

static gchar *serialize_exif_altitude(const GValue * value)
{
    gdouble num;
...
static gchar *serialize_exif_altituderef(const GValue * value)
{
    gdouble num;
...
static void deserialize_exif_altitude(XmpTag * xmptag, GstTagList * taglist, const gchar * gst_tag, const gchar * xmp_tag, const gchar * str, GSList ** pending_tags)
{
    ...
    /* add to the taglist */
    gst_tag_list_add(taglist, xmp_tag_get_merge_mode(xmptag), GST_TAG_GEO_LOCATION_ELEVATION, value, NULL);
...
static gchar *serialize_exif_gps_speed(const GValue * value)
{
    return double_to_fraction_string(g_value_get_double(value) * METERS_PER_SECOND_TO_KILOMETERS_PER_HOUR);
}

static gchar *serialize_exif_gps_speedref(const GValue * value)
{
    /* we always use km/h */
    return g_strdup("K");
}

static void deserialize_exif_gps_speed(XmpTag * xmptag, GstTagList * taglist, const gchar * gst_tag, const gchar * xmp_tag, const gchar * str, GSList ** pending_tags)
{
    ...
    /* add to the taglist */
    gst_tag_list_add(taglist, xmp_tag_get_merge_mode(xmptag), GST_TAG_GEO_LOCATION_MOVEMENT_SPEED, value, NULL);
...
static gchar *serialize_exif_gps_direction(const GValue * value)
{
    return double_to_fraction_string(g_value_get_double(value));
}

static gchar *serialize_exif_gps_directionref(const GValue * value)
{
    /* T for true geographic direction (M would mean magnetic) */
    return g_strdup("T");
}

static void deserialize_exif_gps_direction(XmpTag * xmptag, GstTagList * taglist, const gchar * gst_tag, const gchar * xmp_tag, const gchar * str, GSList ** pending_tags, const gchar * direction_tag, const gchar * directionref_tag)
{
...
static void deserialize_exif_gps_track(XmpTag * xmptag, GstTagList * taglist, const gchar * gst_tag, const gchar * xmp_tag, const gchar * str, GSList ** pending_tags)
{
    deserialize_exif_gps_direction(xmptag, taglist, gst_tag, xmp_tag, str, pending_tags, "exif:GPSTrack", "exif:GPSTrackRef");
}

static void deserialize_exif_gps_img_direction(XmpTag * xmptag, GstTagList * taglist, const gchar * gst_tag, const gchar * xmp_tag, const gchar * str, GSList ** pending_tags)
{
    deserialize_exif_gps_direction(xmptag, taglist, gst_tag, xmp_tag, str, pending_tags, "exif:GPSImgDirection", "exif:GPSImgDirectionRef");
}

static void deserialize_xmp_rating(XmpTag * xmptag, GstTagList * taglist, const gchar * gst_tag, const gchar * xmp_tag, const gchar * str, GSList ** pending_tags)
{
    guint value;
    ...
    {
        GST_WARNING("Unsupported Rating tag %u (should be from 0 to 100), " "ignoring", value);
        return;
    }
...
static gchar *serialize_tiff_orientation(const GValue * value)
{
    const gchar *str;
    gint num;
...
static void deserialize_tiff_orientation(XmpTag * xmptag, GstTagList * taglist, const gchar * gst_tag, const gchar * xmp_tag, const gchar * str, GSList ** pending_tags)
{
    guint value;
    ...
    if (value < 1 || value > 8)
    {
        GST_WARNING("Invalid tiff:Orientation tag %u (should be from 1 to 8), " "ignoring", value);
        return;
    }
    ...
    if (orientation == NULL)
        return;
    gst_tag_list_add(taglist, xmp_tag_get_merge_mode(xmptag), gst_tag, orientation, NULL);
}

/* look at this page for addtional schemas
 * http://www.sno.phy.queensu.ca/~phil/exiftool/TagNames/XMP.html
 */
static gpointer _init_xmp_tag_map()
{
    GPtrArray *array;
    XmpTag *xmpinfo;
    GstXmpSchema *schema;
    ...
    _gst_xmp_schema_add_simple_mapping(schema, GST_TAG_ARTIST, "dc:creator", GST_XMP_TAG_TYPE_SEQ, NULL, NULL);
    _gst_xmp_schema_add_simple_mapping(schema, GST_TAG_COPYRIGHT, "dc:rights", GST_XMP_TAG_TYPE_SIMPLE, NULL, NULL);
    _gst_xmp_schema_add_simple_mapping(schema, GST_TAG_DATE, "dc:date", GST_XMP_TAG_TYPE_SEQ, NULL, NULL);
    _gst_xmp_schema_add_simple_mapping(schema, GST_TAG_DESCRIPTION, "dc:description", GST_XMP_TAG_TYPE_SIMPLE, NULL, NULL);
    _gst_xmp_schema_add_simple_mapping(schema, GST_TAG_KEYWORDS, "dc:subject", GST_XMP_TAG_TYPE_BAG, NULL, NULL);
    _gst_xmp_schema_add_simple_mapping(schema, GST_TAG_TITLE, "dc:title", GST_XMP_TAG_TYPE_SIMPLE, NULL, NULL);
    /* FIXME: we probably want GST_TAG_{,AUDIO_,VIDEO_}MIME_TYPE */
    _gst_xmp_schema_add_simple_mapping(schema, GST_TAG_VIDEO_CODEC, "dc:format", GST_XMP_TAG_TYPE_SIMPLE, NULL, NULL);
    _gst_xmp_add_schema("dc", schema);

    /* xap (xmp) schema */
    schema = gst_xmp_schema_new();
    _gst_xmp_schema_add_simple_mapping(schema, GST_TAG_USER_RATING, "xmp:Rating", GST_XMP_TAG_TYPE_SIMPLE, NULL, deserialize_xmp_rating);
    _gst_xmp_add_schema("xmp", schema);

    /* tiff */
    _gst_xmp_schema_add_simple_mapping(schema, GST_TAG_DEVICE_MANUFACTURER, "tiff:Make", GST_XMP_TAG_TYPE_SIMPLE, NULL, NULL);
    _gst_xmp_schema_add_simple_mapping(schema, GST_TAG_DEVICE_MODEL, "tiff:Model", GST_XMP_TAG_TYPE_SIMPLE, NULL, NULL);
    _gst_xmp_schema_add_simple_mapping(schema, GST_TAG_APPLICATION_NAME, "tiff:Software", GST_XMP_TAG_TYPE_SIMPLE, NULL, NULL);
    _gst_xmp_schema_add_simple_mapping(schema, GST_TAG_IMAGE_ORIENTATION, "tiff:Orientation", GST_XMP_TAG_TYPE_SIMPLE, serialize_tiff_orientation, deserialize_tiff_orientation);
    _gst_xmp_add_schema("tiff", schema);

    /* exif schema */
    _gst_xmp_schema_add_simple_mapping(schema, GST_TAG_DATE_TIME, "exif:DateTimeOriginal", GST_XMP_TAG_TYPE_SIMPLE, NULL, NULL);
    _gst_xmp_schema_add_simple_mapping(schema, GST_TAG_GEO_LOCATION_LATITUDE, "exif:GPSLatitude", GST_XMP_TAG_TYPE_SIMPLE, serialize_exif_latitude, deserialize_exif_latitude);
    _gst_xmp_schema_add_simple_mapping(schema, GST_TAG_GEO_LOCATION_LONGITUDE, "exif:GPSLongitude", GST_XMP_TAG_TYPE_SIMPLE, serialize_exif_longitude, deserialize_exif_longitude);
    ...
    xmpinfo->type = GST_XMP_TAG_TYPE_SIMPLE;
    g_ptr_array_add(array, xmpinfo);
    _gst_xmp_schema_add_mapping(schema, GST_TAG_GEO_LOCATION_MOVEMENT_SPEED, array);
    ...
    xmpinfo->type = GST_XMP_TAG_TYPE_SIMPLE;
    g_ptr_array_add(array, xmpinfo);
    _gst_xmp_schema_add_mapping(schema, GST_TAG_GEO_LOCATION_MOVEMENT_DIRECTION, array);
    ...
    xmpinfo->type = GST_XMP_TAG_TYPE_SIMPLE;
    g_ptr_array_add(array, xmpinfo);
    _gst_xmp_schema_add_mapping(schema, GST_TAG_GEO_LOCATION_CAPTURE_DIRECTION, array);
    _gst_xmp_add_schema("exif", schema);

    /* photoshop schema */
    _gst_xmp_schema_add_simple_mapping(schema, GST_TAG_GEO_LOCATION_COUNTRY, "photoshop:Country", GST_XMP_TAG_TYPE_SIMPLE, NULL, NULL);
    _gst_xmp_schema_add_simple_mapping(schema, GST_TAG_GEO_LOCATION_CITY, "photoshop:City", GST_XMP_TAG_TYPE_SIMPLE, NULL, NULL);
    _gst_xmp_add_schema("photoshop", schema);

    /* iptc4xmpcore schema */
    _gst_xmp_schema_add_simple_mapping(schema, GST_TAG_GEO_LOCATION_SUBLOCATION, "Iptc4xmpCore:Location", GST_XMP_TAG_TYPE_SIMPLE, NULL, NULL);
    _gst_xmp_add_schema("Iptc4xmpCore", schema);

    return NULL;
}

static void xmp_tags_initialize()
{
...
static void read_one_tag(GstTagList * list, const gchar * tag, XmpTag * xmptag, const gchar * v, GSList ** pending_tags)
{
    GType tag_type;
    ...
    switch (tag_type)
    {
        ...
        default:
            if (tag_type == GST_TYPE_DATE_TIME)
            {
                ...
                ret = sscanf(v, "%04d-%02d-%02dT%02d:%02d:%02d.%15s", &year, &month, &day, &hour, &minute, &second, usec_str);
                if (ret < 3)
                {
                ...
                if (v[len - 1] == 'Z')
                {
                    ...
                    datetime = gst_date_time_new(0, year, month, day, hour, minute, second + usecs / 1000000.0);
                }
                else
                {
                    gchar *plus_pos = NULL;
                    ...
                    if (pos)
                    {
                        ...
                        if (ret_tz == 2)
                        {
                            ...
                            GST_LOG("Timezone offset: %f (%d minutes)", gmt_offset / 60.0, gmt_offset);

                            /* no way to know if it is DST or not */
                            datetime = gst_date_time_new(gmt_offset / 60.0, year, month, day, hour, minute, second + usecs / ((gdouble) G_USEC_PER_SEC));
                        }
                        else
                        {
...
GstTagList *gst_tag_list_from_xmp_buffer(const GstBuffer * buffer)
{
    ...
    GST_INFO("xmp packet parsed, %d entries", gst_structure_n_fields((GstStructure *) list));
...
static void string_open_tag(GString * string, const char *tag)
{
...
static char *gst_value_serialize_xmp(const GValue * value)
{
    ...
    if (G_VALUE_TYPE(value) == GST_TYPE_DATE)
    {
        ...
        return g_strdup_printf("%04d-%02d-%02d", (gint) g_date_get_year(date), (gint) g_date_get_month(date), (gint) g_date_get_day(date));
    }
    else if (G_VALUE_TYPE(value) == GST_TYPE_DATE_TIME)
    {
        ...
        {
            /* UTC */
            return g_strdup_printf("%04d-%02d-%02dT%02d:%02d:%02d.%06dZ", year, month, day, hour, min, sec, microsec);
        }
        else
        {
            ...
            return g_strdup_printf("%04d-%02d-%02dT%02d:%02d:%02d.%06d%c%02d:%02d", year, month, day, hour, min, sec, microsec, gmt_offset >= 0 ? '+' : '-', gmt_offset_hour, gmt_offset_min);
        }
    }
    else
    {
...
static void write_one_tag(const GstTagList * list, const gchar * tag, gpointer user_data)
{
...
GstBuffer *gst_tag_list_to_xmp_buffer(const GstTagList * list, gboolean read_only)
{
    ...
    /* xmp header */
    g_string_append(data, "<?xpacket begin=\"\xEF\xBB\xBF\" id=\"W5M0MpCehiHzreSzNTczkc9d\"?>\n");
    g_string_append(data, "<x:xmpmeta xmlns:x=\"adobe:ns:meta/\" x:xmptk=\"GStreamer\">\n");
    g_string_append(data, "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\"");
    i = 0;
    while (ns_match[i].ns_prefix)
    {
        g_string_append_printf(data, " xmlns:%s=\"%s\"", ns_match[i].ns_prefix, ns_match[i].ns_uri);
        i++;
    }
