...
static GstMissingType missing_structure_get_type(const GstStructure * s)
{
    const gchar *type;
    guint i;
...
GstMessage *gst_missing_uri_source_message_new(GstElement * element, const gchar * protocol)
{
    ...
    s = gst_structure_new("missing-plugin", "type", G_TYPE_STRING, "urisource", "detail", G_TYPE_STRING, protocol, "name", G_TYPE_STRING, description, NULL);
...
GstMessage *gst_missing_uri_sink_message_new(GstElement * element, const gchar * protocol)
{
    ...
    s = gst_structure_new("missing-plugin", "type", G_TYPE_STRING, "urisink", "detail", G_TYPE_STRING, protocol, "name", G_TYPE_STRING, description, NULL);
...
GstMessage *gst_missing_element_message_new(GstElement * element, const gchar * factory_name)
{
    ...
    s = gst_structure_new("missing-plugin", "type", G_TYPE_STRING, "element", "detail", G_TYPE_STRING, factory_name, "name", G_TYPE_STRING, description, NULL);
...
GstMessage *gst_missing_decoder_message_new(GstElement * element, const GstCaps * decode_caps)
{
    ...
    s = gst_structure_new("missing-plugin", "type", G_TYPE_STRING, "decoder", "detail", GST_TYPE_CAPS, caps, "name", G_TYPE_STRING, description, NULL);
...
GstMessage *gst_missing_encoder_message_new(GstElement * element, const GstCaps * encode_caps)
{
    ...
    s = gst_structure_new("missing-plugin", "type", G_TYPE_STRING, "encoder", "detail", GST_TYPE_CAPS, caps, "name", G_TYPE_STRING, description, NULL);
...
static gboolean missing_structure_get_string_detail(const GstStructure * s, gchar ** p_detail)
{
    const gchar *detail;
    GType detail_type;
...
static gboolean missing_structure_get_caps_detail(const GstStructure * s, GstCaps ** p_caps)
{
    const GstCaps *caps;
    const GValue *val;
    GType detail_type;
...
static gchar *gst_installer_detail_new(gchar * description, const gchar * type, const gchar * detail)
{
    const gchar *progname;
    GString *s;
