 ...
 */
static inline guint32 gst_fast_random_uint32(void)
{
...
static inline guint32 gst_fast_random_uint32_range(gint32 start, gint32 end)
{
...
static inline gint32 gst_fast_random_int32(void)
{
    return (gint32) gst_fast_random_uint32();
}

static inline gint32 gst_fast_random_int32_range(gint32 start, gint32 end)
{
...
static inline gdouble gst_fast_random_double(void)
{
    gdouble ret;
...
static inline gdouble gst_fast_random_double_range(gdouble start, gdouble end)
{
