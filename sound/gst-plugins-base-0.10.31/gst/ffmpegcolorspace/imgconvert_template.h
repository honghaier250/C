...
static void glue(uyvy422_to_, RGB_NAME) (AVPicture * dst, const AVPicture * src, int width, int height)
{
    uint8_t *s, *d, *d1, *s1;
...
static void glue(yuv422_to_, RGB_NAME) (AVPicture * dst, const AVPicture * src, int width, int height)
{
    uint8_t *s, *d, *d1, *s1;
    int w, y, cb, cr, r_add, g_add, b_add;
    uint8_t *cm = cropTbl + MAX_NEG_CROP;
...
static void glue(yvyu422_to_, RGB_NAME) (AVPicture * dst, const AVPicture * src, int width, int height)
{
    uint8_t *s, *d, *d1, *s1;
    int w, y, cb, cr, r_add, g_add, b_add;
    uint8_t *cm = cropTbl + MAX_NEG_CROP;
...
static void glue(yuva420p_to_, RGB_NAME) (AVPicture * dst, const AVPicture * src, int width, int height)
{
...
static void glue(nv12_to_, RGB_NAME) (AVPicture * dst, const AVPicture * src, int width, int height)
{
...
static void glue(nv21_to_, RGB_NAME) (AVPicture * dst, const AVPicture * src, int width, int height)
{
    const uint8_t *y1_ptr, *y2_ptr, *c_ptr;
    uint8_t *d, *d1, *d2;
    int w, y, cb, cr, r_add, g_add, b_add;
...
static void glue(y800_to_, RGB_NAME) (AVPicture * dst, const AVPicture * src, int width, int height)
{
...
static void glue(y16_to_, RGB_NAME) (AVPicture * dst, const AVPicture * src, int width, int height)
{
    const unsigned char *p;
    unsigned char *q;
    uint8_t *cm = cropTbl + MAX_NEG_CROP;
...
static void glue(RGB_NAME, _to_yuva420p) (AVPicture * dst, const AVPicture * src, int width, int height)
{
    int wrap, wrap3, width2;
...
static void glue(RGB_NAME, _to_nv12) (AVPicture * dst, const AVPicture * src, int width, int height)
{
    int wrap, wrap3;
    int r, g, b, r1, g1, b1, w;
    uint8_t *lum, *c;
...
static void glue(RGB_NAME, _to_nv21) (AVPicture * dst, const AVPicture * src, int width, int height)
{
    int wrap, wrap3;
    int r, g, b, r1, g1, b1, w;
    uint8_t *lum, *c;
...
static void glue(RGB_NAME, _to_y800) (AVPicture * dst, const AVPicture * src, int width, int height)
{
    const unsigned char *p;
    unsigned char *q;
    int r, g, b, dst_wrap, src_wrap;
...
static void glue(RGB_NAME, _to_y16) (AVPicture * dst, const AVPicture * src, int width, int height)
{
    const unsigned char *p;
    unsigned char *q;
    int r, g, b, dst_wrap, src_wrap;
...
static void glue(RGB_NAME, _to_gray16_l) (AVPicture * dst, const AVPicture * src, int width, int height)
{
    const unsigned char *p;
    unsigned char *q;
    int r, g, b, dst_wrap, src_wrap;
...
static void glue(gray16_l_to_, RGB_NAME) (AVPicture * dst, const AVPicture * src, int width, int height)
{
    const unsigned char *p;
    unsigned char *q;
    int r, dst_wrap, src_wrap;
...
static void glue(RGB_NAME, _to_gray16_b) (AVPicture * dst, const AVPicture * src, int width, int height)
{
    const unsigned char *p;
    unsigned char *q;
    int r, g, b, dst_wrap, src_wrap;
...
static void glue(gray16_b_to_, RGB_NAME) (AVPicture * dst, const AVPicture * src, int width, int height)
{
    const unsigned char *p;
    unsigned char *q;
    int r, dst_wrap, src_wrap;
...
static void ayuv4444_to_rgba32(AVPicture * dst, const AVPicture * src, int width, int height)
{
    uint8_t *s, *d, *d1, *s1;
    int w, y, cb, cr, r_add, g_add, b_add;
    uint8_t *cm = cropTbl + MAX_NEG_CROP;
...
static void rgba32_to_ayuv4444(AVPicture * dst, const AVPicture * src, int width, int height)
{
...
static void bgra32_to_ayuv4444(AVPicture * dst, const AVPicture * src, int width, int height)
{
    int src_wrap, dst_wrap, x, y;
    int r, g, b, a;
    uint8_t *d;
...
static void ayuv4444_to_bgra32(AVPicture * dst, const AVPicture * src, int width, int height)
{
    uint8_t *s, *d, *d1, *s1;
    int w, y, cb, cr, r_add, g_add, b_add;
    uint8_t *cm = cropTbl + MAX_NEG_CROP;
...
static void ayuv4444_to_argb32(AVPicture * dst, const AVPicture * src, int width, int height)
{
    uint8_t *s, *d, *d1, *s1;
    int w, y, cb, cr, r_add, g_add, b_add;
    uint8_t *cm = cropTbl + MAX_NEG_CROP;
...
static void argb32_to_ayuv4444(AVPicture * dst, const AVPicture * src, int width, int height)
{
    int src_wrap, dst_wrap, x, y;
    int r, g, b, a;
    uint8_t *d;
...
static void abgr32_to_ayuv4444(AVPicture * dst, const AVPicture * src, int width, int height)
{
    int src_wrap, dst_wrap, x, y;
    int r, g, b, a;
    uint8_t *d;
...
static void ayuv4444_to_abgr32(AVPicture * dst, const AVPicture * src, int width, int height)
{
    uint8_t *s, *d, *d1, *s1;
    int w, y, cb, cr, r_add, g_add, b_add;
    uint8_t *cm = cropTbl + MAX_NEG_CROP;
...
static void ayuv4444_to_rgb24(AVPicture * dst, const AVPicture * src, int width, int height)
{
    uint8_t *s, *d, *d1, *s1;
    int w, y, cb, cr, r_add, g_add, b_add;
    uint8_t *cm = cropTbl + MAX_NEG_CROP;
...
static void rgb24_to_ayuv4444(AVPicture * dst, const AVPicture * src, int width, int height)
{
    int src_wrap, dst_wrap, x, y;
    int r, g, b;
    uint8_t *d;
...
static void v308_to_rgb24(AVPicture * dst, const AVPicture * src, int width, int height)
{
    uint8_t *s, *d, *d1, *s1;
    int w, y, cb, cr, r_add, g_add, b_add;
    uint8_t *cm = cropTbl + MAX_NEG_CROP;
...
static void rgb24_to_v308(AVPicture * dst, const AVPicture * src, int width, int height)
{
    int src_wrap, dst_wrap, x, y;
    int r, g, b;
    uint8_t *d;
