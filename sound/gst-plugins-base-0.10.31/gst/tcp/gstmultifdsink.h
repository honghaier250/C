...
struct _GstMultiFdSinkClass
{
    ...
    void (*add_full) (GstMultiFdSink * sink, int fd, GstSyncMethod sync, GstTCPUnitType format, guint64 value, GstTCPUnitType max_unit, guint64 max_value);
...
void gst_multi_fd_sink_add_full(GstMultiFdSink * sink, int fd, GstSyncMethod sync, GstTCPUnitType min_unit, guint64 min_value, GstTCPUnitType max_unit, guint64 max_value);
