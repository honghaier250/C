...
#else
static void _backup_gst_orc_splat_u8(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_int8 *ORC_RESTRICT ptr0;
...
#else
static void _backup_gst_orc_splat_s16(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union16 *ORC_RESTRICT ptr0;
...
#else
static void _backup_gst_orc_splat_u16(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union16 *ORC_RESTRICT ptr0;
...
#else
static void _backup_gst_orc_splat_u32(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union32 *ORC_RESTRICT ptr0;
