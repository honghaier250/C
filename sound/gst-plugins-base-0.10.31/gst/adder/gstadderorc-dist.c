...
#else
static void _backup_add_int32(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void _backup_add_int16(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union16 *ORC_RESTRICT ptr0;
...
#else
static void _backup_add_int8(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_int8 *ORC_RESTRICT ptr0;
...
#else
static void _backup_add_uint32(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void _backup_add_uint16(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union16 *ORC_RESTRICT ptr0;
...
#else
static void _backup_add_uint8(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_int8 *ORC_RESTRICT ptr0;
...
#else
static void _backup_add_float32(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union32 *ORC_RESTRICT ptr0;
