...
#else
static void _backup_orc_scalarmultiply_f64_ns(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union64 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_scalarmultiply_f32_ns(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_process_int32(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_process_int32_clamp(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_process_int16(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union16 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_process_int16_clamp(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union16 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_process_int8(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_int8 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_process_int8_clamp(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_int8 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_memset_f64(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union64 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_prepare_volumes(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union64 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_process_controlled_f64_1ch(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union64 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_process_controlled_f32_1ch(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_process_controlled_f32_2ch(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union64 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_process_controlled_int32_1ch(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_process_controlled_int16_1ch(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union16 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_process_controlled_int16_2ch(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_process_controlled_int8_1ch(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_int8 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_process_controlled_int8_2ch(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union16 *ORC_RESTRICT ptr0;
