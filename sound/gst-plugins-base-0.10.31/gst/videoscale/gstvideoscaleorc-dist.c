...
#else
static void _backup_orc_merge_linear_u8(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_int8 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_merge_linear_u16(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union16 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_splat_u16(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union16 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_splat_u32(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_downsample_u8(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_int8 *ORC_RESTRICT ptr0;
...
#else
static void _backup_orc_downsample_u16(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union16 *ORC_RESTRICT ptr0;
...
#else
static void _backup_gst_videoscale_orc_downsample_u32(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void _backup_gst_videoscale_orc_downsample_yuyv(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void _backup_gst_videoscale_orc_resample_nearest_u8(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_int8 *ORC_RESTRICT ptr0;
...
#else
static void _backup_gst_videoscale_orc_resample_bilinear_u8(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_int8 *ORC_RESTRICT ptr0;
...
#else
static void _backup_gst_videoscale_orc_resample_nearest_u32(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void _backup_gst_videoscale_orc_resample_bilinear_u32(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void _backup_gst_videoscale_orc_resample_merge_bilinear_u32(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void _backup_gst_videoscale_orc_merge_bicubic_u8(OrcExecutor * ORC_RESTRICT ex)
{
    int i;
    int n = ex->n;
    orc_int8 *ORC_RESTRICT ptr0;
