...
bool Profile::isNameValid(std::string name)
{
    ...
    if ((name.find('/') != std::string::npos) ||
        ...
        (name.find(';') != std::string::npos) || (name.find('#') != std::string::npos) || (name.find('=') != std::string::npos) || (name.find('~') != std::string::npos) || (name.find('.') != std::string::npos))
        return false;
...
name(name), directory(Globals::Config::directory + name + "/"), fileSettings(directory + "settings.ini"), fileTheme(directory + "theme.ini"), fileStatistics(directory + "statistics.bin")
{
