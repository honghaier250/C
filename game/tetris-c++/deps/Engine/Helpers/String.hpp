...
namespace Utils
{
    ...
    namespace String
    {
        ...
        template < typename T > inline std::string toString(T const &x)
        {
            std::ostringstream o;
            if (!(o << x))
        ...
        template < typename T > inline void convert(std::string const &s, T & x, bool failIfLeftOverChars = true)
        {
        ...
        template < typename T > inline T to(std::string const &s, bool failIfLeftOverChars = true)
        {
            T x;
