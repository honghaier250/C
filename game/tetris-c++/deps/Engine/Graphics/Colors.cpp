...
name(name), red(-1), green(-1), blue(-1), ncurses_color(COLOR_WHITE)
{
}
...
std::string Color::toString()
{
    ...
    return (Utils::String::toString(this->red) + "," + Utils::String::toString(this->green) + "," + Utils::String::toString(this->blue));
}
...
ColorPair::ColorPair():
bold(false), ncurses_pair(0)
{
}

ColorPair::ColorPair(Color foreground, Color background):
foreground(foreground), background(background), bold(false), ncurses_pair(0)
{
}
...
Color Colors::name(std::string str)
{
    ...
    if (str == "default")
        color.ncurses_color = COLOR_DEFAULT;
    else if (str == "black")
        color.ncurses_color = COLOR_BLACK;
    else if (str == "red")
        color.ncurses_color = COLOR_RED;
    else if (str == "green")
        color.ncurses_color = COLOR_GREEN;
    else if (str == "yellow")
        color.ncurses_color = COLOR_YELLOW;
    else if (str == "blue")
        color.ncurses_color = COLOR_BLUE;
    else if (str == "magenta")
        color.ncurses_color = COLOR_MAGENTA;
    else if (str == "cyan")
        color.ncurses_color = COLOR_CYAN;
    else if (str == "white")
        color.ncurses_color = COLOR_WHITE;
