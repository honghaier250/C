...
Window::Window(int x, int y, int w, int h):win(NULL), x(x), y(y), width(w), height(h), borderType(BORDER_NONE), topLeftTitle(""), topRightTitle(""), bottomLeftTitle(""), bottomRightTitle("")
{
...
Window::Window(Window * parent, int x, int y, int width, int height):win(NULL), borderType(BORDER_NONE), topLeftTitle(""), topRightTitle(""), bottomLeftTitle(""), bottomRightTitle("")
{
...
void Window::clear()
{
    ...
    {
        this->print(this->topLeftTitle, 1, 0, EngineGlobals::Theme::hilite_hilite_text);
    }
    if (!this->bottomLeftTitle.empty())
    {
        this->print(this->bottomLeftTitle, 0, this->getH() - 1, EngineGlobals::Theme::hilite_hilite_text);
    }
    if (!this->topRightTitle.empty())
    {
        ...
        this->print(this->topRightTitle, x - w, 0, EngineGlobals::Theme::hilite_hilite_text);
    }
    if (!this->bottomRightTitle.empty())
    {
        ...
        this->print(this->bottomRightTitle, x - w, this->getH() - 1, EngineGlobals::Theme::hilite_hilite_text);
    }
}
...
void Window::borders(BorderType type)
{
    ...
    if (type == Window::BORDER_FANCY)
    {
        ...
        wborder(this->win,
                ...
                ACS_URCORNER | EngineGlobals::Theme::dim_text.ncurses_pair, ACS_LLCORNER | EngineGlobals::Theme::dim_text.ncurses_pair, ACS_LRCORNER | EngineGlobals::Theme::dim_dim_text.ncurses_pair);
    }
...
void Window::setBorders()
{
    ...
    {
        this->borders(EngineGlobals::Screen::fancy_borders ? Window::BORDER_FANCY : Window::BORDER_REGULAR);
    }
}
