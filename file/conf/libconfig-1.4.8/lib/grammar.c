...
static void capture_parse_pos (void *scanner, struct scan_context *scan_ctx, config_setting_t * setting)
{
...
void libconfig_yyerror (void *scanner, struct parse_context *ctx, struct scan_context *scan_ctx, char const *s)
{
...
#if (defined __STDC__ || defined __C99__FUNC__ \
     || defined __cplusplus || defined _MSC_VER)
static void yy_symbol_value_print (FILE * yyoutput, int yytype, YYSTYPE const *const yyvaluep, void *scanner, struct parse_context *ctx, struct scan_context *scan_ctx)
#else
static void yy_symbol_value_print (yyoutput, yytype, yyvaluep, scanner, ctx, scan_ctx)
     FILE *yyoutput;
     int yytype;
...
#if (defined __STDC__ || defined __C99__FUNC__ \
     || defined __cplusplus || defined _MSC_VER)
static void yy_symbol_print (FILE * yyoutput, int yytype, YYSTYPE const *const yyvaluep, void *scanner, struct parse_context *ctx, struct scan_context *scan_ctx)
#else
static void yy_symbol_print (yyoutput, yytype, yyvaluep, scanner, ctx, scan_ctx)
     FILE *yyoutput;
     int yytype;
     YYSTYPE const *const yyvaluep;
     void *scanner;
...
#if (defined __STDC__ || defined __C99__FUNC__ \
     || defined __cplusplus || defined _MSC_VER)
static void yy_reduce_print (YYSTYPE * yyvsp, int yyrule, void *scanner, struct parse_context *ctx, struct scan_context *scan_ctx)
#else
static void yy_reduce_print (yyvsp, yyrule, scanner, ctx, scan_ctx)
     YYSTYPE *yyvsp;
     int yyrule;
     void *scanner;
     struct parse_context *ctx;
...
#endif
{
    ...
    for (yyi = 0; yyi < yynrhs; yyi++)
	{
	    ...
	    yy_symbol_print (stderr, yyrhs[yyprhs[yyrule] + yyi], &(yyvsp[(yyi + 1) - (yynrhs)]), scanner, ctx, scan_ctx);
	    YYFPRINTF (stderr, "\n");
	}
}
...
#if (defined __STDC__ || defined __C99__FUNC__ \
     || defined __cplusplus || defined _MSC_VER)
static void yydestruct (const char *yymsg, int yytype, YYSTYPE * yyvaluep, void *scanner, struct parse_context *ctx, struct scan_context *scan_ctx)
#else
static void yydestruct (yymsg, yytype, yyvaluep, scanner, ctx, scan_ctx)
     const char *yymsg;
     int yytype;
     YYSTYPE *yyvaluep;
     void *scanner;
...
int yyparse (void *scanner, struct parse_context *ctx, struct scan_context *scan_ctx)
#else
int yyparse (scanner, ctx, scan_ctx)
     void *scanner;
     struct parse_context *ctx;
     struct scan_context *scan_ctx;
#endif
...
`------------------------------------*/
  yyerrlab:
    ...
    if (yyerrstatus == 3)
	{
		...
		{
		    yydestruct ("Error: discarding", yytoken, &yylval, scanner, ctx, scan_ctx);
		    yychar = YYEMPTY;
		}
	}
...
`-------------------------------------------------------------*/
  yyerrlab1:
    ...
    for (;;)
	{
	    ...
	    yydestruct ("Error: popping", yystos[yystate], yyvsp, scanner, ctx, scan_ctx);
	    YYPOPSTACK (1);
	    yystate = *yyssp;
	    YY_STACK_PRINT (yyss, yyssp);
	}
...
`-------------------------------------------------*/
  ...
  yyreturn:
    if (yychar != YYEMPTY)
	yydestruct ("Cleanup: discarding lookahead", yytoken, &yylval, scanner, ctx, scan_ctx);
    /* Do not reclaim the symbols of the rule which action triggered
    ...
    while (yyssp != yyss)
	{
	    yydestruct ("Cleanup: popping", yystos[*yyssp], yyvsp, scanner, ctx, scan_ctx);
	    YYPOPSTACK (1);
	}
#ifndef yyoverflow
    if (yyss != yyssa)
