...
extern const char **scanctx_cleanup (struct scan_context *ctx, unsigned int *num_filenames);

extern FILE *scanctx_push_include (struct scan_context *ctx, void *prev_buffer, const char **error);
